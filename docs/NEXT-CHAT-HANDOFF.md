...
# **ACTIVE v3 MANUSCRIPT = 4 / 410 — EP001~004 ACCEPTED.**
...
**Next: EP005 — 남의 결정도 내 하루가 된다, on explicit user instruction.**

**회차 분량: 하한 5,500자 · 상한 없음.** 초과는 결함이 아니며 길이를 이유로 장면을 자르지 않는다 (CHG-060).
