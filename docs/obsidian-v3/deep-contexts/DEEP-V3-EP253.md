...
source_snapshot: router=CTX-V3-EP253; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT6-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-6B
- beat: BEAT-V3-B35
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT6-v0.1.md selector `EP253`
- branch: H-B
- concurrency: ACT6_LEDGER
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP252: End Turn=overlapping groups begin making independent demands on infrastructure. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.
...
- projected relationship line: Juno thinks formal fairness ignores trust networks; conflict becomes acute.
...
- zone: Transfer Belt
- projected world pressure: factions overlap rather than map to districts.
...
- Source-owned institutional/world pressure: factions overlap rather than map to districts. Relationship/institution interface: Juno thinks formal fairness ignores trust networks; conflict becomes acute.
...
- classification=NONE. Source clue=NONE. Outgoing selector=one medical rescue request forces Rafi/Leila into reversed positions. No authorial ominous narration beyond Blueprint evidence.
...
## Forecast Outgoing
- projected End Turn: one medical rescue request forces Rafi/Leila into reversed positions.
...
1. Episode Card — exact EP253 Blueprint selector; A-Plot/Want/End Turn authority.
