...
source_snapshot: router=CTX-V3-EP086; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT2-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-2C
- beat: BEAT-V3-B12
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT2-v0.1.md selector `EP086`
- branch: H-A
- concurrency: ACT2_LEDGER
- Current-lived namespace remains H-A; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP085: End Turn=cut to people affected beyond his view. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: affected resident/family
- OFF-POV / INFLUENCE_ONLY_UNLESS_BLUEPRINT_EXPLICIT. affected resident/family owns the episode's lived decision line. Do not reroute success, discovery, or emotional resolution through the protagonist merely for centrality.

## Character Context
- active_core_cap: max 3 salient characters including POV.
- projected_active_core: affected resident/family, family
...
- projected relationship line: grief/anger does not need to be `correct` or `incorrect` about protagonist.
...
- projected world pressure: policy/engineering decisions create moral perspectives outside hero POV.
...
- Source-owned institutional/world pressure: policy/engineering decisions create moral perspectives outside hero POV. Relationship/institution interface: grief/anger does not need to be `correct` or `incorrect` about protagonist.
...
- source clue: NONE.
- local knowledge fence: family does not know technical details.
...
- classification=NONE. Source clue=NONE. Outgoing selector=protagonist later sees/hears part of this reaction. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: experiences protagonist's technical recommendation only as an irreversible closure with incomplete information; receives delayed casualty/evacuation news. Immediate Want: locate a family member or understand why the route shut. Act guard: Disaster/concurrency first. Resolve ACT2_LEDGER geography/time before scene execution; do not explain the branch mechanism. EP094 ends H-A current-lived state.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: experiences protagonist's technical recommendation only as an irreversible closure with incomplete information; receives delayed casualty/evacuation news.
- exact Immediate Want: locate a family member or understand why the route shut.
- exact End Turn: protagonist later sees/hears part of this reaction.
...
## Forecast Outgoing
- projected End Turn: protagonist later sees/hears part of this reaction.
...
1. Episode Card — exact EP086 Blueprint selector; A-Plot/Want/End Turn authority.
2. Immediate Continuity — prior realized CONTINUITY-FROZEN + this forecast selector; never future guessed Actual.
3. POV/Relationship — POV=affected resident/family; relationship line + current role/relationship graph, active core <=3.
4. World/Zone/Material — Zone=L-C / closed-side consequence chain; current world/material/location router, branch=H-A.
