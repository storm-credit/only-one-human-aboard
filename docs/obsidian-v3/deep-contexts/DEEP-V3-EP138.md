...
beat: BEAT-V3-B20
concurrency: NONE
source_snapshot: router=CTX-V3-EP138; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT4-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-4A
- beat: BEAT-V3-B20
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT4-v0.1.md selector `EP138`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP137: End Turn=one wealthy operator, Cassian, appears to have moved assets before several disruptions. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=determine whether Cassian's preparation pattern overlaps known anomalies. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: protagonist's anger rises at possibility someone profited while others suffered.
...
- projected world pressure: wealth can move faster than public institutions.
...
- Source-owned institutional/world pressure: wealth can move faster than public institutions. Relationship/institution interface: protagonist's anger rises at possibility someone profited while others suffered.
...
- source clue: Cassian ambiguity PLANT.
...
- classification=PLANT. Source clue=Cassian ambiguity PLANT. Outgoing selector=one move occurred before any plausible public warning. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: reviews public timing with Sora's limited access; finds several uncanny but individually explainable moves. Immediate Want: determine whether Cassian's preparation pattern overlaps known anomalies. Act guard: Prediction and social consequence before ontology. Evidence must change choices/relationships before any explanatory model hardens.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: reviews public timing with Sora's limited access; finds several uncanny but individually explainable moves.
- exact Immediate Want: determine whether Cassian's preparation pattern overlaps known anomalies.
- exact End Turn: one move occurred before any plausible public warning.
...
## Forecast Outgoing
- projected End Turn: one move occurred before any plausible public warning.
...
1. Episode Card — exact EP138 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=Transfer Belt commercial/industrial interface; current world/material/location router, branch=H-B.
