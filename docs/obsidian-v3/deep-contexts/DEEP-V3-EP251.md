...
source_snapshot: router=CTX-V3-EP251; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT6-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-6B
- beat: BEAT-V3-B34
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT6-v0.1.md selector `EP251`
- branch: H-B
- concurrency: ACT6_LEDGER
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP250: End Turn=release validates some public grievances and disproves others. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=keep technical team from splitting along political interpretations of Hana's release. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: Niko grows more sympathetic to anti-secrecy/worker autonomy networks.
...
- projected world pressure: factions form around needs and interpretations.
...
- Source-owned institutional/world pressure: factions form around needs and interpretations. Relationship/institution interface: Niko grows more sympathetic to anti-secrecy/worker autonomy networks.
...
- classification=NONE. Source clue=NONE. Outgoing selector=strategic restrictions extend another cycle. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: workers read the same facts differently; protagonist narrows work decisions to measurable safety while acknowledging policy grievance is real. Immediate Want: keep technical team from splitting along political interpretations of Hana's release. Act guard: Resolve ACT6_LEDGER concurrency/resource/network state before execution; causality must remain distributed across people and institutions.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: workers read the same facts differently; protagonist narrows work decisions to measurable safety while acknowledging policy grievance is real.
- exact Immediate Want: keep technical team from splitting along political interpretations of Hana's release.
- exact End Turn: strategic restrictions extend another cycle.
...
## Forecast Outgoing
- projected End Turn: strategic restrictions extend another cycle.
...
1. Episode Card — exact EP251 Blueprint selector; A-Plot/Want/End Turn authority.
