...
source_snapshot: router=CTX-V3-EP064; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT2-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-2B
- beat: BEAT-V3-B09
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT2-v0.1.md selector `EP064`
- branch: H-A
- concurrency: ACT2_LEDGER
- Current-lived namespace remains H-A; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP063: End Turn=Mira reports evacuation/freight conflict caused by security routing. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: Mira
- OFF-POV / INFLUENCE_ONLY_UNLESS_BLUEPRINT_EXPLICIT. Mira owns the episode's lived decision line. Do not reroute success, discovery, or emotional resolution through the protagonist merely for centrality.

## Character Context
- active_core_cap: max 3 salient characters including POV.
- projected_active_core: Mira, Selene, Juno
...
- projected relationship line: her decision helps Selene but strains Juno/local networks waiting for supplies.
...
- zone: L-B
- projected world pressure: emergency resource conversion has losers.
...
- Source-owned institutional/world pressure: emergency resource conversion has losers. Relationship/institution interface: her decision helps Selene but strains Juno/local networks waiting for supplies.
...
- classification=NONE. Source clue=NONE. Outgoing selector=public rumor turns `unauthorized bypass` into `terrorist attack` before facts are settled. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: cuts discretionary freight and changes transfer sequencing, angering businesses/work crews that were promised reopening. Immediate Want: keep evac traffic moving while one security corridor is restricted. Act guard: Disaster/concurrency first. Resolve ACT2_LEDGER geography/time before scene execution; do not explain the branch mechanism. EP094 ends H-A current-lived state.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: cuts discretionary freight and changes transfer sequencing, angering businesses/work crews that were promised reopening.
- exact Immediate Want: keep evac traffic moving while one security corridor is restricted.
- exact End Turn: public rumor turns `unauthorized bypass` into `terrorist attack` before facts are settled.
...
## Forecast Outgoing
- projected End Turn: public rumor turns `unauthorized bypass` into `terrorist attack` before facts are settled.
...
1. Episode Card — exact EP064 Blueprint selector; A-Plot/Want/End Turn authority.
2. Immediate Continuity — prior realized CONTINUITY-FROZEN + this forecast selector; never future guessed Actual.
3. POV/Relationship — POV=Mira; relationship line + current role/relationship graph, active core <=3.
