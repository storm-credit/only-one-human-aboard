...
beat: BEAT-V3-B54
concurrency: NONE
source_snapshot: router=CTX-V3-EP400; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT9-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-9B
- beat: BEAT-V3-B54
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT9-v0.1.md selector `EP400`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP399: End Turn=operation succeeds enough for survival but not restoration of lost assets. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=verify people and infrastructure that actually remain. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: protagonist does not ask to rerun a safer branch; begins repair from what exists.
...
- projected world pressure: first unrehearsed survival completed.
...
- Source-owned institutional/world pressure: first unrehearsed survival completed. Relationship/institution interface: protagonist does not ask to rerun a safer branch; begins repair from what exists.
...
- source clue: D11 PAYOFF = external reality exceeded exact rehearsal; no alien reveal. Final no-retry choice PAYOFF.
...
- classification=PAYOFF. Source clue=D11 PAYOFF = external reality exceeded exact rehearsal; no alien reveal. Final no-retry choice PAYOFF. Outgoing selector=attention shifts from survival to how people live afterward. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: crisis stabilizes; some capacity/assets are permanently lost, current continuities survive with real injuries/losses, external signal/source remains unresolved. Immediate Want: verify people and infrastructure that actually remain. Act guard: Descendant completion and return/payoff outrank novelty. No rerun/new ontology by default; EP406-410 add no major mystery and close through consequence/return.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: crisis stabilizes; some capacity/assets are permanently lost, current continuities survive with real injuries/losses, external signal/source remains unresolved.
- exact Immediate Want: verify people and infrastructure that actually remain.
- exact End Turn: attention shifts from survival to how people live afterward.
...
## Forecast Outgoing
- projected End Turn: attention shifts from survival to how people live afterward.
...
1. Episode Card — exact EP400 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=settlement/Ark interface; current world/material/location router, branch=H-B.
