...
beat: BEAT-V3-B46
concurrency: NONE
source_snapshot: router=CTX-V3-EP338; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT8-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-8A
- beat: BEAT-V3-B46
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT8-v0.1.md selector `EP338`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP337: End Turn=one major loss event intersects known Outer Ark physical history. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=verify attrition physically. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: he realizes current extraordinary protection is consequence of scarcity, not proof the last one was always central.
...
- projected world pressure: contingency embedded in infrastructure.
...
- Source-owned institutional/world pressure: contingency embedded in infrastructure. Relationship/institution interface: he realizes current extraordinary protection is consequence of scarcity, not proof the last one was always central.
...
- classification=PAYOFF. Source clue=D07 FINAL PAYOFF. Outgoing selector=question shifts to who has rights over/around the last continuity. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: sees retired/damaged preservation pathways consistent with prior distributed cohort; later redundancy concentrates around remaining continuity. Immediate Want: verify attrition physically. Act guard: HUMAN provenance is not personhood. HUMAN:1 must remain de-collectified and must not become a collectible-character family or sacred merchandise target.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: sees retired/damaged preservation pathways consistent with prior distributed cohort; later redundancy concentrates around remaining continuity.
- exact Immediate Want: verify attrition physically.
- exact End Turn: question shifts to who has rights over/around the last continuity.
...
## Forecast Outgoing
- projected End Turn: question shifts to who has rights over/around the last continuity.
...
1. Episode Card — exact EP338 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=physical preservation support map; current world/material/location router, branch=H-B.
