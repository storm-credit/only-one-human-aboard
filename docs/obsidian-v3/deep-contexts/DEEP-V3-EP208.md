...
beat: BEAT-V3-B29
concurrency: NONE
source_snapshot: router=CTX-V3-EP208; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT5-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-5B
- beat: BEAT-V3-B29
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT5-v0.1.md selector `EP208`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP207: End Turn=Sora finds a third fragment where the event did not occur in either remembered form. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.
...
- projected relationship line: Sora↔Hana differ on how much to disclose to involved people/public.
...
- projected world pressure: epistemic uncertainty becomes institutional problem.
...
- Source-owned institutional/world pressure: epistemic uncertainty becomes institutional problem. Relationship/institution interface: Sora↔Hana differ on how much to disclose to involved people/public.
...
- source clue: no-original-current-state red herring begins, not yet full scale.
...
- classification=SOURCE_DEFINED. Source clue=no-original-current-state red herring begins, not yet full scale. Outgoing selector=protagonist must face Arun again without asking which version is real. No authorial ominous narration beyond Blueprint evidence.
...
## Forecast Outgoing
- projected End Turn: protagonist must face Arun again without asking which version is real.
...
1. Episode Card — exact EP208 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=investigation/records; current world/material/location router, branch=H-B.
