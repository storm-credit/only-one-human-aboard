...
beat: BEAT-V3-B43
concurrency: NONE
source_snapshot: router=CTX-V3-EP318; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT7-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-7C
- beat: BEAT-V3-B43
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT7-v0.1.md selector `EP318`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP317: End Turn=Sora traces rare memory cases to isolation/integrity faults across lineage references. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.
...
- projected relationship line: prior suspicion of carriers becomes a privacy/safety issue rather than criminal class.
...
- projected world pressure: memory leak becomes critical bug model.
...
- Source-owned institutional/world pressure: memory leak becomes critical bug model. Relationship/institution interface: prior suspicion of carriers becomes a privacy/safety issue rather than criminal class.
...
- classification=PAYOFF. Source clue=D04 FINAL PAYOFF. Outgoing selector=one protected route clearly separates ordinary lineage infrastructure from HUMAN preservation chain. No authorial ominous narration beyond Blueprint evidence.
...
## Forecast Outgoing
- projected End Turn: one protected route clearly separates ordinary lineage infrastructure from HUMAN preservation chain.
...
1. Episode Card — exact EP318 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=security/continuity evidence; current world/material/location router, branch=H-B.
