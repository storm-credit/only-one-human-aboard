...
source_snapshot: router=CTX-V3-EP053; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT2-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-2A
- beat: BEAT-V3-B08
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT2-v0.1.md selector `EP053`
- branch: H-A
- concurrency: ACT2_LEDGER
- Current-lived namespace remains H-A; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP052: End Turn=crowding at one junction exceeds model prediction. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=explain why the affected junction failed in an unexpected pattern. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: protagonist and Gideon agree the fact matters for safety but not yet why.
...
- zone: L-A
- projected world pressure: more of Old Works must be treated conservatively.
...
- Source-owned institutional/world pressure: more of Old Works must be treated conservatively. Relationship/institution interface: protagonist and Gideon agree the fact matters for safety but not yet why.
...
- source clue: D03 REINFORCE, hard physical evidence but local-scale.
...
- classification=REINFORCE. Source clue=D03 REINFORCE, hard physical evidence but local-scale. Outgoing selector=reroute crowding creates a separate emergency protagonist cannot reach. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: destructive inspection shows an old repaired interface physically predates its digital history. Immediate Want: explain why the affected junction failed in an unexpected pattern. Act guard: Disaster/concurrency first. Resolve ACT2_LEDGER geography/time before scene execution; do not explain the branch mechanism. EP094 ends H-A current-lived state.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: destructive inspection shows an old repaired interface physically predates its digital history.
- exact Immediate Want: explain why the affected junction failed in an unexpected pattern.
- exact End Turn: reroute crowding creates a separate emergency protagonist cannot reach.
...
## Forecast Outgoing
- projected End Turn: reroute crowding creates a separate emergency protagonist cannot reach.
...
1. Episode Card — exact EP053 Blueprint selector; A-Plot/Want/End Turn authority.
