...
beat: BEAT-V3-B41
concurrency: NONE
source_snapshot: router=CTX-V3-EP300; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT7-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-7B
- beat: BEAT-V3-B41
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT7-v0.1.md selector `EP300`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP299: End Turn=current Arun agrees to review evidence on his own terms. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=discuss incompatible histories without asking which one is `real`. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: current relationship matures around present responsibility.
...
- projected world pressure: counterpart liability rule becomes human before formal law.
...
- Source-owned institutional/world pressure: counterpart liability rule becomes human before formal law. Relationship/institution interface: current relationship matures around present responsibility.
...
- classification=REINFORCE. Source clue=D01/D09 REINFORCE. Outgoing selector=Arun possesses a current-life reason to help inspect one old incident source. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: protagonist shares evidence, current Arun rejects responsibility for acts another history's Arun performed and likewise refuses to blame protagonist for another counterpart's acts. Immediate Want: discuss incompatible histories without asking which one is `real`. Act guard: Action/evidence before ontology. Every explanatory beat must be earned by a concrete decision, cost, failed model, or operational consequence.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: protagonist shares evidence, current Arun rejects responsibility for acts another history's Arun performed and likewise refuses to blame protagonist for another counterpart's acts.
- exact Immediate Want: discuss incompatible histories without asking which one is `real`.
- exact End Turn: Arun possesses a current-life reason to help inspect one old incident source.
...
## Forecast Outgoing
- projected End Turn: Arun possesses a current-life reason to help inspect one old incident source.
...
1. Episode Card — exact EP300 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=neutral current-Arun interaction; current world/material/location router, branch=H-B.
