...
beat: BEAT-V3-B05
concurrency: NONE
source_snapshot: router=CTX-V3-EP034; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT1-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-1C
- beat: BEAT-V3-B05
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT1-v0.1.md selector `EP034`
- branch: H-A
- concurrency: NONE
- Current-lived namespace remains H-A; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP033: End Turn=transit maintenance outside the case forces supplies to reroute. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: Juno
- OFF-POV / INFLUENCE_ONLY_UNLESS_BLUEPRINT_EXPLICIT. Juno owns the episode's lived decision line. Do not reroute success, discovery, or emotional resolution through the protagonist merely for centrality.

## Character Context
- active_core_cap: max 3 salient characters including POV.
- projected_active_core: Mira, Juno, parents
...
- projected relationship line: Juno↔Mira network familiarity grows independently.
...
- projected world pressure: seeds Transit Dispatcher as ordinary worker before later importance.
...
- Source-owned institutional/world pressure: seeds Transit Dispatcher as ordinary worker before later importance. Relationship/institution interface: Juno↔Mira network familiarity grows independently.
...
- classification=NONE. Source clue=NONE. Outgoing selector=a delayed maintenance crew arrives at Old Works after protagonist's team has already changed its work plan. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: works around a reroute, deals with delivery riders/parents/shift workers, and interacts briefly with a dispatcher whose choices affect many people. Immediate Want: keep ordinary community service running through a transit maintenance day. Act guard: Ordinary-world first. Do not objectively confirm regression, branching, substrate, or HUMAN:1; ordinary failures remain genuinely possible.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: works around a reroute, deals with delivery riders/parents/shift workers, and interacts briefly with a dispatcher whose choices affect many people.
- exact Immediate Want: keep ordinary community service running through a transit maintenance day.
- exact End Turn: a delayed maintenance crew arrives at Old Works after protagonist's team has already changed its work plan.
...
## Forecast Outgoing
- projected End Turn: a delayed maintenance crew arrives at Old Works after protagonist's team has already changed its work plan.
...
1. Episode Card — exact EP034 Blueprint selector; A-Plot/Want/End Turn authority.
2. Immediate Continuity — prior realized CONTINUITY-FROZEN + this forecast selector; never future guessed Actual.
3. POV/Relationship — POV=Juno; relationship line + current role/relationship graph, active core <=3.
4. World/Zone/Material — Zone=Midring / Transfer interface; current world/material/location router, branch=H-A.
