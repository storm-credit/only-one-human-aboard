...
source_snapshot: router=CTX-V3-EP249; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT6-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-6B
- beat: BEAT-V3-B34
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT6-v0.1.md selector `EP249`
- branch: H-B
- concurrency: ACT6_LEDGER
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP248: End Turn=Hana possesses records that could explain allocation decisions but inflame the public. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=explain why immediate restoration is not simply a matter of effort. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: resentment toward him becomes personal but understandable.
...
- projected world pressure: physical constraints cannot be solved by political messaging.
...
- Source-owned institutional/world pressure: physical constraints cannot be solved by political messaging. Relationship/institution interface: resentment toward him becomes personal but understandable.
...
- source clue: broader hidden load remains unexplained.
...
- classification=SOURCE_DEFINED. Source clue=broader hidden load remains unexplained. Outgoing selector=Hana decides whether to release historical allocation records. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: faces residents/workers who need power now; refuses to use hidden-HUMAN/ontology suspicions as explanation because he does not know enough. Immediate Want: explain why immediate restoration is not simply a matter of effort. Act guard: Resolve ACT6_LEDGER concurrency/resource/network state before execution; causality must remain distributed across people and institutions.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: faces residents/workers who need power now; refuses to use hidden-HUMAN/ontology suspicions as explanation because he does not know enough.
- exact Immediate Want: explain why immediate restoration is not simply a matter of effort.
- exact End Turn: Hana decides whether to release historical allocation records.
...
## Forecast Outgoing
- projected End Turn: Hana decides whether to release historical allocation records.
...
1. Episode Card — exact EP249 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=Old Works / public hearing-work interface; current world/material/location router, branch=H-B.
