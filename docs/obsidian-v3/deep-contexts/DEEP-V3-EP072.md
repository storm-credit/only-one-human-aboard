...
source_snapshot: router=CTX-V3-EP072; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT2-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-2B
- beat: BEAT-V3-B10
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT2-v0.1.md selector `EP072`
- branch: H-A
- concurrency: ACT2_LEDGER
- Current-lived namespace remains H-A; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP071: End Turn=hospital load and residential supply pressure collide with the prolonged closure. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: Leila
- OFF-POV / INFLUENCE_ONLY_UNLESS_BLUEPRINT_EXPLICIT. Leila owns the episode's lived decision line. Do not reroute success, discovery, or emotional resolution through the protagonist merely for centrality.

## Character Context
- active_core_cap: max 3 salient characters including POV.
- projected_active_core: Leila, Rafi
...
- projected relationship line: Leila↔Rafi conflict becomes professional and moral, not personal hostility.
...
- projected world pressure: hospital system has finite staff/time even with advanced medicine.
...
- Source-owned institutional/world pressure: hospital system has finite staff/time even with advanced medicine. Relationship/institution interface: Leila↔Rafi conflict becomes professional and moral, not personal hostility.
...
- classification=NONE. Source clue=NONE. Outgoing selector=one Midring pocket cannot receive normal distribution because the route remains closed. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: changes triage/transfer thresholds and rejects Rafi's assumption that every successful field rescue can be absorbed immediately. Immediate Want: preserve trauma capacity for incoming casualties without abandoning current patients. Act guard: Disaster/concurrency first. Resolve ACT2_LEDGER geography/time before scene execution; do not explain the branch mechanism. EP094 ends H-A current-lived state.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: changes triage/transfer thresholds and rejects Rafi's assumption that every successful field rescue can be absorbed immediately.
- exact Immediate Want: preserve trauma capacity for incoming casualties without abandoning current patients.
- exact End Turn: one Midring pocket cannot receive normal distribution because the route remains closed.
...
## Forecast Outgoing
- projected End Turn: one Midring pocket cannot receive normal distribution because the route remains closed.
...
1. Episode Card — exact EP072 Blueprint selector; A-Plot/Want/End Turn authority.
2. Immediate Continuity — prior realized CONTINUITY-FROZEN + this forecast selector; never future guessed Actual.
3. POV/Relationship — POV=Leila; relationship line + current role/relationship graph, active core <=3.
4. World/Zone/Material — Zone=Med-University hospital; current world/material/location router, branch=H-A.
