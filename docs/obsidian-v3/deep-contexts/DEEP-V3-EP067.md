...
source_snapshot: router=CTX-V3-EP067; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT2-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-2B
- beat: BEAT-V3-B09
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT2-v0.1.md selector `EP067`
- branch: H-A
- concurrency: ACT2_LEDGER
- Current-lived namespace remains H-A; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP066: End Turn=new structural readings show first zone may be stabilizing. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=assemble a provisional causal chain. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: protagonist/Sora agree on what is known without agreeing on all implications.
...
- zone: L-A
- projected world pressure: local explanation advances before deeper mystery.
...
- Source-owned institutional/world pressure: local explanation advances before deeper mystery. Relationship/institution interface: protagonist/Sora agree on what is known without agreeing on all implications.
...
- source clue: local accident cause PARTIAL PAYOFF; D03 remains open.
...
- classification=PAYOFF+OPEN. Source clue=local accident cause PARTIAL PAYOFF; D03 remains open. Outgoing selector=utilities begin partial restoration; exhausted residents expect reopening. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: cooling failure + aged interface + bypass-amplified propagation now explains much of the disaster, but not the impossible repair age. Immediate Want: assemble a provisional causal chain. Act guard: Disaster/concurrency first. Resolve ACT2_LEDGER geography/time before scene execution; do not explain the branch mechanism. EP094 ends H-A current-lived state.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: cooling failure + aged interface + bypass-amplified propagation now explains much of the disaster, but not the impossible repair age.
- exact Immediate Want: assemble a provisional causal chain.
- exact End Turn: utilities begin partial restoration; exhausted residents expect reopening.
...
## Forecast Outgoing
- projected End Turn: utilities begin partial restoration; exhausted residents expect reopening.
...
1. Episode Card — exact EP067 Blueprint selector; A-Plot/Want/End Turn authority.
