...
beat: BEAT-V3-B25
concurrency: NONE
source_snapshot: router=CTX-V3-EP180; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT4-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-4C
- beat: BEAT-V3-B25
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT4-v0.1.md selector `EP180`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP179: End Turn=protagonist receives notice about an old infrastructure/record anomaly from Act1/2 material. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=decide whether physical evidence can answer what memories cannot. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: asks Sora/Hana access through proper channels rather than acting alone.
...
- projected world pressure: investigation turns from prediction to history/space.
...
- Source-owned institutional/world pressure: investigation turns from prediction to history/space. Relationship/institution interface: asks Sora/Hana access through proper channels rather than acting alone.
...
- source clue: Act5 Legacy investigation PLANT.
...
- classification=PLANT. Source clue=Act5 Legacy investigation PLANT. Outgoing selector=one retired sector identifier maps to a place with no matching disaster history. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: reconnects impossible repair chronology with old restricted service records. Immediate Want: decide whether physical evidence can answer what memories cannot. Act guard: Prediction and social consequence before ontology. Evidence must change choices/relationships before any explanatory model hardens.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: reconnects impossible repair chronology with old restricted service records.
- exact Immediate Want: decide whether physical evidence can answer what memories cannot.
- exact End Turn: one retired sector identifier maps to a place with no matching disaster history.
...
## Forecast Outgoing
- projected End Turn: one retired sector identifier maps to a place with no matching disaster history.
...
1. Episode Card — exact EP180 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=Old Works/Central interface; current world/material/location router, branch=H-B.
