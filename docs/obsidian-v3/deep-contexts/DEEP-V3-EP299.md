...
beat: BEAT-V3-B41
concurrency: NONE
source_snapshot: router=CTX-V3-EP299; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT7-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-7B
- beat: BEAT-V3-B41
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT7-v0.1.md selector `EP299`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP298: End Turn=one fragment concerns Arun/protagonist in a way neither remembers. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=test a claim that in another history he, not Arun, died or was absent. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: his guilt can no longer define Arun universally.
...
- projected world pressure: same identity lineages have divergent moral/causal roles.
...
- Source-owned institutional/world pressure: same identity lineages have divergent moral/causal roles. Relationship/institution interface: his guilt can no longer define Arun universally.
...
- source clue: D01 FINAL PAYOFF sequence begins.
...
- classification=PAYOFF. Source clue=D01 FINAL PAYOFF sequence begins. Outgoing selector=current Arun agrees to review evidence on his own terms. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: finds indirect records consistent with a different Arun/protagonist outcome. Immediate Want: test a claim that in another history he, not Arun, died or was absent. Act guard: Action/evidence before ontology. Every explanatory beat must be earned by a concrete decision, cost, failed model, or operational consequence.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: finds indirect records consistent with a different Arun/protagonist outcome.
- exact Immediate Want: test a claim that in another history he, not Arun, died or was absent.
- exact End Turn: current Arun agrees to review evidence on his own terms.
...
## Forecast Outgoing
- projected End Turn: current Arun agrees to review evidence on his own terms.
...
1. Episode Card — exact EP299 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=evidence comparison; current world/material/location router, branch=H-B.
