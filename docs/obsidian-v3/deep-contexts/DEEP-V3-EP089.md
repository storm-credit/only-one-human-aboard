...
source_snapshot: router=CTX-V3-EP089; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT2-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-2D
- beat: BEAT-V3-B12
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT2-v0.1.md selector `EP089`
- branch: H-A
- concurrency: ACT2_LEDGER
- Current-lived namespace remains H-A; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP088: End Turn=Sora must decide how much sabotage theory remains. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=ensure technical findings are not distorted into a single criminal story. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: Sora agrees to separate criminal/accountability tracks.
...
- projected world pressure: causal complexity becomes institutional record.
...
- Source-owned institutional/world pressure: causal complexity becomes institutional record. Relationship/institution interface: Sora agrees to separate criminal/accountability tracks.
...
- source clue: sabotage red herring near PAYOFF.
...
- classification=PAYOFF. Source clue=sabotage red herring near PAYOFF. Outgoing selector=staged utility/transport restoration starts. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: provides evidence that illegal bypass mattered but did not create root rupture; actual responsibility is distributed across maintenance choices, aging infrastructure and emergency decisions. Immediate Want: ensure technical findings are not distorted into a single criminal story. Act guard: Disaster/concurrency first. Resolve ACT2_LEDGER geography/time before scene execution; do not explain the branch mechanism. EP094 ends H-A current-lived state.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: provides evidence that illegal bypass mattered but did not create root rupture; actual responsibility is distributed across maintenance choices, aging infrastructure and emergency decisions.
- exact Immediate Want: ensure technical findings are not distorted into a single criminal story.
- exact End Turn: staged utility/transport restoration starts.
...
## Forecast Outgoing
- projected End Turn: staged utility/transport restoration starts.
...
1. Episode Card — exact EP089 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=L-A / review interface; current world/material/location router, branch=H-A.
