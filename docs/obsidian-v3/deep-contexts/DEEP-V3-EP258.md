...
source_snapshot: router=CTX-V3-EP258; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT6-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-6B
- beat: BEAT-V3-B35
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT6-v0.1.md selector `EP258`
- branch: H-B
- concurrency: ACT6_LEDGER
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP257: End Turn=technical apprentices begin bypassing authorization to keep local utilities alive. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.
...
- projected relationship line: Niko believes protagonist still moves too slowly.
...
- zone: Old Works
- projected world pressure: local autonomy vs system safety.
...
- Source-owned institutional/world pressure: local autonomy vs system safety. Relationship/institution interface: Niko believes protagonist still moves too slowly.
...
- classification=NONE. Source clue=NONE. Outgoing selector=Niko makes an independent choice anyway. No authorial ominous narration beyond Blueprint evidence.
...
## Forecast Outgoing
- projected End Turn: Niko makes an independent choice anyway.
...
1. Episode Card — exact EP258 Blueprint selector; A-Plot/Want/End Turn authority.
