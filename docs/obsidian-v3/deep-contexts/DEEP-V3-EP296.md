...
beat: BEAT-V3-B41
concurrency: NONE
source_snapshot: router=CTX-V3-EP296; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT7-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-7B
- beat: BEAT-V3-B41
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT7-v0.1.md selector `EP296`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP295: End Turn=protagonist recognizes the case resembles how he treated Arun. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=resolve a practical safety/community interaction involving a known character. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: current person's behavior contradicts testimony without invalidating witness sincerity.
...
- projected world pressure: alternate moral history enters through social reaction.
...
- Source-owned institutional/world pressure: alternate moral history enters through social reaction. Relationship/institution interface: current person's behavior contradicts testimony without invalidating witness sincerity.
...
- source clue: D04/D08 social testimony TRIGGER.
...
- classification=SOURCE_DEFINED. Source clue=D04/D08 social testimony TRIGGER. Outgoing selector=evidence is insufficient to decide whether witness is genuine. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: a rare witness reacts with disproportionate distrust to someone currently behaving responsibly, citing an incompatible remembered atrocity/decision. Immediate Want: resolve a practical safety/community interaction involving a known character. Act guard: Action/evidence before ontology. Every explanatory beat must be earned by a concrete decision, cost, failed model, or operational consequence.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: a rare witness reacts with disproportionate distrust to someone currently behaving responsibly, citing an incompatible remembered atrocity/decision.
- exact Immediate Want: resolve a practical safety/community interaction involving a known character.
- exact End Turn: evidence is insufficient to decide whether witness is genuine.
...
## Forecast Outgoing
- projected End Turn: evidence is insufficient to decide whether witness is genuine.
...
1. Episode Card — exact EP296 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=Midring/current civic recovery; current world/material/location router, branch=H-B.
