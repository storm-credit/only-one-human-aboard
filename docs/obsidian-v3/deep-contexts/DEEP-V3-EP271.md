...
source_snapshot: router=CTX-V3-EP271; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT6-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-6C
- beat: BEAT-V3-B37
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT6-v0.1.md selector `EP271`
- branch: H-B
- concurrency: ACT6_LEDGER
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP270: End Turn=Mira/Juno/medical/security actors begin building a neutral corridor without him. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.
...
- projected relationship line: she asks Juno/medical actors for conditions rather than imposing a plan.
...
- zone: Transfer Belt
- projected world pressure: delayed value of small route choice becomes visible.
...
- Source-owned institutional/world pressure: delayed value of small route choice becomes visible. Relationship/institution interface: she asks Juno/medical actors for conditions rather than imposing a plan.
...
- source clue: emergent-cascade TRIGGER.
...
- classification=SOURCE_DEFINED. Source clue=emergent-cascade TRIGGER. Outgoing selector=medical side must define neutral access rules. No authorial ominous narration beyond Blueprint evidence.
...
## Forecast Outgoing
- projected End Turn: medical side must define neutral access rules.
...
1. Episode Card — exact EP271 Blueprint selector; A-Plot/Want/End Turn authority.
