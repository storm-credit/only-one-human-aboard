...
beat: BEAT-V3-B56
concurrency: NONE
source_snapshot: router=CTX-V3-EP408; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT9-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-9C
- beat: BEAT-V3-B56
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT9-v0.1.md selector `EP408`
- branch: H-B
- concurrency: NONE
...
- OFF-POV / INFLUENCE_ONLY_UNLESS_BLUEPRINT_EXPLICIT. ordinary medical/caregiver external lens owns the episode's lived decision line. Do not reroute success, discovery, or emotional resolution through the protagonist merely for centrality.

## Character Context
- active_core_cap: max 3 salient characters including POV.
- projected_active_core: ordinary medical/caregiver external lens, caregiver, Caregiver
...
- projected relationship line: caregivers/guardianship institution begins ordinary responsibility.
...
- projected world pressure: legacy `HUMAN:1` field becomes a living person's biography rather than title object.
...
- Source-owned institutional/world pressure: legacy `HUMAN:1` field becomes a living person's biography rather than title object. Relationship/institution interface: caregivers/guardianship institution begins ordinary responsibility.
...
- source clue: D06 AFTERSHOCK complete.
- local knowledge fence: no infant interior POV; no future prophecy.
...
- classification=SOURCE_DEFINED. Source clue=D06 AFTERSHOCK complete. Outgoing selector=elsewhere, the city/settlement day continues. No authorial ominous narration beyond Blueprint evidence.
...
## Forecast Outgoing
- projected End Turn: elsewhere, the city/settlement day continues.
...
1. Episode Card — exact EP408 Blueprint selector; A-Plot/Want/End Turn authority.
2. Immediate Continuity — prior realized CONTINUITY-FROZEN + this forecast selector; never future guessed Actual.
3. POV/Relationship — POV=ordinary medical/caregiver external lens; relationship line + current role/relationship graph, active core <=3.
4. World/Zone/Material — Zone=protected medical care; current world/material/location router, branch=H-B.
