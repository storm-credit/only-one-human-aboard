...
source_snapshot: router=CTX-V3-EP278; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT6-v0.1.md; mode=blueprint-compiled
...
---
# DEEP V3 EP278 — 바깥에서 온 것인지 모르는 것
...
- subact: SA-V3-6C
- beat: BEAT-V3-B38
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT6-v0.1.md selector `EP278`
- branch: H-B
- concurrency: ACT6_LEDGER
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP277: End Turn=an old external-observation dataset is reexamined amid recovery work. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=decide whether a faint signal/data anomaly is relevant to current repair/resource planning. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: Hana/Sora or technical staff refuse sensational interpretation.
...
- projected world pressure: external universe may contain information not reducible to current civic history.
...
- Source-owned institutional/world pressure: external universe may contain information not reducible to current civic history. Relationship/institution interface: Hana/Sora or technical staff refuse sensational interpretation.
...
- source clue: Echo Outside — very soft PLANT.
...
- classification=PLANT. Source clue=Echo Outside — very soft PLANT. Outgoing selector=protagonist notices the more immediate puzzle: some procedures/resources still reflect histories nobody remembers. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: sees one minor technical pattern resembling a detail from an earlier alleged contact-risk history, but instrumentation/coincidence remain plausible. Immediate Want: decide whether a faint signal/data anomaly is relevant to current repair/resource planning. Act guard: Resolve ACT6_LEDGER concurrency/resource/network state before execution; causality must remain distributed across people and institutions.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: sees one minor technical pattern resembling a detail from an earlier alleged contact-risk history, but instrumentation/coincidence remain plausible.
- exact Immediate Want: decide whether a faint signal/data anomaly is relevant to current repair/resource planning.
- exact End Turn: protagonist notices the more immediate puzzle: some procedures/resources still reflect histories nobody remembers.
...
## Forecast Outgoing
- projected End Turn: protagonist notices the more immediate puzzle: some procedures/resources still reflect histories nobody remembers.
...
1. Episode Card — exact EP278 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=technical/archive interface; current world/material/location router, branch=H-B.
