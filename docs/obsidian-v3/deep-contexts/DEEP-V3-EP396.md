...
beat: BEAT-V3-B54
concurrency: NONE
source_snapshot: router=CTX-V3-EP396; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT9-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-9B
- beat: BEAT-V3-B54
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT9-v0.1.md selector `EP396`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP395: End Turn=central plan adjusts around Niko/local data. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=sever one connection that preserves convenience/capacity but amplifies hazard. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: choice harms future plans valued by close allies/communities; not everyone agrees.
...
- projected world pressure: irreversible material cost.
...
- Source-owned institutional/world pressure: irreversible material cost. Relationship/institution interface: choice harms future plans valued by close allies/communities; not everyone agrees.
...
- source clue: final no-reset PAYOFF builds.
...
- classification=PAYOFF. Source clue=final no-reset PAYOFF builds. Outgoing selector=the unsynchronized seed node becomes the only stable bridge for staged recovery. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: commits to losing a significant early settlement asset/capacity rather than gamble current continuities for rapid recovery. Immediate Want: sever one connection that preserves convenience/capacity but amplifies hazard. Act guard: Descendant completion and return/payoff outrank novelty. No rerun/new ontology by default; EP406-410 add no major mystery and close through consequence/return.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: commits to losing a significant early settlement asset/capacity rather than gamble current continuities for rapid recovery.
- exact Immediate Want: sever one connection that preserves convenience/capacity but amplifies hazard.
- exact End Turn: the unsynchronized seed node becomes the only stable bridge for staged recovery.
...
## Forecast Outgoing
- projected End Turn: the unsynchronized seed node becomes the only stable bridge for staged recovery.
...
1. Episode Card — exact EP396 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=high-risk coupling; current world/material/location router, branch=H-B.
