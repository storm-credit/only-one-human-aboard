...
beat: BEAT-V3-B24
concurrency: NONE
source_snapshot: router=CTX-V3-EP173; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT4-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-4C
- beat: BEAT-V3-B24
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT4-v0.1.md selector `EP173`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP172: End Turn=evidence shows Cassian once dumped an advantage publicly at personal cost. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=confront Cassian about using possible remembered information privately. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: protagonist sees an uncomfortable future version of his own dilemma.
...
- projected world pressure: foreknowledge creates moral burden without simple duty-to-publish rule.
...
- Source-owned institutional/world pressure: foreknowledge creates moral burden without simple duty-to-publish rule. Relationship/institution interface: protagonist sees an uncomfortable future version of his own dilemma.
...
- source clue: Cassian source near reveal.
...
- classification=SOURCE_DEFINED. Source clue=Cassian source near reveal. Outgoing selector=one detail can only be explained if Cassian personally remembered a prior path. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: Cassian explains—without yet direct POV confirmation—that early successful fragments were followed by failures, disbelief and risks of causing worse outcomes. Immediate Want: confront Cassian about using possible remembered information privately. Act guard: Prediction and social consequence before ontology. Evidence must change choices/relationships before any explanatory model hardens.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: Cassian explains—without yet direct POV confirmation—that early successful fragments were followed by failures, disbelief and risks of causing worse outcomes.
- exact Immediate Want: confront Cassian about using possible remembered information privately.
- exact End Turn: one detail can only be explained if Cassian personally remembered a prior path.
...
## Forecast Outgoing
- projected End Turn: one detail can only be explained if Cassian personally remembered a prior path.
...
1. Episode Card — exact EP173 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=Cassian interview; current world/material/location router, branch=H-B.
