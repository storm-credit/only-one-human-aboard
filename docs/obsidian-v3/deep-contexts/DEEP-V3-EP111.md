...
beat: BEAT-V3-B16
concurrency: NONE
source_snapshot: router=CTX-V3-EP111; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT3-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-3B
- beat: BEAT-V3-B16
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT3-v0.1.md selector `EP111`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP110: End Turn=protagonist tries a private detail he believes only H-A Mira could know. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.
...
- projected relationship line: Mira chooses boundaries without making protagonist a villain.
...
- projected world pressure: current Mira has coworkers/friends/obligations unrelated to him.
...
- Source-owned institutional/world pressure: current Mira has coworkers/friends/obligations unrelated to him. Relationship/institution interface: Mira chooses boundaries without making protagonist a villain.
...
- source clue: sincere contradiction, no answer.
...
- classification=SOURCE_DEFINED. Source clue=sincere contradiction, no answer. Outgoing selector=she agrees to one controlled comparison, not reunion. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: independently checks the private detail and discovers it does not fit her life, while another less intimate fact does. She considers trauma, fraud, memory disorder, or some unknown shared source. Immediate Want: decide whether to continue talking to protagonist after his claim. Act guard: H-B is current-lived. H-A knowledge/state enters only through explicit memory/provenance; secondary characters retain independent causality.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: independently checks the private detail and discovers it does not fit her life, while another less intimate fact does. She considers trauma, fraud, memory disorder, or some unknown shared source.
- exact Immediate Want: decide whether to continue talking to protagonist after his claim.
- exact End Turn: she agrees to one controlled comparison, not reunion.
...
## Forecast Outgoing
- projected End Turn: she agrees to one controlled comparison, not reunion.
...
1. Episode Card — exact EP111 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=home/work transition; current world/material/location router, branch=H-B.
