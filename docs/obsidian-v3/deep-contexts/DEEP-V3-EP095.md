...
## Projected Incoming
FORECAST from EP094: End Turn=protagonist recognizes a concrete situation he remembers and believes he can prevent. | Continuity Output=H-A reader-facing world lost; H-B begins Act3. One major protagonist transfer only.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.
