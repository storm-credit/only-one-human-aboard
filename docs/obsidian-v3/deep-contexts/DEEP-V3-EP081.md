...
source_snapshot: router=CTX-V3-EP081; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT2-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-2C
- beat: BEAT-V3-B11
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT2-v0.1.md selector `EP081`
- branch: H-A
- concurrency: ACT2_LEDGER
- Current-lived namespace remains H-A; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP080: End Turn=one bulkhead does not seal cleanly due deformation. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=restore enough boundary integrity to stop pressure cascade. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.

## Character Context
- active_core_cap: max 3 salient characters including POV.
- projected_active_core: [주인공/TBD], Arun, Niko
...
- projected relationship line: Niko sees protagonist freeze briefly at the Arun-like geometry.
...
- projected world pressure: physical choices narrow.
...
- Source-owned institutional/world pressure: physical choices narrow. Relationship/institution interface: Niko sees protagonist freeze briefly at the Arun-like geometry.
...
- source clue: Arun behavioral trigger, no memory reveal.
...
- classification=SOURCE_DEFINED. Source clue=Arun behavioral trigger, no memory reveal. Outgoing selector=trapped-group list becomes known. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: improvises a brace/bypass but cannot save both access and full sealing capacity. Immediate Want: restore enough boundary integrity to stop pressure cascade. Act guard: Disaster/concurrency first. Resolve ACT2_LEDGER geography/time before scene execution; do not explain the branch mechanism. EP094 ends H-A current-lived state.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: improvises a brace/bypass but cannot save both access and full sealing capacity.
- exact Immediate Want: restore enough boundary integrity to stop pressure cascade.
- exact End Turn: trapped-group list becomes known.
...
## Forecast Outgoing
- projected End Turn: trapped-group list becomes known.
...
1. Episode Card — exact EP081 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=L-A/L-G interface; current world/material/location router, branch=H-A.
