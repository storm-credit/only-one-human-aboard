...
source_snapshot: router=CTX-V3-EP078; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT2-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-2C
- beat: BEAT-V3-B11
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT2-v0.1.md selector `EP078`
- branch: H-A
- concurrency: ACT2_LEDGER
- Current-lived namespace remains H-A; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP077: End Turn=Selene must choose operational priority. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.
...
- projected_active_core: Selene, Rafi
...
- projected relationship line: Selene↔Rafi conflict sharpens; she treats protagonist assessment as evidence, not order.
...
- zone: L-D/L-A
- projected world pressure: command decision has real political/public cost.
...
- Source-owned institutional/world pressure: command decision has real political/public cost. Relationship/institution interface: Selene↔Rafi conflict sharpens; she treats protagonist assessment as evidence, not order.
...
- classification=NONE. Source clue=NONE. Outgoing selector=an unofficial access shortcut is discovered in use by a small group. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: permits bounded rescue window, delays general reopening, assigns hard abort conditions. Immediate Want: authorize the smallest action set that protects trapped people and avoids citywide prolongation. Act guard: Disaster/concurrency first. Resolve ACT2_LEDGER geography/time before scene execution; do not explain the branch mechanism. EP094 ends H-A current-lived state.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: permits bounded rescue window, delays general reopening, assigns hard abort conditions.
- exact Immediate Want: authorize the smallest action set that protects trapped people and avoids citywide prolongation.
- exact End Turn: an unofficial access shortcut is discovered in use by a small group.
...
## Forecast Outgoing
- projected End Turn: an unofficial access shortcut is discovered in use by a small group.
...
1. Episode Card — exact EP078 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=L-D/L-A; current world/material/location router, branch=H-A.
