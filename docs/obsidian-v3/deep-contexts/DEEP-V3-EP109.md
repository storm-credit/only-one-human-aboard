...
beat: BEAT-V3-B16
concurrency: NONE
source_snapshot: router=CTX-V3-EP109; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT3-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-3B
- beat: BEAT-V3-B16
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT3-v0.1.md selector `EP109`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP108: End Turn=he decides Mira is the one person whose shared past he must confront directly. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.
...
- projected relationship line: his assumption that `our relationship can be restored because I know the old version` is challenged.
...
- projected world pressure: relationship history is evidence but remains emotionally primary.
...
- Source-owned institutional/world pressure: relationship history is evidence but remains emotionally primary. Relationship/institution interface: his assumption that `our relationship can be restored because I know the old version` is challenged.
...
- source clue: H-B Mira delta TRIGGER.
...
- classification=SOURCE_DEFINED. Source clue=H-B Mira delta TRIGGER. Outgoing selector=Mira asks why he is behaving as if she owes him a relationship she does not remember. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: asks about a shared event/home/routine from H-A. Mira gives a different sequence that predates his H-B arrival. Immediate Want: test Mira's memory without confessing an impossible claim all at once. Act guard: H-B is current-lived. H-A knowledge/state enters only through explicit memory/provenance; secondary characters retain independent causality.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: asks about a shared event/home/routine from H-A. Mira gives a different sequence that predates his H-B arrival.
- exact Immediate Want: test Mira's memory without confessing an impossible claim all at once.
- exact End Turn: Mira asks why he is behaving as if she owes him a relationship she does not remember.
...
## Forecast Outgoing
- projected End Turn: Mira asks why he is behaving as if she owes him a relationship she does not remember.
...
1. Episode Card — exact EP109 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=neutral Midring/Transfer social place; current world/material/location router, branch=H-B.
