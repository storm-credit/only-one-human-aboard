...
beat: BEAT-V3-B53
concurrency: NONE
source_snapshot: router=CTX-V3-EP390; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT9-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-9B
- beat: BEAT-V3-B53
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT9-v0.1.md selector `EP390`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP389: End Turn=current medical/technical data favor neither extreme response. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.
...
- projected relationship line: trusts local teams rather than treating them as extensions of herself.
...
- projected world pressure: distributed autonomy becomes survival asset.
...
- Source-owned institutional/world pressure: distributed autonomy becomes survival asset. Relationship/institution interface: trusts local teams rather than treating them as extensions of herself.
...
- classification=NONE. Source clue=NONE. Outgoing selector=induced stress begins damaging a high-capacity settlement coupling. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: delegates bounded local medical authority and prioritizes continuity of care over perfect centralized optimization. Immediate Want: preserve care when communication timing makes central triage unreliable. Act guard: Descendant completion and return/payoff outrank novelty. No rerun/new ontology by default; EP406-410 add no major mystery and close through consequence/return.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: delegates bounded local medical authority and prioritizes continuity of care over perfect centralized optimization.
- exact Immediate Want: preserve care when communication timing makes central triage unreliable.
- exact End Turn: induced stress begins damaging a high-capacity settlement coupling.
...
## Forecast Outgoing
- projected End Turn: induced stress begins damaging a high-capacity settlement coupling.
...
1. Episode Card — exact EP390 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=local/Ark medical coordination; current world/material/location router, branch=H-B.
