...
beat: BEAT-V3-B23
concurrency: NONE
source_snapshot: router=CTX-V3-EP162; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT4-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-4B
- beat: BEAT-V3-B23
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT4-v0.1.md selector `EP162`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP161: End Turn=one suspect claims they acted because they too `knew` something would happen. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=determine whether rumor itself helped cause attack behavior. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: Sora/protagonist understand information can create the event it predicts.
...
- projected world pressure: social reflexivity.
...
- Source-owned institutional/world pressure: social reflexivity. Relationship/institution interface: Sora/protagonist understand information can create the event it predicts.
...
- source clue: system cannot simply treat remembered path as neutral data.
...
- classification=SOURCE_DEFINED. Source clue=system cannot simply treat remembered path as neutral data. Outgoing selector=Sora finds the original fragment source was earlier than the public rumor ecosystem. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: finds some actors exploited public prediction to hide preparation; prophecy became part of causal chain. Immediate Want: determine whether rumor itself helped cause attack behavior. Act guard: Prediction and social consequence before ontology. Evidence must change choices/relationships before any explanatory model hardens.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: finds some actors exploited public prediction to hide preparation; prophecy became part of causal chain.
- exact Immediate Want: determine whether rumor itself helped cause attack behavior.
- exact End Turn: Sora finds the original fragment source was earlier than the public rumor ecosystem.
...
## Forecast Outgoing
- projected End Turn: Sora finds the original fragment source was earlier than the public rumor ecosystem.
...
1. Episode Card — exact EP162 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=security/technical review; current world/material/location router, branch=H-B.
