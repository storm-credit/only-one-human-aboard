...
beat: BEAT-V3-B47
concurrency: NONE
source_snapshot: router=CTX-V3-EP349; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT8-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-8B
- beat: BEAT-V3-B47
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT8-v0.1.md selector `EP349`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP348: End Turn=proposal costs more resources than administrators planned. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=test whether proposed safeguards can generalize beyond one sympathetic family. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.

## Character Context
- active_core_cap: max 3 salient characters including POV.
- projected_active_core: [주인공/TBD], Mira, family
...
- projected relationship line: Mira/Leila/legal actors challenge unequal resource assumptions.
...
- projected world pressure: rights become scalable constraint.
...
- Source-owned institutional/world pressure: rights become scalable constraint. Relationship/institution interface: Mira/Leila/legal actors challenge unequal resource assumptions.
...
- source clue: D09 institutional payoff preparation.
...
- classification=PAYOFF. Source clue=D09 institutional payoff preparation. Outgoing selector=branch-born youth/child speaks or acts within family decision without becoming symbolic mascot. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: models operational consequences across adult-only lineages and unpopular/unknown groups; protection cannot depend on narrative likability. Immediate Want: test whether proposed safeguards can generalize beyond one sympathetic family. Act guard: HUMAN provenance is not personhood. HUMAN:1 must remain de-collectified and must not become a collectible-character family or sacred merchandise target.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: models operational consequences across adult-only lineages and unpopular/unknown groups; protection cannot depend on narrative likability.
- exact Immediate Want: test whether proposed safeguards can generalize beyond one sympathetic family.
- exact End Turn: branch-born youth/child speaks or acts within family decision without becoming symbolic mascot.
...
## Forecast Outgoing
- projected End Turn: branch-born youth/child speaks or acts within family decision without becoming symbolic mascot.
...
1. Episode Card — exact EP349 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=technical/resource comparison; current world/material/location router, branch=H-B.
