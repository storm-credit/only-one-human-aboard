...
beat: BEAT-V3-B20
concurrency: NONE
source_snapshot: router=CTX-V3-EP143; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT4-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-4A
- beat: BEAT-V3-B20
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT4-v0.1.md selector `EP143`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP142: End Turn=one precaution reveals an unrelated safety issue, making prediction look more credible. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: media/fraud-victim lens
- OFF-POV / INFLUENCE_ONLY_UNLESS_BLUEPRINT_EXPLICIT. media/fraud-victim lens owns the episode's lived decision line. Do not reroute success, discovery, or emotional resolution through the protagonist merely for centrality.

## Character Context
- active_core_cap: max 3 salient characters including POV.
- projected_active_core: media/fraud-victim lens, family
...
- projected relationship line: family/friend conflict over belief.
...
- projected world pressure: rumor economy creates ordinary victims.
...
- Source-owned institutional/world pressure: rumor economy creates ordinary victims. Relationship/institution interface: family/friend conflict over belief.
...
- source clue: high-profile fake ecology REINFORCE.
...
- classification=REINFORCE. Source clue=high-profile fake ecology REINFORCE. Outgoing selector=the fake predictor repeats one detail apparently copied from a genuinely restricted source. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: sees how a charismatic predictor uses vague claims, selective screenshots and paid access. The victim's local problem is fraud, not ontology. Immediate Want: recover money/status after paying for a supposed future-warning service. Act guard: Prediction and social consequence before ontology. Evidence must change choices/relationships before any explanatory model hardens.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: sees how a charismatic predictor uses vague claims, selective screenshots and paid access. The victim's local problem is fraud, not ontology.
- exact Immediate Want: recover money/status after paying for a supposed future-warning service.
- exact End Turn: the fake predictor repeats one detail apparently copied from a genuinely restricted source.
...
## Forecast Outgoing
- projected End Turn: the fake predictor repeats one detail apparently copied from a genuinely restricted source.
...
1. Episode Card — exact EP143 Blueprint selector; A-Plot/Want/End Turn authority.
2. Immediate Continuity — prior realized CONTINUITY-FROZEN + this forecast selector; never future guessed Actual.
3. POV/Relationship — POV=media/fraud-victim lens; relationship line + current role/relationship graph, active core <=3.
4. World/Zone/Material — Zone=Midring / public network; current world/material/location router, branch=H-B.
