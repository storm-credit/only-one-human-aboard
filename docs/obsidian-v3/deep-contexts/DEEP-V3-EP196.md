...
beat: BEAT-V3-B27
concurrency: NONE
source_snapshot: router=CTX-V3-EP196; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT5-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-5A
- beat: BEAT-V3-B27
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT5-v0.1.md selector `EP196`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP195: End Turn=the person's family history contains a gap matching the orphan event period. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.
...
- projected relationship line: Hana/Sora agree on evidence reality, disagree on disclosure timing.
...
- projected world pressure: official H-B history is demonstrably incomplete in a way ordinary deletion cannot explain.
...
- Source-owned institutional/world pressure: official H-B history is demonstrably incomplete in a way ordinary deletion cannot explain. Relationship/institution interface: Hana/Sora agree on evidence reality, disagree on disclosure timing.
...
- source clue: Act5 first hard PAYOFF: an absent lived history left multiple traces.
...
- classification=PAYOFF. Source clue=Act5 first hard PAYOFF: an absent lived history left multiple traces. Outgoing selector=one old incident reference contains the name `Arun Kalev` where protagonist expects a dead colleague. No authorial ominous narration beyond Blueprint evidence.
...
## Forecast Outgoing
- projected End Turn: one old incident reference contains the name `Arun Kalev` where protagonist expects a dead colleague.
...
1. Episode Card — exact EP196 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=archive/legacy review; current world/material/location router, branch=H-B.
