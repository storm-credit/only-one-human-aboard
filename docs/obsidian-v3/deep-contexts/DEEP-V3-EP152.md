...
beat: BEAT-V3-B22
concurrency: NONE
source_snapshot: router=CTX-V3-EP152; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT4-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-4B
- beat: BEAT-V3-B22
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT4-v0.1.md selector `EP152`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP151: End Turn=one predicted detail occurs early and differently. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=determine whether attack has begun or normal anomaly is being misread. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: Niko/current team sees protagonist intentionally distrust his own foreknowledge.
...
- zone: target sector
- projected world pressure: alert fatigue risk.
...
- Source-owned institutional/world pressure: alert fatigue risk. Relationship/institution interface: Niko/current team sees protagonist intentionally distrust his own foreknowledge.
...
- source clue: predictive half-life REINFORCE.
...
- classification=REINFORCE. Source clue=predictive half-life REINFORCE. Outgoing selector=Sora identifies a real hostile/sabotage actor elsewhere in the target network. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: an access disturbance resembles predicted pattern but sequence is wrong; he resists overreacting. Immediate Want: determine whether attack has begun or normal anomaly is being misread. Act guard: Prediction and social consequence before ontology. Evidence must change choices/relationships before any explanatory model hardens.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: an access disturbance resembles predicted pattern but sequence is wrong; he resists overreacting.
- exact Immediate Want: determine whether attack has begun or normal anomaly is being misread.
- exact End Turn: Sora identifies a real hostile/sabotage actor elsewhere in the target network.
...
## Forecast Outgoing
- projected End Turn: Sora identifies a real hostile/sabotage actor elsewhere in the target network.
...
1. Episode Card — exact EP152 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=target sector; current world/material/location router, branch=H-B.
