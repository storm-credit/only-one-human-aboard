...
source_snapshot: router=CTX-V3-EP062; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT2-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-2B
- beat: BEAT-V3-B09
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT2-v0.1.md selector `EP062`
- branch: H-A
- concurrency: ACT2_LEDGER
- Current-lived namespace remains H-A; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP061: End Turn=Selene demands immediate route release for a medical movement. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.
...
- projected_active_core: Selene, Sora
...
- projected relationship line: Selene↔Sora tension established around safety vs evidence, not personal dislike.
...
- projected world pressure: emergency authority has limits and negotiated overlap.
...
- Source-owned institutional/world pressure: emergency authority has limits and negotiated overlap. Relationship/institution interface: Selene↔Sora tension established around safety vs evidence, not personal dislike.
...
- classification=NONE. Source clue=NONE. Outgoing selector=the escorted window creates a new logistics bottleneck elsewhere. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: confronts Sora over security hold; creates a timed escorted-use compromise instead of overriding investigation outright. Immediate Want: move response/medical assets through the safest available corridor. Act guard: Disaster/concurrency first. Resolve ACT2_LEDGER geography/time before scene execution; do not explain the branch mechanism. EP094 ends H-A current-lived state.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: confronts Sora over security hold; creates a timed escorted-use compromise instead of overriding investigation outright.
- exact Immediate Want: move response/medical assets through the safest available corridor.
- exact End Turn: the escorted window creates a new logistics bottleneck elsewhere.
...
## Forecast Outgoing
- projected End Turn: the escorted window creates a new logistics bottleneck elsewhere.
...
1. Episode Card — exact EP062 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=L-D / security perimeter; current world/material/location router, branch=H-A.
