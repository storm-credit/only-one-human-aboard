...
beat: BEAT-V3-B19
concurrency: NONE
source_snapshot: router=CTX-V3-EP134; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT3-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-3C
- beat: BEAT-V3-B19
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT3-v0.1.md selector `EP134`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP133: End Turn=the feature has no obvious reason to exist in current layout. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=name a workable theory. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: Mira rejects being treated as `wrong version` of herself.
...
- projected world pressure: character theories may be wrong; author voice does not resolve them.
...
- Source-owned institutional/world pressure: character theories may be wrong; author voice does not resolve them. Relationship/institution interface: Mira rejects being treated as `wrong version` of herself.
...
- source clue: parallel-world/few-world red herring PLANT.
...
- classification=PLANT. Source clue=parallel-world/few-world red herring PLANT. Outgoing selector=protagonist realizes another claimant could become socially explosive if public. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: considers regression, manipulated memory, multiple versions of Meridian, hidden reconstruction; none fits all evidence. Immediate Want: name a workable theory. Act guard: H-B is current-lived. H-A knowledge/state enters only through explicit memory/provenance; secondary characters retain independent causality.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: considers regression, manipulated memory, multiple versions of Meridian, hidden reconstruction; none fits all evidence.
- exact Immediate Want: name a workable theory.
- exact End Turn: protagonist realizes another claimant could become socially explosive if public.
...
## Forecast Outgoing
- projected End Turn: protagonist realizes another claimant could become socially explosive if public.
...
1. Episode Card — exact EP134 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=private debrief; current world/material/location router, branch=H-B.
