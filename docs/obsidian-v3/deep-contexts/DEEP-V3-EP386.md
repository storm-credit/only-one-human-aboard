...
beat: BEAT-V3-B53
concurrency: NONE
source_snapshot: router=CTX-V3-EP386; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT9-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-9B
- beat: BEAT-V3-B53
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT9-v0.1.md selector `EP386`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP385: End Turn=several synchronized nodes enter protective mode while one unsynchronized node remains stable. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=determine failure mechanism before teams react to `external attack` rumors. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: Sora/security is not made lead just because signal looks structured.
...
- projected world pressure: physical evidence outranks fear.
...
- Source-owned institutional/world pressure: physical evidence outranks fear. Relationship/institution interface: Sora/security is not made lead just because signal looks structured.
...
- source clue: Echo Outside resemblance stays ambiguous.
...
- classification=SOURCE_DEFINED. Source clue=Echo Outside resemblance stays ambiguous. Outgoing selector=persistent local continuity teams risk being isolated if synchronized links fail. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: damage patterns fit induced/coupled stress better than targeted strike; exact source unknown. Immediate Want: determine failure mechanism before teams react to `external attack` rumors. Act guard: Descendant completion and return/payoff outrank novelty. No rerun/new ontology by default; EP406-410 add no major mystery and close through consequence/return.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: damage patterns fit induced/coupled stress better than targeted strike; exact source unknown.
- exact Immediate Want: determine failure mechanism before teams react to `external attack` rumors.
- exact End Turn: persistent local continuity teams risk being isolated if synchronized links fail.
...
## Forecast Outgoing
- projected End Turn: persistent local continuity teams risk being isolated if synchronized links fail.
...
1. Episode Card — exact EP386 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=deployment diagnostics; current world/material/location router, branch=H-B.
