...
beat: BEAT-V3-B31
concurrency: NONE
source_snapshot: router=CTX-V3-EP221; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT5-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-5C
- beat: BEAT-V3-B31
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT5-v0.1.md selector `EP221`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP220: End Turn=question shifts from `is the 1 real?` to `what is HUMAN?` | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=test what attributes correlate with HUMAN classification. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: Leila/medical route remains separate; no mass scanning allowed.
...
- projected world pressure: privacy prevents brute-force identity hunt.
...
- Source-owned institutional/world pressure: privacy prevents brute-force identity hunt. Relationship/institution interface: Leila/medical route remains separate; no mass scanning allowed.
...
- source clue: HUMAN classification mystery REINFORCE.
...
- classification=REINFORCE. Source clue=HUMAN classification mystery REINFORCE. Outgoing selector=protagonist's own anomaly makes him a public/private suspect candidate despite no matching field evidence. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: ordinary demographic/medical/civic categories do not map; current citizens are not tagged in a way that explains it. Immediate Want: test what attributes correlate with HUMAN classification. Act guard: Keep Arun current-life separation explicit and hold HUMAN meaning behind the reveal fence; do not collapse identity into explanation.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: ordinary demographic/medical/civic categories do not map; current citizens are not tagged in a way that explains it.
- exact Immediate Want: test what attributes correlate with HUMAN classification.
- exact End Turn: protagonist's own anomaly makes him a public/private suspect candidate despite no matching field evidence.
...
## Forecast Outgoing
- projected End Turn: protagonist's own anomaly makes him a public/private suspect candidate despite no matching field evidence.
...
1. Episode Card — exact EP221 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=Central / civic records; current world/material/location router, branch=H-B.
