...
beat: BEAT-V3-B15
concurrency: NONE
source_snapshot: router=CTX-V3-EP107; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT3-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-3A
- beat: BEAT-V3-B15
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT3-v0.1.md selector `EP107`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP106: End Turn=he schedules a medical check without disclosing `회귀` claim fully. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.
...
- projected relationship line: protagonist resents being told uncertainty is not proof of sanity or insanity.
...
- projected world pressure: medical privacy and normal post-trauma care.
...
- Source-owned institutional/world pressure: medical privacy and normal post-trauma care. Relationship/institution interface: protagonist resents being told uncertainty is not proof of sanity or insanity.
...
- source clue: no magical diagnostic confirmation.
...
- classification=SOURCE_DEFINED. Source clue=no magical diagnostic confirmation. Outgoing selector=one clinician asks whether his memories are only wrong about recent events or older relationships too. No authorial ominous narration beyond Blueprint evidence.
...
## Forecast Outgoing
- projected End Turn: one clinician asks whether his memories are only wrong about recent events or older relationships too.
...
1. Episode Card — exact EP107 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=clinic / Med-University interface; current world/material/location router, branch=H-B.
