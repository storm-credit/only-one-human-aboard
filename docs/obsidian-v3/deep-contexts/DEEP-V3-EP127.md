...
beat: BEAT-V3-B18
concurrency: NONE
source_snapshot: router=CTX-V3-EP127; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT3-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-3C
- beat: BEAT-V3-B18
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT3-v0.1.md selector `EP127`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP126: End Turn=one old maintenance/registry record is located that can independently test the claimant detail. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=test the old record against claimant memory. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: protagonist/Sora agreement narrows: `something real is here`, not what it means.
...
- projected world pressure: physical/institutional evidence starts outranking testimony alone.
...
- Source-owned institutional/world pressure: physical/institutional evidence starts outranking testimony alone. Relationship/institution interface: protagonist/Sora agreement narrows: `something real is here`, not what it means.
...
- source clue: independent evidence REINFORCE.
...
- classification=REINFORCE. Source clue=independent evidence REINFORCE. Outgoing selector=claimant withdraws from further contact. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: record partially matches a detail that neither H-A nor H-B should contain, but context remains incomplete. Immediate Want: test the old record against claimant memory. Act guard: H-B is current-lived. H-A knowledge/state enters only through explicit memory/provenance; secondary characters retain independent causality.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: record partially matches a detail that neither H-A nor H-B should contain, but context remains incomplete.
- exact Immediate Want: test the old record against claimant memory.
- exact End Turn: claimant withdraws from further contact.
...
## Forecast Outgoing
- projected End Turn: claimant withdraws from further contact.
...
1. Episode Card — exact EP127 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=archive/service interface; current world/material/location router, branch=H-B.
