...
source_snapshot: router=CTX-V3-EP073; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT2-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-2B
- beat: BEAT-V3-B10
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT2-v0.1.md selector `EP073`
- branch: H-A
- concurrency: ACT2_LEDGER
- Current-lived namespace remains H-A; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP072: End Turn=one Midring pocket cannot receive normal distribution because the route remains closed. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=identify a repair path that could safely shorten closure. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: Niko resents the conservative answer but follows it.
...
- projected world pressure: competence sometimes means refusing action.
...
- Source-owned institutional/world pressure: competence sometimes means refusing action. Relationship/institution interface: Niko resents the conservative answer but follows it.
...
- classification=NONE. Source clue=NONE. Outgoing selector=Mira/Juno conflict over distribution escalates. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: finds no honest shortcut; his technical answer is `wait and brace`, not a clever save. Immediate Want: identify a repair path that could safely shorten closure. Act guard: Disaster/concurrency first. Resolve ACT2_LEDGER geography/time before scene execution; do not explain the branch mechanism. EP094 ends H-A current-lived state.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: finds no honest shortcut; his technical answer is `wait and brace`, not a clever save.
- exact Immediate Want: identify a repair path that could safely shorten closure.
- exact End Turn: Mira/Juno conflict over distribution escalates.
...
## Forecast Outgoing
- projected End Turn: Mira/Juno conflict over distribution escalates.
...
1. Episode Card — exact EP073 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=L-A rest/analysis; current world/material/location router, branch=H-A.
