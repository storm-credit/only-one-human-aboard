...
source_snapshot: router=CTX-V3-EP068; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT2-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-2B
- beat: BEAT-V3-B10
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT2-v0.1.md selector `EP068`
- branch: H-A
- concurrency: ACT2_LEDGER
- Current-lived namespace remains H-A; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP067: End Turn=utilities begin partial restoration; exhausted residents expect reopening. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=verify limited restoration will not overload weakened structure. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: Selene accepts conservative technical limit but notes public pressure is rising.
...
- projected world pressure: first visible recovery.
...
- Source-owned institutional/world pressure: first visible recovery. Relationship/institution interface: Selene accepts conservative technical limit but notes public pressure is rising.
...
- classification=NONE. Source clue=NONE. Outgoing selector=protagonist finally has a short off-duty window. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: certifies only a narrow utility restoration; refuses full route reopening. Immediate Want: verify limited restoration will not overload weakened structure. Act guard: Disaster/concurrency first. Resolve ACT2_LEDGER geography/time before scene execution; do not explain the branch mechanism. EP094 ends H-A current-lived state.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: certifies only a narrow utility restoration; refuses full route reopening.
- exact Immediate Want: verify limited restoration will not overload weakened structure.
- exact End Turn: protagonist finally has a short off-duty window.
...
## Forecast Outgoing
- projected End Turn: protagonist finally has a short off-duty window.
...
1. Episode Card — exact EP068 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=L-A / L-C boundary; current world/material/location router, branch=H-A.
