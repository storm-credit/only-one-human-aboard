...
source_snapshot: router=CTX-V3-EP071; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT2-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-2B
- beat: BEAT-V3-B10
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT2-v0.1.md selector `EP071`
- branch: H-A
- concurrency: ACT2_LEDGER
- Current-lived namespace remains H-A; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP070: End Turn=Leila refuses one requested transfer priority. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=explain repair-layer age before reopening decisions. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: Gideon still refuses metaphysical speculation; Niko is increasingly convinced records cannot be trusted.
...
- projected world pressure: safety restriction must remain longer.
...
- Source-owned institutional/world pressure: safety restriction must remain longer. Relationship/institution interface: Gideon still refuses metaphysical speculation; Niko is increasingly convinced records cannot be trusted.
...
- source clue: D03 strong REINFORCE.
...
- classification=REINFORCE. Source clue=D03 strong REINFORCE. Outgoing selector=hospital load and residential supply pressure collide with the prolonged closure. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: destructive inspection confirms material sequence incompatible with current recorded renovation chronology. Immediate Want: explain repair-layer age before reopening decisions. Act guard: Disaster/concurrency first. Resolve ACT2_LEDGER geography/time before scene execution; do not explain the branch mechanism. EP094 ends H-A current-lived state.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: destructive inspection confirms material sequence incompatible with current recorded renovation chronology.
- exact Immediate Want: explain repair-layer age before reopening decisions.
- exact End Turn: hospital load and residential supply pressure collide with the prolonged closure.
...
## Forecast Outgoing
- projected End Turn: hospital load and residential supply pressure collide with the prolonged closure.
...
1. Episode Card — exact EP071 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=L-A damaged junction; current world/material/location router, branch=H-A.
