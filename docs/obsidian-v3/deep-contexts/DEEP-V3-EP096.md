...
beat: BEAT-V3-B14
concurrency: NONE
source_snapshot: router=CTX-V3-EP096; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT3-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-3A
- beat: BEAT-V3-B14
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT3-v0.1.md selector `EP096`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP095: End Turn=he remembers a small near-future work problem he can prevent. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=prevent a minor failure he remembers occurring before Act2. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: Gideon/Niko are impressed but suspicious of his confidence.
...
- zone: Old Works
- projected world pressure: reader receives genuine regression competence reward.
...
- Source-owned institutional/world pressure: reader receives genuine regression competence reward. Relationship/institution interface: Gideon/Niko are impressed but suspicious of his confidence.
...
- source clue: foreknowledge appears accurate.
...
- classification=SOURCE_DEFINED. Source clue=foreknowledge appears accurate. Outgoing selector=protagonist decides he can prevent the Act2 catastrophe too. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: intervenes early on a mundane equipment issue using H-A memory and prevents downtime/injury. Immediate Want: prevent a minor failure he remembers occurring before Act2. Act guard: H-B is current-lived. H-A knowledge/state enters only through explicit memory/provenance; secondary characters retain independent causality.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: intervenes early on a mundane equipment issue using H-A memory and prevents downtime/injury.
- exact Immediate Want: prevent a minor failure he remembers occurring before Act2.
- exact End Turn: protagonist decides he can prevent the Act2 catastrophe too.
...
## Forecast Outgoing
- projected End Turn: protagonist decides he can prevent the Act2 catastrophe too.
...
1. Episode Card — exact EP096 Blueprint selector; A-Plot/Want/End Turn authority.
