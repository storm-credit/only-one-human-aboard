...
beat: BEAT-V3-B41
concurrency: NONE
source_snapshot: router=CTX-V3-EP297; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT7-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-7B
- beat: BEAT-V3-B41
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT7-v0.1.md selector `EP297`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP296: End Turn=evidence is insufficient to decide whether witness is genuine. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=judge current person on current action rather than remembered reputation. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: current trust becomes an explicit present choice.
...
- projected world pressure: moral responsibility is local to lived acts.
...
- Source-owned institutional/world pressure: moral responsibility is local to lived acts. Relationship/institution interface: current trust becomes an explicit present choice.
...
- source clue: D09 personhood ethics REINFORCE.
...
- classification=REINFORCE. Source clue=D09 personhood ethics REINFORCE. Outgoing selector=Ivo recognizes a second relationship that contradicts both witness and current life. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: current actor makes a difficult but defensible choice; protagonist resists importing guilt from other history. Immediate Want: judge current person on current action rather than remembered reputation. Act guard: Action/evidence before ontology. Every explanatory beat must be earned by a concrete decision, cost, failed model, or operational consequence.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: current actor makes a difficult but defensible choice; protagonist resists importing guilt from other history.
- exact Immediate Want: judge current person on current action rather than remembered reputation.
- exact End Turn: Ivo recognizes a second relationship that contradicts both witness and current life.
...
## Forecast Outgoing
- projected End Turn: Ivo recognizes a second relationship that contradicts both witness and current life.
...
1. Episode Card — exact EP297 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=same/current incident chain; current world/material/location router, branch=H-B.
