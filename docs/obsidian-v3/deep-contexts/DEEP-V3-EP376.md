...
beat: BEAT-V3-B51
concurrency: NONE
source_snapshot: router=CTX-V3-EP376; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT9-v0.1.md; mode=blueprint-compiled
...
---
# DEEP V3 EP376 — 말하지 못하는 사람을 기다리는 법
...
- subact: SA-V3-9A
- beat: BEAT-V3-B51
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT9-v0.1.md selector `EP376`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP375: End Turn=one quiescent-lineage representation question delays shared-resource approval. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=keep deployment moving without treating quiescent claims as abandoned. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: active groups accept delay only because rule is temporary/reviewable.
...
- projected world pressure: governance remains imperfect and procedural.
...
- Source-owned institutional/world pressure: governance remains imperfect and procedural. Relationship/institution interface: active groups accept delay only because rule is temporary/reviewable.
...
- classification=SOURCE_DEFINED. Source clue=D09 AFTERSHOCK. Outgoing selector=an affected D3 representative challenges one allocation rule in practice. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: supports reserve/hold rules and trusteeship for shared resources while refusing fabricated votes. Immediate Want: keep deployment moving without treating quiescent claims as abandoned. Act guard: Descendant completion and return/payoff outrank novelty. No rerun/new ontology by default; EP406-410 add no major mystery and close through consequence/return.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: supports reserve/hold rules and trusteeship for shared resources while refusing fabricated votes.
- exact Immediate Want: keep deployment moving without treating quiescent claims as abandoned.
- exact End Turn: an affected D3 representative challenges one allocation rule in practice.
...
## Forecast Outgoing
- projected End Turn: an affected D3 representative challenges one allocation rule in practice.
...
1. Episode Card — exact EP376 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=transitional compact operations; current world/material/location router, branch=H-B.
