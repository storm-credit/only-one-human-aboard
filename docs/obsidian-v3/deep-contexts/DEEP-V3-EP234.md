...
source_snapshot: router=CTX-V3-EP234; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT6-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-6A
- beat: BEAT-V3-B32
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT6-v0.1.md selector `EP234`
- branch: H-B
- concurrency: ACT6_LEDGER
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP233: End Turn=black-market offers appear for strategic parts and service slots. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.
...
- projected relationship line: team suspicion turns toward outsiders; protagonist stops a premature accusation.
...
- zone: Old Works
- projected world pressure: crime, bureaucracy and scarcity overlap.
...
- Source-owned institutional/world pressure: crime, bureaucracy and scarcity overlap. Relationship/institution interface: team suspicion turns toward outsiders; protagonist stops a premature accusation.
...
- source clue: no single collapse cause.
...
- classification=SOURCE_DEFINED. Source clue=no single collapse cause. Outgoing selector=Sora opens a diversion case. No authorial ominous narration beyond Blueprint evidence.
...
## Forecast Outgoing
- projected End Turn: Sora opens a diversion case.
...
1. Episode Card — exact EP234 Blueprint selector; A-Plot/Want/End Turn authority.
