...
beat: BEAT-V3-B44
concurrency: NONE
source_snapshot: router=CTX-V3-EP325; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT7-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-7C
- beat: BEAT-V3-B44
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT7-v0.1.md selector `EP325`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP324: End Turn=current resource pressure threatens a quiescent/deep lineage preservation decision. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.
...
- projected relationship line: gives protagonist a living example of identity without original privilege.
...
- projected world pressure: scale is metabolized through personhood, not diagram.
...
- Source-owned institutional/world pressure: scale is metabolized through personhood, not diagram. Relationship/institution interface: gives protagonist a living example of identity without original privilege.
...
- classification=SOURCE_DEFINED. Source clue=D01 AFTERSHOCK. Outgoing selector=protagonist must make a similar current choice. No authorial ominous narration beyond Blueprint evidence.
...
## Forecast Outgoing
- projected End Turn: protagonist must make a similar current choice.
...
1. Episode Card — exact EP325 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=current life / evidence aftermath; current world/material/location router, branch=H-B.
