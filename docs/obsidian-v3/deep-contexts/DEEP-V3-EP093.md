...
source_snapshot: router=CTX-V3-EP093; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT2-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-2D
- beat: BEAT-V3-B13
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT2-v0.1.md selector `EP093`
- branch: H-A
- concurrency: ACT2_LEDGER
- Current-lived namespace remains H-A; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP092: End Turn=one maintenance/access identifier resolves incorrectly for a moment, then corrects. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=verify a localized continuity of service/control before leaving a dangerous pocket. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: final contact with one known person is cut mid-action; no farewell or chosen-one framing.
...
- projected world pressure: from reader view, this can still look like another equipment/service failure.
...
- Source-owned institutional/world pressure: from reader view, this can still look like another equipment/service failure. Relationship/institution interface: final contact with one known person is cut mid-action; no farewell or chosen-one framing.
...
- source clue: C4 misbinding — AUTHOR-ONLY TRIGGER begins. No explanation.
- local knowledge fence: no confirmed death; no time-travel narration.
...
- classification=SOURCE_DEFINED. Source clue=C4 misbinding — AUTHOR-ONLY TRIGGER begins. No explanation. Outgoing selector=sensory/operational interruption at apparent lethal threshold. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: power/thermal instability forces emergency system migration/failover at an invisible deeper layer while protagonist is still actively engaged in a hazardous local task. His experienced environment develops a brief impossible continuity break. Immediate Want: verify a localized continuity of service/control before leaving a dangerous pocket. Act guard: Disaster/concurrency first. Resolve ACT2_LEDGER geography/time before scene execution; do not explain the branch mechanism. EP094 ends H-A current-lived state.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: power/thermal instability forces emergency system migration/failover at an invisible deeper layer while protagonist is still actively engaged in a hazardous local task. His experienced environment develops a brief impossible continuity break.
- exact Immediate Want: verify a localized continuity of service/control before leaving a dangerous pocket.
- exact End Turn: sensory/operational interruption at apparent lethal threshold.
...
## Forecast Outgoing
- projected End Turn: sensory/operational interruption at apparent lethal threshold.
...
1. Episode Card — exact EP093 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=L-G/L-A recovery access; current world/material/location router, branch=H-A.
