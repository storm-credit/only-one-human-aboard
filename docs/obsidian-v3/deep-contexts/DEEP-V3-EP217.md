...
beat: BEAT-V3-B30
concurrency: NONE
source_snapshot: router=CTX-V3-EP217; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT5-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-5C
- beat: BEAT-V3-B30
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT5-v0.1.md selector `EP217`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP216: End Turn=Mira reports public rumor of `one real human` beginning to spread through misread leaks. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.
...
- projected relationship line: Mira explicitly rejects treating his anomaly as proof he is `the one`.
...
- projected world pressure: title mystery becomes social red herring.
...
- Source-owned institutional/world pressure: title mystery becomes social red herring. Relationship/institution interface: Mira explicitly rejects treating his anomaly as proof he is `the one`.
...
- source clue: protagonist=HUMAN RH — REINFORCE.
...
- classification=REINFORCE. Source clue=protagonist=HUMAN RH — REINFORCE. Outgoing selector=one rumor targets a restricted facility, creating real security/resource consequences. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: sees travel, market and workplace behavior react before facts exist; she refuses protagonist-centered speculation. Immediate Want: manage operational disruption as rumors reinterpret `HUMAN:1` into chosen survivor/secret ruler stories. Act guard: Keep Arun current-life separation explicit and hold HUMAN meaning behind the reveal fence; do not collapse identity into explanation.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: sees travel, market and workplace behavior react before facts exist; she refuses protagonist-centered speculation.
- exact Immediate Want: manage operational disruption as rumors reinterpret `HUMAN:1` into chosen survivor/secret ruler stories.
- exact End Turn: one rumor targets a restricted facility, creating real security/resource consequences.
...
## Forecast Outgoing
- projected End Turn: one rumor targets a restricted facility, creating real security/resource consequences.
...
1. Episode Card — exact EP217 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=Transfer Belt / public-information consequence; current world/material/location router, branch=H-B.
