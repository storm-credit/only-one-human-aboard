...
source_snapshot: router=CTX-V3-EP267; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT6-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-6C
- beat: BEAT-V3-B36
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT6-v0.1.md selector `EP267`
- branch: H-B
- concurrency: ACT6_LEDGER
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP266: End Turn=hospital corridor approaches capacity threshold. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.
...
- projected relationship line: Leila↔Juno/Mira network begins practical bridge toward neutral corridor.
...
- projected world pressure: healthcare creates cross-faction cooperation pressure.
...
- Source-owned institutional/world pressure: healthcare creates cross-faction cooperation pressure. Relationship/institution interface: Leila↔Juno/Mira network begins practical bridge toward neutral corridor.
...
- source clue: neutral corridor chain REINFORCE.
...
- classification=REINFORCE. Source clue=neutral corridor chain REINFORCE. Outgoing selector=one control point faces armed/semi-armed confrontation. No authorial ominous narration beyond Blueprint evidence.
...
## Forecast Outgoing
- projected End Turn: one control point faces armed/semi-armed confrontation.
...
1. Episode Card — exact EP267 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=Medical corridor; current world/material/location router, branch=H-B.
