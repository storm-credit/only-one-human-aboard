...
beat: BEAT-V3-B18
concurrency: NONE
source_snapshot: router=CTX-V3-EP126; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT3-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-3C
- beat: BEAT-V3-B18
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT3-v0.1.md selector `EP126`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP125: End Turn=Sora demands evidence before accepting any `third history` theory. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.
...
- projected relationship line: Sora refuses protagonist's strongest interpretation while taking the evidence seriously.
...
- projected world pressure: rational skepticism is not villainy.
...
- Source-owned institutional/world pressure: rational skepticism is not villainy. Relationship/institution interface: Sora refuses protagonist's strongest interpretation while taking the evidence seriously.
...
- classification=SOURCE_DEFINED. Source clue=theory discipline. Outgoing selector=one old maintenance/registry record is located that can independently test the claimant detail. No authorial ominous narration beyond Blueprint evidence.
...
## Forecast Outgoing
- projected End Turn: one old maintenance/registry record is located that can independently test the claimant detail.
...
1. Episode Card — exact EP126 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=security investigation; current world/material/location router, branch=H-B.
