...
beat: BEAT-V3-B17
concurrency: NONE
source_snapshot: router=CTX-V3-EP118; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT3-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-3B
- beat: BEAT-V3-B17
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT3-v0.1.md selector `EP118`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP117: End Turn=procedure prevents a small failure in a context unlike H-A. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=use H-A knowledge without assuming identical causality. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: Niko notices protagonist is now less certain and more collaborative.
...
- zone: field repair
- projected world pressure: learned knowledge can migrate/usefully persist independent of remembered history.
...
- Source-owned institutional/world pressure: learned knowledge can migrate/usefully persist independent of remembered history. Relationship/institution interface: Niko notices protagonist is now less certain and more collaborative.
...
- source clue: predictive half-life versus institutional knowledge distinction.
...
- classification=SOURCE_DEFINED. Source clue=predictive half-life versus institutional knowledge distinction. Outgoing selector=protagonist hears of someone else making an impossible memory claim. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: adapts the procedure rather than reproducing remembered steps blindly; succeeds. Immediate Want: use H-A knowledge without assuming identical causality. Act guard: H-B is current-lived. H-A knowledge/state enters only through explicit memory/provenance; secondary characters retain independent causality.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: adapts the procedure rather than reproducing remembered steps blindly; succeeds.
- exact Immediate Want: use H-A knowledge without assuming identical causality.
- exact End Turn: protagonist hears of someone else making an impossible memory claim.
...
## Forecast Outgoing
- projected End Turn: protagonist hears of someone else making an impossible memory claim.
...
1. Episode Card — exact EP118 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=field repair; current world/material/location router, branch=H-B.
