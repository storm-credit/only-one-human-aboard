...
source_snapshot: router=CTX-V3-EP077; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT2-v0.1.md; mode=blueprint-compiled
...
---
# DEEP V3 EP077 — 한 사람을 위한 길, 많은 사람의 길
...
- subact: SA-V3-2C
- beat: BEAT-V3-B11
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT2-v0.1.md selector `EP077`
- branch: H-A
- concurrency: ACT2_LEDGER
- Current-lived namespace remains H-A; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP076: End Turn=a separate rescue need arises behind the restricted area. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=determine if a rescue access can coexist with reopening traffic. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: Rafi pushes from medical salvageability; protagonist feels Arun-pattern pressure.
...
- zone: L-A
- projected world pressure: rescue and city restoration compete for same corridor capacity.
...
- Source-owned institutional/world pressure: rescue and city restoration compete for same corridor capacity. Relationship/institution interface: Rafi pushes from medical salvageability; protagonist feels Arun-pattern pressure.
...
- source clue: Arun echo REINFORCE.
...
- classification=REINFORCE. Source clue=Arun echo REINFORCE. Outgoing selector=Selene must choose operational priority. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: concludes both cannot safely use same pressure/load window. Immediate Want: determine if a rescue access can coexist with reopening traffic. Act guard: Disaster/concurrency first. Resolve ACT2_LEDGER geography/time before scene execution; do not explain the branch mechanism. EP094 ends H-A current-lived state.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: concludes both cannot safely use same pressure/load window.
- exact Immediate Want: determine if a rescue access can coexist with reopening traffic.
- exact End Turn: Selene must choose operational priority.
...
## Forecast Outgoing
- projected End Turn: Selene must choose operational priority.
...
1. Episode Card — exact EP077 Blueprint selector; A-Plot/Want/End Turn authority.
