...
beat: BEAT-V3-B55
concurrency: NONE
source_snapshot: router=CTX-V3-EP401; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT9-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-9C
- beat: BEAT-V3-B55
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT9-v0.1.md selector `EP401`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP400: End Turn=attention shifts from survival to how people live afterward. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=document the failure without turning it into a heroic myth. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: worker/Niko/other teams receive causal credit.
...
- projected world pressure: new lesson enters institutions consciously this time.
...
- Source-owned institutional/world pressure: new lesson enters institutions consciously this time. Relationship/institution interface: worker/Niko/other teams receive causal credit.
...
- source clue: Knowledge Without History AFTERSHOCK inverted—this lesson has known provenance.
...
- classification=SOURCE_DEFINED. Source clue=Knowledge Without History AFTERSHOCK inverted—this lesson has known provenance. Outgoing selector=ordinary service priorities compete with rebuilding lost showcase assets. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: causal review records external disturbance, synchronized coupling, reserve choices, local deviations and institutional responses; no single savior narrative. Immediate Want: document the failure without turning it into a heroic myth. Act guard: Descendant completion and return/payoff outrank novelty. No rerun/new ontology by default; EP406-410 add no major mystery and close through consequence/return.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: causal review records external disturbance, synchronized coupling, reserve choices, local deviations and institutional responses; no single savior narrative.
- exact Immediate Want: document the failure without turning it into a heroic myth.
- exact End Turn: ordinary service priorities compete with rebuilding lost showcase assets.
...
## Forecast Outgoing
- projected End Turn: ordinary service priorities compete with rebuilding lost showcase assets.
...
1. Episode Card — exact EP401 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=settlement diagnostics; current world/material/location router, branch=H-B.
