...
source_snapshot: router=CTX-V3-EP279; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT6-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-6C
- beat: BEAT-V3-B38
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT6-v0.1.md selector `EP279`
- branch: H-B
- concurrency: ACT6_LEDGER
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP278: End Turn=protagonist notices the more immediate puzzle: some procedures/resources still reflect histories nobody remembers. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.
...
- projected relationship line: present relationships are damaged/changed but active; no reset repairs them.
...
- projected world pressure: emergency legitimacy unresolved, services lower, neutral corridor/network persists.
...
- Source-owned institutional/world pressure: emergency legitimacy unresolved, services lower, neutral corridor/network persists. Relationship/institution interface: present relationships are damaged/changed but active; no reset repairs them.
...
- source clue: Act7 scale-inference setup; Echo Outside remains peripheral.
...
- classification=SOURCE_DEFINED. Source clue=Act7 scale-inference setup; Echo Outside remains peripheral. Outgoing selector=an inherited procedure/record with no local origin becomes the first concrete Act7 investigation path. No authorial ominous narration beyond Blueprint evidence.
...
- exact End Turn: an inherited procedure/record with no local origin becomes the first concrete Act7 investigation path.
...
## Forecast Outgoing
- projected End Turn: an inherited procedure/record with no local origin becomes the first concrete Act7 investigation path.
...
1. Episode Card — exact EP279 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=Midring / Old Works / city recovery route; current world/material/location router, branch=H-B.
