...
beat: BEAT-V3-B54
concurrency: NONE
source_snapshot: router=CTX-V3-EP394; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT9-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-9B
- beat: BEAT-V3-B54
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT9-v0.1.md selector `EP394`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP393: End Turn=decoupling requires local manual/physical actions across several nodes. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=design a decoupling sequence that preserves active continuities and thermal margins. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: assigns real ownership to local technicians rather than micromanaging all nodes.
...
- projected world pressure: protagonist competence central but distributed execution necessary.
...
- Source-owned institutional/world pressure: protagonist competence central but distributed execution necessary. Relationship/institution interface: assigns real ownership to local technicians rather than micromanaging all nodes.
...
- classification=NONE. Source clue=NONE. Outgoing selector=one local team reports their node cannot follow central timing safely. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: uses damage-analysis skill to choose which connections fail first/last; old histories inform thresholds but not sequence. Immediate Want: design a decoupling sequence that preserves active continuities and thermal margins. Act guard: Descendant completion and return/payoff outrank novelty. No rerun/new ontology by default; EP406-410 add no major mystery and close through consequence/return.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: uses damage-analysis skill to choose which connections fail first/last; old histories inform thresholds but not sequence.
- exact Immediate Want: design a decoupling sequence that preserves active continuities and thermal margins.
- exact End Turn: one local team reports their node cannot follow central timing safely.
...
## Forecast Outgoing
- projected End Turn: one local team reports their node cannot follow central timing safely.
...
1. Episode Card — exact EP394 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=coupled infrastructure; current world/material/location router, branch=H-B.
