...
source_snapshot: router=CTX-V3-EP233; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT6-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-6A
- beat: BEAT-V3-B32
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT6-v0.1.md selector `EP233`
- branch: H-B
- concurrency: ACT6_LEDGER
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP232: End Turn=theft/diversion accusations begin around scarce parts. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.
...
- projected relationship line: Juno's virtue—community loyalty—shows its exclusion risk.
...
- zone: Midring
- projected world pressure: scarcity changes ordinary social networks before violence.
...
- Source-owned institutional/world pressure: scarcity changes ordinary social networks before violence. Relationship/institution interface: Juno's virtue—community loyalty—shows its exclusion risk.
...
- classification=NONE. Source clue=NONE. Outgoing selector=black-market offers appear for strategic parts and service slots. No authorial ominous narration beyond Blueprint evidence.
...
## Forecast Outgoing
- projected End Turn: black-market offers appear for strategic parts and service slots.
...
1. Episode Card — exact EP233 Blueprint selector; A-Plot/Want/End Turn authority.
