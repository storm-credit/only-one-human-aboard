...
source_snapshot: router=CTX-V3-EP254; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT6-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-6B
- beat: BEAT-V3-B35
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT6-v0.1.md selector `EP254`
- branch: H-B
- concurrency: ACT6_LEDGER
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP253: End Turn=one medical rescue request forces Rafi/Leila into reversed positions. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=keep technical crews working across political/network lines. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: he cannot repair social trust with engineering logic.
...
- zone: Old Works
- projected world pressure: labor/safety bloc becomes distinct but not ideologically pure.
...
- Source-owned institutional/world pressure: labor/safety bloc becomes distinct but not ideologically pure. Relationship/institution interface: he cannot repair social trust with engineering logic.
...
- classification=NONE. Source clue=NONE. Outgoing selector=a rescue operation would consume scarce field capacity. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: refuses to let a safety crew be labeled by district/faction; must negotiate access with people who distrust each other. Immediate Want: keep technical crews working across political/network lines. Act guard: Resolve ACT6_LEDGER concurrency/resource/network state before execution; causality must remain distributed across people and institutions.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: refuses to let a safety crew be labeled by district/faction; must negotiate access with people who distrust each other.
- exact Immediate Want: keep technical crews working across political/network lines.
- exact End Turn: a rescue operation would consume scarce field capacity.
...
## Forecast Outgoing
- projected End Turn: a rescue operation would consume scarce field capacity.
...
1. Episode Card — exact EP254 Blueprint selector; A-Plot/Want/End Turn authority.
