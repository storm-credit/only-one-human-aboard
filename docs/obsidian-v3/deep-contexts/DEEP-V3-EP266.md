...
source_snapshot: router=CTX-V3-EP266; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT6-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-6C
- beat: BEAT-V3-B36
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT6-v0.1.md selector `EP266`
- branch: H-B
- concurrency: ACT6_LEDGER
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP265: End Turn=a violent cell exploits the slowdown to approach a control point. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=manage technical consequences of his disablement decision. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: confronted by people directly harmed by longer outages; cannot hide behind `I saved more people` certainty.
...
- projected world pressure: right technical decision can create real suffering.
...
- Source-owned institutional/world pressure: right technical decision can create real suffering. Relationship/institution interface: confronted by people directly harmed by longer outages; cannot hide behind `I saved more people` certainty.
...
- classification=SOURCE_DEFINED. Source clue=moral aftershock. Outgoing selector=hospital corridor approaches capacity threshold. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: alternative systems run hotter/slower; he must prioritize stabilization without choosing district allocation himself. Immediate Want: manage technical consequences of his disablement decision. Act guard: Resolve ACT6_LEDGER concurrency/resource/network state before execution; causality must remain distributed across people and institutions.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: alternative systems run hotter/slower; he must prioritize stabilization without choosing district allocation himself.
- exact Immediate Want: manage technical consequences of his disablement decision.
- exact End Turn: hospital corridor approaches capacity threshold.
...
## Forecast Outgoing
- projected End Turn: hospital corridor approaches capacity threshold.
...
1. Episode Card — exact EP266 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=Old Works / Midring consequence; current world/material/location router, branch=H-B.
