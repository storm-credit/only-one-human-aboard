...
beat: BEAT-V3-B14
concurrency: NONE
source_snapshot: router=CTX-V3-EP099; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT3-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-3A
- beat: BEAT-V3-B14
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT3-v0.1.md selector `EP099`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP098: End Turn=consequence intersects protagonist's next workday. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=stop another H-A incident and confirm the pattern. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: Niko jokes/asks how he knew; protagonist gives a plausible technical excuse.
...
- zone: Old Works
- projected world pressure: successful intervention changes a schedule.
...
- Source-owned institutional/world pressure: successful intervention changes a schedule. Relationship/institution interface: Niko jokes/asks how he knew; protagonist gives a plausible technical excuse.
...
- source clue: foreknowledge REINFORCE.
...
- classification=REINFORCE. Source clue=foreknowledge REINFORCE. Outgoing selector=the changed schedule does not produce one downstream event he strongly remembers. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: uses remembered inspection timing to catch a small issue earlier than anyone else. Immediate Want: stop another H-A incident and confirm the pattern. Act guard: H-B is current-lived. H-A knowledge/state enters only through explicit memory/provenance; secondary characters retain independent causality.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: uses remembered inspection timing to catch a small issue earlier than anyone else.
- exact Immediate Want: stop another H-A incident and confirm the pattern.
- exact End Turn: the changed schedule does not produce one downstream event he strongly remembers.
...
## Forecast Outgoing
- projected End Turn: the changed schedule does not produce one downstream event he strongly remembers.
...
1. Episode Card — exact EP099 Blueprint selector; A-Plot/Want/End Turn authority.
