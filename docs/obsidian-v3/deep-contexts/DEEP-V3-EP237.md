...
source_snapshot: router=CTX-V3-EP237; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT6-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-6A
- beat: BEAT-V3-B33
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT6-v0.1.md selector `EP237`
- branch: H-B
- concurrency: ACT6_LEDGER
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP236: End Turn=Transfer Belt congestion forces a dispatcher to improvise next week. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.
...
- projected relationship line: Mira dislikes its unequal delays; dispatcher defends local crowd/vehicle reality.
...
- zone: Transfer Belt
- projected world pressure: ordinary expertise, not prophecy.
...
- Source-owned institutional/world pressure: ordinary expertise, not prophecy. Relationship/institution interface: Mira dislikes its unequal delays; dispatcher defends local crowd/vehicle reality.
...
- source clue: emergent-cascade seed — PLANT, never announced as important.
...
- classification=PLANT+SEED. Source clue=emergent-cascade seed — PLANT, never announced as important. Outgoing selector=one medical/supply group reaches Midring earlier; another group is delayed. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: creates a temporary routing pattern using a normally low-priority service connection and staggered vehicle turnback. It is lawful-enough within emergency discretion but awkward for audit. Immediate Want: keep a repeatedly overloaded trunk from locking the whole network. Act guard: Resolve ACT6_LEDGER concurrency/resource/network state before execution; causality must remain distributed across people and institutions.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: creates a temporary routing pattern using a normally low-priority service connection and staggered vehicle turnback. It is lawful-enough within emergency discretion but awkward for audit.
- exact Immediate Want: keep a repeatedly overloaded trunk from locking the whole network.
- exact End Turn: one medical/supply group reaches Midring earlier; another group is delayed.
...
## Forecast Outgoing
- projected End Turn: one medical/supply group reaches Midring earlier; another group is delayed.
...
1. Episode Card — exact EP237 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=Transfer Belt; current world/material/location router, branch=H-B.
