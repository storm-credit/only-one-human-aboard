...
beat: BEAT-V3-B28
concurrency: NONE
source_snapshot: router=CTX-V3-EP198; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT5-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-5B
- beat: BEAT-V3-B28
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT5-v0.1.md selector `EP198`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP197: End Turn=H-B public records indicate Arun is not dead. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.
...
- projected relationship line: current living person's relatives have their own truth/resentment.
...
- projected world pressure: memorial claim is socially real even when history conflicts.
...
- Source-owned institutional/world pressure: memorial claim is socially real even when history conflicts. Relationship/institution interface: current living person's relatives have their own truth/resentment.
...
- source clue: living/dead contradiction REINFORCE.
...
- classification=REINFORCE. Source clue=living/dead contradiction REINFORCE. Outgoing selector=protagonist is informed Arun has a current H-B work/home life. No authorial ominous narration beyond Blueprint evidence.
...
## Forecast Outgoing
- projected End Turn: protagonist is informed Arun has a current H-B work/home life.
...
1. Episode Card — exact EP198 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=memorial/family context; current world/material/location router, branch=H-B.
