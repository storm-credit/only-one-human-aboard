...
source_snapshot: router=CTX-V3-EP056; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT2-v0.1.md; mode=blueprint-compiled
...
---
# DEEP V3 EP056 — 아이들을 먼저 어디로 보낼 것인가
...
- subact: SA-V3-2A
- beat: BEAT-V3-B08
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT2-v0.1.md selector `EP056`
- branch: H-A
- concurrency: ACT2_LEDGER
- Current-lived namespace remains H-A; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP055: End Turn=route closures hit a school group already in movement. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: School Caregiver
- OFF-POV / INFLUENCE_ONLY_UNLESS_BLUEPRINT_EXPLICIT. School Caregiver owns the episode's lived decision line. Do not reroute success, discovery, or emotional resolution through the protagonist merely for centrality.

## Character Context
- active_core_cap: max 3 salient characters including POV.
- projected_active_core: School Caregiver, caregiver, Caregiver
...
- projected relationship line: parents/staff disagree about staying together vs moving quickly; caregiver owns the decision.
...
- projected world pressure: school/community emergency competence exists independently of protagonist.
...
- Source-owned institutional/world pressure: school/community emergency competence exists independently of protagonist. Relationship/institution interface: parents/staff disagree about staying together vs moving quickly; caregiver owns the decision.
...
- source clue: Act1 drill seed → PAYOFF.
...
- classification=PAYOFF+SEED. Source clue=Act1 drill seed → PAYOFF. Outgoing selector=group clears, but several parents are stranded on the other side of a transit closure. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: chooses a locally known secondary route used during ordinary drills; not a secret passage. Immediate Want: move a group of children to a safe reunification site before standard corridor closes. Act guard: Disaster/concurrency first. Resolve ACT2_LEDGER geography/time before scene execution; do not explain the branch mechanism. EP094 ends H-A current-lived state.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: chooses a locally known secondary route used during ordinary drills; not a secret passage.
- exact Immediate Want: move a group of children to a safe reunification site before standard corridor closes.
- exact End Turn: group clears, but several parents are stranded on the other side of a transit closure.
...
## Forecast Outgoing
- projected End Turn: group clears, but several parents are stranded on the other side of a transit closure.
...
1. Episode Card — exact EP056 Blueprint selector; A-Plot/Want/End Turn authority.
2. Immediate Continuity — prior realized CONTINUITY-FROZEN + this forecast selector; never future guessed Actual.
3. POV/Relationship — POV=School Caregiver; relationship line + current role/relationship graph, active core <=3.
4. World/Zone/Material — Zone=L-C Midring school/community route; current world/material/location router, branch=H-A.
