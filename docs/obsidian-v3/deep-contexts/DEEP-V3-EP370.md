...
- classification=PAYOFF. Source clue=Act8 major PAYOFF; D10 hands to Act9. Outgoing selector=Meridian begins building/activating the first real settlement commons where old histories cannot guarantee the answer. No authorial ominous narration beyond Blueprint evidence.
...
- exact End Turn: Meridian begins building/activating the first real settlement commons where old histories cannot guarantee the answer.
...
## Forecast Outgoing
- projected End Turn: Meridian begins building/activating the first real settlement commons where old histories cannot guarantee the answer.
