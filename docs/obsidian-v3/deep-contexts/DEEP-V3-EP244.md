...
source_snapshot: router=CTX-V3-EP244; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT6-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-6A
- beat: BEAT-V3-B33
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT6-v0.1.md selector `EP244`
- branch: H-B
- concurrency: ACT6_LEDGER
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP243: End Turn=one practical workaround is copied by other blocks. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=keep repairs moving under improvised city routines. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: he credits local crews rather than central plan.
...
- projected world pressure: city adapts from below.
...
- Source-owned institutional/world pressure: city adapts from below. Relationship/institution interface: he credits local crews rather than central plan.
...
- source clue: no reveal that Dispatcher choice is special.
...
- classification=SOURCE_DEFINED. Source clue=no reveal that Dispatcher choice is special. Outgoing selector=rolling outages become less predictable and emergency policy begins hardening. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: sees many unofficial-but-not-illegal adaptations around transport/work; cannot know which will matter later. Immediate Want: keep repairs moving under improvised city routines. Act guard: Resolve ACT6_LEDGER concurrency/resource/network state before execution; causality must remain distributed across people and institutions.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: sees many unofficial-but-not-illegal adaptations around transport/work; cannot know which will matter later.
- exact Immediate Want: keep repairs moving under improvised city routines.
- exact End Turn: rolling outages become less predictable and emergency policy begins hardening.
...
## Forecast Outgoing
- projected End Turn: rolling outages become less predictable and emergency policy begins hardening.
...
1. Episode Card — exact EP244 Blueprint selector; A-Plot/Want/End Turn authority.
