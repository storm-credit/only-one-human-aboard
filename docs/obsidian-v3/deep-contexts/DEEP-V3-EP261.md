...
source_snapshot: router=CTX-V3-EP261; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT6-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-6B
- beat: BEAT-V3-B35
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT6-v0.1.md selector `EP261`
- branch: H-B
- concurrency: ACT6_LEDGER
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP260: End Turn=broader high-capacity path approaches a politically forced restart decision. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=keep Gideon/Niko/team aligned before the most consequential repair decision yet. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: protagonist relinquishes some control but becomes firmer on the larger risk.
...
- zone: Old Works
- projected world pressure: technical conflict prepares B36.
...
- Source-owned institutional/world pressure: technical conflict prepares B36. Relationship/institution interface: protagonist relinquishes some control but becomes firmer on the larger risk.
...
- source clue: high-capacity failure mode TRIGGER.
...
- classification=SOURCE_DEFINED. Source clue=high-capacity failure mode TRIGGER. Outgoing selector=civic order demands a rapid-restoration plan. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: accepts Niko's local initiative but distinguishes it from the unstable high-capacity path officials want restored. Immediate Want: keep Gideon/Niko/team aligned before the most consequential repair decision yet. Act guard: Resolve ACT6_LEDGER concurrency/resource/network state before execution; causality must remain distributed across people and institutions.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: accepts Niko's local initiative but distinguishes it from the unstable high-capacity path officials want restored.
- exact Immediate Want: keep Gideon/Niko/team aligned before the most consequential repair decision yet.
- exact End Turn: civic order demands a rapid-restoration plan.
...
## Forecast Outgoing
- projected End Turn: civic order demands a rapid-restoration plan.
...
1. Episode Card — exact EP261 Blueprint selector; A-Plot/Want/End Turn authority.
