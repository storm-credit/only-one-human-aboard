...
beat: BEAT-V3-B20
concurrency: NONE
source_snapshot: router=CTX-V3-EP144; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT4-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-4A
- beat: BEAT-V3-B20
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT4-v0.1.md selector `EP144`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP143: End Turn=the fake predictor repeats one detail apparently copied from a genuinely restricted source. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=distinguish copied restricted detail from impossible memory. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: protagonist learns not every uncanny claim deserves his personal attention.
...
- projected world pressure: local fraud investigation can close.
...
- Source-owned institutional/world pressure: local fraud investigation can close. Relationship/institution interface: protagonist learns not every uncanny claim deserves his personal attention.
...
- source clue: one fake case PARTIAL PAYOFF.
...
- classification=PAYOFF. Source clue=one fake case PARTIAL PAYOFF. Outgoing selector=Mira reports unusual evacuation/asset movement around the predicted target by people with no link to the exposed fraud. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: traces the detail through ordinary leakage chain; this case is not supernatural. Immediate Want: distinguish copied restricted detail from impossible memory. Act guard: Prediction and social consequence before ontology. Evidence must change choices/relationships before any explanatory model hardens.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: traces the detail through ordinary leakage chain; this case is not supernatural.
- exact Immediate Want: distinguish copied restricted detail from impossible memory.
- exact End Turn: Mira reports unusual evacuation/asset movement around the predicted target by people with no link to the exposed fraud.
...
## Forecast Outgoing
- projected End Turn: Mira reports unusual evacuation/asset movement around the predicted target by people with no link to the exposed fraud.
...
1. Episode Card — exact EP144 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=security/technical interface; current world/material/location router, branch=H-B.
