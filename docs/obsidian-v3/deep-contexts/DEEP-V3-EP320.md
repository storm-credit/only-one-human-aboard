...
beat: BEAT-V3-B44
concurrency: NONE
source_snapshot: router=CTX-V3-EP320; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT7-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-7C
- beat: BEAT-V3-B44
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT7-v0.1.md selector `EP320`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP319: End Turn=remaining synthesis question: what exactly is Meridian carrying and why so many lineages? | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=distinguish multiple universes/ships from one-ark architecture. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: characters who favored parallel-world theory concede it was reasonable but incomplete.
...
- projected world pressure: one Outer Ark fact paid.
...
- Source-owned institutional/world pressure: one Outer Ark fact paid. Relationship/institution interface: characters who favored parallel-world theory concede it was reasonable but incomplete.
...
- source clue: D08 FINAL PAYOFF step 1.
...
- classification=PAYOFF. Source clue=D08 FINAL PAYOFF step 1. Outgoing selector=lineage indices expand beyond any small finite set characters have encountered. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: verifies all relevant substrate/resource/maintenance evidence belongs to one physical Meridian whose external mission clock never rewound. Immediate Want: distinguish multiple universes/ships from one-ark architecture. Act guard: Action/evidence before ontology. Every explanatory beat must be earned by a concrete decision, cost, failed model, or operational consequence.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: verifies all relevant substrate/resource/maintenance evidence belongs to one physical Meridian whose external mission clock never rewound.
- exact Immediate Want: distinguish multiple universes/ships from one-ark architecture.
- exact End Turn: lineage indices expand beyond any small finite set characters have encountered.
...
## Forecast Outgoing
- projected End Turn: lineage indices expand beyond any small finite set characters have encountered.
...
1. Episode Card — exact EP320 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=physical/navigation/maintenance evidence interface; current world/material/location router, branch=H-B.
