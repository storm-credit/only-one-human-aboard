...
beat: BEAT-V3-B15
concurrency: NONE
source_snapshot: router=CTX-V3-EP103; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT3-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-3A
- beat: BEAT-V3-B15
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT3-v0.1.md selector `EP103`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP102: End Turn=he checks the cooling segment's older maintenance history. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=verify the future failure point from H-A. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: he asks questions too intensely and draws Gideon's attention.
...
- projected world pressure: technical records provide pre-existing historical delta.
...
- Source-owned institutional/world pressure: technical records provide pre-existing historical delta. Relationship/institution interface: he asks questions too intensely and draws Gideon's attention.
...
- source clue: literal-regression model materially weakened — TRIGGER.
...
- classification=SOURCE_DEFINED. Source clue=literal-regression model materially weakened — TRIGGER. Outgoing selector=protagonist checks whether Niko/Gideon history also differs. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: discovers a key component/repair state is not the one he remembers; the difference dates well before his H-B arrival. Immediate Want: verify the future failure point from H-A. Act guard: H-B is current-lived. H-A knowledge/state enters only through explicit memory/provenance; secondary characters retain independent causality.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: discovers a key component/repair state is not the one he remembers; the difference dates well before his H-B arrival.
- exact Immediate Want: verify the future failure point from H-A.
- exact End Turn: protagonist checks whether Niko/Gideon history also differs.
...
## Forecast Outgoing
- projected End Turn: protagonist checks whether Niko/Gideon history also differs.
...
1. Episode Card — exact EP103 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=Old Works cooling network; current world/material/location router, branch=H-B.
