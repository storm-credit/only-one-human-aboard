...
source_snapshot: router=CTX-V3-EP229; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT6-v0.1.md; mode=blueprint-compiled
...
- projected relationship line: Gideon accepts one delay; Niko thinks caution is becoming institutional surrender.
...
- zone: Old Works
- projected world pressure: scarcity first appears as schedules, queues and deferred maintenance.
...
- Source-owned institutional/world pressure: scarcity first appears as schedules, queues and deferred maintenance. Relationship/institution interface: Gideon accepts one delay; Niko thinks caution is becoming institutional surrender.
...
- source clue: broader hidden-load/resource mystery — soft PLANT only.
...
- classification=PLANT. Source clue=broader hidden-load/resource mystery — soft PLANT only. Outgoing selector=another utility job loses its fabrication slot. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: allocation window is cut again; team must patch rather than replace. Protagonist documents risk accumulation instead of claiming immediate catastrophe. Immediate Want: secure power/material window for a routine but important structural repair. Act guard: Resolve ACT6_LEDGER concurrency/resource/network state before execution; causality must remain distributed across people and institutions.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: allocation window is cut again; team must patch rather than replace. Protagonist documents risk accumulation instead of claiming immediate catastrophe.
- exact Immediate Want: secure power/material window for a routine but important structural repair.
- exact End Turn: another utility job loses its fabrication slot.
...
## Forecast Outgoing
- projected End Turn: another utility job loses its fabrication slot.
...
1. Episode Card — exact EP229 Blueprint selector; A-Plot/Want/End Turn authority.
