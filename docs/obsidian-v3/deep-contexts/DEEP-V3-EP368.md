...
beat: BEAT-V3-B50
concurrency: NONE
source_snapshot: router=CTX-V3-EP368; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT8-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-8C
- beat: BEAT-V3-B50
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT8-v0.1.md selector `EP368`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP367: End Turn=settlement systems need immediate operational authority before permanent law exists. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=understand legacy `promotion` terminology now tied to settlement/depth. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: protagonist rejects language of `winning history`.
...
- projected world pressure: D10 MacGuffin meaning clarifies.
...
- Source-owned institutional/world pressure: D10 MacGuffin meaning clarifies. Relationship/institution interface: protagonist rejects language of `winning history`.
...
- classification=SOURCE_DEFINED. Source clue=D10 TRIGGER. Outgoing selector=first deployment schedule must be protected under new temporary rules. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: establishes it means resource/depth/preservation/external preparation, not choosing a morally best civilization score. Immediate Want: understand legacy `promotion` terminology now tied to settlement/depth. Act guard: HUMAN provenance is not personhood. HUMAN:1 must remain de-collectified and must not become a collectible-character family or sacred merchandise target.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: establishes it means resource/depth/preservation/external preparation, not choosing a morally best civilization score.
- exact Immediate Want: understand legacy `promotion` terminology now tied to settlement/depth.
- exact End Turn: first deployment schedule must be protected under new temporary rules.
...
## Forecast Outgoing
- projected End Turn: first deployment schedule must be protected under new temporary rules.
...
1. Episode Card — exact EP368 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=technical settlement-preparation records; current world/material/location router, branch=H-B.
