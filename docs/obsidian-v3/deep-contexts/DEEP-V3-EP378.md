...
beat: BEAT-V3-B51
concurrency: NONE
source_snapshot: router=CTX-V3-EP378; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT9-v0.1.md; mode=blueprint-compiled
...
---
# DEEP V3 EP378 — 살 수 있는 곳, 아직 살고 있는 곳
...
- subact: SA-V3-9A
- beat: BEAT-V3-B51
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT9-v0.1.md selector `EP378`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP377: End Turn=first settlement commons reach limited operational state. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.
...
- projected relationship line: protagonist chooses a current H-B/settlement commitment rather than symbolic first-person status.
...
- projected world pressure: two-way dependence sets B52.
...
- Source-owned institutional/world pressure: two-way dependence sets B52. Relationship/institution interface: protagonist chooses a current H-B/settlement commitment rather than symbolic first-person status.
...
- classification=SOURCE_DEFINED. Source clue=no new mystery. Outgoing selector=transitional government must define shared-resource authority during dependency period. No authorial ominous narration beyond Blueprint evidence.
...
## Forecast Outgoing
- projected End Turn: transitional government must define shared-resource authority during dependency period.
...
1. Episode Card — exact EP378 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=Meridian ↔ settlement commons; current world/material/location router, branch=H-B.
