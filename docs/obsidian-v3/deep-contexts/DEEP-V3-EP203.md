...
beat: BEAT-V3-B28
concurrency: NONE
source_snapshot: router=CTX-V3-EP203; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT5-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-5B
- beat: BEAT-V3-B28
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT5-v0.1.md selector `EP203`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP202: End Turn=protagonist receives permission/contact window with Arun. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=decide what he actually wants from Arun—absolution, proof, or information. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: family/Mira interaction prevents self-contained guilt monologue.
...
- zone: home / Old Works
- projected world pressure: present-life obligation continues.
...
- Source-owned institutional/world pressure: present-life obligation continues. Relationship/institution interface: family/Mira interaction prevents self-contained guilt monologue.
...
- source clue: Arun personal line primed.
...
- classification=SOURCE_DEFINED. Source clue=Arun personal line primed. Outgoing selector=meeting begins next episode. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: replays only necessary H-A facts and recognizes he cannot ask current Arun to forgive an event this Arun may not have lived. Immediate Want: decide what he actually wants from Arun—absolution, proof, or information. Act guard: Keep Arun current-life separation explicit and hold HUMAN meaning behind the reveal fence; do not collapse identity into explanation.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: replays only necessary H-A facts and recognizes he cannot ask current Arun to forgive an event this Arun may not have lived.
- exact Immediate Want: decide what he actually wants from Arun—absolution, proof, or information.
- exact End Turn: meeting begins next episode.
...
## Forecast Outgoing
- projected End Turn: meeting begins next episode.
...
1. Episode Card — exact EP203 Blueprint selector; A-Plot/Want/End Turn authority.
