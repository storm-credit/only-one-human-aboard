...
source_snapshot: router=CTX-V3-EP048; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT2-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-2A
- beat: BEAT-V3-B07
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT2-v0.1.md selector `EP048`
- branch: H-A
- concurrency: ACT2_LEDGER
- Current-lived namespace remains H-A; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP047: End Turn=one trapped worker is on the wrong side of a newly isolated section. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=create enough structural stability for rescue. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: Niko is assigned live sensor relay; protagonist must trust his readout.
...
- projected world pressure: technical success creates a rescue option but does not rescue anyone by itself.
...
- Source-owned institutional/world pressure: technical success creates a rescue option but does not rescue anyone by itself. Relationship/institution interface: Niko is assigned live sensor relay; protagonist must trust his readout.
...
- classification=NONE. Source clue=NONE. Outgoing selector=Rafi's team commits to entry. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: uses temporary bracing and pressure-safe sequencing rather than reopening the main barrier. Immediate Want: create enough structural stability for rescue. Act guard: Disaster/concurrency first. Resolve ACT2_LEDGER geography/time before scene execution; do not explain the branch mechanism. EP094 ends H-A current-lived state.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: uses temporary bracing and pressure-safe sequencing rather than reopening the main barrier.
- exact Immediate Want: create enough structural stability for rescue.
- exact End Turn: Rafi's team commits to entry.
...
## Forecast Outgoing
- projected End Turn: Rafi's team commits to entry.
...
1. Episode Card — exact EP048 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=L-A service access; current world/material/location router, branch=H-A.
