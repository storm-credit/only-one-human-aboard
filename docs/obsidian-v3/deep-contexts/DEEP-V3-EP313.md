...
beat: BEAT-V3-B43
concurrency: NONE
source_snapshot: router=CTX-V3-EP313; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT7-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-7C
- beat: BEAT-V3-B43
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT7-v0.1.md selector `EP313`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP312: End Turn=protected maintenance map contains repeated microscopic/distributed anchor terminology. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=determine whether namespace corresponds to actual hardware/resources. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: technical team must coordinate with archive/security rather than protagonist gaining root access.
...
- projected world pressure: ultradense physical substrate begins factual reveal.
...
- Source-owned institutional/world pressure: ultradense physical substrate begins factual reveal. Relationship/institution interface: technical team must coordinate with archive/security rather than protagonist gaining root access.
...
- source clue: D03 FINAL PAYOFF + D08 REINFORCE.
...
- classification=REINFORCE+PAYOFF. Source clue=D03 FINAL PAYOFF + D08 REINFORCE. Outgoing selector=load patterns imply different execution depths. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: traces distributed protected nodes/anchor maintenance loads; no one atom contains a city, and no one node equals one simple world. Immediate Want: determine whether namespace corresponds to actual hardware/resources. Act guard: Action/evidence before ontology. Every explanatory beat must be earned by a concrete decision, cost, failed model, or operational consequence.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: traces distributed protected nodes/anchor maintenance loads; no one atom contains a city, and no one node equals one simple world.
- exact Immediate Want: determine whether namespace corresponds to actual hardware/resources.
- exact End Turn: load patterns imply different execution depths.
...
## Forecast Outgoing
- projected End Turn: load patterns imply different execution depths.
...
1. Episode Card — exact EP313 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=protected support infrastructure; current world/material/location router, branch=H-B.
