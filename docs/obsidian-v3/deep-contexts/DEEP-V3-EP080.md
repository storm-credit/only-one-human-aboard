...
source_snapshot: router=CTX-V3-EP080; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT2-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-2C
- beat: BEAT-V3-B11
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT2-v0.1.md selector `EP080`
- branch: H-A
- concurrency: ACT2_LEDGER
- Current-lived namespace remains H-A; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP079: End Turn=first pressure alarm trips across a second boundary. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.
...
- projected relationship line: Selene accepts responsibility for command choice rather than hiding behind protagonist's technical report.
...
- zone: mobile command
- projected world pressure: emergency authority visible at its harshest.
...
- Source-owned institutional/world pressure: emergency authority visible at its harshest. Relationship/institution interface: Selene accepts responsibility for command choice rather than hiding behind protagonist's technical report.
...
- classification=NONE. Source clue=NONE. Outgoing selector=one bulkhead does not seal cleanly due deformation. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: orders staged closures and reroutes teams; one closure traps people on the wrong side temporarily. Immediate Want: prevent secondary breach from propagating while rescue personnel remain inside. Act guard: Disaster/concurrency first. Resolve ACT2_LEDGER geography/time before scene execution; do not explain the branch mechanism. EP094 ends H-A current-lived state.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: orders staged closures and reroutes teams; one closure traps people on the wrong side temporarily.
- exact Immediate Want: prevent secondary breach from propagating while rescue personnel remain inside.
- exact End Turn: one bulkhead does not seal cleanly due deformation.
...
## Forecast Outgoing
- projected End Turn: one bulkhead does not seal cleanly due deformation.
...
1. Episode Card — exact EP080 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=mobile command; current world/material/location router, branch=H-A.
