...
source_snapshot: router=CTX-V3-EP257; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT6-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-6B
- beat: BEAT-V3-B35
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT6-v0.1.md selector `EP257`
- branch: H-B
- concurrency: ACT6_LEDGER
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP256: End Turn=hospital requests an exception from a resource rule. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.
...
- projected relationship line: Rafi now worries she is risking system capacity—their expected roles invert without becoming caricatures.
...
- zone: Med-University
- projected world pressure: medicine cannot be reduced to one utilitarian formula.
...
- Source-owned institutional/world pressure: medicine cannot be reduced to one utilitarian formula. Relationship/institution interface: Rafi now worries she is risking system capacity—their expected roles invert without becoming caricatures.
...
- source clue: future D3-rights moral groundwork.
...
- classification=SOURCE_DEFINED. Source clue=future D3-rights moral groundwork. Outgoing selector=technical apprentices begin bypassing authorization to keep local utilities alive. No authorial ominous narration beyond Blueprint evidence.
...
## Forecast Outgoing
- projected End Turn: technical apprentices begin bypassing authorization to keep local utilities alive.
...
1. Episode Card — exact EP257 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=Med-University; current world/material/location router, branch=H-B.
