...
source_snapshot: router=CTX-V3-EP082; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT2-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-2C
- beat: BEAT-V3-B11
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT2-v0.1.md selector `EP082`
- branch: H-A
- concurrency: ACT2_LEDGER
- Current-lived namespace remains H-A; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP081: End Turn=trapped-group list becomes known. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=decide what technical recommendation to give with known people still inside. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: one trapped person has a connection to a known secondary character, preventing abstract numbers.
...
- projected world pressure: decision support under uncertainty.
...
- Source-owned institutional/world pressure: decision support under uncertainty. Relationship/institution interface: one trapped person has a connection to a known secondary character, preventing abstract numbers.
...
- source clue: Arun old decision structure now unmistakably mirrored.
...
- classification=SOURCE_DEFINED. Source clue=Arun old decision structure now unmistakably mirrored. Outgoing selector=Selene asks for his final structural recommendation. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: maps likely casualty envelopes for `open longer` vs `seal now`; no option is clean. Immediate Want: decide what technical recommendation to give with known people still inside. Act guard: Disaster/concurrency first. Resolve ACT2_LEDGER geography/time before scene execution; do not explain the branch mechanism. EP094 ends H-A current-lived state.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: maps likely casualty envelopes for `open longer` vs `seal now`; no option is clean.
- exact Immediate Want: decide what technical recommendation to give with known people still inside.
- exact End Turn: Selene asks for his final structural recommendation.
...
## Forecast Outgoing
- projected End Turn: Selene asks for his final structural recommendation.
...
1. Episode Card — exact EP082 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=L-D support / L-A; current world/material/location router, branch=H-A.
