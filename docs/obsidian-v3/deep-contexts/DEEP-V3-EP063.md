...
source_snapshot: router=CTX-V3-EP063; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT2-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-2B
- beat: BEAT-V3-B09
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT2-v0.1.md selector `EP063`
- branch: H-A
- concurrency: ACT2_LEDGER
- Current-lived namespace remains H-A; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP062: End Turn=the escorted window creates a new logistics bottleneck elsewhere. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=distinguish recent tampering from old structural condition. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: Gideon backs the separation; Niko begins distrusting the official asset history.
...
- projected world pressure: multiple causes coexist.
...
- Source-owned institutional/world pressure: multiple causes coexist. Relationship/institution interface: Gideon backs the separation; Niko begins distrusting the official asset history.
...
- source clue: D03 REINFORCE; master-saboteur simplification weakens.
...
- classification=REINFORCE. Source clue=D03 REINFORCE; master-saboteur simplification weakens. Outgoing selector=Mira reports evacuation/freight conflict caused by security routing. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: shows bypass is recent/mundane while one material seam is much older and unrelated to the illegal work. Immediate Want: distinguish recent tampering from old structural condition. Act guard: Disaster/concurrency first. Resolve ACT2_LEDGER geography/time before scene execution; do not explain the branch mechanism. EP094 ends H-A current-lived state.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: shows bypass is recent/mundane while one material seam is much older and unrelated to the illegal work.
- exact Immediate Want: distinguish recent tampering from old structural condition.
- exact End Turn: Mira reports evacuation/freight conflict caused by security routing.
...
## Forecast Outgoing
- projected End Turn: Mira reports evacuation/freight conflict caused by security routing.
...
1. Episode Card — exact EP063 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=L-A restricted inspection; current world/material/location router, branch=H-A.
