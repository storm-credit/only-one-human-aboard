...
beat: BEAT-V3-B47
concurrency: NONE
source_snapshot: router=CTX-V3-EP348; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT8-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-8B
- beat: BEAT-V3-B47
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT8-v0.1.md selector `EP348`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP347: End Turn=family asks for a reversible option now, not historical apology. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: D3 rights-family adult A
- OFF-POV / INFLUENCE_ONLY_UNLESS_BLUEPRINT_EXPLICIT. D3 rights-family adult A owns the episode's lived decision line. Do not reroute success, discovery, or emotional resolution through the protagonist merely for centrality.

## Character Context
- active_core_cap: max 3 salient characters including POV.
- projected_active_core: D3 rights-family adult A, family
...
- projected relationship line: family members do not all agree; some prefer remaining active despite resource cost.
...
- projected world pressure: affected persons generate policy options themselves.
...
- Source-owned institutional/world pressure: affected persons generate policy options themselves. Relationship/institution interface: family members do not all agree; some prefer remaining active despite resource cost.
...
- source clue: D09 solution path REINFORCE.
...
- classification=REINFORCE. Source clue=D09 solution path REINFORCE. Outgoing selector=proposal costs more resources than administrators planned. No authorial ominous narration beyond Blueprint evidence.
...
## Forecast Outgoing
- projected End Turn: proposal costs more resources than administrators planned.
...
1. Episode Card — exact EP348 Blueprint selector; A-Plot/Want/End Turn authority.
2. Immediate Continuity — prior realized CONTINUITY-FROZEN + this forecast selector; never future guessed Actual.
3. POV/Relationship — POV=D3 rights-family adult A; relationship line + current role/relationship graph, active core <=3.
4. World/Zone/Material — Zone=family/civic interface; current world/material/location router, branch=H-B.
