...
source_snapshot: router=CTX-V3-EP275; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT6-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-6C
- beat: BEAT-V3-B37
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT6-v0.1.md selector `EP275`
- branch: H-B
- concurrency: ACT6_LEDGER
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP274: End Turn=corridor prevents one confrontation and moves vulnerable people. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.
...
- projected_active_core: 루카스, Mira, Rafi
...
- projected relationship line: reconnects with Mira/Juno/Rafi after they made choices without him.
...
- projected world pressure: network causality stays plural.
...
- Source-owned institutional/world pressure: network causality stays plural. Relationship/institution interface: reconnects with Mira/Juno/Rafi after they made choices without him.
...
- source clue: emergent actor meaning PAYOFF without naming a chosen person.
...
- classification=PAYOFF. Source clue=emergent actor meaning PAYOFF without naming a chosen person. Outgoing selector=someone traces the corridor's earliest enabling route decision back to the dispatcher. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: sees immediate relief but also new burdens on receiving zones; no magical solution to scarcity. Immediate Want: assess what the movement changed physically and socially. Act guard: Resolve ACT6_LEDGER concurrency/resource/network state before execution; causality must remain distributed across people and institutions.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: sees immediate relief but also new burdens on receiving zones; no magical solution to scarcity.
- exact Immediate Want: assess what the movement changed physically and socially.
- exact End Turn: someone traces the corridor's earliest enabling route decision back to the dispatcher.
...
## Forecast Outgoing
- projected End Turn: someone traces the corridor's earliest enabling route decision back to the dispatcher.
...
1. Episode Card — exact EP275 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=corridor aftermath; current world/material/location router, branch=H-B.
