...
beat: BEAT-V3-B53
concurrency: NONE
source_snapshot: router=CTX-V3-EP391; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT9-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-9B
- beat: BEAT-V3-B53
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT9-v0.1.md selector `EP391`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP390: End Turn=induced stress begins damaging a high-capacity settlement coupling. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=determine why failures propagate across physically separate nodes. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: protagonist recognizes an ordinary worker's commissioning choice contains crucial evidence.
...
- projected world pressure: final-solution mechanism becomes observable.
...
- Source-owned institutional/world pressure: final-solution mechanism becomes observable. Relationship/institution interface: protagonist recognizes an ordinary worker's commissioning choice contains crucial evidence.
...
- source clue: emergent actor seed → TRIGGER.
...
- classification=SEED. Source clue=emergent actor seed → TRIGGER. Outgoing selector=Selene must keep access open while teams physically decouple systems. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: damage chronology shows synchronized/coupled control/power behavior is amplifying the external disturbance; asynchronous isolated node from EP371 remains comparatively stable. Immediate Want: determine why failures propagate across physically separate nodes. Act guard: Descendant completion and return/payoff outrank novelty. No rerun/new ontology by default; EP406-410 add no major mystery and close through consequence/return.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: damage chronology shows synchronized/coupled control/power behavior is amplifying the external disturbance; asynchronous isolated node from EP371 remains comparatively stable.
- exact Immediate Want: determine why failures propagate across physically separate nodes.
- exact End Turn: Selene must keep access open while teams physically decouple systems.
...
## Forecast Outgoing
- projected End Turn: Selene must keep access open while teams physically decouple systems.
...
1. Episode Card — exact EP391 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=damaged coupling infrastructure; current world/material/location router, branch=H-B.
