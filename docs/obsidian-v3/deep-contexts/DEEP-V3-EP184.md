...
beat: BEAT-V3-B26
concurrency: NONE
source_snapshot: router=CTX-V3-EP184; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT5-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-5A
- beat: BEAT-V3-B26
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT5-v0.1.md selector `EP184`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP183: End Turn=maintenance wear implies heavy historical use that records deny. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: Hana
- OFF-POV / INFLUENCE_ONLY_UNLESS_BLUEPRINT_EXPLICIT. Hana owns the episode's lived decision line. Do not reroute success, discovery, or emotional resolution through the protagonist merely for centrality.

## Character Context
- active_core_cap: max 3 salient characters including POV.
- projected_active_core: Hana, Sora, family
...
- projected relationship line: Hana↔Sora future tension seeded: preservation vs active investigation.
...
- projected world pressure: archivist work is procedures, access and incomplete data, not truth-file ownership.
...
- Source-owned institutional/world pressure: archivist work is procedures, access and incomplete data, not truth-file ownership. Relationship/institution interface: Hana↔Sora future tension seeded: preservation vs active investigation.
...
- source clue: absent-history record family PLANT.
...
- classification=PLANT. Source clue=absent-history record family PLANT. Outgoing selector=one record references casualty logistics without named disaster. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: identifies several mundane record migrations plus one orphan record family tied to the legacy complex. Immediate Want: prevent old maintenance/municipal records from being discarded or normalized before provenance review. Act guard: Keep Arun current-life separation explicit and hold HUMAN meaning behind the reveal fence; do not collapse identity into explanation.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: identifies several mundane record migrations plus one orphan record family tied to the legacy complex.
- exact Immediate Want: prevent old maintenance/municipal records from being discarded or normalized before provenance review.
- exact End Turn: one record references casualty logistics without named disaster.
...
## Forecast Outgoing
- projected End Turn: one record references casualty logistics without named disaster.
...
1. Episode Card — exact EP184 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=Central archive / offsite legacy records; current world/material/location router, branch=H-B.
