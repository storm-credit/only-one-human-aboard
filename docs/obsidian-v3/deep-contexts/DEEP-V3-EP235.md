...
source_snapshot: router=CTX-V3-EP235; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT6-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-6A
- beat: BEAT-V3-B32
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT6-v0.1.md selector `EP235`
- branch: H-B
- concurrency: ACT6_LEDGER
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP234: End Turn=Sora opens a diversion case. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=estimate when patch accumulation becomes unacceptable. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: Niko argues for unauthorized local fixes; protagonist says improvisation without coordination can weaponize the network unintentionally.
...
- zone: Old Works
- projected world pressure: Act6 technical stakes established.
...
- Source-owned institutional/world pressure: Act6 technical stakes established. Relationship/institution interface: Niko argues for unauthorized local fixes; protagonist says improvisation without coordination can weaponize the network unintentionally.
...
- source clue: later high-capacity path danger PLANT.
...
- classification=PLANT. Source clue=later high-capacity path danger PLANT. Outgoing selector=security reports parts theft is real but not centrally organized. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: builds a risk map showing several systems can limp independently but concurrent stress is dangerous. Immediate Want: estimate when patch accumulation becomes unacceptable. Act guard: Resolve ACT6_LEDGER concurrency/resource/network state before execution; causality must remain distributed across people and institutions.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: builds a risk map showing several systems can limp independently but concurrent stress is dangerous.
- exact Immediate Want: estimate when patch accumulation becomes unacceptable.
- exact End Turn: security reports parts theft is real but not centrally organized.
...
## Forecast Outgoing
- projected End Turn: security reports parts theft is real but not centrally organized.
...
1. Episode Card — exact EP235 Blueprint selector; A-Plot/Want/End Turn authority.
