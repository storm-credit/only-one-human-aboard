...
beat: BEAT-V3-B53
concurrency: NONE
source_snapshot: router=CTX-V3-EP388; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT9-v0.1.md; mode=blueprint-compiled
...
---
# DEEP V3 EP388 — 돌아오면 된다는 말이 안 되는 사람들
...
- subact: SA-V3-9B
- beat: BEAT-V3-B53
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT9-v0.1.md selector `EP388`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP387: End Turn=medical team has local embodied persons exposed to rising stress. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.
...
- projected relationship line: Act2 `one more person` instinct returns with mature resource discipline.
...
- projected world pressure: death stakes explicitly local/final for continuity.
...
- Source-owned institutional/world pressure: death stakes explicitly local/final for continuity. Relationship/institution interface: Act2 `one more person` instinct returns with mature resource discipline.
...
- source clue: death/personhood AFTERSHOCK.
...
- classification=SOURCE_DEFINED. Source clue=death/personhood AFTERSHOCK. Outgoing selector=one local clinic/power node must operate autonomously. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: triages real injuries and refuses language treating them as replaceable because related lineages/backups exist. Immediate Want: stabilize physically local persistent persons when evacuation/link recovery is uncertain. Act guard: Descendant completion and return/payoff outrank novelty. No rerun/new ontology by default; EP406-410 add no major mystery and close through consequence/return.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: triages real injuries and refuses language treating them as replaceable because related lineages/backups exist.
- exact Immediate Want: stabilize physically local persistent persons when evacuation/link recovery is uncertain.
- exact End Turn: one local clinic/power node must operate autonomously.
...
## Forecast Outgoing
- projected End Turn: one local clinic/power node must operate autonomously.
...
1. Episode Card — exact EP388 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=destination-side/local medical response; current world/material/location router, branch=H-B.
