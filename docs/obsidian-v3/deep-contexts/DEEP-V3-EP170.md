...
beat: BEAT-V3-B24
concurrency: NONE
source_snapshot: router=CTX-V3-EP170; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT4-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-4C
- beat: BEAT-V3-B24
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT4-v0.1.md selector `EP170`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP169: End Turn=Ivo's public statement causes immediate behavioral changes. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.
...
- projected relationship line: family/work contacts react with worry, belief and exhaustion; he is not a cult leader.
...
- projected world pressure: genuine anomaly can ruin an ordinary life.
...
- Source-owned institutional/world pressure: genuine anomaly can ruin an ordinary life. Relationship/institution interface: family/work contacts react with worry, belief and exhaustion; he is not a cult leader.
...
- source clue: direct POV intentionally confirms lived certainty, NOT mechanism or perfect accuracy.
- local knowledge fence: no system truth; his memories are partial and internally overconfident.
...
- classification=SOURCE_DEFINED. Source clue=direct POV intentionally confirms lived certainty, NOT mechanism or perfect accuracy. Outgoing selector=a prediction he just repeated is already becoming less likely because of public response. No authorial ominous narration beyond Blueprint evidence.
...
## Forecast Outgoing
- projected End Turn: a prediction he just repeated is already becoming less likely because of public response.
...
1. Episode Card — exact EP170 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=ordinary home/work/public transition; current world/material/location router, branch=H-B.
