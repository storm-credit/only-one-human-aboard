...
beat: BEAT-V3-B52
concurrency: NONE
source_snapshot: router=CTX-V3-EP383; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT9-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-9A
- beat: BEAT-V3-B52
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT9-v0.1.md selector `EP383`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP382: End Turn=local operations need an independent reserve plan for communication/power loss. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: settlement operations worker 2
- OFF-POV / INFLUENCE_ONLY_UNLESS_BLUEPRINT_EXPLICIT. settlement operations worker 2 owns the episode's lived decision line. Do not reroute success, discovery, or emotional resolution through the protagonist merely for centrality.

## Character Context
- active_core_cap: max 3 salient characters including POV.
- projected_active_core: settlement operations worker 2
...
- projected relationship line: unpopular with allocation requesters but supported by safety rules.
...
- projected world pressure: operational resilience is not maximized utilization.
...
- Source-owned institutional/world pressure: operational resilience is not maximized utilization. Relationship/institution interface: unpopular with allocation requesters but supported by safety rules.
...
- source clue: final crisis fair plant.
...
- classification=PLANT. Source clue=final crisis fair plant. Outgoing selector=one real environmental pattern causes small synchronization/noise anomalies. No authorial ominous narration beyond Blueprint evidence.
...
## Forecast Outgoing
- projected End Turn: one real environmental pattern causes small synchronization/noise anomalies.
...
1. Episode Card — exact EP383 Blueprint selector; A-Plot/Want/End Turn authority.
2. Immediate Continuity — prior realized CONTINUITY-FROZEN + this forecast selector; never future guessed Actual.
3. POV/Relationship — POV=settlement operations worker 2; relationship line + current role/relationship graph, active core <=3.
4. World/Zone/Material — Zone=destination-side power/substrate operations; current world/material/location router, branch=H-B.
