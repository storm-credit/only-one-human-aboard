...
beat: BEAT-V3-B41
concurrency: NONE
source_snapshot: router=CTX-V3-EP298; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT7-v0.1.md; mode=blueprint-compiled
...
---
# DEEP V3 EP298 — 기억이 많을수록 덜 확실해지는 것
...
- subact: SA-V3-7B
- beat: BEAT-V3-B41
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT7-v0.1.md selector `EP298`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP297: End Turn=Ivo recognizes a second relationship that contradicts both witness and current life. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: Ivo
- OFF-POV / INFLUENCE_ONLY_UNLESS_BLUEPRINT_EXPLICIT. Ivo owns the episode's lived decision line. Do not reroute success, discovery, or emotional resolution through the protagonist merely for centrality.

## Character Context
- active_core_cap: max 3 salient characters including POV.
- projected_active_core: Ivo, family
...
- projected relationship line: his ordinary family/work contacts see a humbler but more fragmented person.
...
- projected world pressure: strongest carrier becomes less—not more—oracular.
...
- Source-owned institutional/world pressure: strongest carrier becomes less—not more—oracular. Relationship/institution interface: his ordinary family/work contacts see a humbler but more fragmented person.
...
- source clue: D04 rare-leak model prepares final explanation.
...
- classification=SOURCE_DEFINED. Source clue=D04 rare-leak model prepares final explanation. Outgoing selector=one fragment concerns Arun/protagonist in a way neither remembers. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: labels a remembered relationship/event as a possibility rather than prophecy; admits conflicting fragments cannot all be one past. Immediate Want: decide whether to share another fragment now that he has learned his certainty can hurt people. Act guard: Action/evidence before ontology. Every explanatory beat must be earned by a concrete decision, cost, failed model, or operational consequence.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: labels a remembered relationship/event as a possibility rather than prophecy; admits conflicting fragments cannot all be one past.
- exact Immediate Want: decide whether to share another fragment now that he has learned his certainty can hurt people.
- exact End Turn: one fragment concerns Arun/protagonist in a way neither remembers.
...
## Forecast Outgoing
- projected End Turn: one fragment concerns Arun/protagonist in a way neither remembers.
...
1. Episode Card — exact EP298 Blueprint selector; A-Plot/Want/End Turn authority.
2. Immediate Continuity — prior realized CONTINUITY-FROZEN + this forecast selector; never future guessed Actual.
3. POV/Relationship — POV=Ivo; relationship line + current role/relationship graph, active core <=3.
4. World/Zone/Material — Zone=ordinary home/work + controlled evidence context; current world/material/location router, branch=H-B.
