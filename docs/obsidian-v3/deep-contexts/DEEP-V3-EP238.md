...
source_snapshot: router=CTX-V3-EP238; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT6-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-6A
- beat: BEAT-V3-B33
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT6-v0.1.md selector `EP238`
- branch: H-B
- concurrency: ACT6_LEDGER
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP237: End Turn=one medical/supply group reaches Midring earlier; another group is delayed. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=use newly arrived material/medical access to finish a safety patch. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: protagonist sees scarcity produces winners/losers even when no one cheats.
...
- projected world pressure: causal consequences travel without protagonist awareness.
...
- Source-owned institutional/world pressure: causal consequences travel without protagonist awareness. Relationship/institution interface: protagonist sees scarcity produces winners/losers even when no one cheats.
...
- classification=NONE. Source clue=NONE. Outgoing selector=delayed residents/workers complain about allocation favoritism. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: benefits indirectly from route decision without knowing its origin; one job closes while another must wait. Immediate Want: use newly arrived material/medical access to finish a safety patch. Act guard: Resolve ACT6_LEDGER concurrency/resource/network state before execution; causality must remain distributed across people and institutions.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: benefits indirectly from route decision without knowing its origin; one job closes while another must wait.
- exact Immediate Want: use newly arrived material/medical access to finish a safety patch.
- exact End Turn: delayed residents/workers complain about allocation favoritism.
...
## Forecast Outgoing
- projected End Turn: delayed residents/workers complain about allocation favoritism.
...
1. Episode Card — exact EP238 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=Midring/Old Works interface; current world/material/location router, branch=H-B.
