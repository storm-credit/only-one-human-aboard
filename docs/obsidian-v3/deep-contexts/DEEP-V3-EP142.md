...
beat: BEAT-V3-B20
concurrency: NONE
source_snapshot: router=CTX-V3-EP142; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT4-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-4A
- beat: BEAT-V3-B20
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT4-v0.1.md selector `EP142`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP141: End Turn=prediction names a transit/industrial target and a narrow time window. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=decide whether to act on a prediction he cannot validate. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: Mira approves bounded precautions, rejects disruptive speculative shutdown.
...
- projected world pressure: foreknowledge claims begin affecting operations.
...
- Source-owned institutional/world pressure: foreknowledge claims begin affecting operations. Relationship/institution interface: Mira approves bounded precautions, rejects disruptive speculative shutdown.
...
- source clue: predictive-half-life principle seed.
...
- classification=SEED. Source clue=predictive-half-life principle seed. Outgoing selector=one precaution reveals an unrelated safety issue, making prediction look more credible. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: recommends only low-cost technical precautions where evidence independently supports them. Immediate Want: decide whether to act on a prediction he cannot validate. Act guard: Prediction and social consequence before ontology. Evidence must change choices/relationships before any explanatory model hardens.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: recommends only low-cost technical precautions where evidence independently supports them.
- exact Immediate Want: decide whether to act on a prediction he cannot validate.
- exact End Turn: one precaution reveals an unrelated safety issue, making prediction look more credible.
...
## Forecast Outgoing
- projected End Turn: one precaution reveals an unrelated safety issue, making prediction look more credible.
...
1. Episode Card — exact EP142 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=Old Works / Transfer planning; current world/material/location router, branch=H-B.
