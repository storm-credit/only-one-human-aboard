...
source_snapshot: router=CTX-V3-EP264; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT6-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-6C
- beat: BEAT-V3-B36
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT6-v0.1.md selector `EP264`
- branch: H-B
- concurrency: ACT6_LEDGER
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP263: End Turn=Juno's network considers blocking freight to force medical allocation change. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=make the technical recommendation he can defend. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: he knows this removes a political option and will harm people short-term.
...
- projected world pressure: irreversible technical choice distinct from Act2 door closure.
...
- Source-owned institutional/world pressure: irreversible technical choice distinct from Act2 door closure. Relationship/institution interface: he knows this removes a political option and will harm people short-term.
...
- source clue: protagonist Act6 irreversible decision PAYOFF.
...
- classification=PAYOFF. Source clue=protagonist Act6 irreversible decision PAYOFF. Outgoing selector=immediate scarcity projections worsen. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: recommends physical isolation/disablement of a key coupling so unsafe rapid restart becomes impossible until slower repair is completed. Immediate Want: make the technical recommendation he can defend. Act guard: Resolve ACT6_LEDGER concurrency/resource/network state before execution; causality must remain distributed across people and institutions.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: recommends physical isolation/disablement of a key coupling so unsafe rapid restart becomes impossible until slower repair is completed.
- exact Immediate Want: make the technical recommendation he can defend.
- exact End Turn: immediate scarcity projections worsen.
...
## Forecast Outgoing
- projected End Turn: immediate scarcity projections worsen.
...
1. Episode Card — exact EP264 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=high-capacity path; current world/material/location router, branch=H-B.
