...
beat: BEAT-V3-B40
concurrency: NONE
source_snapshot: router=CTX-V3-EP288; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT7-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-7A
- beat: BEAT-V3-B40
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT7-v0.1.md selector `EP288`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP287: End Turn=the language points toward other records describing `lineage`/`depth` in nonfamily/nonpersonnel contexts. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.
...
- projected_active_core: 루카스, Niko
...
- projected relationship line: Niko proposes the adaptation; protagonist accepts the evidence and lets Niko own the field check.
...
- zone: Old Works
- projected world pressure: inherited learning is useful but must answer to present bodies, time and resources.
...
- Source-owned institutional/world pressure: inherited learning is useful but must answer to present bodies, time and resources. Relationship/institution interface: Niko proposes the adaptation; protagonist accepts the evidence and lets Niko own the field check.
...
- source clue: D05 guards against omniscient-system interpretation.
...
- classification=SOURCE_DEFINED. Source clue=D05 guards against omniscient-system interpretation. Outgoing selector=the repaired route holds, but the modification must be justified before the next service window. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: discovers one inherited rule is overcautious/poorly fitted to present topology; following it would preserve a theoretical margin but leave a real neighborhood service offline. He and Niko test a bounded modification and physically restore the smaller route. Immediate Want: restore one current utility/repair path without blindly applying an inherited safeguard. Act guard: Action/evidence before ontology. Every explanatory beat must be earned by a concrete decision, cost, failed model, or operational consequence.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: discovers one inherited rule is overcautious/poorly fitted to present topology; following it would preserve a theoretical margin but leave a real neighborhood service offline. He and Niko test a bounded modification and physically restore the smaller route.
- exact Immediate Want: restore one current utility/repair path without blindly applying an inherited safeguard.
- exact End Turn: the repaired route holds, but the modification must be justified before the next service window.
...
## Forecast Outgoing
- projected End Turn: the repaired route holds, but the modification must be justified before the next service window.
...
1. Episode Card — exact EP288 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=Old Works; current world/material/location router, branch=H-B.
