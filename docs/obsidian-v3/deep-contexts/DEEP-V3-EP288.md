...
## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=apply the inherited safeguard to a current repair. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: Niko proposes adaptation; protagonist accepts evidence-based modification.
...
- zone: Old Works
- projected world pressure: inherited learning is useful but not perfect optimization.
...
- Source-owned institutional/world pressure: inherited learning is useful but not perfect optimization. Relationship/institution interface: Niko proposes adaptation; protagonist accepts evidence-based modification.
...
- classification=SOURCE_DEFINED. Source clue=D05 guards against omniscient-system interpretation. Outgoing selector=another domain shows a safeguard that saved lives for reasons nobody recalls. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: discovers one inherited rule is overcautious/poorly fitted to present topology; blindly following it would worsen recovery time. Immediate Want: apply the inherited safeguard to a current repair. Act guard: Action/evidence before ontology. Every explanatory beat must be earned by a concrete decision, cost, failed model, or operational consequence.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: discovers one inherited rule is overcautious/poorly fitted to present topology; blindly following it would worsen recovery time.
- exact Immediate Want: apply the inherited safeguard to a current repair.
- exact End Turn: another domain shows a safeguard that saved lives for reasons nobody recalls.
...
## Forecast Outgoing
- projected End Turn: another domain shows a safeguard that saved lives for reasons nobody recalls.
