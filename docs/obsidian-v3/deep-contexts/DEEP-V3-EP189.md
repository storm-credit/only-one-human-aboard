...
beat: BEAT-V3-B27
concurrency: NONE
source_snapshot: router=CTX-V3-EP189; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT5-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-5A
- beat: BEAT-V3-B27
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT5-v0.1.md selector `EP189`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP188: End Turn=protagonist later sees the same name in an incompatible registry. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=establish minimum physical history of the structure. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: asks Hana for records rather than declaring theory.
...
- zone: Legacy Layer
- projected world pressure: engineering archaeology.
...
- Source-owned institutional/world pressure: engineering archaeology. Relationship/institution interface: asks Hana for records rather than declaring theory.
...
- source clue: impossible-repair lifecycle moves toward PAYOFF.
...
- classification=PAYOFF. Source clue=impossible-repair lifecycle moves toward PAYOFF. Outgoing selector=Hana finds an old casualty-service code near the same period. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: counts repair generations/material transitions and proves at least one major intervention missing from H-B chronology. Immediate Want: establish minimum physical history of the structure. Act guard: Keep Arun current-life separation explicit and hold HUMAN meaning behind the reveal fence; do not collapse identity into explanation.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: counts repair generations/material transitions and proves at least one major intervention missing from H-B chronology.
- exact Immediate Want: establish minimum physical history of the structure.
- exact End Turn: Hana finds an old casualty-service code near the same period.
...
## Forecast Outgoing
- projected End Turn: Hana finds an old casualty-service code near the same period.
...
1. Episode Card — exact EP189 Blueprint selector; A-Plot/Want/End Turn authority.
