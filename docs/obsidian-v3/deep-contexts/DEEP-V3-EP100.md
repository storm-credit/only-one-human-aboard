...
beat: BEAT-V3-B14
concurrency: NONE
source_snapshot: router=CTX-V3-EP100; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT3-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-3A
- beat: BEAT-V3-B14
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT3-v0.1.md selector `EP100`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP099: End Turn=the changed schedule does not produce one downstream event he strongly remembers. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=understand whether his intervention caused the first deviation. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: he becomes more confident/controlling about what others should do.
...
- projected world pressure: causal divergence is real.
...
- Source-owned institutional/world pressure: causal divergence is real. Relationship/institution interface: he becomes more confident/controlling about what others should do.
...
- source clue: sets up false comfort that all differences come from him.
...
- classification=SOURCE_DEFINED. Source clue=sets up false comfort that all differences come from him. Outgoing selector=Mira reacts to a shared-memory reference in a way he cannot explain by his intervention. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: traces one changed timetable to his own action and feels relief: `내가 바꿨다` explains the difference. Immediate Want: understand whether his intervention caused the first deviation. Act guard: H-B is current-lived. H-A knowledge/state enters only through explicit memory/provenance; secondary characters retain independent causality.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: traces one changed timetable to his own action and feels relief: `내가 바꿨다` explains the difference.
- exact Immediate Want: understand whether his intervention caused the first deviation.
- exact End Turn: Mira reacts to a shared-memory reference in a way he cannot explain by his intervention.
...
## Forecast Outgoing
- projected End Turn: Mira reacts to a shared-memory reference in a way he cannot explain by his intervention.
...
1. Episode Card — exact EP100 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=Transfer Belt / Old Works; current world/material/location router, branch=H-B.
