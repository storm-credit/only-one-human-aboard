...
beat: BEAT-V3-B14
concurrency: NONE
source_snapshot: router=CTX-V3-EP098; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT3-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-3A
- beat: BEAT-V3-B14
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT3-v0.1.md selector `EP098`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP097: End Turn=an ordinary resident/worker elsewhere lives through a detail protagonist assumes has not happened yet. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: ordinary H-B worker/resident
- OFF-POV / INFLUENCE_ONLY_UNLESS_BLUEPRINT_EXPLICIT. ordinary H-B worker/resident owns the episode's lived decision line. Do not reroute success, discovery, or emotional resolution through the protagonist merely for centrality.

## Character Context
- active_core_cap: max 3 salient characters including POV.
- projected_active_core: ordinary H-B worker/resident, family
...
- projected relationship line: independent family/work relation proves H-B continuity before protagonist's arrival.
...
- projected world pressure: H-B is not an empty reset waiting for protagonist.
...
- Source-owned institutional/world pressure: H-B is not an empty reset waiting for protagonist. Relationship/institution interface: independent family/work relation proves H-B continuity before protagonist's arrival.
...
- source clue: pre-existing delta — PLANT visible to reader before protagonist fully sees it.
- local knowledge fence: no ontology awareness.
...
- classification=PLANT. Source clue=pre-existing delta — PLANT visible to reader before protagonist fully sees it. Outgoing selector=consequence intersects protagonist's next workday. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: the person references a recent local event or institutional decision that, in H-A, happened differently or not at all. The scene never treats it as strange. Immediate Want: solve a normal work/family issue unrelated to protagonist. Act guard: H-B is current-lived. H-A knowledge/state enters only through explicit memory/provenance; secondary characters retain independent causality.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: the person references a recent local event or institutional decision that, in H-A, happened differently or not at all. The scene never treats it as strange.
- exact Immediate Want: solve a normal work/family issue unrelated to protagonist.
- exact End Turn: consequence intersects protagonist's next workday.
...
## Forecast Outgoing
- projected End Turn: consequence intersects protagonist's next workday.
...
1. Episode Card — exact EP098 Blueprint selector; A-Plot/Want/End Turn authority.
2. Immediate Continuity — prior realized CONTINUITY-FROZEN + this forecast selector; never future guessed Actual.
3. POV/Relationship — POV=ordinary H-B worker/resident; relationship line + current role/relationship graph, active core <=3.
