...
beat: BEAT-V3-B05
concurrency: NONE
source_snapshot: router=CTX-V3-EP029; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT1-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-1C
- beat: BEAT-V3-B05
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT1-v0.1.md selector `EP029`
- branch: H-A
- concurrency: NONE
- Current-lived namespace remains H-A; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP028: End Turn=inspection materials from another site show a version/wear mismatch harder to explain bureaucratically. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.
...
- projected relationship line: Niko notices the mismatch first and earns credit.
...
- projected world pressure: material provenance matters to safety.
...
- Source-owned institutional/world pressure: material provenance matters to safety. Relationship/institution interface: Niko notices the mismatch first and earns credit.
...
- source clue: D03 Impossible Infrastructure — PLANT/REINFORCE.
...
- classification=PLANT+REINFORCE. Source clue=D03 Impossible Infrastructure — PLANT/REINFORCE. Outgoing selector=paperwork says the impossible layer should never have been installed there. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: material generation and documented renovation date do not line up cleanly. Immediate Want: certify a repair layer for continued use. Act guard: Ordinary-world first. Do not objectively confirm regression, branching, substrate, or HUMAN:1; ordinary failures remain genuinely possible.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: material generation and documented renovation date do not line up cleanly.
- exact Immediate Want: certify a repair layer for continued use.
- exact End Turn: paperwork says the impossible layer should never have been installed there.
...
## Forecast Outgoing
- projected End Turn: paperwork says the impossible layer should never have been installed there.
...
1. Episode Card — exact EP029 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=Old Works structural retrofit corridor; current world/material/location router, branch=H-A.
