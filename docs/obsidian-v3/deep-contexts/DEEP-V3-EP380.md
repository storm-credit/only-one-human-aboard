...
beat: BEAT-V3-B52
concurrency: NONE
source_snapshot: router=CTX-V3-EP380; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT9-v0.1.md; mode=blueprint-compiled
...
---
# DEEP V3 EP380 — 임시정부가 영구정부가 되지 않게
...
- subact: SA-V3-9A
- beat: BEAT-V3-B52
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT9-v0.1.md selector `EP380`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP379: End Turn=emergency security jurisdiction overlaps settlement autonomy. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=understand who can order technical shutdown during transition. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: protagonist's technical signoff remains narrow.
...
- projected world pressure: temporary compact is real but incomplete.
...
- Source-owned institutional/world pressure: temporary compact is real but incomplete. Relationship/institution interface: protagonist's technical signoff remains narrow.
...
- classification=NONE. Source clue=NONE. Outgoing selector=Selene faces a concrete request to expand emergency authority. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: maps authority boundaries with engineers/security/civic review; no one `captain` owns all domains. Immediate Want: understand who can order technical shutdown during transition. Act guard: Descendant completion and return/payoff outrank novelty. No rerun/new ontology by default; EP406-410 add no major mystery and close through consequence/return.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: maps authority boundaries with engineers/security/civic review; no one `captain` owns all domains.
- exact Immediate Want: understand who can order technical shutdown during transition.
- exact End Turn: Selene faces a concrete request to expand emergency authority.
...
## Forecast Outgoing
- projected End Turn: Selene faces a concrete request to expand emergency authority.
...
1. Episode Card — exact EP380 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=compact operations; current world/material/location router, branch=H-B.
