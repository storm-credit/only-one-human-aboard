...
beat: BEAT-V3-B47
concurrency: NONE
source_snapshot: router=CTX-V3-EP346; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT8-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-8B
- beat: BEAT-V3-B47
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT8-v0.1.md selector `EP346`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP345: End Turn=old doctrine treats lineage relation more like one continuity family than current citizens find acceptable. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=prevent debate from collapsing into `save the child` sentiment only. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: protagonist refuses savior/spokesperson role and supports direct affected testimony.
...
- projected world pressure: adult D3 rights stand on their own.
...
- Source-owned institutional/world pressure: adult D3 rights stand on their own. Relationship/institution interface: protagonist refuses savior/spokesperson role and supports direct affected testimony.
...
- source clue: D09 rights logic strengthened.
...
- classification=SOURCE_DEFINED. Source clue=D09 rights logic strengthened. Outgoing selector=resource administrators argue the lineage was created as a test and old mandate permits closure. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: identifies adult continuities that would still face the same destructive-risk problem even if no child existed. Immediate Want: prevent debate from collapsing into `save the child` sentiment only. Act guard: HUMAN provenance is not personhood. HUMAN:1 must remain de-collectified and must not become a collectible-character family or sacred merchandise target.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: identifies adult continuities that would still face the same destructive-risk problem even if no child existed.
- exact Immediate Want: prevent debate from collapsing into `save the child` sentiment only.
- exact End Turn: resource administrators argue the lineage was created as a test and old mandate permits closure.
...
## Forecast Outgoing
- projected End Turn: resource administrators argue the lineage was created as a test and old mandate permits closure.
...
1. Episode Card — exact EP346 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=civic/technical review; current world/material/location router, branch=H-B.
