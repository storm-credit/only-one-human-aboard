...
beat: BEAT-V3-B45
concurrency: NONE
source_snapshot: router=CTX-V3-EP330; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT8-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-8A
- beat: BEAT-V3-B45
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT8-v0.1.md selector `EP330`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP329: End Turn=definition points to biological preservation systems distinct from civic substrate. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=test whether `Natural-Origin` means ordinary genetics, birth method, or direct departure-era biological continuity. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: he sees why current citizens can be fully persons without carrying that label.
...
- projected world pressure: Natural-Origin is provenance, not species-worth hierarchy.
...
- Source-owned institutional/world pressure: Natural-Origin is provenance, not species-worth hierarchy. Relationship/institution interface: he sees why current citizens can be fully persons without carrying that label.
...
- source clue: HUMAN definition near payoff.
...
- classification=PAYOFF. Source clue=HUMAN definition near payoff. Outgoing selector=medical preservation route can independently test the interpretation. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: genetic archive and current citizen biology do not map to HUMAN count; continuity/provenance from departure is the differentiator. Immediate Want: test whether `Natural-Origin` means ordinary genetics, birth method, or direct departure-era biological continuity. Act guard: HUMAN provenance is not personhood. HUMAN:1 must remain de-collectified and must not become a collectible-character family or sacred merchandise target.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: genetic archive and current citizen biology do not map to HUMAN count; continuity/provenance from departure is the differentiator.
- exact Immediate Want: test whether `Natural-Origin` means ordinary genetics, birth method, or direct departure-era biological continuity.
- exact End Turn: medical preservation route can independently test the interpretation.
...
## Forecast Outgoing
- projected End Turn: medical preservation route can independently test the interpretation.
...
1. Episode Card — exact EP330 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=technical/medical interface; current world/material/location router, branch=H-B.
