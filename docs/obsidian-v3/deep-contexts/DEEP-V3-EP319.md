...
beat: BEAT-V3-B43
concurrency: NONE
source_snapshot: router=CTX-V3-EP319; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT7-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-7C
- beat: BEAT-V3-B43
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT7-v0.1.md selector `EP319`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP318: End Turn=one protected route clearly separates ordinary lineage infrastructure from HUMAN preservation chain. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=test whether his own continuity path could be the `HUMAN:1` path. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: chosen-one suspicion collapses for him personally.
...
- projected world pressure: title mystery narrows without definition.
...
- Source-owned institutional/world pressure: title mystery narrows without definition. Relationship/institution interface: chosen-one suspicion collapses for him personally.
...
- source clue: D06 PARTIAL PAYOFF: protagonist is NOT HUMAN:1.
...
- classification=PAYOFF. Source clue=D06 PARTIAL PAYOFF: protagonist is NOT HUMAN:1. Outgoing selector=remaining synthesis question: what exactly is Meridian carrying and why so many lineages? No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: physical/registry evidence shows protagonist belongs to ordinary civilization-lineage infrastructure; HUMAN support chain is distinct. Immediate Want: test whether his own continuity path could be the `HUMAN:1` path. Act guard: Action/evidence before ontology. Every explanatory beat must be earned by a concrete decision, cost, failed model, or operational consequence.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: physical/registry evidence shows protagonist belongs to ordinary civilization-lineage infrastructure; HUMAN support chain is distinct.
- exact Immediate Want: test whether his own continuity path could be the `HUMAN:1` path.
- exact End Turn: remaining synthesis question: what exactly is Meridian carrying and why so many lineages?
...
## Forecast Outgoing
- projected End Turn: remaining synthesis question: what exactly is Meridian carrying and why so many lineages?
...
1. Episode Card — exact EP319 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=deep support routing boundary; current world/material/location router, branch=H-B.
