...
beat: BEAT-V3-B20
concurrency: NONE
source_snapshot: router=CTX-V3-EP141; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT4-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-4A
- beat: BEAT-V3-B20
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT4-v0.1.md selector `EP141`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP140: End Turn=a popular media account claims a precise upcoming incident. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.
...
- projected relationship line: Sora↔media friction; she refuses to reveal protected Act3 claimant data.
...
- projected world pressure: public safety vs privacy.
...
- Source-owned institutional/world pressure: public safety vs privacy. Relationship/institution interface: Sora↔media friction; she refuses to reveal protected Act3 claimant data.
...
- source clue: predicted-attack thread PLANT.
...
- classification=PLANT. Source clue=predicted-attack thread PLANT. Outgoing selector=prediction names a transit/industrial target and a narrow time window. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: traces source chain; finds copied details, edits and ambiguous timing, but one specific operational fact cannot be explained. Immediate Want: decide whether the public prediction is a threat, fraud or actionable warning. Act guard: Prediction and social consequence before ontology. Evidence must change choices/relationships before any explanatory model hardens.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: traces source chain; finds copied details, edits and ambiguous timing, but one specific operational fact cannot be explained.
- exact Immediate Want: decide whether the public prediction is a threat, fraud or actionable warning.
- exact End Turn: prediction names a transit/industrial target and a narrow time window.
...
## Forecast Outgoing
- projected End Turn: prediction names a transit/industrial target and a narrow time window.
...
1. Episode Card — exact EP141 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=security/media liaison; current world/material/location router, branch=H-B.
