...
beat: BEAT-V3-B30
concurrency: NONE
source_snapshot: router=CTX-V3-EP219; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT5-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-5C
- beat: BEAT-V3-B30
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT5-v0.1.md selector `EP219`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP218: End Turn=family/community rumor reaches protagonist's private life. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: Juno/family lens
- OFF-POV / INFLUENCE_ONLY_UNLESS_BLUEPRINT_EXPLICIT. Juno/family lens owns the episode's lived decision line. Do not reroute success, discovery, or emotional resolution through the protagonist merely for centrality.

## Character Context
- active_core_cap: max 3 salient characters including POV.
- projected_active_core: Juno/family lens, Juno, family
...
- projected relationship line: family member asks protagonist directly; he can only say he does not know.
...
- zone: Midring
- projected world pressure: myth formation shown without author endorsement.
...
- Source-owned institutional/world pressure: myth formation shown without author endorsement. Relationship/institution interface: family member asks protagonist directly; he can only say he does not know.
...
- source clue: chosen-one red herring socialized.
...
- classification=SOURCE_DEFINED. Source clue=chosen-one red herring socialized. Outgoing selector=deeper records confirm the count is current and actively maintained. No authorial ominous narration beyond Blueprint evidence.
...
- exact End Turn: deeper records confirm the count is current and actively maintained.
...
## Forecast Outgoing
- projected End Turn: deeper records confirm the count is current and actively maintained.
...
1. Episode Card — exact EP219 Blueprint selector; A-Plot/Want/End Turn authority.
2. Immediate Continuity — prior realized CONTINUITY-FROZEN + this forecast selector; never future guessed Actual.
3. POV/Relationship — POV=Juno/family lens; relationship line + current role/relationship graph, active core <=3.
