...
source_snapshot: router=CTX-V3-EP083; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT2-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-2C
- beat: BEAT-V3-B11
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT2-v0.1.md selector `EP083`
- branch: H-A
- concurrency: ACT2_LEDGER
- Current-lived namespace remains H-A; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP082: End Turn=Selene asks for his final structural recommendation. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.
...
- projected relationship line: Rafi gains a short rescue window; protagonist still has to recommend what happens after it.
...
- zone: L-A boundary
- projected world pressure: ingenuity changes options but cannot erase tradeoff.
...
- Source-owned institutional/world pressure: ingenuity changes options but cannot erase tradeoff. Relationship/institution interface: Rafi gains a short rescue window; protagonist still has to recommend what happens after it.
...
- source clue: Arun reveal threshold.
...
- classification=SOURCE_DEFINED. Source clue=Arun reveal threshold. Outgoing selector=rescue window ends with people still unreachable. No authorial ominous narration beyond Blueprint evidence.
...
## Forecast Outgoing
- projected End Turn: rescue window ends with people still unreachable.
...
1. Episode Card — exact EP083 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=L-A boundary; current world/material/location router, branch=H-A.
