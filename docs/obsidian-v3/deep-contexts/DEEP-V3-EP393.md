...
beat: BEAT-V3-B54
concurrency: NONE
source_snapshot: router=CTX-V3-EP393; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT9-v0.1.md; mode=blueprint-compiled
...
---
# DEEP V3 EP393 — 실패한 정착지를 다시 불러오지 않는다
...
- subact: SA-V3-9B
- beat: BEAT-V3-B54
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT9-v0.1.md selector `EP393`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP392: End Turn=teams must decide whether to fully decouple and accept permanent loss of part of early settlement infrastructure. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=choose between risky restoration of synchronized network and deliberate staged decoupling with permanent losses. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: his long false belief finally changes through action.
...
- projected world pressure: irreversibility becomes operational.
...
- Source-owned institutional/world pressure: irreversibility becomes operational. Relationship/institution interface: his long false belief finally changes through action.
...
- source clue: final protagonist-arc TRIGGER.
...
- classification=SOURCE_DEFINED. Source clue=final protagonist-arc TRIGGER. Outgoing selector=decoupling requires local manual/physical actions across several nodes. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: rejects a `restore/retry from known configuration` impulse because active current persons/infrastructure cannot be replaced by another lived history; recommends physical decoupling and rebuilding forward. Immediate Want: choose between risky restoration of synchronized network and deliberate staged decoupling with permanent losses. Act guard: Descendant completion and return/payoff outrank novelty. No rerun/new ontology by default; EP406-410 add no major mystery and close through consequence/return.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: rejects a `restore/retry from known configuration` impulse because active current persons/infrastructure cannot be replaced by another lived history; recommends physical decoupling and rebuilding forward.
- exact Immediate Want: choose between risky restoration of synchronized network and deliberate staged decoupling with permanent losses.
- exact End Turn: decoupling requires local manual/physical actions across several nodes.
...
## Forecast Outgoing
- projected End Turn: decoupling requires local manual/physical actions across several nodes.
...
1. Episode Card — exact EP393 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=settlement control/technical interface; current world/material/location router, branch=H-B.
