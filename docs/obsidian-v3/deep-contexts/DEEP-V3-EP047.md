...
source_snapshot: router=CTX-V3-EP047; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT2-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-2A
- beat: BEAT-V3-B07
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT2-v0.1.md selector `EP047`
- branch: H-A
- concurrency: ACT2_LEDGER
- Current-lived namespace remains H-A; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP046: End Turn=thermal readings rise outside the first predicted footprint. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=explain why heat propagation exceeds the simplified service diagram. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: calls Gideon in for independent history review; does not claim sabotage.
...
- zone: L-A
- projected world pressure: older infrastructure matters operationally.
...
- Source-owned institutional/world pressure: older infrastructure matters operationally. Relationship/institution interface: calls Gideon in for independent history review; does not claim sabotage.
...
- classification=REINFORCE. Source clue=D03 Impossible Infrastructure — REINFORCE. Outgoing selector=one trapped worker is on the wrong side of a newly isolated section. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: finds a legacy junction/material layer that conducts/loads differently from current record. Immediate Want: explain why heat propagation exceeds the simplified service diagram. Act guard: Disaster/concurrency first. Resolve ACT2_LEDGER geography/time before scene execution; do not explain the branch mechanism. EP094 ends H-A current-lived state.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: finds a legacy junction/material layer that conducts/loads differently from current record.
- exact Immediate Want: explain why heat propagation exceeds the simplified service diagram.
- exact End Turn: one trapped worker is on the wrong side of a newly isolated section.
...
## Forecast Outgoing
- projected End Turn: one trapped worker is on the wrong side of a newly isolated section.
...
1. Episode Card — exact EP047 Blueprint selector; A-Plot/Want/End Turn authority.
