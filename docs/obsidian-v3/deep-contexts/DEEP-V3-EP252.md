...
source_snapshot: router=CTX-V3-EP252; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT6-v0.1.md; mode=blueprint-compiled
...
---
# DEEP V3 EP252 — 비상은 자동으로 끝나지 않는다
...
- subact: SA-V3-6B
- beat: BEAT-V3-B34
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT6-v0.1.md selector `EP252`
- branch: H-B
- concurrency: ACT6_LEDGER
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP251: End Turn=strategic restrictions extend another cycle. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=learn when extraordinary repair/access rules expire. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: Selene/protagonist share concern for different reasons.
...
- projected world pressure: institutional drift into Act6 factions.
...
- Source-owned institutional/world pressure: institutional drift into Act6 factions. Relationship/institution interface: Selene/protagonist share concern for different reasons.
...
- classification=NONE. Source clue=NONE. Outgoing selector=overlapping groups begin making independent demands on infrastructure. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: discovers multiple emergency measures now have different review clocks and political constituencies; no single `end emergency` switch exists. Immediate Want: learn when extraordinary repair/access rules expire. Act guard: Resolve ACT6_LEDGER concurrency/resource/network state before execution; causality must remain distributed across people and institutions.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: discovers multiple emergency measures now have different review clocks and political constituencies; no single `end emergency` switch exists.
- exact Immediate Want: learn when extraordinary repair/access rules expire.
- exact End Turn: overlapping groups begin making independent demands on infrastructure.
...
## Forecast Outgoing
- projected End Turn: overlapping groups begin making independent demands on infrastructure.
...
1. Episode Card — exact EP252 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=Civic/Old Works interface; current world/material/location router, branch=H-B.
