...
beat: BEAT-V3-B24
concurrency: NONE
source_snapshot: router=CTX-V3-EP169; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT4-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-4C
- beat: BEAT-V3-B24
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT4-v0.1.md selector `EP169`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP168: End Turn=Ivo chooses to speak publicly despite advice. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=persuade Ivo to label his claims as uncertain lived memories rather than prophecy. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: protagonist sees his own control flaw mirrored.
...
- projected world pressure: public reaction accelerates.
...
- Source-owned institutional/world pressure: public reaction accelerates. Relationship/institution interface: protagonist sees his own control flaw mirrored.
...
- source clue: information intervention principle.
...
- classification=SOURCE_DEFINED. Source clue=information intervention principle. Outgoing selector=Ivo's public statement causes immediate behavioral changes. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: fails to control him; Ivo has his own reasons and agency. Immediate Want: persuade Ivo to label his claims as uncertain lived memories rather than prophecy. Act guard: Prediction and social consequence before ontology. Evidence must change choices/relationships before any explanatory model hardens.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: fails to control him; Ivo has his own reasons and agency.
- exact Immediate Want: persuade Ivo to label his claims as uncertain lived memories rather than prophecy.
- exact End Turn: Ivo's public statement causes immediate behavioral changes.
...
## Forecast Outgoing
- projected End Turn: Ivo's public statement causes immediate behavioral changes.
...
1. Episode Card — exact EP169 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=public/media boundary; current world/material/location router, branch=H-B.
