...
beat: BEAT-V3-B17
concurrency: NONE
source_snapshot: router=CTX-V3-EP123; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT3-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-3B
- beat: BEAT-V3-B17
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT3-v0.1.md selector `EP123`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP122: End Turn=the one remaining physical detail survives falsification. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=decide whether the surviving detail deserves deeper investigation. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: agrees with Leila not to publicize the claimant as proof.
...
- projected world pressure: anomaly remains isolated, not social phenomenon.
...
- Source-owned institutional/world pressure: anomaly remains isolated, not social phenomenon. Relationship/institution interface: agrees with Leila not to publicize the claimant as proof.
...
- source clue: independent incompatible memory case moves from rumor to credible anomaly.
...
- classification=SOURCE_DEFINED. Source clue=independent incompatible memory case moves from rumor to credible anomaly. Outgoing selector=Sora asks who else might have accessed the same hidden detail. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: establishes it cannot be explained by his interventions and likely predates both his arrival and claimant's access. Immediate Want: decide whether the surviving detail deserves deeper investigation. Act guard: H-B is current-lived. H-A knowledge/state enters only through explicit memory/provenance; secondary characters retain independent causality.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: establishes it cannot be explained by his interventions and likely predates both his arrival and claimant's access.
- exact Immediate Want: decide whether the surviving detail deserves deeper investigation.
- exact End Turn: Sora asks who else might have accessed the same hidden detail.
...
## Forecast Outgoing
- projected End Turn: Sora asks who else might have accessed the same hidden detail.
...
1. Episode Card — exact EP123 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=Old Works/records interface; current world/material/location router, branch=H-B.
