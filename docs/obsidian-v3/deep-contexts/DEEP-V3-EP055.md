...
source_snapshot: router=CTX-V3-EP055; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT2-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-2A
- beat: BEAT-V3-B08
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT2-v0.1.md selector `EP055`
- branch: H-A
- concurrency: ACT2_LEDGER
- Current-lived namespace remains H-A; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP054: End Turn=reroute saves one crowd but leaves a school/community group with a shrinking exit window. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=inspect a boundary affecting Midring ventilation before residents are moved unnecessarily. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: he hears family lives nearby but does not abandon assignment to personally control them.
...
- projected world pressure: technical evidence informs but does not dictate civic evacuation.
...
- Source-owned institutional/world pressure: technical evidence informs but does not dictate civic evacuation. Relationship/institution interface: he hears family lives nearby but does not abandon assignment to personally control them.
...
- classification=NONE. Source clue=NONE. Outgoing selector=route closures hit a school group already in movement. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: confirms heat/power instability is real but localized; recommends route restrictions, not full residential evacuation. Immediate Want: inspect a boundary affecting Midring ventilation before residents are moved unnecessarily. Act guard: Disaster/concurrency first. Resolve ACT2_LEDGER geography/time before scene execution; do not explain the branch mechanism. EP094 ends H-A current-lived state.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: confirms heat/power instability is real but localized; recommends route restrictions, not full residential evacuation.
- exact Immediate Want: inspect a boundary affecting Midring ventilation before residents are moved unnecessarily.
- exact End Turn: route closures hit a school group already in movement.
...
## Forecast Outgoing
- projected End Turn: route closures hit a school group already in movement.
...
1. Episode Card — exact EP055 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=L-A → edge of L-C; current world/material/location router, branch=H-A.
