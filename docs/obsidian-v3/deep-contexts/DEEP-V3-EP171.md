...
beat: BEAT-V3-B24
concurrency: NONE
source_snapshot: router=CTX-V3-EP171; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT4-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-4C
- beat: BEAT-V3-B24
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT4-v0.1.md selector `EP171`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP170: End Turn=a prediction he just repeated is already becoming less likely because of public response. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=observe what changed after Ivo's disclosure. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: protagonist tries to explain divergence; Ivo experiences it as loss of certainty.
...
- projected world pressure: predictive information is causally active.
...
- Source-owned institutional/world pressure: predictive information is causally active. Relationship/institution interface: protagonist tries to explain divergence; Ivo experiences it as loss of certainty.
...
- source clue: predictive half-life strong PAYOFF.
...
- classification=PAYOFF. Source clue=predictive half-life strong PAYOFF. Outgoing selector=Cassian agrees to one interview after his past behavior becomes public issue. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: public/official precautions remove one condition required for Ivo's remembered event. Immediate Want: observe what changed after Ivo's disclosure. Act guard: Prediction and social consequence before ontology. Evidence must change choices/relationships before any explanatory model hardens.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: public/official precautions remove one condition required for Ivo's remembered event.
- exact Immediate Want: observe what changed after Ivo's disclosure.
- exact End Turn: Cassian agrees to one interview after his past behavior becomes public issue.
...
## Forecast Outgoing
- projected End Turn: Cassian agrees to one interview after his past behavior becomes public issue.
...
1. Episode Card — exact EP171 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=citywide practical consequences; current world/material/location router, branch=H-B.
