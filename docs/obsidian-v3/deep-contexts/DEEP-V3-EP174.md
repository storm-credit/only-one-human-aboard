...
beat: BEAT-V3-B24
concurrency: NONE
source_snapshot: router=CTX-V3-EP174; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT4-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-4C
- beat: BEAT-V3-B24
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT4-v0.1.md selector `EP174`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP173: End Turn=one detail can only be explained if Cassian personally remembered a prior path. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: Cassian
- OFF-POV / INFLUENCE_ONLY_UNLESS_BLUEPRINT_EXPLICIT. Cassian owns the episode's lived decision line. Do not reroute success, discovery, or emotional resolution through the protagonist merely for centrality.

## Character Context
- active_core_cap: max 3 salient characters including POV.
- projected_active_core: Cassian, family
...
- projected relationship line: family/business partners resist; his identity is preparation, not greed alone.
...
- projected world pressure: genuine leak can become wealth, caution, exploitation and public good.
...
- Source-owned institutional/world pressure: genuine leak can become wealth, caution, exploitation and public good. Relationship/institution interface: family/business partners resist; his identity is preparation, not greed alone.
...
- source clue: Cassian L3 genuine fragment PAYOFF; no broader ontology.
...
- classification=PAYOFF. Source clue=Cassian L3 genuine fragment PAYOFF; no broader ontology. Outgoing selector=released information corroborates a second incompatible history artifact. No authorial ominous narration beyond Blueprint evidence.
...
## Forecast Outgoing
- projected End Turn: released information corroborates a second incompatible history artifact.
...
1. Episode Card — exact EP174 Blueprint selector; A-Plot/Want/End Turn authority.
2. Immediate Continuity — prior realized CONTINUITY-FROZEN + this forecast selector; never future guessed Actual.
3. POV/Relationship — POV=Cassian; relationship line + current role/relationship graph, active core <=3.
4. World/Zone/Material — Zone=commercial/private work context; current world/material/location router, branch=H-B.
