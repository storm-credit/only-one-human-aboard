...
source_snapshot: router=CTX-V3-EP066; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT2-v0.1.md; mode=blueprint-compiled
...
---
# DEEP V3 EP066 — 범인은 있었지만 테러는 아닐 수 있다
...
- subact: SA-V3-2B
- beat: BEAT-V3-B09
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT2-v0.1.md selector `EP066`
- branch: H-A
- concurrency: ACT2_LEDGER
- Current-lived namespace remains H-A; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP065: End Turn=Sora identifies the bypass motive as likely mundane productivity/workflow pressure. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.
...
- projected relationship line: Sora must resist institutional pressure for a clean terrorist narrative.
...
- zone: L-F
- projected world pressure: real wrongdoing can coexist with noncriminal root cause.
...
- Source-owned institutional/world pressure: real wrongdoing can coexist with noncriminal root cause. Relationship/institution interface: Sora must resist institutional pressure for a clean terrorist narrative.
...
- source clue: sabotage red herring PARTIAL PAYOFF.
...
- classification=PAYOFF. Source clue=sabotage red herring PARTIAL PAYOFF. Outgoing selector=new structural readings show first zone may be stabilizing. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: evidence points to unauthorized maintenance convenience / falsified completion, possibly multiple responsible staff, not ideological sabotage. Immediate Want: establish who defeated the interlock and why. Act guard: Disaster/concurrency first. Resolve ACT2_LEDGER geography/time before scene execution; do not explain the branch mechanism. EP094 ends H-A current-lived state.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: evidence points to unauthorized maintenance convenience / falsified completion, possibly multiple responsible staff, not ideological sabotage.
- exact Immediate Want: establish who defeated the interlock and why.
- exact End Turn: new structural readings show first zone may be stabilizing.
...
## Forecast Outgoing
- projected End Turn: new structural readings show first zone may be stabilizing.
...
1. Episode Card — exact EP066 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=L-F; current world/material/location router, branch=H-A.
