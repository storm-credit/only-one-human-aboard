...
source_snapshot: router=CTX-V3-EP045; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT2-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-2A
- beat: BEAT-V3-B07
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT2-v0.1.md selector `EP045`
- branch: H-A
- concurrency: ACT2_LEDGER
- Current-lived namespace remains H-A; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP044: End Turn=first injured workers are reported beyond the closed corridor. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=find a structurally viable rescue access. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: protagonist recognizes he cannot authorize entry himself.
...
- zone: L-A perimeter
- projected world pressure: emergency protocol shifts from worksite response to cross-agency incident.
...
- Source-owned institutional/world pressure: emergency protocol shifts from worksite response to cross-agency incident. Relationship/institution interface: protagonist recognizes he cannot authorize entry himself.
...
- classification=NONE. Source clue=NONE. Outgoing selector=Selene arrives and narrows the safe window further. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: maps one rated service path and one unsafe shorter route; sends technical assessment to incident command. Immediate Want: find a structurally viable rescue access. Act guard: Disaster/concurrency first. Resolve ACT2_LEDGER geography/time before scene execution; do not explain the branch mechanism. EP094 ends H-A current-lived state.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: maps one rated service path and one unsafe shorter route; sends technical assessment to incident command.
- exact Immediate Want: find a structurally viable rescue access.
- exact End Turn: Selene arrives and narrows the safe window further.
...
## Forecast Outgoing
- projected End Turn: Selene arrives and narrows the safe window further.
...
1. Episode Card — exact EP045 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=L-A perimeter; current world/material/location router, branch=H-A.
