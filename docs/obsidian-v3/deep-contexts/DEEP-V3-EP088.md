...
source_snapshot: router=CTX-V3-EP088; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT2-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-2D
- beat: BEAT-V3-B12
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT2-v0.1.md selector `EP088`
- branch: H-A
- concurrency: ACT2_LEDGER
- Current-lived namespace remains H-A; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP087: End Turn=new data suggest the present event's initiating cause can finally be closed. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=finish the causal reconstruction. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.

## Character Context
- active_core_cap: max 3 salient characters including POV.
- projected_active_core: [주인공/TBD], Sora, Gideon
...
- projected relationship line: protagonist/Sora/Gideon can each accept different parts without one owning truth.
...
- zone: L-A analysis
- projected world pressure: public/operational findings begin forming.
...
- Source-owned institutional/world pressure: public/operational findings begin forming. Relationship/institution interface: protagonist/Sora/Gideon can each accept different parts without one owning truth.
...
- source clue: Act2 local cause PAYOFF begins.
...
- classification=PAYOFF. Source clue=Act2 local cause PAYOFF begins. Outgoing selector=Sora must decide how much sabotage theory remains. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: establishes cooling-segment failure as initiating event; old interface worsened spread; unauthorized bypass further amplified it. Immediate Want: finish the causal reconstruction. Act guard: Disaster/concurrency first. Resolve ACT2_LEDGER geography/time before scene execution; do not explain the branch mechanism. EP094 ends H-A current-lived state.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: establishes cooling-segment failure as initiating event; old interface worsened spread; unauthorized bypass further amplified it.
- exact Immediate Want: finish the causal reconstruction.
- exact End Turn: Sora must decide how much sabotage theory remains.
...
## Forecast Outgoing
- projected End Turn: Sora must decide how much sabotage theory remains.
...
1. Episode Card — exact EP088 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=L-A analysis; current world/material/location router, branch=H-A.
