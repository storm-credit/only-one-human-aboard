...
beat: BEAT-V3-B42
concurrency: NONE
source_snapshot: router=CTX-V3-EP308; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT7-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-7B
- beat: BEAT-V3-B42
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT7-v0.1.md selector `EP308`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP307: End Turn=Leila finds medical continuity metadata relevant to protagonist's Act2 event. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=determine whether his Act2 event was resurrection after death. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: protagonist loses one comforting/mystical interpretation but gains a more frightening technical one.
...
- projected world pressure: continuity anchor architecture begins to surface.
...
- Source-owned institutional/world pressure: continuity anchor architecture begins to surface. Relationship/institution interface: protagonist loses one comforting/mystical interpretation but gains a more frightening technical one.
...
- source clue: D02 PARTIAL-to-FINAL PAYOFF sequence.
...
- classification=PAYOFF. Source clue=D02 PARTIAL-to-FINAL PAYOFF sequence. Outgoing selector=the destination binding still makes no sense. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: evidence indicates active continuity migration began **before confirmed death**, distinguishing his case from reconstructing a dead snapshot. Immediate Want: determine whether his Act2 event was resurrection after death. Act guard: Action/evidence before ontology. Every explanatory beat must be earned by a concrete decision, cost, failed model, or operational consequence.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: evidence indicates active continuity migration began **before confirmed death**, distinguishing his case from reconstructing a dead snapshot.
- exact Immediate Want: determine whether his Act2 event was resurrection after death.
- exact End Turn: the destination binding still makes no sense.
...
## Forecast Outgoing
- projected End Turn: the destination binding still makes no sense.
...
1. Episode Card — exact EP308 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=medical/technical continuity review; current world/material/location router, branch=H-B.
