...
beat: BEAT-V3-B15
concurrency: NONE
source_snapshot: router=CTX-V3-EP104; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT3-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-3A
- beat: BEAT-V3-B15
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT3-v0.1.md selector `EP104`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP103: End Turn=protagonist checks whether Niko/Gideon history also differs. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=prove the maintenance delta is a clerical error. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: Gideon asks what answer protagonist is trying to obtain; protagonist lies badly about routine curiosity.
...
- projected world pressure: physical state outranks memory.
...
- Source-owned institutional/world pressure: physical state outranks memory. Relationship/institution interface: Gideon asks what answer protagonist is trying to obtain; protagonist lies badly about routine curiosity.
...
- source clue: pre-existing delta PAYOFF.
...
- classification=PAYOFF. Source clue=pre-existing delta PAYOFF. Outgoing selector=Niko's qualification status also differs. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: multiple independent records/material states agree: this H-B component was replaced earlier under different circumstances. Immediate Want: prove the maintenance delta is a clerical error. Act guard: H-B is current-lived. H-A knowledge/state enters only through explicit memory/provenance; secondary characters retain independent causality.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: multiple independent records/material states agree: this H-B component was replaced earlier under different circumstances.
- exact Immediate Want: prove the maintenance delta is a clerical error.
- exact End Turn: Niko's qualification status also differs.
...
## Forecast Outgoing
- projected End Turn: Niko's qualification status also differs.
...
1. Episode Card — exact EP104 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=diagnostics records / Old Works; current world/material/location router, branch=H-B.
