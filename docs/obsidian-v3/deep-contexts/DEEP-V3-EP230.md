...
source_snapshot: router=CTX-V3-EP230; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT6-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-6A
- beat: BEAT-V3-B32
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT6-v0.1.md selector `EP230`
- branch: H-B
- concurrency: ACT6_LEDGER
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP229: End Turn=another utility job loses its fabrication slot. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=determine which deferred repairs can safely survive another cycle. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: management asks him for a politically convenient single priority list; he gives conditional engineering bands instead.
...
- zone: Old Works
- projected world pressure: technical scarcity is real before anyone calls it crisis.
...
- Source-owned institutional/world pressure: technical scarcity is real before anyone calls it crisis. Relationship/institution interface: management asks him for a politically convenient single priority list; he gives conditional engineering bands instead.
...
- classification=NONE. Source clue=NONE. Outgoing selector=Transfer Belt begins formal curtailment. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: ranks structural risk and refuses to pretend all temporary patches are equivalent. Immediate Want: determine which deferred repairs can safely survive another cycle. Act guard: Resolve ACT6_LEDGER concurrency/resource/network state before execution; causality must remain distributed across people and institutions.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: ranks structural risk and refuses to pretend all temporary patches are equivalent.
- exact Immediate Want: determine which deferred repairs can safely survive another cycle.
- exact End Turn: Transfer Belt begins formal curtailment.
...
## Forecast Outgoing
- projected End Turn: Transfer Belt begins formal curtailment.
...
1. Episode Card — exact EP230 Blueprint selector; A-Plot/Want/End Turn authority.
