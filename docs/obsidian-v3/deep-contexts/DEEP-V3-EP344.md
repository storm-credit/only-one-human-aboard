...
beat: BEAT-V3-B47
concurrency: NONE
source_snapshot: router=CTX-V3-EP344; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT8-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-8B
- beat: BEAT-V3-B47
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT8-v0.1.md selector `EP344`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP343: End Turn=one family member has no counterpart/source identity outside this lineage. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=determine what the procedure physically does to the threatened D3 lineage. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: affected people demand to participate in decision, not be represented solely by protagonist.
...
- projected world pressure: technical options create rights distinctions.
...
- Source-owned institutional/world pressure: technical options create rights distinctions. Relationship/institution interface: affected people demand to participate in decision, not be represented solely by protagonist.
...
- source clue: quiescence != deletion REINFORCE.
...
- classification=REINFORCE. Source clue=quiescence != deletion REINFORCE. Outgoing selector=branch-born child exposes source-ownership logic as incoherent. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: establishes resource relief could be achieved by safe slowdown/quiescence, but an older aggressive procedure risks continuity loss and is easier/faster. Immediate Want: determine what the procedure physically does to the threatened D3 lineage. Act guard: HUMAN provenance is not personhood. HUMAN:1 must remain de-collectified and must not become a collectible-character family or sacred merchandise target.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: establishes resource relief could be achieved by safe slowdown/quiescence, but an older aggressive procedure risks continuity loss and is easier/faster.
- exact Immediate Want: determine what the procedure physically does to the threatened D3 lineage.
- exact End Turn: branch-born child exposes source-ownership logic as incoherent.
...
## Forecast Outgoing
- projected End Turn: branch-born child exposes source-ownership logic as incoherent.
...
1. Episode Card — exact EP344 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=technical preservation review; current world/material/location router, branch=H-B.
