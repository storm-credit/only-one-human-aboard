...
source_snapshot: router=CTX-V3-EP075; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT2-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-2B
- beat: BEAT-V3-B10
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT2-v0.1.md selector `EP075`
- branch: H-A
- concurrency: ACT2_LEDGER
- Current-lived namespace remains H-A; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP074: End Turn=provisional route-reopening proposal arrives from operations/political pressure. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=review partial reopening evidence before public expectation hardens. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: Selene warns him a qualified `maybe` will become a political `yes` unless they define limits clearly.
...
- projected world pressure: recovery creates pressure to normalize.
...
- Source-owned institutional/world pressure: recovery creates pressure to normalize. Relationship/institution interface: Selene warns him a qualified `maybe` will become a political `yes` unless they define limits clearly.
...
- source clue: secondary-breach setup PLANT.
...
- classification=PLANT. Source clue=secondary-breach setup PLANT. Outgoing selector=limited reopening is scheduled under conditions. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: says one route may be conditionally usable, but an old interface remains uncertain; recommends strict load/pressure limits. Immediate Want: review partial reopening evidence before public expectation hardens. Act guard: Disaster/concurrency first. Resolve ACT2_LEDGER geography/time before scene execution; do not explain the branch mechanism. EP094 ends H-A current-lived state.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: says one route may be conditionally usable, but an old interface remains uncertain; recommends strict load/pressure limits.
- exact Immediate Want: review partial reopening evidence before public expectation hardens.
- exact End Turn: limited reopening is scheduled under conditions.
...
## Forecast Outgoing
- projected End Turn: limited reopening is scheduled under conditions.
...
1. Episode Card — exact EP075 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=L-A / mobile review; current world/material/location router, branch=H-A.
