...
beat: BEAT-V3-B17
concurrency: NONE
source_snapshot: router=CTX-V3-EP122; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT3-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-3B
- beat: BEAT-V3-B17
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT3-v0.1.md selector `EP122`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP121: End Turn=first check is ambiguous rather than miraculous. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=see whether the claimant is reliable. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: protagonist confronts his desire for a witness who validates him.
...
- projected world pressure: memory fragments are not perfect maps.
...
- Source-owned institutional/world pressure: memory fragments are not perfect maps. Relationship/institution interface: protagonist confronts his desire for a witness who validates him.
...
- source clue: predictive/recall fallibility PAYOFF.
...
- classification=PAYOFF. Source clue=predictive/recall fallibility PAYOFF. Outgoing selector=the one remaining physical detail survives falsification. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: another detail from the same memory is demonstrably wrong in H-B. Immediate Want: see whether the claimant is reliable. Act guard: H-B is current-lived. H-A knowledge/state enters only through explicit memory/provenance; secondary characters retain independent causality.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: another detail from the same memory is demonstrably wrong in H-B.
- exact Immediate Want: see whether the claimant is reliable.
- exact End Turn: the one remaining physical detail survives falsification.
...
## Forecast Outgoing
- projected End Turn: the one remaining physical detail survives falsification.
...
1. Episode Card — exact EP122 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=investigation route; current world/material/location router, branch=H-B.
