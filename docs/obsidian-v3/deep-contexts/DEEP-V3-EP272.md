...
source_snapshot: router=CTX-V3-EP272; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT6-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-6C
- beat: BEAT-V3-B37
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT6-v0.1.md selector `EP272`
- branch: H-B
- concurrency: ACT6_LEDGER
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP271: End Turn=medical side must define neutral access rules. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.
...
- projected relationship line: Rafi applies earlier triage lessons differently at network scale.
...
- projected world pressure: neutral corridor gains practical rules.
...
- Source-owned institutional/world pressure: neutral corridor gains practical rules. Relationship/institution interface: Rafi applies earlier triage lessons differently at network scale.
...
- source clue: emergent chain REINFORCE.
...
- classification=REINFORCE. Source clue=emergent chain REINFORCE. Outgoing selector=Selene must decide whether security will honor the corridor even for distrusted groups. No authorial ominous narration beyond Blueprint evidence.
...
## Forecast Outgoing
- projected End Turn: Selene must decide whether security will honor the corridor even for distrusted groups.
...
1. Episode Card — exact EP272 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=Medical/Transfer interface; current world/material/location router, branch=H-B.
