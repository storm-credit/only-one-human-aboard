...
beat: BEAT-V3-B14
concurrency: NONE
source_snapshot: router=CTX-V3-EP097; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT3-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-3A
- beat: BEAT-V3-B14
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT3-v0.1.md selector `EP097`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP096: End Turn=protagonist decides he can prevent the Act2 catastrophe too. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=build a private prevention list without sounding delusional. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: he starts treating others as future victims before they know anything; mild social friction appears.
...
- projected world pressure: current H-B work records seem mostly familiar.
...
- Source-owned institutional/world pressure: current H-B work records seem mostly familiar. Relationship/institution interface: he starts treating others as future victims before they know anything; mild social friction appears.
...
- source clue: regression theory remains strongest.
...
- classification=SOURCE_DEFINED. Source clue=regression theory remains strongest. Outgoing selector=an ordinary resident/worker elsewhere lives through a detail protagonist assumes has not happened yet. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: notes cooling segment, duplicate ID, maintenance schedule, routes, people he wants to protect. Immediate Want: build a private prevention list without sounding delusional. Act guard: H-B is current-lived. H-A knowledge/state enters only through explicit memory/provenance; secondary characters retain independent causality.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: notes cooling segment, duplicate ID, maintenance schedule, routes, people he wants to protect.
- exact Immediate Want: build a private prevention list without sounding delusional.
- exact End Turn: an ordinary resident/worker elsewhere lives through a detail protagonist assumes has not happened yet.
...
## Forecast Outgoing
- projected End Turn: an ordinary resident/worker elsewhere lives through a detail protagonist assumes has not happened yet.
...
1. Episode Card — exact EP097 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=Old Works / commute; current world/material/location router, branch=H-B.
