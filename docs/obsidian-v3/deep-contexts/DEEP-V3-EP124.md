...
beat: BEAT-V3-B18
concurrency: NONE
source_snapshot: router=CTX-V3-EP124; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT3-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-3C
- beat: BEAT-V3-B18
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT3-v0.1.md selector `EP124`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP123: End Turn=Sora asks who else might have accessed the same hidden detail. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.
...
- projected relationship line: Sora treats protagonist as a witness/technical consultant, not fellow detective.
...
- projected world pressure: investigation must earn conclusions.
...
- Source-owned institutional/world pressure: investigation must earn conclusions. Relationship/institution interface: Sora treats protagonist as a witness/technical consultant, not fellow detective.
...
- source clue: mundane hypotheses remain alive.
...
- classification=SOURCE_DEFINED. Source clue=mundane hypotheses remain alive. Outgoing selector=access trail does not support a simple leak. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: works with Sora to trace access, old records, rumor channels and possible coaching. Immediate Want: test mundane information-leak explanations. Act guard: H-B is current-lived. H-A knowledge/state enters only through explicit memory/provenance; secondary characters retain independent causality.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: works with Sora to trace access, old records, rumor channels and possible coaching.
- exact Immediate Want: test mundane information-leak explanations.
- exact End Turn: access trail does not support a simple leak.
...
## Forecast Outgoing
- projected End Turn: access trail does not support a simple leak.
...
1. Episode Card — exact EP124 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=security/records route; current world/material/location router, branch=H-B.
