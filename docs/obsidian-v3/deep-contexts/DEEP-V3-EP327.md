...
beat: BEAT-V3-B44
concurrency: NONE
source_snapshot: router=CTX-V3-EP327; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT7-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-7C
- beat: BEAT-V3-B44
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT7-v0.1.md selector `EP327`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP326: End Turn=an immediate preservation/resource case requires society to decide whether a lived lineage can be treated as expendable. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.
...
- projected relationship line: multiple institutions/affected people demand representation.
...
- projected world pressure: Act7 scale reveal converts directly into Act8 operational rights conflict.
...
- Source-owned institutional/world pressure: Act7 scale reveal converts directly into Act8 operational rights conflict. Relationship/institution interface: multiple institutions/affected people demand representation.
...
- source clue: D08 FINAL PAYOFF complete; D09 active; protagonist non-HUMAN confirmed; HUMAN meaning still open.
...
- classification=PAYOFF+OPEN. Source clue=D08 FINAL PAYOFF complete; D09 active; protagonist non-HUMAN confirmed; HUMAN meaning still open. Outgoing selector=the question becomes not `어느 세계가 진짜인가` but `살아 있는 계보를 누가 어떤 권리로 멈출 수 있는가`—expressed through the concrete threatened case, not narration slogan. No authorial ominous narration beyond Blueprint evidence.
...
- exact End Turn: the question becomes not `어느 세계가 진짜인가` but `살아 있는 계보를 누가 어떤 권리로 멈출 수 있는가`—expressed through the concrete threatened case, not narration slogan.
...
## Forecast Outgoing
- projected End Turn: the question becomes not `어느 세계가 진짜인가` but `살아 있는 계보를 누가 어떤 권리로 멈출 수 있는가`—expressed through the concrete threatened case, not narration slogan.
...
1. Episode Card — exact EP327 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=Civic/technical preservation interface; current world/material/location router, branch=H-B.
