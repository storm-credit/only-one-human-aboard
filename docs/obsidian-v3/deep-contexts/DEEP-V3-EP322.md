...
beat: BEAT-V3-B44
concurrency: NONE
source_snapshot: router=CTX-V3-EP322; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT7-v0.1.md; mode=blueprint-compiled
...
---
# DEEP V3 EP322 — 셀 수 없는 것이 모두 사람은 아니다
...
- subact: SA-V3-7C
- beat: BEAT-V3-B44
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT7-v0.1.md selector `EP322`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP321: End Turn=Hana asks whether all indexed states were ever conscious. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.
...
- projected relationship line: Leila/others insist labels cannot alone settle personhood at deep boundary.
...
- projected world pressure: D0~D4 author structure becomes late reader-facing approximate operational categories, perhaps not exact author labels in dialogue.
...
- Source-owned institutional/world pressure: D0~D4 author structure becomes late reader-facing approximate operational categories, perhaps not exact author labels in dialogue. Relationship/institution interface: Leila/others insist labels cannot alone settle personhood at deep boundary.
...
- source clue: D08 FINAL PAYOFF step 3.
...
- classification=PAYOFF. Source clue=D08 FINAL PAYOFF step 3. Outgoing selector=some fully lived lineages clearly contain persons with independent claims. No authorial ominous narration beyond Blueprint evidence.
...
## Forecast Outgoing
- projected End Turn: some fully lived lineages clearly contain persons with independent claims.
...
1. Episode Card — exact EP322 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=archive/technical synthesis; current world/material/location router, branch=H-B.
