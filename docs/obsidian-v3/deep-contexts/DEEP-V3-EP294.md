...
beat: BEAT-V3-B40
concurrency: NONE
source_snapshot: router=CTX-V3-EP294; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT7-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-7A
- beat: BEAT-V3-B40
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT7-v0.1.md selector `EP294`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP293: End Turn=one preservation incident links the load to continuity cases. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=decide whether to use another inherited rule despite unknown source. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: teaches Niko that unexplained does not mean useless, while Niko reminds him inherited rules can be wrong.
...
- projected world pressure: D05 practical payoff.
...
- Source-owned institutional/world pressure: D05 practical payoff. Relationship/institution interface: teaches Niko that unexplained does not mean useless, while Niko reminds him inherited rules can be wrong.
...
- source clue: D05 FINAL PAYOFF approaching.
...
- classification=PAYOFF. Source clue=D05 FINAL PAYOFF approaching. Outgoing selector=Leila reports a continuity/identity case where `same person` assumptions are causing immediate harm. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: adapts it cautiously and prevents a local failure; shows why civilization would preserve successful lessons even without autobiographical context. Immediate Want: decide whether to use another inherited rule despite unknown source. Act guard: Action/evidence before ontology. Every explanatory beat must be earned by a concrete decision, cost, failed model, or operational consequence.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: adapts it cautiously and prevents a local failure; shows why civilization would preserve successful lessons even without autobiographical context.
- exact Immediate Want: decide whether to use another inherited rule despite unknown source.
- exact End Turn: Leila reports a continuity/identity case where `same person` assumptions are causing immediate harm.
...
## Forecast Outgoing
- projected End Turn: Leila reports a continuity/identity case where `same person` assumptions are causing immediate harm.
...
1. Episode Card — exact EP294 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=repair/recovery site; current world/material/location router, branch=H-B.
