...
beat: BEAT-V3-B22
concurrency: NONE
source_snapshot: router=CTX-V3-EP158; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT4-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-4B
- beat: BEAT-V3-B22
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT4-v0.1.md selector `EP158`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP157: End Turn=attack shifts because traffic patterns changed. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=adapt to Mira/Selene/Sora-created current geometry. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: acknowledges others changed the outcome before he could.
...
- projected world pressure: multi-causal resolution.
...
- Source-owned institutional/world pressure: multi-causal resolution. Relationship/institution interface: acknowledges others changed the outcome before he could.
...
- source clue: `memory is not destiny` PAYOFF.
...
- classification=PAYOFF. Source clue=`memory is not destiny` PAYOFF. Outgoing selector=last active threat moves toward medical/evacuation interface. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: uses H-A memory only as one warning among present evidence; helps prevent a structural secondary casualty the remembered path never contained. Immediate Want: adapt to Mira/Selene/Sora-created current geometry. Act guard: Prediction and social consequence before ontology. Evidence must change choices/relationships before any explanatory model hardens.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: uses H-A memory only as one warning among present evidence; helps prevent a structural secondary casualty the remembered path never contained.
- exact Immediate Want: adapt to Mira/Selene/Sora-created current geometry.
- exact End Turn: last active threat moves toward medical/evacuation interface.
...
## Forecast Outgoing
- projected End Turn: last active threat moves toward medical/evacuation interface.
...
1. Episode Card — exact EP158 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=target boundary; current world/material/location router, branch=H-B.
