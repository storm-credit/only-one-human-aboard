...
beat: BEAT-V3-B25
concurrency: NONE
source_snapshot: router=CTX-V3-EP178; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT4-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-4C
- beat: BEAT-V3-B25
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT4-v0.1.md selector `EP178`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP177: End Turn=institutions must decide how to handle future claims after Act4 attack. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=prevent a policy response that either canonizes or criminalizes all claimants. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: Sora/Leila positions constrain policy; protagonist is one input.
...
- projected world pressure: temporary verification/privacy guidance created.
...
- Source-owned institutional/world pressure: temporary verification/privacy guidance created. Relationship/institution interface: Sora/Leila positions constrain policy; protagonist is one input.
...
- source clue: social consequence PAYOFF.
...
- classification=PAYOFF. Source clue=social consequence PAYOFF. Outgoing selector=public still creates informal markets/beliefs despite policy. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: contributes evidence that genuine cases are too sparse/unreliable for predictive authority. Immediate Want: prevent a policy response that either canonizes or criminalizes all claimants. Act guard: Prediction and social consequence before ontology. Evidence must change choices/relationships before any explanatory model hardens.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: contributes evidence that genuine cases are too sparse/unreliable for predictive authority.
- exact Immediate Want: prevent a policy response that either canonizes or criminalizes all claimants.
- exact End Turn: public still creates informal markets/beliefs despite policy.
...
## Forecast Outgoing
- projected End Turn: public still creates informal markets/beliefs despite policy.
...
1. Episode Card — exact EP178 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=civic/security review; current world/material/location router, branch=H-B.
