...
beat: BEAT-V3-B45
concurrency: NONE
source_snapshot: router=CTX-V3-EP334; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT8-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-8A
- beat: BEAT-V3-B45
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT8-v0.1.md selector `EP334`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP333: End Turn=civic review must decide what public wording is safe/accurate. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.
...
- projected relationship line: affected current citizens challenge language choices; protagonist is not spokesperson for everyone.
...
- zone: Civic Core
- projected world pressure: terminology itself has institutional consequences.
...
- Source-owned institutional/world pressure: terminology itself has institutional consequences. Relationship/institution interface: affected current citizens challenge language choices; protagonist is not spokesperson for everyone.
...
- classification=SOURCE_DEFINED. Source clue=HUMAN social AFTERSHOCK. Outgoing selector=older departure records indicate HUMAN count was not always 1. No authorial ominous narration beyond Blueprint evidence.
...
## Forecast Outgoing
- projected End Turn: older departure records indicate HUMAN count was not always 1.
...
1. Episode Card — exact EP334 Blueprint selector; A-Plot/Want/End Turn authority.
