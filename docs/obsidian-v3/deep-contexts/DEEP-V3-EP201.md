...
beat: BEAT-V3-B28
concurrency: NONE
source_snapshot: router=CTX-V3-EP201; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT5-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-5B
- beat: BEAT-V3-B28
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT5-v0.1.md selector `EP201`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP200: End Turn=protagonist recognizes he is about to make the same mistake with Arun. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=confirm with his own eyes that H-B Arun exists. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: protagonist freezes rather than immediately claiming friendship/guilt.
...
- projected world pressure: same identity lineage can have an independent present.
...
- Source-owned institutional/world pressure: same identity lineage can have an independent present. Relationship/institution interface: protagonist freezes rather than immediately claiming friendship/guilt.
...
- source clue: Arun alive PAYOFF begins.
...
- classification=PAYOFF. Source clue=Arun alive PAYOFF begins. Outgoing selector=Arun notices/recognizes protagonist—but not in the way H-A memory expects. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: sees Arun working with current colleagues/obligations before any confrontation; current life is visibly not a waiting-room for protagonist. Immediate Want: confirm with his own eyes that H-B Arun exists. Act guard: Keep Arun current-life separation explicit and hold HUMAN meaning behind the reveal fence; do not collapse identity into explanation.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: sees Arun working with current colleagues/obligations before any confrontation; current life is visibly not a waiting-room for protagonist.
- exact Immediate Want: confirm with his own eyes that H-B Arun exists.
- exact End Turn: Arun notices/recognizes protagonist—but not in the way H-A memory expects.
...
## Forecast Outgoing
- projected End Turn: Arun notices/recognizes protagonist—but not in the way H-A memory expects.
...
1. Episode Card — exact EP201 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=Arun current worksite vicinity `[exact occupation C2/TBD, outside protagonist team]`; current world/material/location router, branch=H-B.
