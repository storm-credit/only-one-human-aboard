...
source_snapshot: router=CTX-V3-EP091; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT2-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-2D
- beat: BEAT-V3-B12
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT2-v0.1.md selector `EP091`
- branch: H-A
- concurrency: ACT2_LEDGER
- Current-lived namespace remains H-A; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP090: End Turn=a small service irregularity appears outside the local failure model. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=close his incident role and go home. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: family contact promised; protagonist believes the worst is over.
...
- projected world pressure: Sora limits master-saboteur theory; Mira restores partial network; Selene moves command to recovery mode.
...
- Source-owned institutional/world pressure: Sora limits master-saboteur theory; Mira restores partial network; Selene moves command to recovery mode. Relationship/institution interface: family contact promised; protagonist believes the worst is over.
...
- source clue: Act2 local mystery PAYOFF. D03 chronology remains unexplained but nonurgent.
...
- classification=PAYOFF. Source clue=Act2 local mystery PAYOFF. D03 chronology remains unexplained but nonurgent. Outgoing selector=seemingly unrelated power/thermal service margin degrades again. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: local failure chain is substantially solved; remaining damaged zone stays sealed for later work. Immediate Want: close his incident role and go home. Act guard: Disaster/concurrency first. Resolve ACT2_LEDGER geography/time before scene execution; do not explain the branch mechanism. EP094 ends H-A current-lived state.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: local failure chain is substantially solved; remaining damaged zone stays sealed for later work.
- exact Immediate Want: close his incident role and go home.
- exact End Turn: seemingly unrelated power/thermal service margin degrades again.
...
## Forecast Outgoing
- projected End Turn: seemingly unrelated power/thermal service margin degrades again.
...
1. Episode Card — exact EP091 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=Old Works / temporary command; current world/material/location router, branch=H-A.
