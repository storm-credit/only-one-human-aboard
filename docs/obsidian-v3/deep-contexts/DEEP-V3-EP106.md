...
beat: BEAT-V3-B15
concurrency: NONE
source_snapshot: router=CTX-V3-EP106; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT3-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-3A
- beat: BEAT-V3-B15
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT3-v0.1.md selector `EP106`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP105: End Turn=protagonist is shown a document/photo/message predating his arrival that supports their memory. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=find one explanation that fits both physical and social pre-existing deltas. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: he withdraws socially, which family notices.
...
- zone: Old Works / home
- projected world pressure: no authority treats him as special.
...
- Source-owned institutional/world pressure: no authority treats him as special. Relationship/institution interface: he withdraws socially, which family notices.
...
- source clue: regression theory weakens further; conspiracy/neurological explanations rise.
...
- classification=SOURCE_DEFINED. Source clue=regression theory weakens further; conspiracy/neurological explanations rise. Outgoing selector=he schedules a medical check without disclosing `회귀` claim fully. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: tests account compromise, memory injury, institutional record manipulation, but no single mundane explanation fits yet. Immediate Want: find one explanation that fits both physical and social pre-existing deltas. Act guard: H-B is current-lived. H-A knowledge/state enters only through explicit memory/provenance; secondary characters retain independent causality.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: tests account compromise, memory injury, institutional record manipulation, but no single mundane explanation fits yet.
- exact Immediate Want: find one explanation that fits both physical and social pre-existing deltas.
- exact End Turn: he schedules a medical check without disclosing `회귀` claim fully.
...
## Forecast Outgoing
- projected End Turn: he schedules a medical check without disclosing `회귀` claim fully.
...
1. Episode Card — exact EP106 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=Old Works / home; current world/material/location router, branch=H-B.
