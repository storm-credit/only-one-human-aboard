...
beat: BEAT-V3-B27
concurrency: NONE
source_snapshot: router=CTX-V3-EP191; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT5-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-5A
- beat: BEAT-V3-B27
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT5-v0.1.md selector `EP191`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP190: End Turn=one document references a registry batch that still exists. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=tie orphan record period to material evidence. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: Gideon warns correlation is not exact event identity.
...
- zone: Legacy Layer
- projected world pressure: multiple evidence routes converge gradually.
...
- Source-owned institutional/world pressure: multiple evidence routes converge gradually. Relationship/institution interface: Gideon warns correlation is not exact event identity.
...
- source clue: physical/archive convergence REINFORCE.
...
- classification=REINFORCE. Source clue=physical/archive convergence REINFORCE. Outgoing selector=Sora locates access history suggesting no current H-B actor fabricated the evidence recently. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: material age/repair sequence and orphan records converge within a broad historical band. Immediate Want: tie orphan record period to material evidence. Act guard: Keep Arun current-life separation explicit and hold HUMAN meaning behind the reveal fence; do not collapse identity into explanation.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: material age/repair sequence and orphan records converge within a broad historical band.
- exact Immediate Want: tie orphan record period to material evidence.
- exact End Turn: Sora locates access history suggesting no current H-B actor fabricated the evidence recently.
...
## Forecast Outgoing
- projected End Turn: Sora locates access history suggesting no current H-B actor fabricated the evidence recently.
...
1. Episode Card — exact EP191 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=Legacy Layer; current world/material/location router, branch=H-B.
