...
beat: BEAT-V3-B43
concurrency: NONE
source_snapshot: router=CTX-V3-EP317; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT7-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-7C
- beat: BEAT-V3-B43
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT7-v0.1.md selector `EP317`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP316: End Turn=Sora asks who authorized creation/termination of these lives. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=identify current actor responsible for the lineage field. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: anger cannot be resolved by arresting a villain.
...
- projected world pressure: current society inherits a system it did not design fully understand.
...
- Source-owned institutional/world pressure: current society inherits a system it did not design fully understand. Relationship/institution interface: anger cannot be resolved by arresting a villain.
...
- source clue: every-disaster-system theory reframed; architecture > mastermind.
...
- classification=SOURCE_DEFINED. Source clue=every-disaster-system theory reframed; architecture > mastermind. Outgoing selector=Sora traces rare memory cases to isolation/integrity faults across lineage references. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: finds distributed legacy automation, inherited mandates and partial human/civic oversight—not one secret mastermind. Immediate Want: identify current actor responsible for the lineage field. Act guard: Action/evidence before ontology. Every explanatory beat must be earned by a concrete decision, cost, failed model, or operational consequence.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: finds distributed legacy automation, inherited mandates and partial human/civic oversight—not one secret mastermind.
- exact Immediate Want: identify current actor responsible for the lineage field.
- exact End Turn: Sora traces rare memory cases to isolation/integrity faults across lineage references.
...
## Forecast Outgoing
- projected End Turn: Sora traces rare memory cases to isolation/integrity faults across lineage references.
...
1. Episode Card — exact EP317 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=Civic/technical oversight; current world/material/location router, branch=H-B.
