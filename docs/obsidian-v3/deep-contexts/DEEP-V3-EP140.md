...
beat: BEAT-V3-B20
concurrency: NONE
source_snapshot: router=CTX-V3-EP140; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT4-v0.1.md; mode=blueprint-compiled
...
---
# DEEP V3 EP140 — 맞힌 것만 세면 누구나 예언자다
...
- subact: SA-V3-4A
- beat: BEAT-V3-B20
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT4-v0.1.md selector `EP140`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP139: End Turn=Cassian voluntarily supplies some records but withholds one private planning source. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.
...
- projected relationship line: protagonist admits confirmation bias but one cluster still stands out.
...
- projected world pressure: reputations simplify messy data.
...
- Source-owned institutional/world pressure: reputations simplify messy data. Relationship/institution interface: protagonist admits confirmation bias but one cluster still stands out.
...
- source clue: fraud/luck/pattern-recognition ecology REINFORCE.
...
- classification=REINFORCE. Source clue=fraud/luck/pattern-recognition ecology REINFORCE. Outgoing selector=a popular media account claims a precise upcoming incident. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: discovers many failed preparations and false alarms hidden by reputation; accuracy drops substantially. Immediate Want: test Cassian's track record against misses. Act guard: Prediction and social consequence before ontology. Evidence must change choices/relationships before any explanatory model hardens.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: discovers many failed preparations and false alarms hidden by reputation; accuracy drops substantially.
- exact Immediate Want: test Cassian's track record against misses.
- exact End Turn: a popular media account claims a precise upcoming incident.
...
## Forecast Outgoing
- projected End Turn: a popular media account claims a precise upcoming incident.
...
1. Episode Card — exact EP140 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=records / ordinary social space; current world/material/location router, branch=H-B.
