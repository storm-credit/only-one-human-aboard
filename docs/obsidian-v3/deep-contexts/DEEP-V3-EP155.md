...
beat: BEAT-V3-B22
concurrency: NONE
source_snapshot: router=CTX-V3-EP155; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT4-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-4B
- beat: BEAT-V3-B22
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT4-v0.1.md selector `EP155`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP154: End Turn=civilians become trapped in a location that should have been empty under prediction. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.
...
- projected relationship line: Sora challenges a superior/public demand to treat all foreknowledge claimants as suspects.
...
- zone: security chain
- projected world pressure: security response to anomaly claims matures.
...
- Source-owned institutional/world pressure: security response to anomaly claims matures. Relationship/institution interface: Sora challenges a superior/public demand to treat all foreknowledge claimants as suspects.
...
- source clue: real attack local cause advances.
...
- classification=SOURCE_DEFINED. Source clue=real attack local cause advances. Outgoing selector=one perpetrator expects a security reaction that did not happen because Selene changed plan. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: distinguishes rumor copycats from real operational network; current digital/physical evidence outranks prophecy. Immediate Want: identify actual perpetrators and prevent a second action. Act guard: Prediction and social consequence before ontology. Evidence must change choices/relationships before any explanatory model hardens.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: distinguishes rumor copycats from real operational network; current digital/physical evidence outranks prophecy.
- exact Immediate Want: identify actual perpetrators and prevent a second action.
- exact End Turn: one perpetrator expects a security reaction that did not happen because Selene changed plan.
...
## Forecast Outgoing
- projected End Turn: one perpetrator expects a security reaction that did not happen because Selene changed plan.
...
1. Episode Card — exact EP155 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=security chain; current world/material/location router, branch=H-B.
