...
beat: BEAT-V3-B27
concurrency: NONE
source_snapshot: router=CTX-V3-EP195; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT5-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-5A
- beat: BEAT-V3-B27
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT5-v0.1.md selector `EP195`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP194: End Turn=current address of one `dead` person exists. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=verify whether the death marker is simple mistaken identity. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.

## Character Context
- active_core_cap: max 3 salient characters including POV.
- projected_active_core: [주인공/TBD], Sora, family
...
- projected relationship line: protagonist wants contact; Sora insists on a lawful reason and non-harassing approach.
...
- projected world pressure: living people cannot be treated as evidence objects.
...
- Source-owned institutional/world pressure: living people cannot be treated as evidence objects. Relationship/institution interface: protagonist wants contact; Sora insists on a lawful reason and non-harassing approach.
...
- source clue: death contradiction REINFORCE.
...
- classification=REINFORCE. Source clue=death contradiction REINFORCE. Outgoing selector=the person's family history contains a gap matching the orphan event period. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: compares age, identity data and family links; mismatch remains too specific for easy namesake explanation. Immediate Want: verify whether the death marker is simple mistaken identity. Act guard: Keep Arun current-life separation explicit and hold HUMAN meaning behind the reveal fence; do not collapse identity into explanation.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: compares age, identity data and family links; mismatch remains too specific for easy namesake explanation.
- exact Immediate Want: verify whether the death marker is simple mistaken identity.
- exact End Turn: the person's family history contains a gap matching the orphan event period.
...
## Forecast Outgoing
- projected End Turn: the person's family history contains a gap matching the orphan event period.
...
1. Episode Card — exact EP195 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=registry/public records; current world/material/location router, branch=H-B.
