...
source_snapshot: router=CTX-V3-EP241; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT6-v0.1.md; mode=blueprint-compiled
...
---
# DEEP V3 EP241 — 손님이 아니라 같이 일하는 사람
...
- subact: SA-V3-6A
- beat: BEAT-V3-B33
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT6-v0.1.md selector `EP241`
- branch: H-B
- concurrency: ACT6_LEDGER
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP240: End Turn=one new contact offers a medical transport coordination channel. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.
...
- projected relationship line: one previously separate group forms a small working trust edge that later matters.
...
- zone: Midring
- projected world pressure: mutual aid is network formation, not inspirational montage.
...
- Source-owned institutional/world pressure: mutual aid is network formation, not inspirational montage. Relationship/institution interface: one previously separate group forms a small working trust edge that later matters.
...
- source clue: neutral-corridor social seed REINFORCE.
...
- classification=REINFORCE+SEED. Source clue=neutral-corridor social seed REINFORCE. Outgoing selector=school/family transport shortage worsens. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: pairs local volunteers with displaced medical/service workers; distrust is practical, not ideological. Immediate Want: integrate newcomers/help without losing local trust. Act guard: Resolve ACT6_LEDGER concurrency/resource/network state before execution; causality must remain distributed across people and institutions.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: pairs local volunteers with displaced medical/service workers; distrust is practical, not ideological.
- exact Immediate Want: integrate newcomers/help without losing local trust.
- exact End Turn: school/family transport shortage worsens.
...
## Forecast Outgoing
- projected End Turn: school/family transport shortage worsens.
...
1. Episode Card — exact EP241 Blueprint selector; A-Plot/Want/End Turn authority.
