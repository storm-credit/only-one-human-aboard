...
source_snapshot: router=CTX-V3-EP265; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT6-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-6C
- beat: BEAT-V3-B36
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT6-v0.1.md selector `EP265`
- branch: H-B
- concurrency: ACT6_LEDGER
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP264: End Turn=immediate scarcity projections worsen. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.
...
- projected relationship line: community solidarity edges toward coercion.
...
- projected world pressure: leverage is not automatically extremism or virtue.
...
- Source-owned institutional/world pressure: leverage is not automatically extremism or virtue. Relationship/institution interface: community solidarity edges toward coercion.
...
- classification=NONE. Source clue=NONE. Outgoing selector=a violent cell exploits the slowdown to approach a control point. No authorial ominous narration beyond Blueprint evidence.
...
## Forecast Outgoing
- projected End Turn: a violent cell exploits the slowdown to approach a control point.
...
1. Episode Card — exact EP265 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=Midring / freight access; current world/material/location router, branch=H-B.
