...
beat: BEAT-V3-B53
concurrency: NONE
source_snapshot: router=CTX-V3-EP392; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT9-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-9B
- beat: BEAT-V3-B53
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT9-v0.1.md selector `EP392`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP391: End Turn=Selene must keep access open while teams physically decouple systems. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: Selene
- OFF-POV / INFLUENCE_ONLY_UNLESS_BLUEPRINT_EXPLICIT. Selene owns the episode's lived decision line. Do not reroute success, discovery, or emotional resolution through the protagonist merely for centrality.

## Character Context
- active_core_cap: max 3 salient characters including POV.
- projected_active_core: Selene
...
- projected relationship line: final order choice prioritizes bounded purpose over control of everything.
...
- projected world pressure: crisis enters decisive physical phase.
...
- Source-owned institutional/world pressure: crisis enters decisive physical phase. Relationship/institution interface: final order choice prioritizes bounded purpose over control of everything.
...
- classification=NONE. Source clue=NONE. Outgoing selector=teams must decide whether to fully decouple and accept permanent loss of part of early settlement infrastructure. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: abandons one symbolic/valuable perimeter asset to concentrate safety on people and critical nodes; establishes corridors for technical/medical movement. Immediate Want: protect repair/evacuation work without defending every failing asset equally. Act guard: Descendant completion and return/payoff outrank novelty. No rerun/new ontology by default; EP406-410 add no major mystery and close through consequence/return.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: abandons one symbolic/valuable perimeter asset to concentrate safety on people and critical nodes; establishes corridors for technical/medical movement.
- exact Immediate Want: protect repair/evacuation work without defending every failing asset equally.
- exact End Turn: teams must decide whether to fully decouple and accept permanent loss of part of early settlement infrastructure.
...
## Forecast Outgoing
- projected End Turn: teams must decide whether to fully decouple and accept permanent loss of part of early settlement infrastructure.
...
1. Episode Card — exact EP392 Blueprint selector; A-Plot/Want/End Turn authority.
2. Immediate Continuity — prior realized CONTINUITY-FROZEN + this forecast selector; never future guessed Actual.
3. POV/Relationship — POV=Selene; relationship line + current role/relationship graph, active core <=3.
4. World/Zone/Material — Zone=crisis command / settlement perimeter; current world/material/location router, branch=H-B.
