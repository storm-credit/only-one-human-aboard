...
beat: BEAT-V3-B26
concurrency: NONE
source_snapshot: router=CTX-V3-EP187; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT5-v0.1.md; mode=blueprint-compiled
...
---
# DEEP V3 EP187 — 지워진 사건이 아니라 없는 사건
...
- subact: SA-V3-5A
- beat: BEAT-V3-B26
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT5-v0.1.md selector `EP187`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP186: End Turn=a family/ordinary person notices an old memorial marker associated with the area. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=test whether missing history is simple censorship/deletion. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: protagonist/Sora theory diverges: conspiracy remains possible but weakens.
...
- projected world pressure: absence itself has structure.
...
- Source-owned institutional/world pressure: absence itself has structure. Relationship/institution interface: protagonist/Sora theory diverges: conspiracy remains possible but weakens.
...
- source clue: `hidden conspiracy` red herring weakens.
...
- classification=SOURCE_DEFINED. Source clue=`hidden conspiracy` red herring weakens. Outgoing selector=memorial practice supplies a human-scale contradiction. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: finds current H-B civic history lacks downstream consequences expected from a major hidden disaster—suggesting not merely a cover-up. Immediate Want: test whether missing history is simple censorship/deletion. Act guard: Keep Arun current-life separation explicit and hold HUMAN meaning behind the reveal fence; do not collapse identity into explanation.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: finds current H-B civic history lacks downstream consequences expected from a major hidden disaster—suggesting not merely a cover-up.
- exact Immediate Want: test whether missing history is simple censorship/deletion.
- exact End Turn: memorial practice supplies a human-scale contradiction.
...
## Forecast Outgoing
- projected End Turn: memorial practice supplies a human-scale contradiction.
...
1. Episode Card — exact EP187 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=Legacy Layer / public edge; current world/material/location router, branch=H-B.
