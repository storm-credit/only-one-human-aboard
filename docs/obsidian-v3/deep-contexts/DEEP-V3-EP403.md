...
beat: BEAT-V3-B55
concurrency: NONE
source_snapshot: router=CTX-V3-EP403; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT9-v0.1.md; mode=blueprint-compiled
...
---
# DEEP V3 EP403 — 선택하지 않은 삶은 내 삶이 아니다
...
- subact: SA-V3-9C
- beat: BEAT-V3-B55
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT9-v0.1.md selector `EP403`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP402: End Turn=families begin choosing whether/when to move, stay, or split across locations. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=handle a major personal relationship choice without using alternate-history memories as entitlement. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: main emotional ledger closes behaviorally; exact romance outcome stays current-choice based, not destiny payoff.
...
- projected world pressure: identity lesson returns to ordinary relationship.
...
- Source-owned institutional/world pressure: identity lesson returns to ordinary relationship. Relationship/institution interface: main emotional ledger closes behaviorally; exact romance outcome stays current-choice based, not destiny payoff.
...
- source clue: D01/D08 AFTERSHOCK.
...
- classification=SOURCE_DEFINED. Source clue=D01/D08 AFTERSHOCK. Outgoing selector=settlement allocation creates one last difficult personal/logistics decision. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: accepts Mira/Arun/family current choices as current, even when they differ from lives he remembers or imagined restoring. Immediate Want: handle a major personal relationship choice without using alternate-history memories as entitlement. Act guard: Descendant completion and return/payoff outrank novelty. No rerun/new ontology by default; EP406-410 add no major mystery and close through consequence/return.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: accepts Mira/Arun/family current choices as current, even when they differ from lives he remembers or imagined restoring.
- exact Immediate Want: handle a major personal relationship choice without using alternate-history memories as entitlement.
- exact End Turn: settlement allocation creates one last difficult personal/logistics decision.
...
## Forecast Outgoing
- projected End Turn: settlement allocation creates one last difficult personal/logistics decision.
...
1. Episode Card — exact EP403 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=current family/relationship setting; current world/material/location router, branch=H-B.
