...
source_snapshot: router=CTX-V3-EP255; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT6-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-6B
- beat: BEAT-V3-B35
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT6-v0.1.md selector `EP255`
- branch: H-B
- concurrency: ACT6_LEDGER
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP254: End Turn=a rescue operation would consume scarce field capacity. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.
...
- projected relationship line: colleagues are shocked; Rafi's same virtue has learned system limits.
...
- projected world pressure: scarcity changes moral choices without personality swap.
...
- Source-owned institutional/world pressure: scarcity changes moral choices without personality swap. Relationship/institution interface: colleagues are shocked; Rafi's same virtue has learned system limits.
...
- classification=NONE. Source clue=NONE. Outgoing selector=Leila argues for an exception on a different patient. No authorial ominous narration beyond Blueprint evidence.
...
## Forecast Outgoing
- projected End Turn: Leila argues for an exception on a different patient.
...
1. Episode Card — exact EP255 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=Emergency/Medical corridor; current world/material/location router, branch=H-B.
