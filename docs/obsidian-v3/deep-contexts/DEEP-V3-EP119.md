...
beat: BEAT-V3-B17
concurrency: NONE
source_snapshot: router=CTX-V3-EP119; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT3-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-3B
- beat: BEAT-V3-B17
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT3-v0.1.md selector `EP119`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP118: End Turn=protagonist hears of someone else making an impossible memory claim. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=determine whether the reported case resembles his own experience. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: protagonist wants access; Leila sets privacy/clinical boundaries.
...
- projected world pressure: his anomaly does not grant automatic right to another person's case.
...
- Source-owned institutional/world pressure: his anomaly does not grant automatic right to another person's case. Relationship/institution interface: protagonist wants access; Leila sets privacy/clinical boundaries.
...
- source clue: independent memory case PLANT.
...
- classification=PLANT. Source clue=independent memory case PLANT. Outgoing selector=the claimant reportedly knows one physical detail not in public records. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: learns a patient/citizen has a concrete memory of one death/event that never happened in H-B. Immediate Want: determine whether the reported case resembles his own experience. Act guard: H-B is current-lived. H-A knowledge/state enters only through explicit memory/provenance; secondary characters retain independent causality.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: learns a patient/citizen has a concrete memory of one death/event that never happened in H-B.
- exact Immediate Want: determine whether the reported case resembles his own experience.
- exact End Turn: the claimant reportedly knows one physical detail not in public records.
...
## Forecast Outgoing
- projected End Turn: the claimant reportedly knows one physical detail not in public records.
...
1. Episode Card — exact EP119 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=Med-University / security referral context; current world/material/location router, branch=H-B.
