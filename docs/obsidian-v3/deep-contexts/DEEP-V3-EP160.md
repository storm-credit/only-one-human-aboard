...
beat: BEAT-V3-B23
concurrency: NONE
source_snapshot: router=CTX-V3-EP160; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT4-v0.1.md; mode=blueprint-compiled
...
---
# DEEP V3 EP160 — 사건의 끝과 예언의 끝은 다르다
...
- subact: SA-V3-4B
- beat: BEAT-V3-B23
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT4-v0.1.md selector `EP160`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP159: End Turn=security indicates main attack is contained. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=understand what the prediction actually got right. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: protagonist stops using `미래 기억` as his preferred label.
...
- projected world pressure: attack local investigation continues normally.
...
- Source-owned institutional/world pressure: attack local investigation continues normally. Relationship/institution interface: protagonist stops using `미래 기억` as his preferred label.
...
- source clue: predictive half-life PAYOFF.
...
- classification=PAYOFF. Source clue=predictive half-life PAYOFF. Outgoing selector=source of accurate fragments still unexplained. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: separates target family, broad event class and a few details from wrong timing/order/people/outcome. Immediate Want: understand what the prediction actually got right. Act guard: Prediction and social consequence before ontology. Evidence must change choices/relationships before any explanatory model hardens.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: separates target family, broad event class and a few details from wrong timing/order/people/outcome.
- exact Immediate Want: understand what the prediction actually got right.
- exact End Turn: source of accurate fragments still unexplained.
...
## Forecast Outgoing
- projected End Turn: source of accurate fragments still unexplained.
...
1. Episode Card — exact EP160 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=post-incident review; current world/material/location router, branch=H-B.
