...
- classification=PAYOFF. Source clue=Act3 major PAYOFF: `내 기억만 잘못된 게 아니다.` Outgoing selector=someone uses supposed foreknowledge for material advantage. No authorial ominous narration beyond Blueprint evidence.
...
- exact End Turn: someone uses supposed foreknowledge for material advantage.
...
## Forecast Outgoing
- projected End Turn: someone uses supposed foreknowledge for material advantage.
