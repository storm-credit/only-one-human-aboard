...
beat: BEAT-V3-B44
concurrency: NONE
source_snapshot: router=CTX-V3-EP324; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT7-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-7C
- beat: BEAT-V3-B44
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT7-v0.1.md selector `EP324`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP323: End Turn=question immediately becomes what happened to fully lived lineages after tests. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=determine how deep lived histories were historically treated when no longer active. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: protagonist connects doctrine's weakness to Arun/claimant cases.
...
- projected world pressure: Act8 rights crisis seeded.
...
- Source-owned institutional/world pressure: Act8 rights crisis seeded. Relationship/institution interface: protagonist connects doctrine's weakness to Arun/claimant cases.
...
- classification=SOURCE_DEFINED. Source clue=D09 late TRIGGER. Outgoing selector=current resource pressure threatens a quiescent/deep lineage preservation decision. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: finds old Continuity Doctrine language equating related branches with one continuing lineage more than current people would accept. Immediate Want: determine how deep lived histories were historically treated when no longer active. Act guard: Action/evidence before ontology. Every explanatory beat must be earned by a concrete decision, cost, failed model, or operational consequence.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: finds old Continuity Doctrine language equating related branches with one continuing lineage more than current people would accept.
- exact Immediate Want: determine how deep lived histories were historically treated when no longer active.
- exact End Turn: current resource pressure threatens a quiescent/deep lineage preservation decision.
...
## Forecast Outgoing
- projected End Turn: current resource pressure threatens a quiescent/deep lineage preservation decision.
...
1. Episode Card — exact EP324 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=continuity/resource policy records; current world/material/location router, branch=H-B.
