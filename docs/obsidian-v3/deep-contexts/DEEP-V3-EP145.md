...
beat: BEAT-V3-B20
concurrency: NONE
source_snapshot: router=CTX-V3-EP145; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT4-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-4A
- beat: BEAT-V3-B20
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT4-v0.1.md selector `EP145`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP144: End Turn=Mira reports unusual evacuation/asset movement around the predicted target by people with no link to the exposed fraud. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.
...
- projected relationship line: Mira↔Juno coordinate public-facing information without agreeing on how much to reassure people.
...
- zone: Transfer Belt
- projected world pressure: belief changes the system before any attack occurs.
...
- Source-owned institutional/world pressure: belief changes the system before any attack occurs. Relationship/institution interface: Mira↔Juno coordinate public-facing information without agreeing on how much to reassure people.
...
- source clue: social feedback loop TRIGGER.
...
- classification=SOURCE_DEFINED. Source clue=social feedback loop TRIGGER. Outgoing selector=a real security anomaly appears at the predicted target family. No authorial ominous narration beyond Blueprint evidence.
...
## Forecast Outgoing
- projected End Turn: a real security anomaly appears at the predicted target family.
...
1. Episode Card — exact EP145 Blueprint selector; A-Plot/Want/End Turn authority.
