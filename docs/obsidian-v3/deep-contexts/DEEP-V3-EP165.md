...
beat: BEAT-V3-B23
concurrency: NONE
source_snapshot: router=CTX-V3-EP165; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT4-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-4B
- beat: BEAT-V3-B23
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT4-v0.1.md selector `EP165`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP164: End Turn=meeting arranged under ordinary legal/medical/privacy limits. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=test whether Ivo predicts future or remembers something. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: protagonist sees dangerous certainty he recognizes in his earlier self.
...
- projected world pressure: extraordinary case remains person, not oracle service.
...
- Source-owned institutional/world pressure: extraordinary case remains person, not oracle service. Relationship/institution interface: protagonist sees dangerous certainty he recognizes in his earlier self.
...
- source clue: future-sight theory materially weakened; other-lived-history interpretation rises.
...
- classification=SOURCE_DEFINED. Source clue=future-sight theory materially weakened; other-lived-history interpretation rises. Outgoing selector=Ivo insists another event happened that protagonist remembers differently too. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: Ivo describes one event as something already lived, not a vision, yet parts of it clearly did not happen in H-B. Immediate Want: test whether Ivo predicts future or remembers something. Act guard: Prediction and social consequence before ontology. Evidence must change choices/relationships before any explanatory model hardens.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: Ivo describes one event as something already lived, not a vision, yet parts of it clearly did not happen in H-B.
- exact Immediate Want: test whether Ivo predicts future or remembers something.
- exact End Turn: Ivo insists another event happened that protagonist remembers differently too.
...
## Forecast Outgoing
- projected End Turn: Ivo insists another event happened that protagonist remembers differently too.
...
1. Episode Card — exact EP165 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=meeting/interview; current world/material/location router, branch=H-B.
