...
source_snapshot: router=CTX-V3-EP262; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT6-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-6C
- beat: BEAT-V3-B36
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT6-v0.1.md selector `EP262`
- branch: H-B
- concurrency: ACT6_LEDGER
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP261: End Turn=civic order demands a rapid-restoration plan. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=quantify the risk of rapid restoration. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: team split is technical and moral, not partisan only.
...
- projected world pressure: real tradeoff is explicit.
...
- Source-owned institutional/world pressure: real tradeoff is explicit. Relationship/institution interface: team split is technical and moral, not partisan only.
...
- classification=NONE. Source clue=NONE. Outgoing selector=civic pressure asks for a binary recommendation. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: establishes that quick restart could relieve thousands now but expose multiple unstable loads to a catastrophic cascade. Immediate Want: quantify the risk of rapid restoration. Act guard: Resolve ACT6_LEDGER concurrency/resource/network state before execution; causality must remain distributed across people and institutions.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: establishes that quick restart could relieve thousands now but expose multiple unstable loads to a catastrophic cascade.
- exact Immediate Want: quantify the risk of rapid restoration.
- exact End Turn: civic pressure asks for a binary recommendation.
...
## Forecast Outgoing
- projected End Turn: civic pressure asks for a binary recommendation.
...
1. Episode Card — exact EP262 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=high-capacity utility/transfer path; current world/material/location router, branch=H-B.
