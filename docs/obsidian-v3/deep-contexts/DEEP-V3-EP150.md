...
beat: BEAT-V3-B21
concurrency: NONE
source_snapshot: router=CTX-V3-EP150; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT4-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-4A
- beat: BEAT-V3-B21
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT4-v0.1.md selector `EP150`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP149: End Turn=one regular customer reports seeing suspicious pre-positioned equipment near target route. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=decide whether new physical evidence justifies escalating precautions. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.

## Character Context
- active_core_cap: max 3 salient characters including POV.
- projected_active_core: [주인공/TBD], Selene, Sora
...
- projected relationship line: he hands security conclusion to Sora/Selene rather than chasing suspect himself.
...
- projected world pressure: warning becomes ordinary threat response.
...
- Source-owned institutional/world pressure: warning becomes ordinary threat response. Relationship/institution interface: he hands security conclusion to Sora/Selene rather than chasing suspect himself.
...
- source clue: predicted attack TRIGGER.
...
- classification=SOURCE_DEFINED. Source clue=predicted attack TRIGGER. Outgoing selector=security raises posture as the remembered/predicted window approaches. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: confirms suspicious equipment/access pattern is operationally dangerous regardless of prophecy source. Immediate Want: decide whether new physical evidence justifies escalating precautions. Act guard: Prediction and social consequence before ontology. Evidence must change choices/relationships before any explanatory model hardens.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: confirms suspicious equipment/access pattern is operationally dangerous regardless of prophecy source.
- exact Immediate Want: decide whether new physical evidence justifies escalating precautions.
- exact End Turn: security raises posture as the remembered/predicted window approaches.
...
## Forecast Outgoing
- projected End Turn: security raises posture as the remembered/predicted window approaches.
...
1. Episode Card — exact EP150 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=target infrastructure; current world/material/location router, branch=H-B.
