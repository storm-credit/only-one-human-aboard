...
beat: BEAT-V3-B55
concurrency: NONE
source_snapshot: router=CTX-V3-EP404; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT9-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-9C
- beat: BEAT-V3-B55
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT9-v0.1.md selector `EP404`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP403: End Turn=settlement allocation creates one last difficult personal/logistics decision. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.
...
- projected relationship line: autonomy arc closes without romance reducing her role.
...
- projected world pressure: arrival creates ordinary migration choices, not universal exodus.
...
- Source-owned institutional/world pressure: arrival creates ordinary migration choices, not universal exodus. Relationship/institution interface: autonomy arc closes without romance reducing her role.
...
- classification=NONE. Source clue=NONE. Outgoing selector=protagonist must accept a future he cannot pre-script. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: chooses based on current career/relationships, not because another history says she belongs with protagonist. Immediate Want: make a personal/professional location choice among Meridian, settlement commons and split work. Act guard: Descendant completion and return/payoff outrank novelty. No rerun/new ontology by default; EP406-410 add no major mystery and close through consequence/return.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: chooses based on current career/relationships, not because another history says she belongs with protagonist.
- exact Immediate Want: make a personal/professional location choice among Meridian, settlement commons and split work.
- exact End Turn: protagonist must accept a future he cannot pre-script.
...
## Forecast Outgoing
- projected End Turn: protagonist must accept a future he cannot pre-script.
...
1. Episode Card — exact EP404 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=settlement/ship logistics; current world/material/location router, branch=H-B.
