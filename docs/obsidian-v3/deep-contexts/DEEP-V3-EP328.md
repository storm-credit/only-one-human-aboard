...
beat: BEAT-V3-B45
concurrency: NONE
source_snapshot: router=CTX-V3-EP328; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT8-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-8A
- beat: BEAT-V3-B45
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT8-v0.1.md selector `EP328`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP327: End Turn=the question becomes not `어느 세계가 진짜인가` but `살아 있는 계보를 누가 어떤 권리로 멈출 수 있는가`—expressed through the concrete threatened case, not narration slogan. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.
...
- projected relationship line: protagonist refuses public demand to identify the `real human` before meaning is established.
...
- projected world pressure: current civic personhood vocabulary and legacy mission taxonomy are separated.
...
- Source-owned institutional/world pressure: current civic personhood vocabulary and legacy mission taxonomy are separated. Relationship/institution interface: protagonist refuses public demand to identify the `real human` before meaning is established.
...
- source clue: D06 TRIGGER begins.
...
- classification=SOURCE_DEFINED. Source clue=D06 TRIGGER begins. Outgoing selector=Hana locates a damaged departure-era definition chain. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: compares neighboring mission-era classifications and physical routing; evidence suggests origin/provenance continuity rather than intelligence/citizenship. Immediate Want: determine what legacy `HUMAN` field technically separates after Act7 proved he is not it. Act guard: HUMAN provenance is not personhood. HUMAN:1 must remain de-collectified and must not become a collectible-character family or sacred merchandise target.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: compares neighboring mission-era classifications and physical routing; evidence suggests origin/provenance continuity rather than intelligence/citizenship.
- exact Immediate Want: determine what legacy `HUMAN` field technically separates after Act7 proved he is not it.
- exact End Turn: Hana locates a damaged departure-era definition chain.
...
## Forecast Outgoing
- projected End Turn: Hana locates a damaged departure-era definition chain.
...
1. Episode Card — exact EP328 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=Civic/technical preservation review; current world/material/location router, branch=H-B.
