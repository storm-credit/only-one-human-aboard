...
beat: BEAT-V3-B06
concurrency: NONE
source_snapshot: router=CTX-V3-EP037; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT1-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-1C
- beat: BEAT-V3-B06
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT1-v0.1.md selector `EP037`
- branch: H-A
- concurrency: NONE
- Current-lived namespace remains H-A; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP036: End Turn=one inspection slot must be moved because of access scheduling. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=clear an asset-identification conflict before inspection. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: Gideon insists on documenting rather than `cleaning` the oddity away.
...
- projected world pressure: legacy asset bureaucracy.
...
- Source-owned institutional/world pressure: legacy asset bureaucracy. Relationship/institution interface: Gideon insists on documenting rather than `cleaning` the oddity away.
...
- source clue: duplicate legacy ID — PLANT; very soft future namespace clue.
...
- classification=PLANT. Source clue=duplicate legacy ID — PLANT; very soft future namespace clue. Outgoing selector=maintenance scheduler chooses which physical inspection moves first. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: two legacy references partially collide around the cooling corridor; operations treats it as a migration artifact. Immediate Want: clear an asset-identification conflict before inspection. Act guard: Ordinary-world first. Do not objectively confirm regression, branching, substrate, or HUMAN:1; ordinary failures remain genuinely possible.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: two legacy references partially collide around the cooling corridor; operations treats it as a migration artifact.
- exact Immediate Want: clear an asset-identification conflict before inspection.
- exact End Turn: maintenance scheduler chooses which physical inspection moves first.
...
## Forecast Outgoing
- projected End Turn: maintenance scheduler chooses which physical inspection moves first.
...
1. Episode Card — exact EP037 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=diagnostics/asset registry; current world/material/location router, branch=H-A.
