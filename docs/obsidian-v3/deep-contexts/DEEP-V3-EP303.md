...
beat: BEAT-V3-B41
concurrency: NONE
source_snapshot: router=CTX-V3-EP303; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT7-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-7B
- beat: BEAT-V3-B41
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT7-v0.1.md selector `EP303`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP302: End Turn=Sora identifies multiple distinct life/status records under one lineage family. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: Sora
- OFF-POV / INFLUENCE_ONLY_UNLESS_BLUEPRINT_EXPLICIT. Sora owns the episode's lived decision line. Do not reroute success, discovery, or emotional resolution through the protagonist merely for centrality.
...
- projected relationship line: Sora limits her own suspicion instinct institutionally.
...
- projected world pressure: current legal response develops before full ontology.
...
- Source-owned institutional/world pressure: current legal response develops before full ontology. Relationship/institution interface: Sora limits her own suspicion instinct institutionally.
...
- source clue: D09 operational seed.
...
- classification=SEED. Source clue=D09 operational seed. Outgoing selector=a claimant/successor dispute forces the continuity question more sharply. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: current acts/evidence control present accountability; alternate-history evidence may inform risk/inquiry but cannot automatically transfer guilt. Immediate Want: decide whether evidence of another-history wrongdoing can justify current investigation/restriction. Act guard: Action/evidence before ontology. Every explanatory beat must be earned by a concrete decision, cost, failed model, or operational consequence.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: current acts/evidence control present accountability; alternate-history evidence may inform risk/inquiry but cannot automatically transfer guilt.
- exact Immediate Want: decide whether evidence of another-history wrongdoing can justify current investigation/restriction.
- exact End Turn: a claimant/successor dispute forces the continuity question more sharply.
...
## Forecast Outgoing
- projected End Turn: a claimant/successor dispute forces the continuity question more sharply.
...
1. Episode Card — exact EP303 Blueprint selector; A-Plot/Want/End Turn authority.
2. Immediate Continuity — prior realized CONTINUITY-FROZEN + this forecast selector; never future guessed Actual.
3. POV/Relationship — POV=Sora; relationship line + current role/relationship graph, active core <=3.
4. World/Zone/Material — Zone=security/legal review; current world/material/location router, branch=H-B.
