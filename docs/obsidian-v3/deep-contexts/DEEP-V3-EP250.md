...
source_snapshot: router=CTX-V3-EP250; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT6-v0.1.md; mode=blueprint-compiled
...
---
# DEEP V3 EP250 — 공개하면 늦고 숨기면 더 늦는다
...
- subact: SA-V3-6B
- beat: BEAT-V3-B34
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT6-v0.1.md selector `EP250`
- branch: H-B
- concurrency: ACT6_LEDGER
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP249: End Turn=Hana decides whether to release historical allocation records. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.
...
- projected relationship line: Sora thinks timing risks unrest; Hana thinks secrecy is already corroding legitimacy.
...
- projected world pressure: truth timing has operational consequence.
...
- Source-owned institutional/world pressure: truth timing has operational consequence. Relationship/institution interface: Sora thinks timing risks unrest; Hana thinks secrecy is already corroding legitimacy.
...
- source clue: knowledge/history residue remains background.
...
- classification=SOURCE_DEFINED. Source clue=knowledge/history residue remains background. Outgoing selector=release validates some public grievances and disproves others. No authorial ominous narration beyond Blueprint evidence.
...
## Forecast Outgoing
- projected End Turn: release validates some public grievances and disproves others.
...
1. Episode Card — exact EP250 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=Civic Core/archive; current world/material/location router, branch=H-B.
