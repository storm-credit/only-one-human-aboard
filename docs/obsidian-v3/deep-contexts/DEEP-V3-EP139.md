...
beat: BEAT-V3-B20
concurrency: NONE
source_snapshot: router=CTX-V3-EP139; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT4-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-4A
- beat: BEAT-V3-B20
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT4-v0.1.md selector `EP139`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP138: End Turn=one move occurred before any plausible public warning. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.
...
- projected relationship line: Sora refuses protagonist's moral certainty without dismissing concern.
...
- projected world pressure: investigation of wealth/insider advantage has evidence standards.
...
- Source-owned institutional/world pressure: investigation of wealth/insider advantage has evidence standards. Relationship/institution interface: Sora refuses protagonist's moral certainty without dismissing concern.
...
- source clue: multiple mundane explanations remain.
...
- classification=SOURCE_DEFINED. Source clue=multiple mundane explanations remain. Outgoing selector=Cassian voluntarily supplies some records but withholds one private planning source. No authorial ominous narration beyond Blueprint evidence.
...
## Forecast Outgoing
- projected End Turn: Cassian voluntarily supplies some records but withholds one private planning source.
...
1. Episode Card — exact EP139 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=security/financial investigation; current world/material/location router, branch=H-B.
