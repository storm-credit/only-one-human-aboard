...
beat: BEAT-V3-B30
concurrency: NONE
source_snapshot: router=CTX-V3-EP213; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT5-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-5C
- beat: BEAT-V3-B30
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT5-v0.1.md selector `EP213`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP212: End Turn=one repeated value reads `HUMAN: 1` without definition. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.
...
- projected relationship line: Hana refuses semantic speculation without provenance.
...
- projected world pressure: field is boring/legacy/technical, not glowing revelation.
...
- Source-owned institutional/world pressure: field is boring/legacy/technical, not glowing revelation. Relationship/institution interface: Hana refuses semantic speculation without provenance.
...
- source clue: HUMAN:1 — PLANT/TRIGGER.
...
- classification=PLANT. Source clue=HUMAN:1 — PLANT/TRIGGER. Outgoing selector=access to one deeper record is restricted by mission-era classification. No authorial ominous narration beyond Blueprint evidence.
...
## Forecast Outgoing
- projected End Turn: access to one deeper record is restricted by mission-era classification.
...
1. Episode Card — exact EP213 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=Central archive/technical terminal; current world/material/location router, branch=H-B.
