...
beat: BEAT-V3-B44
concurrency: NONE
source_snapshot: router=CTX-V3-EP323; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT7-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-7C
- beat: BEAT-V3-B44
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT7-v0.1.md selector `EP323`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP322: End Turn=some fully lived lineages clearly contain persons with independent claims. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=infer purpose from what lineages preserve/transfer rather than one mission statement. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: Act6 dispatcher's unexpected cascade becomes key evidence that low-depth prediction misses socially emergent outcomes.
...
- projected world pressure: civilization-search purpose becomes credible hypothesis, not divine explanation.
...
- Source-owned institutional/world pressure: civilization-search purpose becomes credible hypothesis, not divine explanation. Relationship/institution interface: Act6 dispatcher's unexpected cascade becomes key evidence that low-depth prediction misses socially emergent outcomes.
...
- source clue: hidden mission PARTIAL PAYOFF.
...
- classification=PAYOFF. Source clue=hidden mission PARTIAL PAYOFF. Outgoing selector=question immediately becomes what happened to fully lived lineages after tests. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: sees pattern: risks, failures, institutional learning, novel choices, descendant states; does not find a single `better civilization` score. Immediate Want: infer purpose from what lineages preserve/transfer rather than one mission statement. Act guard: Action/evidence before ontology. Every explanatory beat must be earned by a concrete decision, cost, failed model, or operational consequence.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: sees pattern: risks, failures, institutional learning, novel choices, descendant states; does not find a single `better civilization` score.
- exact Immediate Want: infer purpose from what lineages preserve/transfer rather than one mission statement.
- exact End Turn: question immediately becomes what happened to fully lived lineages after tests.
...
## Forecast Outgoing
- projected End Turn: question immediately becomes what happened to fully lived lineages after tests.
...
1. Episode Card — exact EP323 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=post-reveal practical review; current world/material/location router, branch=H-B.
