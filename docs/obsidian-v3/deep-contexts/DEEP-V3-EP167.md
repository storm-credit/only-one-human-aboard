...
beat: BEAT-V3-B24
concurrency: NONE
source_snapshot: router=CTX-V3-EP167; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT4-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-4C
- beat: BEAT-V3-B24
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT4-v0.1.md selector `EP167`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP166: End Turn=one Ivo detail is testable and high-risk if public. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=test one Ivo claim privately. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: Ivo interprets failure as `world changed`; protagonist sees memory divergence instead.
...
- projected world pressure: genuine leak still unreliable.
...
- Source-owned institutional/world pressure: genuine leak still unreliable. Relationship/institution interface: Ivo interprets failure as `world changed`; protagonist sees memory divergence instead.
...
- source clue: rare-memory integrity fault pattern REINFORCE.
...
- classification=REINFORCE. Source clue=rare-memory integrity fault pattern REINFORCE. Outgoing selector=Sora learns Cassian once acted on a similar fragment years earlier. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: current evidence partially supports it, but another detail fails. Immediate Want: test one Ivo claim privately. Act guard: Prediction and social consequence before ontology. Evidence must change choices/relationships before any explanatory model hardens.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: current evidence partially supports it, but another detail fails.
- exact Immediate Want: test one Ivo claim privately.
- exact End Turn: Sora learns Cassian once acted on a similar fragment years earlier.
...
## Forecast Outgoing
- projected End Turn: Sora learns Cassian once acted on a similar fragment years earlier.
...
1. Episode Card — exact EP167 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=service/archive interface; current world/material/location router, branch=H-B.
