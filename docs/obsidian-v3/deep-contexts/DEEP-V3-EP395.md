...
beat: BEAT-V3-B54
concurrency: NONE
source_snapshot: router=CTX-V3-EP395; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT9-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-9B
- beat: BEAT-V3-B54
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT9-v0.1.md selector `EP395`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP394: End Turn=one local team reports their node cannot follow central timing safely. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: Niko
- OFF-POV / INFLUENCE_ONLY_UNLESS_BLUEPRINT_EXPLICIT. Niko owns the episode's lived decision line. Do not reroute success, discovery, or emotional resolution through the protagonist merely for centrality.

## Character Context
- active_core_cap: max 3 salient characters including POV.
- projected_active_core: Niko
...
- projected relationship line: completes Niko's autonomy arc; protagonist must trust his independent judgment.
...
- projected world pressure: novel current choice, not remembered history, matters.
...
- Source-owned institutional/world pressure: novel current choice, not remembered history, matters. Relationship/institution interface: completes Niko's autonomy arc; protagonist must trust his independent judgment.
...
- source clue: final novelty theme REINFORCE.
...
- classification=REINFORCE. Source clue=final novelty theme REINFORCE. Outgoing selector=central plan adjusts around Niko/local data. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: refuses a literal central sequence, uses current measurements to stage a local thermal bridge/bypass, and communicates reasoning rather than just disobeying. Immediate Want: keep a local continuity/power island stable when central decoupling timing does not match real damage. Act guard: Descendant completion and return/payoff outrank novelty. No rerun/new ontology by default; EP406-410 add no major mystery and close through consequence/return.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: refuses a literal central sequence, uses current measurements to stage a local thermal bridge/bypass, and communicates reasoning rather than just disobeying.
- exact Immediate Want: keep a local continuity/power island stable when central decoupling timing does not match real damage.
- exact End Turn: central plan adjusts around Niko/local data.
...
## Forecast Outgoing
- projected End Turn: central plan adjusts around Niko/local data.
...
1. Episode Card — exact EP395 Blueprint selector; A-Plot/Want/End Turn authority.
2. Immediate Continuity — prior realized CONTINUITY-FROZEN + this forecast selector; never future guessed Actual.
3. POV/Relationship — POV=Niko; relationship line + current role/relationship graph, active core <=3.
4. World/Zone/Material — Zone=local technical node; current world/material/location router, branch=H-B.
