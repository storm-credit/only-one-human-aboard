...
beat: BEAT-V3-B40
concurrency: NONE
source_snapshot: router=CTX-V3-EP291; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT7-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-7A
- beat: BEAT-V3-B40
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT7-v0.1.md selector `EP291`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP290: End Turn=one ID maps to a maintenance load not attributable to known city systems. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=explain a persistent protected load while city remains resource-constrained. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: anger arises because H-B just suffered scarcity; he lacks authority to shut anything off.
...
- projected world pressure: hidden load becomes immediate resource/political problem.
...
- Source-owned institutional/world pressure: hidden load becomes immediate resource/political problem. Relationship/institution interface: anger arises because H-B just suffered scarcity; he lacks authority to shut anything off.
...
- source clue: D08 REINFORCE through physical evidence.
...
- classification=REINFORCE. Source clue=D08 REINFORCE through physical evidence. Outgoing selector=access request triggers legacy protection rules. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: confirms the load is real, distributed and larger/more structured than the known HUMAN preservation route alone. Immediate Want: explain a persistent protected load while city remains resource-constrained. Act guard: Action/evidence before ontology. Every explanatory beat must be earned by a concrete decision, cost, failed model, or operational consequence.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: confirms the load is real, distributed and larger/more structured than the known HUMAN preservation route alone.
- exact Immediate Want: explain a persistent protected load while city remains resource-constrained.
- exact End Turn: access request triggers legacy protection rules.
...
## Forecast Outgoing
- projected End Turn: access request triggers legacy protection rules.
...
1. Episode Card — exact EP291 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=Old Works / protected support routing; current world/material/location router, branch=H-B.
