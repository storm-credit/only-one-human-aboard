...
beat: BEAT-V3-B18
concurrency: NONE
source_snapshot: router=CTX-V3-EP131; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT3-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-3C
- beat: BEAT-V3-B18
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT3-v0.1.md selector `EP131`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP130: End Turn=protagonist arrives late and realizes something changed without him. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=decide whether his goal is to restore H-A or protect H-B. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: first behavioral preference for present people.
...
- zone: Midring
- projected world pressure: no grand declaration.
...
- Source-owned institutional/world pressure: no grand declaration. Relationship/institution interface: first behavioral preference for present people.
...
- source clue: character arc movement.
...
- classification=SOURCE_DEFINED. Source clue=character arc movement. Outgoing selector=final independent record test is ready. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: cannot answer fully, but chooses one current commitment over chasing an immediate H-A echo. Immediate Want: decide whether his goal is to restore H-A or protect H-B. Act guard: H-B is current-lived. H-A knowledge/state enters only through explicit memory/provenance; secondary characters retain independent causality.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: cannot answer fully, but chooses one current commitment over chasing an immediate H-A echo.
- exact Immediate Want: decide whether his goal is to restore H-A or protect H-B.
- exact End Turn: final independent record test is ready.
...
## Forecast Outgoing
- projected End Turn: final independent record test is ready.
...
1. Episode Card — exact EP131 Blueprint selector; A-Plot/Want/End Turn authority.
