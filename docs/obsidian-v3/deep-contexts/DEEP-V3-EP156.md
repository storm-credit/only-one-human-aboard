...
beat: BEAT-V3-B22
concurrency: NONE
source_snapshot: router=CTX-V3-EP156; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT4-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-4B
- beat: BEAT-V3-B22
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT4-v0.1.md selector `EP156`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP155: End Turn=one perpetrator expects a security reaction that did not happen because Selene changed plan. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=keep a damaged barrier/utility path stable during extraction. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: his confidence shifts from remembering to diagnosing present conditions.
...
- projected world pressure: practical competence retakes center.
...
- Source-owned institutional/world pressure: practical competence retakes center. Relationship/institution interface: his confidence shifts from remembering to diagnosing present conditions.
...
- source clue: future-memory limitation PAYOFF approaching.
...
- classification=PAYOFF. Source clue=future-memory limitation PAYOFF approaching. Outgoing selector=Mira must choose whether to sacrifice one transport route to preserve evacuation. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: confronts people whose presence here is entirely H-B-specific; old sequence cannot guide him. Immediate Want: keep a damaged barrier/utility path stable during extraction. Act guard: Prediction and social consequence before ontology. Evidence must change choices/relationships before any explanatory model hardens.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: confronts people whose presence here is entirely H-B-specific; old sequence cannot guide him.
- exact Immediate Want: keep a damaged barrier/utility path stable during extraction.
- exact End Turn: Mira must choose whether to sacrifice one transport route to preserve evacuation.
...
## Forecast Outgoing
- projected End Turn: Mira must choose whether to sacrifice one transport route to preserve evacuation.
...
1. Episode Card — exact EP156 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=trapped civilian/service route; current world/material/location router, branch=H-B.
