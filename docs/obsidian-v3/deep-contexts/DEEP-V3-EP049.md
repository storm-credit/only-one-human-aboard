...
source_snapshot: router=CTX-V3-EP049; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT2-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-2A
- beat: BEAT-V3-B07
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT2-v0.1.md selector `EP049`
- branch: H-A
- concurrency: ACT2_LEDGER
- Current-lived namespace remains H-A; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP048: End Turn=Rafi's team commits to entry. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.
...
- projected relationship line: Rafi↔Selene trust under pressure; Rafi establishes his `one more salvageable person` instinct.
...
- projected world pressure: field medicine has independent priorities.
...
- Source-owned institutional/world pressure: field medicine has independent priorities. Relationship/institution interface: Rafi↔Selene trust under pressure; Rafi establishes his `one more salvageable person` instinct.
...
- classification=NONE. Source clue=NONE. Outgoing selector=electrical isolation knocks out a Transfer Belt feed before extraction is fully complete. No authorial ominous narration beyond Blueprint evidence.
...
## Forecast Outgoing
- projected End Turn: electrical isolation knocks out a Transfer Belt feed before extraction is fully complete.
...
1. Episode Card — exact EP049 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=L-A trapped-worker cell; current world/material/location router, branch=H-A.
