...
beat: BEAT-V3-B18
concurrency: NONE
source_snapshot: router=CTX-V3-EP125; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT3-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-3C
- beat: BEAT-V3-B18
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT3-v0.1.md selector `EP125`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP124: End Turn=access trail does not support a simple leak. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=compare claimant's remembered event to H-A and H-B. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: protagonist's private need for validation becomes fear instead.
...
- projected world pressure: third-history possibility becomes thinkable without being named as such.
...
- Source-owned institutional/world pressure: third-history possibility becomes thinkable without being named as such. Relationship/institution interface: protagonist's private need for validation becomes fear instead.
...
- source clue: major Act3 TRIGGER.
...
- classification=SOURCE_DEFINED. Source clue=major Act3 TRIGGER. Outgoing selector=Sora demands evidence before accepting any `third history` theory. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: realizes claimant memory contradicts both—meaning the claimant is not merely remembering protagonist's H-A. Immediate Want: compare claimant's remembered event to H-A and H-B. Act guard: H-B is current-lived. H-A knowledge/state enters only through explicit memory/provenance; secondary characters retain independent causality.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: realizes claimant memory contradicts both—meaning the claimant is not merely remembering protagonist's H-A.
- exact Immediate Want: compare claimant's remembered event to H-A and H-B.
- exact End Turn: Sora demands evidence before accepting any `third history` theory.
...
## Forecast Outgoing
- projected End Turn: Sora demands evidence before accepting any `third history` theory.
...
1. Episode Card — exact EP125 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=ordinary civic location tied to claimant memory; current world/material/location router, branch=H-B.
