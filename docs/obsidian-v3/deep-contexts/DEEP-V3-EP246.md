...
source_snapshot: router=CTX-V3-EP246; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT6-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-6B
- beat: BEAT-V3-B34
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT6-v0.1.md selector `EP246`
- branch: H-B
- concurrency: ACT6_LEDGER
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP245: End Turn=a strategic facility suffers obstruction/sabotage during the delay. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.
...
- projected relationship line: Selene's order instinct begins approaching authoritarian edge without crossing into caricature.
...
- projected world pressure: emergency law becomes daily politics.
...
- Source-owned institutional/world pressure: emergency law becomes daily politics. Relationship/institution interface: Selene's order instinct begins approaching authoritarian edge without crossing into caricature.
...
- classification=NONE. Source clue=NONE. Outgoing selector=security sweeps delay a legitimate community shipment. No authorial ominous narration beyond Blueprint evidence.
...
## Forecast Outgoing
- projected End Turn: security sweeps delay a legitimate community shipment.
...
1. Episode Card — exact EP246 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=Civic Core / strategic facility perimeter; current world/material/location router, branch=H-B.
