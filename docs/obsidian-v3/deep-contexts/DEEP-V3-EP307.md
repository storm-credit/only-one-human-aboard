...
beat: BEAT-V3-B42
concurrency: NONE
source_snapshot: router=CTX-V3-EP307; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT7-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-7B
- beat: BEAT-V3-B42
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT7-v0.1.md selector `EP307`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP306: End Turn=a second case lacks even the claimant's remembered continuity but shares lineage metadata. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: ordinary claimant/successor 2
- OFF-POV / INFLUENCE_ONLY_UNLESS_BLUEPRINT_EXPLICIT. ordinary claimant/successor 2 owns the episode's lived decision line. Do not reroute success, discovery, or emotional resolution through the protagonist merely for centrality.

## Character Context
- active_core_cap: max 3 salient characters including POV.
- projected_active_core: ordinary claimant/successor 2, family
...
- projected relationship line: family learns recognition can coexist with difference.
...
- projected world pressure: successor/counterpart ethics broaden beyond protagonist.
...
- Source-owned institutional/world pressure: successor/counterpart ethics broaden beyond protagonist. Relationship/institution interface: family learns recognition can coexist with difference.
...
- source clue: D09 personhood REINFORCE.
...
- classification=REINFORCE. Source clue=D09 personhood REINFORCE. Outgoing selector=Leila finds medical continuity metadata relevant to protagonist's Act2 event. No authorial ominous narration beyond Blueprint evidence.
...
## Forecast Outgoing
- projected End Turn: Leila finds medical continuity metadata relevant to protagonist's Act2 event.
...
1. Episode Card — exact EP307 Blueprint selector; A-Plot/Want/End Turn authority.
2. Immediate Continuity — prior realized CONTINUITY-FROZEN + this forecast selector; never future guessed Actual.
3. POV/Relationship — POV=ordinary claimant/successor 2; relationship line + current role/relationship graph, active core <=3.
4. World/Zone/Material — Zone=civic/household setting; current world/material/location router, branch=H-B.
