...
source_snapshot: router=CTX-V3-EP079; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT2-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-2C
- beat: BEAT-V3-B11
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT2-v0.1.md selector `EP079`
- branch: H-A
- concurrency: ACT2_LEDGER
- Current-lived namespace remains H-A; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP078: End Turn=an unofficial access shortcut is discovered in use by a small group. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=assess damage after someone uses the legacy shortcut. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: anger at the shortcut users risks becoming moral blame; Gideon redirects him to current failure mechanics.
...
- zone: L-G edge
- projected world pressure: reasonable desperation can amplify risk.
...
- Source-owned institutional/world pressure: reasonable desperation can amplify risk. Relationship/institution interface: anger at the shortcut users risks becoming moral blame; Gideon redirects him to current failure mechanics.
...
- source clue: L-G legacy pocket enters as physical hazard, not secret lore.
...
- classification=SOURCE_DEFINED. Source clue=L-G legacy pocket enters as physical hazard, not secret lore. Outgoing selector=first pressure alarm trips across a second boundary. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: finds load/pressure transient has reached the heat-weakened interface; immediate risk rises sharply. Immediate Want: assess damage after someone uses the legacy shortcut. Act guard: Disaster/concurrency first. Resolve ACT2_LEDGER geography/time before scene execution; do not explain the branch mechanism. EP094 ends H-A current-lived state.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: finds load/pressure transient has reached the heat-weakened interface; immediate risk rises sharply.
- exact Immediate Want: assess damage after someone uses the legacy shortcut.
- exact End Turn: first pressure alarm trips across a second boundary.
...
## Forecast Outgoing
- projected End Turn: first pressure alarm trips across a second boundary.
...
1. Episode Card — exact EP079 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=L-G edge; current world/material/location router, branch=H-A.
