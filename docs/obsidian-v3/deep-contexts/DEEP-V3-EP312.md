...
beat: BEAT-V3-B43
concurrency: NONE
source_snapshot: router=CTX-V3-EP312; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT7-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-7C
- beat: BEAT-V3-B43
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT7-v0.1.md selector `EP312`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP311: End Turn=the oversized address structure now demands physical explanation. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=estimate what the address namespace is actually indexing. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: protagonist resists naming `parallel universes` as fact; asks for physical load corroboration.
...
- projected world pressure: scale becomes engineering question.
...
- Source-owned institutional/world pressure: scale becomes engineering question. Relationship/institution interface: protagonist resists naming `parallel universes` as fact; asks for physical load corroboration.
...
- source clue: D08 FINAL PAYOFF sequence begins.
...
- classification=PAYOFF. Source clue=D08 FINAL PAYOFF sequence begins. Outgoing selector=protected maintenance map contains repeated microscopic/distributed anchor terminology. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: simple person/room/document/version models fail by orders of structural depth even without exact count. Immediate Want: estimate what the address namespace is actually indexing. Act guard: Action/evidence before ontology. Every explanatory beat must be earned by a concrete decision, cost, failed model, or operational consequence.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: simple person/room/document/version models fail by orders of structural depth even without exact count.
- exact Immediate Want: estimate what the address namespace is actually indexing.
- exact End Turn: protected maintenance map contains repeated microscopic/distributed anchor terminology.
...
## Forecast Outgoing
- projected End Turn: protected maintenance map contains repeated microscopic/distributed anchor terminology.
...
1. Episode Card — exact EP312 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=Old Works / registry-maintenance interface; current world/material/location router, branch=H-B.
