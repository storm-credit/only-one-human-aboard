...
beat: BEAT-V3-B47
concurrency: NONE
source_snapshot: router=CTX-V3-EP343; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT8-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-8B
- beat: BEAT-V3-B47
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT8-v0.1.md selector `EP343`
- branch: H-B
- concurrency: NONE
...
- projected relationship line: family disagreement centers on risk, not philosophical identity.
...
- projected world pressure: rights crisis is operational and immediate.
...
- Source-owned institutional/world pressure: rights crisis is operational and immediate. Relationship/institution interface: family disagreement centers on risk, not philosophical identity.
...
- source clue: D09 CONCRETE PAYOFF case begins.
...
- classification=PAYOFF. Source clue=D09 CONCRETE PAYOFF case begins. Outgoing selector=one family member has no counterpart/source identity outside this lineage. No authorial ominous narration beyond Blueprint evidence.
...
## Forecast Outgoing
- projected End Turn: one family member has no counterpart/source identity outside this lineage.
...
1. Episode Card — exact EP343 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=lived-lineage civic/home context via authorized interface; current world/material/location router, branch=H-B.
