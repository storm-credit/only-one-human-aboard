...
beat: BEAT-V3-B27
concurrency: NONE
source_snapshot: router=CTX-V3-EP193; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT5-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-5A
- beat: BEAT-V3-B27
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT5-v0.1.md selector `EP193`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP192: End Turn=Registry Worker flags impossible person/death references in the old batch. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=understand why structural/casualty record includes people not linked to any H-B disaster. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: protagonist recognizes one surname/person-network familiar from current life.
...
- projected world pressure: history anomaly enters kinship/legal domain.
...
- Source-owned institutional/world pressure: history anomaly enters kinship/legal domain. Relationship/institution interface: protagonist recognizes one surname/person-network familiar from current life.
...
- source clue: death/identity contradiction PLANT.
...
- classification=PLANT. Source clue=death/identity contradiction PLANT. Outgoing selector=registry specialist refuses broad export because records include living persons. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: sees names/status transitions that cannot all fit current family/civic history. Immediate Want: understand why structural/casualty record includes people not linked to any H-B disaster. Act guard: Keep Arun current-life separation explicit and hold HUMAN meaning behind the reveal fence; do not collapse identity into explanation.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: sees names/status transitions that cannot all fit current family/civic history.
- exact Immediate Want: understand why structural/casualty record includes people not linked to any H-B disaster.
- exact End Turn: registry specialist refuses broad export because records include living persons.
...
## Forecast Outgoing
- projected End Turn: registry specialist refuses broad export because records include living persons.
...
1. Episode Card — exact EP193 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=Central registry interface; current world/material/location router, branch=H-B.
