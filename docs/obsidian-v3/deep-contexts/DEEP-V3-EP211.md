...
beat: BEAT-V3-B29
concurrency: NONE
source_snapshot: router=CTX-V3-EP211; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT5-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-5B
- beat: BEAT-V3-B29
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT5-v0.1.md selector `EP211`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP210: End Turn=provided record points toward a deeper administrative classification chain unrelated to his personal case. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=integrate the encounter without calling H-B Arun a resurrection. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: first grief movement not based on restoring past.
...
- projected world pressure: series death rule emotional proof.
...
- Source-owned institutional/world pressure: series death rule emotional proof. Relationship/institution interface: first grief movement not based on restoring past.
...
- source clue: counterpart != resurrection PAYOFF.
...
- classification=PAYOFF. Source clue=counterpart != resurrection PAYOFF. Outgoing selector=Hana asks protagonist to examine a technical field attached to legacy preservation records. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: behaviorally accepts that his H-A Arun remains lost even while current Arun lives. Immediate Want: integrate the encounter without calling H-B Arun a resurrection. Act guard: Keep Arun current-life separation explicit and hold HUMAN meaning behind the reveal fence; do not collapse identity into explanation.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: behaviorally accepts that his H-A Arun remains lost even while current Arun lives.
- exact Immediate Want: integrate the encounter without calling H-B Arun a resurrection.
- exact End Turn: Hana asks protagonist to examine a technical field attached to legacy preservation records.
...
## Forecast Outgoing
- projected End Turn: Hana asks protagonist to examine a technical field attached to legacy preservation records.
...
1. Episode Card — exact EP211 Blueprint selector; A-Plot/Want/End Turn authority.
