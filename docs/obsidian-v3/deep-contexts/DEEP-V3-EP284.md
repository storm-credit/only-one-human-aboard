...
beat: BEAT-V3-B39
concurrency: NONE
source_snapshot: router=CTX-V3-EP284; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT7-v0.1.md; mode=blueprint-compiled
...
---
# DEEP V3 EP284 — 왜 그렇게 만들었는지 모르는 규칙
...
- subact: SA-V3-7A
- beat: BEAT-V3-B39
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT7-v0.1.md selector `EP284`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP283: End Turn=an older inherited procedure proves unexpectedly relevant to the redesign. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=determine whether inherited rule is still technically justified. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: protagonist now tests inherited knowledge rather than worshipping it.
...
- projected world pressure: D05 becomes current practical problem.
...
- Source-owned institutional/world pressure: D05 becomes current practical problem. Relationship/institution interface: protagonist now tests inherited knowledge rather than worshipping it.
...
- source clue: Knowledge Without History TRIGGER.
...
- classification=SOURCE_DEFINED. Source clue=Knowledge Without History TRIGGER. Outgoing selector=Hana finds the same pattern in nonengineering policy. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: rule prevents one failure mode but includes extra restrictions nobody can trace to H-B history. Immediate Want: determine whether inherited rule is still technically justified. Act guard: Action/evidence before ontology. Every explanatory beat must be earned by a concrete decision, cost, failed model, or operational consequence.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: rule prevents one failure mode but includes extra restrictions nobody can trace to H-B history.
- exact Immediate Want: determine whether inherited rule is still technically justified.
- exact End Turn: Hana finds the same pattern in nonengineering policy.
...
## Forecast Outgoing
- projected End Turn: Hana finds the same pattern in nonengineering policy.
...
1. Episode Card — exact EP284 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=Old Works / civic standards; current world/material/location router, branch=H-B.
