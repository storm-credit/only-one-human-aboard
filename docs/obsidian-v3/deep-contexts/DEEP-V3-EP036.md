...
beat: BEAT-V3-B06
concurrency: NONE
source_snapshot: router=CTX-V3-EP036; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT1-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-1C
- beat: BEAT-V3-B06
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT1-v0.1.md selector `EP036`
- branch: H-A
- concurrency: NONE
- Current-lived namespace remains H-A; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP035: End Turn=routine trend review flags a cooling segment drifting outside its expected band. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=determine whether a small thermal drift requires shutdown. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: Niko pushes for immediate invasive check; protagonist chooses proportionate response.
...
- projected world pressure: maintenance backlog and risk prioritization.
...
- Source-owned institutional/world pressure: maintenance backlog and risk prioritization. Relationship/institution interface: Niko pushes for immediate invasive check; protagonist chooses proportionate response.
...
- source clue: Act2 cooling failure — PLANT.
...
- classification=PLANT. Source clue=Act2 cooling failure — PLANT. Outgoing selector=one inspection slot must be moved because of access scheduling. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: drift is within emergency tolerance but outside long-term trend; orders additional inspection, not alarm. Immediate Want: determine whether a small thermal drift requires shutdown. Act guard: Ordinary-world first. Do not objectively confirm regression, branching, substrate, or HUMAN:1; ordinary failures remain genuinely possible.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: drift is within emergency tolerance but outside long-term trend; orders additional inspection, not alarm.
- exact Immediate Want: determine whether a small thermal drift requires shutdown.
- exact End Turn: one inspection slot must be moved because of access scheduling.
...
## Forecast Outgoing
- projected End Turn: one inspection slot must be moved because of access scheduling.
...
1. Episode Card — exact EP036 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=Old Works / cooling distribution edge; current world/material/location router, branch=H-A.
