...
beat: BEAT-V3-B22
concurrency: NONE
source_snapshot: router=CTX-V3-EP154; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT4-v0.1.md; mode=blueprint-compiled
...
---
# DEEP V3 EP154 — 알고 있던 공격, 모르는 공격자
...
- subact: SA-V3-4B
- beat: BEAT-V3-B22
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT4-v0.1.md selector `EP154`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP153: End Turn=hostile action starts at an alternate access point. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=contain physical consequences of real sabotage/hostage event. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: protagonist cannot `solve` security side; follows Selene's constraints.
...
- projected world pressure: survival thriller local action.
...
- Source-owned institutional/world pressure: survival thriller local action. Relationship/institution interface: protagonist cannot `solve` security side; follows Selene's constraints.
...
- source clue: memory contains path fragments, not complete truth.
...
- classification=SOURCE_DEFINED. Source clue=memory contains path fragments, not complete truth. Outgoing selector=civilians become trapped in a location that should have been empty under prediction. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: uses technical familiarity but realizes the actual actor's route/motive is not in remembered prediction. Immediate Want: contain physical consequences of real sabotage/hostage event. Act guard: Prediction and social consequence before ontology. Evidence must change choices/relationships before any explanatory model hardens.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: uses technical familiarity but realizes the actual actor's route/motive is not in remembered prediction.
- exact Immediate Want: contain physical consequences of real sabotage/hostage event.
- exact End Turn: civilians become trapped in a location that should have been empty under prediction.
...
## Forecast Outgoing
- projected End Turn: civilians become trapped in a location that should have been empty under prediction.
...
1. Episode Card — exact EP154 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=infrastructure target; current world/material/location router, branch=H-B.
