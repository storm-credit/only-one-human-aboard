...
beat: BEAT-V3-B15
concurrency: NONE
source_snapshot: router=CTX-V3-EP108; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT3-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-3A
- beat: BEAT-V3-B15
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT3-v0.1.md selector `EP108`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP107: End Turn=one clinician asks whether his memories are only wrong about recent events or older relationships too. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=compare H-A memory against low-stakes personal history. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: discovers a family event occurred differently yet everyone involved treats H-B version as normal.
...
- projected world pressure: divergence reaches private life.
...
- Source-owned institutional/world pressure: divergence reaches private life. Relationship/institution interface: discovers a family event occurred differently yet everyone involved treats H-B version as normal.
...
- source clue: `같은 세계를 내가 바꿨다` explanation no longer sufficient.
...
- classification=SOURCE_DEFINED. Source clue=`같은 세계를 내가 바꿨다` explanation no longer sufficient. Outgoing selector=he decides Mira is the one person whose shared past he must confront directly. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: checks ordinary photos/messages/work records rather than cosmic databases; some match, some differ in small ways. Immediate Want: compare H-A memory against low-stakes personal history. Act guard: H-B is current-lived. H-A knowledge/state enters only through explicit memory/provenance; secondary characters retain independent causality.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: checks ordinary photos/messages/work records rather than cosmic databases; some match, some differ in small ways.
- exact Immediate Want: compare H-A memory against low-stakes personal history.
- exact End Turn: he decides Mira is the one person whose shared past he must confront directly.
...
## Forecast Outgoing
- projected End Turn: he decides Mira is the one person whose shared past he must confront directly.
...
1. Episode Card — exact EP108 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=Midring / private records; current world/material/location router, branch=H-B.
