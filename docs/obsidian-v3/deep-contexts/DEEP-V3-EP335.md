...
beat: BEAT-V3-B46
concurrency: NONE
source_snapshot: router=CTX-V3-EP335; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT8-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-8A
- beat: BEAT-V3-B46
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT8-v0.1.md selector `EP335`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP334: End Turn=older departure records indicate HUMAN count was not always 1. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=test whether exactly one Natural-Origin continuity was designed from launch. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: protagonist resists simple prophecy/design narrative.
...
- projected world pressure: historical attrition becomes investigation.
...
- Source-owned institutional/world pressure: historical attrition becomes investigation. Relationship/institution interface: protagonist resists simple prophecy/design narrative.
...
- source clue: D07 TRIGGER begins.
...
- classification=SOURCE_DEFINED. Source clue=D07 TRIGGER begins. Outgoing selector=one departure inventory fragment gives a plural HUMAN class. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: current records are consistent with long-term one, but gaps/old capacity maps imply a larger original preservation distribution. Immediate Want: test whether exactly one Natural-Origin continuity was designed from launch. Act guard: HUMAN provenance is not personhood. HUMAN:1 must remain de-collectified and must not become a collectible-character family or sacred merchandise target.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: current records are consistent with long-term one, but gaps/old capacity maps imply a larger original preservation distribution.
- exact Immediate Want: test whether exactly one Natural-Origin continuity was designed from launch.
- exact End Turn: one departure inventory fragment gives a plural HUMAN class.
...
## Forecast Outgoing
- projected End Turn: one departure inventory fragment gives a plural HUMAN class.
...
1. Episode Card — exact EP335 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=archive/technical provenance; current world/material/location router, branch=H-B.
