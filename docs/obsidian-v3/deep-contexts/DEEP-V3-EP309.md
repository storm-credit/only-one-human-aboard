...
beat: BEAT-V3-B42
concurrency: NONE
source_snapshot: router=CTX-V3-EP309; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT7-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-7B
- beat: BEAT-V3-B42
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT7-v0.1.md selector `EP309`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP308: End Turn=the destination binding still makes no sense. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.
...
- projected relationship line: protagonist cannot use medicine to prove he is `the same soul`.
...
- projected world pressure: death stakes preserved.
...
- Source-owned institutional/world pressure: death stakes preserved. Relationship/institution interface: protagonist cannot use medicine to prove he is `the same soul`.
...
- classification=REINFORCE. Source clue=D02/D09 REINFORCE. Outgoing selector=Registry Worker locates the destination-binding record family. No authorial ominous narration beyond Blueprint evidence.
...
## Forecast Outgoing
- projected End Turn: Registry Worker locates the destination-binding record family.
...
1. Episode Card — exact EP309 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=Med-University / continuity evidence review; current world/material/location router, branch=H-B.
