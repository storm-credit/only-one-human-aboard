...
source_snapshot: router=CTX-V3-EP232; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT6-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-6A
- beat: BEAT-V3-B32
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT6-v0.1.md selector `EP232`
- branch: H-B
- concurrency: ACT6_LEDGER
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP231: End Turn=Midring community networks start bulk-buying/organizing around delays. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=prevent deferred maintenance from creating a hidden safety cascade. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: he refuses a district representative's request to declare their zone technically `most important`.
...
- projected world pressure: geography affects scarcity without caste logic.
...
- Source-owned institutional/world pressure: geography affects scarcity without caste logic. Relationship/institution interface: he refuses a district representative's request to declare their zone technically `most important`.
...
- source clue: physical resource limits REINFORCE.
...
- classification=REINFORCE. Source clue=physical resource limits REINFORCE. Outgoing selector=theft/diversion accusations begin around scarce parts. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: sees centralized-service dependence make Rim interruptions worse than older mixed zones; recommends rotating protection windows rather than one permanent priority. Immediate Want: prevent deferred maintenance from creating a hidden safety cascade. Act guard: Resolve ACT6_LEDGER concurrency/resource/network state before execution; causality must remain distributed across people and institutions.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: sees centralized-service dependence make Rim interruptions worse than older mixed zones; recommends rotating protection windows rather than one permanent priority.
- exact Immediate Want: prevent deferred maintenance from creating a hidden safety cascade.
- exact End Turn: theft/diversion accusations begin around scarce parts.
...
## Forecast Outgoing
- projected End Turn: theft/diversion accusations begin around scarce parts.
...
1. Episode Card — exact EP232 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=Old Works / Rim interface; current world/material/location router, branch=H-B.
