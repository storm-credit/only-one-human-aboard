...
source_snapshot: router=CTX-V3-EP256; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT6-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-6B
- beat: BEAT-V3-B35
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT6-v0.1.md selector `EP256`
- branch: H-B
- concurrency: ACT6_LEDGER
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP255: End Turn=Leila argues for an exception on a different patient. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=restore a local service without becoming bargaining chip for one network. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: resentment grows at his insistence on technical neutrality.
...
- projected world pressure: infrastructure becomes political leverage.
...
- Source-owned institutional/world pressure: infrastructure becomes political leverage. Relationship/institution interface: resentment grows at his insistence on technical neutrality.
...
- classification=SOURCE_DEFINED. Source clue=B36 setup. Outgoing selector=hospital requests an exception from a resource rule. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: crew access is blocked until allocation grievance is addressed; protagonist must negotiate process, not decide policy. Immediate Want: restore a local service without becoming bargaining chip for one network. Act guard: Resolve ACT6_LEDGER concurrency/resource/network state before execution; causality must remain distributed across people and institutions.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: crew access is blocked until allocation grievance is addressed; protagonist must negotiate process, not decide policy.
- exact Immediate Want: restore a local service without becoming bargaining chip for one network.
- exact End Turn: hospital requests an exception from a resource rule.
...
## Forecast Outgoing
- projected End Turn: hospital requests an exception from a resource rule.
...
1. Episode Card — exact EP256 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=Old Works / Midring boundary; current world/material/location router, branch=H-B.
