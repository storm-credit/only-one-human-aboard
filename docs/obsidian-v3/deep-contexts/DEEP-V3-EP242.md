...
source_snapshot: router=CTX-V3-EP242; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT6-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-6A
- beat: BEAT-V3-B33
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT6-v0.1.md selector `EP242`
- branch: H-B
- concurrency: ACT6_LEDGER
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP241: End Turn=school/family transport shortage worsens. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=schedule inspection around reduced transport and staffing. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: control flaw is pressured; he cannot supervise every job.
...
- projected world pressure: reduced mobility degrades maintenance quality indirectly.
...
- Source-owned institutional/world pressure: reduced mobility degrades maintenance quality indirectly. Relationship/institution interface: control flaw is pressured; he cannot supervise every job.
...
- classification=NONE. Source clue=NONE. Outgoing selector=ordinary families begin self-organizing travel. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: technical team cannot all arrive simultaneously; protagonist must delegate a measurement to another crew and accept delayed certainty. Immediate Want: schedule inspection around reduced transport and staffing. Act guard: Resolve ACT6_LEDGER concurrency/resource/network state before execution; causality must remain distributed across people and institutions.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: technical team cannot all arrive simultaneously; protagonist must delegate a measurement to another crew and accept delayed certainty.
- exact Immediate Want: schedule inspection around reduced transport and staffing.
- exact End Turn: ordinary families begin self-organizing travel.
...
## Forecast Outgoing
- projected End Turn: ordinary families begin self-organizing travel.
...
1. Episode Card — exact EP242 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=Old Works / Midring; current world/material/location router, branch=H-B.
