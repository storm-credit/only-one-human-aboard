...
beat: BEAT-V3-B43
concurrency: NONE
source_snapshot: router=CTX-V3-EP316; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT7-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-7C
- beat: BEAT-V3-B43
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT7-v0.1.md selector `EP316`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP315: End Turn=some deep-lineage records include births/families/institutions, not just test agents. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=determine whether high-depth lineages are merely simulations without persons. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: Act6 H-B suffering becomes the emotional comparison; he refuses `가짜였나` framing.
...
- projected world pressure: D3 lived civilization category becomes necessary inference.
...
- Source-owned institutional/world pressure: D3 lived civilization category becomes necessary inference. Relationship/institution interface: Act6 H-B suffering becomes the emotional comparison; he refuses `가짜였나` framing.
...
- classification=SOURCE_DEFINED. Source clue=D08/D09 TRIGGER. Outgoing selector=Sora asks who authorized creation/termination of these lives. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: encounters operational traces impossible to reduce to abstract forecasts—long-lived relationships, births, institutions, local history and continuity resource protections. Immediate Want: determine whether high-depth lineages are merely simulations without persons. Act guard: Action/evidence before ontology. Every explanatory beat must be earned by a concrete decision, cost, failed model, or operational consequence.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: encounters operational traces impossible to reduce to abstract forecasts—long-lived relationships, births, institutions, local history and continuity resource protections.
- exact Immediate Want: determine whether high-depth lineages are merely simulations without persons.
- exact End Turn: Sora asks who authorized creation/termination of these lives.
...
## Forecast Outgoing
- projected End Turn: Sora asks who authorized creation/termination of these lives.
...
1. Episode Card — exact EP316 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=archive/technical evidence; current world/material/location router, branch=H-B.
