...
beat: BEAT-V3-B52
concurrency: NONE
source_snapshot: router=CTX-V3-EP382; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT9-v0.1.md; mode=blueprint-compiled
...
---
# DEEP V3 EP382 — 먼저 도착한 사람이 주인이 아니다
...
- subact: SA-V3-9A
- beat: BEAT-V3-B52
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT9-v0.1.md selector `EP382`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP381: End Turn=one operational bottleneck tempts administrators to prioritize H-B automatically. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=stop a practical shortcut that would convert first deployment into political ownership. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: protagonist refuses symbolic founder status for himself/close allies.
...
- projected world pressure: first presence ≠ sovereignty.
...
- Source-owned institutional/world pressure: first presence ≠ sovereignty. Relationship/institution interface: protagonist refuses symbolic founder status for himself/close allies.
...
- source clue: D10 settlement meaning PAYOFF.
...
- classification=PAYOFF. Source clue=D10 settlement meaning PAYOFF. Outgoing selector=local operations need an independent reserve plan for communication/power loss. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: contributes evidence that early location/installation sequence reflects engineering constraints, not civic rank; affected groups negotiate temporary use rights. Immediate Want: stop a practical shortcut that would convert first deployment into political ownership. Act guard: Descendant completion and return/payoff outrank novelty. No rerun/new ontology by default; EP406-410 add no major mystery and close through consequence/return.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: contributes evidence that early location/installation sequence reflects engineering constraints, not civic rank; affected groups negotiate temporary use rights.
- exact Immediate Want: stop a practical shortcut that would convert first deployment into political ownership.
- exact End Turn: local operations need an independent reserve plan for communication/power loss.
...
## Forecast Outgoing
- projected End Turn: local operations need an independent reserve plan for communication/power loss.
...
1. Episode Card — exact EP382 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=resource allocation; current world/material/location router, branch=H-B.
