...
beat: BEAT-V3-B24
concurrency: NONE
source_snapshot: router=CTX-V3-EP166; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT4-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-4C
- beat: BEAT-V3-B24
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT4-v0.1.md selector `EP166`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP165: End Turn=Ivo insists another event happened that protagonist remembers differently too. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=compare Ivo's memories to H-A/H-B/Act3 claimant evidence. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: protagonist resists treating Ivo's confidence as authority.
...
- projected world pressure: multiple incompatible lived-history hypothesis strengthens.
...
- Source-owned institutional/world pressure: multiple incompatible lived-history hypothesis strengthens. Relationship/institution interface: protagonist resists treating Ivo's confidence as authority.
...
- source clue: Ivo genuine-case TRIGGER.
...
- classification=SOURCE_DEFINED. Source clue=Ivo genuine-case TRIGGER. Outgoing selector=one Ivo detail is testable and high-risk if public. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: finds overlap plus contradiction; Ivo is not simply sharing protagonist's past. Immediate Want: compare Ivo's memories to H-A/H-B/Act3 claimant evidence. Act guard: Prediction and social consequence before ontology. Evidence must change choices/relationships before any explanatory model hardens.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: finds overlap plus contradiction; Ivo is not simply sharing protagonist's past.
- exact Immediate Want: compare Ivo's memories to H-A/H-B/Act3 claimant evidence.
- exact End Turn: one Ivo detail is testable and high-risk if public.
...
## Forecast Outgoing
- projected End Turn: one Ivo detail is testable and high-risk if public.
...
1. Episode Card — exact EP166 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=controlled interview / evidence route; current world/material/location router, branch=H-B.
