...
source_snapshot: router=CTX-V3-EP085; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT2-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-2C
- beat: BEAT-V3-B12
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT2-v0.1.md selector `EP085`
- branch: H-A
- concurrency: ACT2_LEDGER
- Current-lived namespace remains H-A; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP084: End Turn=Selene executes the closure plan. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=verify the boundary holds and find any remaining technical rescue option. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: protagonist rejects praise from one responder because he knows who was left unreachable.
...
- zone: L-A
- projected world pressure: immediate lives saved and lost are both concrete.
...
- Source-owned institutional/world pressure: immediate lives saved and lost are both concrete. Relationship/institution interface: protagonist rejects praise from one responder because he knows who was left unreachable.
...
- source clue: Arun personal history begins explicit reveal through triggered recollection/context.
...
- classification=SOURCE_DEFINED. Source clue=Arun personal history begins explicit reveal through triggered recollection/context. Outgoing selector=cut to people affected beyond his view. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: closure prevents larger cascade; residual access options are gone or too dangerous. Immediate Want: verify the boundary holds and find any remaining technical rescue option. Act guard: Disaster/concurrency first. Resolve ACT2_LEDGER geography/time before scene execution; do not explain the branch mechanism. EP094 ends H-A current-lived state.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: closure prevents larger cascade; residual access options are gone or too dangerous.
- exact Immediate Want: verify the boundary holds and find any remaining technical rescue option.
- exact End Turn: cut to people affected beyond his view.
...
## Forecast Outgoing
- projected End Turn: cut to people affected beyond his view.
...
1. Episode Card — exact EP085 Blueprint selector; A-Plot/Want/End Turn authority.
