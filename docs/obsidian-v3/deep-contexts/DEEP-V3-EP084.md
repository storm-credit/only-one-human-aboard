...
source_snapshot: router=CTX-V3-EP084; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT2-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-2C
- beat: BEAT-V3-B12
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT2-v0.1.md selector `EP084`
- branch: H-A
- concurrency: ACT2_LEDGER
- Current-lived namespace remains H-A; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP083: End Turn=rescue window ends with people still unreachable. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=give the least-wrong structural recommendation. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: he does not say `I decide`; Selene owns command, but he cannot evade responsibility for the evidence he provides.
...
- zone: L-A/L-D
- projected world pressure: irreversible technical recommendation.
...
- Source-owned institutional/world pressure: irreversible technical recommendation. Relationship/institution interface: he does not say `I decide`; Selene owns command, but he cannot evade responsibility for the evidence he provides.
...
- source clue: Arun parallel TRIGGER.
...
- classification=SOURCE_DEFINED. Source clue=Arun parallel TRIGGER. Outgoing selector=Selene executes the closure plan. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: recommends sealing/isolation of the compromised boundary after the rescue window, knowing some people cannot be reached. Immediate Want: give the least-wrong structural recommendation. Act guard: Disaster/concurrency first. Resolve ACT2_LEDGER geography/time before scene execution; do not explain the branch mechanism. EP094 ends H-A current-lived state.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: recommends sealing/isolation of the compromised boundary after the rescue window, knowing some people cannot be reached.
- exact Immediate Want: give the least-wrong structural recommendation.
- exact End Turn: Selene executes the closure plan.
...
## Forecast Outgoing
- projected End Turn: Selene executes the closure plan.
...
1. Episode Card — exact EP084 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=L-A/L-D; current world/material/location router, branch=H-A.
