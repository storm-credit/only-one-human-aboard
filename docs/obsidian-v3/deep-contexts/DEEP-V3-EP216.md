...
beat: BEAT-V3-B30
concurrency: NONE
source_snapshot: router=CTX-V3-EP216; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT5-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-5C
- beat: BEAT-V3-B30
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT5-v0.1.md selector `EP216`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP215: End Turn=physical maintenance references suggest the field corresponds to something actually preserved, not mere metadata. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=see whether `HUMAN` field maps to a physical maintenance load. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: his job gives physical inference, not access rights.
...
- projected world pressure: deep preservation chain seed.
...
- Source-owned institutional/world pressure: deep preservation chain seed. Relationship/institution interface: his job gives physical inference, not access rights.
...
- source clue: HUMAN physicality REINFORCE; no biological definition.
...
- classification=REINFORCE. Source clue=HUMAN physicality REINFORCE; no biological definition. Outgoing selector=Mira reports public rumor of `one real human` beginning to spread through misread leaks. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: finds indirect power/maintenance/protection routes that bypass ordinary civic services, but cannot locate endpoint. Immediate Want: see whether `HUMAN` field maps to a physical maintenance load. Act guard: Keep Arun current-life separation explicit and hold HUMAN meaning behind the reveal fence; do not collapse identity into explanation.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: finds indirect power/maintenance/protection routes that bypass ordinary civic services, but cannot locate endpoint.
- exact Immediate Want: see whether `HUMAN` field maps to a physical maintenance load.
- exact End Turn: Mira reports public rumor of `one real human` beginning to spread through misread leaks.
...
## Forecast Outgoing
- projected End Turn: Mira reports public rumor of `one real human` beginning to spread through misread leaks.
...
1. Episode Card — exact EP216 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=Old Works / preservation-support infrastructure interface; current world/material/location router, branch=H-B.
