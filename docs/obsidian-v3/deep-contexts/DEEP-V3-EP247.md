...
source_snapshot: router=CTX-V3-EP247; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT6-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-6B
- beat: BEAT-V3-B34
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT6-v0.1.md selector `EP247`
- branch: H-B
- concurrency: ACT6_LEDGER
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP246: End Turn=security sweeps delay a legitimate community shipment. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=resist pressure for a reopening certificate he cannot support. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: some workers/residents blame him for prolonged scarcity; Gideon backs process but not every conclusion.
...
- projected world pressure: technical refusal has social cost.
...
- Source-owned institutional/world pressure: technical refusal has social cost. Relationship/institution interface: some workers/residents blame him for prolonged scarcity; Gideon backs process but not every conclusion.
...
- source clue: protagonist Act6 irreversible-line preparation.
...
- classification=SOURCE_DEFINED. Source clue=protagonist Act6 irreversible-line preparation. Outgoing selector=Sora investigates whether sabotage justified broader restrictions. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: refuses certification and provides the exact physical failure mode rather than moral argument. Immediate Want: resist pressure for a reopening certificate he cannot support. Act guard: Resolve ACT6_LEDGER concurrency/resource/network state before execution; causality must remain distributed across people and institutions.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: refuses certification and provides the exact physical failure mode rather than moral argument.
- exact Immediate Want: resist pressure for a reopening certificate he cannot support.
- exact End Turn: Sora investigates whether sabotage justified broader restrictions.
...
## Forecast Outgoing
- projected End Turn: Sora investigates whether sabotage justified broader restrictions.
...
1. Episode Card — exact EP247 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=Old Works / facility support; current world/material/location router, branch=H-B.
