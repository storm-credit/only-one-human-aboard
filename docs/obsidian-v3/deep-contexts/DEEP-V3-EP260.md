...
source_snapshot: router=CTX-V3-EP260; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT6-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-6B
- beat: BEAT-V3-B35
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT6-v0.1.md selector `EP260`
- branch: H-B
- concurrency: ACT6_LEDGER
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP259: End Turn=workaround helps immediately but changes load elsewhere. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: Gideon
- OFF-POV / INFLUENCE_ONLY_UNLESS_BLUEPRINT_EXPLICIT. Gideon owns the episode's lived decision line. Do not reroute success, discovery, or emotional resolution through the protagonist merely for centrality.

## Character Context
- active_core_cap: max 3 salient characters including POV.
- projected_active_core: Gideon, Niko
...
- projected relationship line: Gideon gives Niko formal credit and responsibility, surprising protagonist.
...
- zone: Old Works
- projected world pressure: caution can enable change, not only delay it.
...
- Source-owned institutional/world pressure: caution can enable change, not only delay it. Relationship/institution interface: Gideon gives Niko formal credit and responsibility, surprising protagonist.
...
- classification=NONE. Source clue=NONE. Outgoing selector=broader high-capacity path approaches a politically forced restart decision. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: finds most of it sound and one hidden system interaction dangerous; preserves useful method while ordering correction. Immediate Want: evaluate Niko's workaround fairly rather than defend senior authority. Act guard: Resolve ACT6_LEDGER concurrency/resource/network state before execution; causality must remain distributed across people and institutions.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: finds most of it sound and one hidden system interaction dangerous; preserves useful method while ordering correction.
- exact Immediate Want: evaluate Niko's workaround fairly rather than defend senior authority.
- exact End Turn: broader high-capacity path approaches a politically forced restart decision.
...
## Forecast Outgoing
- projected End Turn: broader high-capacity path approaches a politically forced restart decision.
...
1. Episode Card — exact EP260 Blueprint selector; A-Plot/Want/End Turn authority.
2. Immediate Continuity — prior realized CONTINUITY-FROZEN + this forecast selector; never future guessed Actual.
3. POV/Relationship — POV=Gideon; relationship line + current role/relationship graph, active core <=3.
