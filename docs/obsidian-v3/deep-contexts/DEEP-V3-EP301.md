...
beat: BEAT-V3-B41
concurrency: NONE
source_snapshot: router=CTX-V3-EP301; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT7-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-7B
- beat: BEAT-V3-B41
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT7-v0.1.md selector `EP301`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP300: End Turn=Arun possesses a current-life reason to help inspect one old incident source. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: Arun H-B
- OFF-POV / INFLUENCE_ONLY_UNLESS_BLUEPRINT_EXPLICIT. Arun H-B owns the episode's lived decision line. Do not reroute success, discovery, or emotional resolution through the protagonist merely for centrality.
...
- projected relationship line: demonstrates agency independent of alternate selves.
...
- projected world pressure: same face does not imply transferable duty.
...
- Source-owned institutional/world pressure: same face does not imply transferable duty. Relationship/institution interface: demonstrates agency independent of alternate selves.
...
- source clue: D01 FINAL PAYOFF: protagonist's guilt is real to H-A but not universal history.
...
- classification=PAYOFF. Source clue=D01 FINAL PAYOFF: protagonist's guilt is real to H-A but not universal history. Outgoing selector=their evidence points to an identity/continuity registry collision. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: chooses bounded cooperation because the infrastructure/personhood issue affects current people, not because protagonist needs closure. Immediate Want: decide how much of his current life to risk for an investigation born from other versions of him. Act guard: Action/evidence before ontology. Every explanatory beat must be earned by a concrete decision, cost, failed model, or operational consequence.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: chooses bounded cooperation because the infrastructure/personhood issue affects current people, not because protagonist needs closure.
- exact Immediate Want: decide how much of his current life to risk for an investigation born from other versions of him.
- exact End Turn: their evidence points to an identity/continuity registry collision.
...
## Forecast Outgoing
- projected End Turn: their evidence points to an identity/continuity registry collision.
...
1. Episode Card — exact EP301 Blueprint selector; A-Plot/Want/End Turn authority.
2. Immediate Continuity — prior realized CONTINUITY-FROZEN + this forecast selector; never future guessed Actual.
3. POV/Relationship — POV=Arun H-B; relationship line + current role/relationship graph, active core <=3.
4. World/Zone/Material — Zone=current work/home / evidence route; current world/material/location router, branch=H-B.
