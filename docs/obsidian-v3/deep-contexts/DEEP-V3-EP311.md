...
beat: BEAT-V3-B42
concurrency: NONE
source_snapshot: router=CTX-V3-EP311; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT7-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-7B
- beat: BEAT-V3-B42
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT7-v0.1.md selector `EP311`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP310: End Turn=registry structure contains far more address depth than a few alternate worlds would require. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: Registry Worker
- OFF-POV / INFLUENCE_ONLY_UNLESS_BLUEPRINT_EXPLICIT. Registry Worker owns the episode's lived decision line. Do not reroute success, discovery, or emotional resolution through the protagonist merely for centrality.

## Character Context
- active_core_cap: max 3 salient characters including POV.
- projected_active_core: Registry Worker
...
- projected relationship line: worker refuses administrative convenience of collapsing people into one identity.
...
- projected world pressure: small-multiverse/original-world assumption weakens institutionally.
...
- Source-owned institutional/world pressure: small-multiverse/original-world assumption weakens institutionally. Relationship/institution interface: worker refuses administrative convenience of collapsing people into one identity.
...
- source clue: D08 TRIGGER complete; D02 FINAL PAYOFF: protagonist's Act2 was rare misbinding, no time reversal.
...
- classification=PAYOFF. Source clue=D08 TRIGGER complete; D02 FINAL PAYOFF: protagonist's Act2 was rare misbinding, no time reversal. Outgoing selector=the oversized address structure now demands physical explanation. No authorial ominous narration beyond Blueprint evidence.
...
- exact End Turn: the oversized address structure now demands physical explanation.
...
## Forecast Outgoing
- projected End Turn: the oversized address structure now demands physical explanation.
...
1. Episode Card — exact EP311 Blueprint selector; A-Plot/Want/End Turn authority.
2. Immediate Continuity — prior realized CONTINUITY-FROZEN + this forecast selector; never future guessed Actual.
3. POV/Relationship — POV=Registry Worker; relationship line + current role/relationship graph, active core <=3.
4. World/Zone/Material — Zone=continuity/identity registry; current world/material/location router, branch=H-B.
