...
source_snapshot: router=CTX-V3-EP090; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT2-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-2D
- beat: BEAT-V3-B12
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT2-v0.1.md selector `EP090`
- branch: H-A
- concurrency: ACT2_LEDGER
- Current-lived namespace remains H-A; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP089: End Turn=staged utility/transport restoration starts. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=certify one limited movement route. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: short Mira/Selene contact shows each has changed relationship to him after the decision.
...
- zone: L-A → L-B edge
- projected world pressure: visible recovery creates relief without erasing loss.
...
- Source-owned institutional/world pressure: visible recovery creates relief without erasing loss. Relationship/institution interface: short Mira/Selene contact shows each has changed relationship to him after the decision.
...
- classification=NONE. Source clue=NONE. Outgoing selector=a small service irregularity appears outside the local failure model. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: completes a narrow safety signoff; sees evacuees/responders physically moving again. Immediate Want: certify one limited movement route. Act guard: Disaster/concurrency first. Resolve ACT2_LEDGER geography/time before scene execution; do not explain the branch mechanism. EP094 ends H-A current-lived state.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: completes a narrow safety signoff; sees evacuees/responders physically moving again.
- exact Immediate Want: certify one limited movement route.
- exact End Turn: a small service irregularity appears outside the local failure model.
...
## Forecast Outgoing
- projected End Turn: a small service irregularity appears outside the local failure model.
...
1. Episode Card — exact EP090 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=L-A → L-B edge; current world/material/location router, branch=H-A.
