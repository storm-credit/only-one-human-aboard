...
beat: BEAT-V3-B51
concurrency: NONE
source_snapshot: router=CTX-V3-EP372; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT9-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-9A
- beat: BEAT-V3-B51
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT9-v0.1.md selector `EP372`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP371: End Turn=first local environment readings differ slightly from model envelope. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=determine whether environmental deviations threaten structural/thermal margins. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: he explicitly cannot order deployment schedule alone.
...
- projected world pressure: external reality begins adding data no lived history perfectly owns.
...
- Source-owned institutional/world pressure: external reality begins adding data no lived history perfectly owns. Relationship/institution interface: he explicitly cannot order deployment schedule alone.
...
- source clue: Echo Outside/external uncertainty REINFORCE softly.
...
- classification=REINFORCE. Source clue=Echo Outside/external uncertainty REINFORCE softly. Outgoing selector=settlement capacity must be allocated before all infrastructure is ready. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: compares real degradation with modeled cases; most are manageable but material/thermal behavior has a small unmodeled coupling. Immediate Want: determine whether environmental deviations threaten structural/thermal margins. Act guard: Descendant completion and return/payoff outrank novelty. No rerun/new ontology by default; EP406-410 add no major mystery and close through consequence/return.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: compares real degradation with modeled cases; most are manageable but material/thermal behavior has a small unmodeled coupling.
- exact Immediate Want: determine whether environmental deviations threaten structural/thermal margins.
- exact End Turn: settlement capacity must be allocated before all infrastructure is ready.
...
## Forecast Outgoing
- projected End Turn: settlement capacity must be allocated before all infrastructure is ready.
...
1. Episode Card — exact EP372 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=deployment diagnostics / Outer Ark interface; current world/material/location router, branch=H-B.
