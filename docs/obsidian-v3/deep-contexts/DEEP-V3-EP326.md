...
beat: BEAT-V3-B44
concurrency: NONE
source_snapshot: router=CTX-V3-EP326; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT7-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-7C
- beat: BEAT-V3-B44
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT7-v0.1.md selector `EP326`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP325: End Turn=protagonist must make a similar current choice. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=decide whether any past state deserves restoration priority. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.

## Character Context
- active_core_cap: max 3 salient characters including POV.
- projected_active_core: [주인공/TBD], Mira, Arun
...
- projected relationship line: Mira/current family/Arun boundaries become accepted behaviorally.
...
- projected world pressure: protagonist arc crosses major threshold.
...
- Source-owned institutional/world pressure: protagonist arc crosses major threshold. Relationship/institution interface: Mira/current family/Arun boundaries become accepted behaviorally.
...
- source clue: one-original-world red herring FINAL PAYOFF.
...
- classification=PAYOFF. Source clue=one-original-world red herring FINAL PAYOFF. Outgoing selector=an immediate preservation/resource case requires society to decide whether a lived lineage can be treated as expendable. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: abandons search for a unique current original; chooses to protect present H-B people and threatened lived persons based on current continuity/rights, not resemblance to H-A. Immediate Want: decide whether any past state deserves restoration priority. Act guard: Action/evidence before ontology. Every explanatory beat must be earned by a concrete decision, cost, failed model, or operational consequence.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: abandons search for a unique current original; chooses to protect present H-B people and threatened lived persons based on current continuity/rights, not resemblance to H-A.
- exact Immediate Want: decide whether any past state deserves restoration priority.
- exact End Turn: an immediate preservation/resource case requires society to decide whether a lived lineage can be treated as expendable.
...
## Forecast Outgoing
- projected End Turn: an immediate preservation/resource case requires society to decide whether a lived lineage can be treated as expendable.
...
1. Episode Card — exact EP326 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=Midring/Old Works; current world/material/location router, branch=H-B.
