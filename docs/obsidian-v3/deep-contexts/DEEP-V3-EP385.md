...
beat: BEAT-V3-B53
concurrency: NONE
source_snapshot: router=CTX-V3-EP385; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT9-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-9B
- beat: BEAT-V3-B53
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT9-v0.1.md selector `EP385`
- branch: H-B
- concurrency: NONE
...
- OFF-POV / INFLUENCE_ONLY_UNLESS_BLUEPRINT_EXPLICIT. technical deployment role 2 owns the episode's lived decision line. Do not reroute success, discovery, or emotional resolution through the protagonist merely for centrality.

## Character Context
- active_core_cap: max 3 salient characters including POV.
- projected_active_core: technical deployment role 2
...
- projected relationship line: reports before forcing a reboot; credibility rests on seeded role.
...
- projected world pressure: real outside condition hits settlement.
...
- Source-owned institutional/world pressure: real outside condition hits settlement. Relationship/institution interface: reports before forcing a reboot; credibility rests on seeded role.
...
- source clue: D11 TRIGGER begins.
...
- classification=SOURCE_DEFINED. Source clue=D11 TRIGGER begins. Outgoing selector=several synchronized nodes enter protective mode while one unsynchronized node remains stable. No authorial ominous narration beyond Blueprint evidence.
...
## Forecast Outgoing
- projected End Turn: several synchronized nodes enter protective mode while one unsynchronized node remains stable.
...
1. Episode Card — exact EP385 Blueprint selector; A-Plot/Want/End Turn authority.
2. Immediate Continuity — prior realized CONTINUITY-FROZEN + this forecast selector; never future guessed Actual.
3. POV/Relationship — POV=technical deployment role 2; relationship line + current role/relationship graph, active core <=3.
