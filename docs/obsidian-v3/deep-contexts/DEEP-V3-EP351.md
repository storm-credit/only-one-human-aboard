...
beat: BEAT-V3-B48
concurrency: NONE
source_snapshot: router=CTX-V3-EP351; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT8-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-8B
- beat: BEAT-V3-B48
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT8-v0.1.md selector `EP351`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP350: End Turn=formal review must choose immediate procedure. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=understand the old doctrine well enough to know what must change now. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: he sees why past designers/operators might have thought it defensible without endorsing current use.
...
- projected world pressure: historical ethical drift, not original-villain retcon.
...
- Source-owned institutional/world pressure: historical ethical drift, not original-villain retcon. Relationship/institution interface: he sees why past designers/operators might have thought it defensible without endorsing current use.
...
- classification=REINFORCE. Source clue=D09 REINFORCE. Outgoing selector=current law lacks a clean category for lineage-level consent. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: reconstructs its original rationale: shallow/short related branches were treated as one continuity of learning; depth later outgrew the legal assumption. Immediate Want: understand the old doctrine well enough to know what must change now. Act guard: HUMAN provenance is not personhood. HUMAN:1 must remain de-collectified and must not become a collectible-character family or sacred merchandise target.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: reconstructs its original rationale: shallow/short related branches were treated as one continuity of learning; depth later outgrew the legal assumption.
- exact Immediate Want: understand the old doctrine well enough to know what must change now.
- exact End Turn: current law lacks a clean category for lineage-level consent.
...
## Forecast Outgoing
- projected End Turn: current law lacks a clean category for lineage-level consent.
...
1. Episode Card — exact EP351 Blueprint selector; A-Plot/Want/End Turn authority.
