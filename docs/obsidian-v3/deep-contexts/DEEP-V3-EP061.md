...
source_snapshot: router=CTX-V3-EP061; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT2-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-2B
- beat: BEAT-V3-B09
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT2-v0.1.md selector `EP061`
- branch: H-A
- concurrency: ACT2_LEDGER
- Current-lived namespace remains H-A; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP060: End Turn=security hold blocks a route Selene wants for response staging. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=recover access to inspect the materially inconsistent junction. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: Sora refuses informal access but gives a logged technical window after evidence capture.
...
- zone: L-A
- projected world pressure: security and engineering can cooperate without one absorbing the other.
...
- Source-owned institutional/world pressure: security and engineering can cooperate without one absorbing the other. Relationship/institution interface: Sora refuses informal access but gives a logged technical window after evidence capture.
...
- source clue: D03 separate from sabotage line.
...
- classification=SOURCE_DEFINED. Source clue=D03 separate from sabotage line. Outgoing selector=Selene demands immediate route release for a medical movement. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: argues that bypass evidence and old repair chronology are distinct; cannot prove they share cause. Immediate Want: recover access to inspect the materially inconsistent junction. Act guard: Disaster/concurrency first. Resolve ACT2_LEDGER geography/time before scene execution; do not explain the branch mechanism. EP094 ends H-A current-lived state.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: argues that bypass evidence and old repair chronology are distinct; cannot prove they share cause.
- exact Immediate Want: recover access to inspect the materially inconsistent junction.
- exact End Turn: Selene demands immediate route release for a medical movement.
...
## Forecast Outgoing
- projected End Turn: Selene demands immediate route release for a medical movement.
...
1. Episode Card — exact EP061 Blueprint selector; A-Plot/Want/End Turn authority.
