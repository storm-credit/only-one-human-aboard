...
beat: BEAT-V3-B52
concurrency: NONE
source_snapshot: router=CTX-V3-EP384; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT9-v0.1.md; mode=blueprint-compiled
...
---
# DEEP V3 EP384 — 독립하기 전에 연습하지 않는 것
...
- subact: SA-V3-9A
- beat: BEAT-V3-B52
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT9-v0.1.md selector `EP384`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP383: End Turn=one real environmental pattern causes small synchronization/noise anomalies. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=decide whether to launch a new fully lived rehearsal for the uncertain external hazard envelope. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: this is a concrete application of Act8 norm, with admitted loss of certainty.
...
- projected world pressure: irreversible-future rule begins before crisis.
...
- Source-owned institutional/world pressure: irreversible-future rule begins before crisis. Relationship/institution interface: this is a concrete application of Act8 norm, with admitted loss of certainty.
...
- source clue: final `no retry through people` principle TRIGGER.
...
## Genre Engine
- Execution engine: rejects creating an involuntary D3 crisis civilization; teams use non-conscious modeling + existing historical lessons + physical testing instead. Immediate Want: decide whether to launch a new fully lived rehearsal for the uncertain external hazard envelope. Act guard: Descendant completion and return/payoff outrank novelty. No rerun/new ontology by default; EP406-410 add no major mystery and close through consequence/return.
...
1. Episode Card — exact EP384 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=Ark/settlement technical planning; current world/material/location router, branch=H-B.
