...
beat: BEAT-V3-B16
concurrency: NONE
source_snapshot: router=CTX-V3-EP110; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT3-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-3B
- beat: BEAT-V3-B16
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT3-v0.1.md selector `EP110`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP109: End Turn=Mira asks why he is behaving as if she owes him a relationship she does not remember. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.
...
- projected relationship line: Mira accepts he may sincerely remember something but refuses that sincerity as a claim on her current life.
...
- zone: Midring
- projected world pressure: personal testimony has no automatic legal/social authority.
...
- Source-owned institutional/world pressure: personal testimony has no automatic legal/social authority. Relationship/institution interface: Mira accepts he may sincerely remember something but refuses that sincerity as a claim on her current life.
...
- source clue: other-history relationship theme PLANT.
...
- classification=PLANT. Source clue=other-history relationship theme PLANT. Outgoing selector=protagonist tries a private detail he believes only H-A Mira could know. No authorial ominous narration beyond Blueprint evidence.
...
## Forecast Outgoing
- projected End Turn: protagonist tries a private detail he believes only H-A Mira could know.
...
1. Episode Card — exact EP110 Blueprint selector; A-Plot/Want/End Turn authority.
