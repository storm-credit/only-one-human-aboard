...
beat: BEAT-V3-B23
concurrency: NONE
source_snapshot: router=CTX-V3-EP163; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT4-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-4B
- beat: BEAT-V3-B23
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT4-v0.1.md selector `EP163`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP162: End Turn=Sora finds the original fragment source was earlier than the public rumor ecosystem. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.
...
- projected relationship line: Sora is forced to treat genuine anomaly as a possibility without declaring mechanism.
...
- projected world pressure: rare cases are buried inside noise.
...
- Source-owned institutional/world pressure: rare cases are buried inside noise. Relationship/institution interface: Sora is forced to treat genuine anomaly as a possibility without declaring mechanism.
...
- classification=PLANT. Source clue=Ivo-path PLANT. Outgoing selector=the person has made other claims—some wrong, some disturbingly specific. No authorial ominous narration beyond Blueprint evidence.
...
- exact End Turn: the person has made other claims—some wrong, some disturbingly specific.
...
## Forecast Outgoing
- projected End Turn: the person has made other claims—some wrong, some disturbingly specific.
...
1. Episode Card — exact EP163 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=records/investigation; current world/material/location router, branch=H-B.
