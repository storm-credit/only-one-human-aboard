...
source_snapshot: router=CTX-V3-EP069; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT2-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-2B
- beat: BEAT-V3-B10
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT2-v0.1.md selector `EP069`
- branch: H-A
- concurrency: ACT2_LEDGER
- Current-lived namespace remains H-A; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP068: End Turn=protagonist finally has a short off-duty window. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=contact family and sleep. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: family asks him not to turn himself into the only responsible person; he does not fully accept it.
...
- projected world pressure: fatigue, food, charging, temporary shelter routines.
...
- Source-owned institutional/world pressure: fatigue, food, charging, temporary shelter routines. Relationship/institution interface: family asks him not to turn himself into the only responsible person; he does not fully accept it.
...
- classification=NONE. Source clue=NONE. Outgoing selector=a new destructive-inspection result arrives before he sleeps. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: family is safe but inconvenienced; protagonist hears how closures affect ordinary routines he has not seen. Immediate Want: contact family and sleep. Act guard: Disaster/concurrency first. Resolve ACT2_LEDGER geography/time before scene execution; do not explain the branch mechanism. EP094 ends H-A current-lived state.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: family is safe but inconvenienced; protagonist hears how closures affect ordinary routines he has not seen.
- exact Immediate Want: contact family and sleep.
- exact End Turn: a new destructive-inspection result arrives before he sleeps.
...
## Forecast Outgoing
- projected End Turn: a new destructive-inspection result arrives before he sleeps.
...
1. Episode Card — exact EP069 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=responder rest area; current world/material/location router, branch=H-A.
