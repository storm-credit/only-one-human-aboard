...
source_snapshot: router=CTX-V3-EP074; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT2-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-2B
- beat: BEAT-V3-B10
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT2-v0.1.md selector `EP074`
- branch: H-A
- concurrency: ACT2_LEDGER
- Current-lived namespace remains H-A; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP073: End Turn=Mira/Juno conflict over distribution escalates. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.
...
- projected relationship line: Mira↔Juno tension + trust deepen.
...
- projected world pressure: formal/informal systems combine under scarcity.
...
- Source-owned institutional/world pressure: formal/informal systems combine under scarcity. Relationship/institution interface: Mira↔Juno tension + trust deepen.
...
- classification=NONE. Source clue=NONE. Outgoing selector=provisional route-reopening proposal arrives from operations/political pressure. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: uses Juno's household knowledge but refuses to hand Juno unilateral priority control; creates a mixed list/route. Immediate Want: deliver limited supplies without creating an insider-only network. Act guard: Disaster/concurrency first. Resolve ACT2_LEDGER geography/time before scene execution; do not explain the branch mechanism. EP094 ends H-A current-lived state.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: uses Juno's household knowledge but refuses to hand Juno unilateral priority control; creates a mixed list/route.
- exact Immediate Want: deliver limited supplies without creating an insider-only network.
- exact End Turn: provisional route-reopening proposal arrives from operations/political pressure.
...
## Forecast Outgoing
- projected End Turn: provisional route-reopening proposal arrives from operations/political pressure.
...
1. Episode Card — exact EP074 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=L-B / remote L-C coordination; current world/material/location router, branch=H-A.
