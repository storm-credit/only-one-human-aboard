...
beat: BEAT-V3-B25
concurrency: NONE
source_snapshot: router=CTX-V3-EP175; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT4-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-4C
- beat: BEAT-V3-B25
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT4-v0.1.md selector `EP175`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP174: End Turn=released information corroborates a second incompatible history artifact. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.
...
- projected relationship line: protagonist/Sora collaborate while Ivo/Cassian remain separate people, not a team.
...
- projected world pressure: incompatible-history hypothesis becomes credible.
...
- Source-owned institutional/world pressure: incompatible-history hypothesis becomes credible. Relationship/institution interface: protagonist/Sora collaborate while Ivo/Cassian remain separate people, not a team.
...
- source clue: multiple lived histories REINFORCE.
...
- classification=REINFORCE. Source clue=multiple lived histories REINFORCE. Outgoing selector=a physical/cultural artifact offers an independent route. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: two evidence chains support histories that cannot both be H-B and do not match each other fully. Immediate Want: compare Ivo/Cassian evidence without assuming one is correct. Act guard: Prediction and social consequence before ontology. Evidence must change choices/relationships before any explanatory model hardens.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: two evidence chains support histories that cannot both be H-B and do not match each other fully.
- exact Immediate Want: compare Ivo/Cassian evidence without assuming one is correct.
- exact End Turn: a physical/cultural artifact offers an independent route.
...
## Forecast Outgoing
- projected End Turn: a physical/cultural artifact offers an independent route.
...
1. Episode Card — exact EP175 Blueprint selector; A-Plot/Want/End Turn authority.
