...
source_snapshot: router=CTX-V3-EP059; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT2-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-2B
- beat: BEAT-V3-B09
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT2-v0.1.md selector `EP059`
- branch: H-A
- concurrency: ACT2_LEDGER
- Current-lived namespace remains H-A; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP058: End Turn=rumor arrives that the accident may have been deliberate. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=understand a safety interlock state that does not match failure sequence. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: protagonist wants technical access preserved; security is called because evidence is now criminally relevant.
...
- projected world pressure: ordinary workflow violations can become serious under disaster.
...
- Source-owned institutional/world pressure: ordinary workflow violations can become serious under disaster. Relationship/institution interface: protagonist wants technical access preserved; security is called because evidence is now criminally relevant.
...
- source clue: sabotage red herring — TRIGGER with real underlying wrongdoing.
...
- classification=SOURCE_DEFINED. Source clue=sabotage red herring — TRIGGER with real underlying wrongdoing. Outgoing selector=Sora freezes one access chain. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: finds an unauthorized bypass/falsified completion marker. It likely worsened propagation but did not initiate the cooling rupture. Immediate Want: understand a safety interlock state that does not match failure sequence. Act guard: Disaster/concurrency first. Resolve ACT2_LEDGER geography/time before scene execution; do not explain the branch mechanism. EP094 ends H-A current-lived state.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: finds an unauthorized bypass/falsified completion marker. It likely worsened propagation but did not initiate the cooling rupture.
- exact Immediate Want: understand a safety interlock state that does not match failure sequence.
- exact End Turn: Sora freezes one access chain.
...
## Forecast Outgoing
- projected End Turn: Sora freezes one access chain.
...
1. Episode Card — exact EP059 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=L-A service-control point; current world/material/location router, branch=H-A.
