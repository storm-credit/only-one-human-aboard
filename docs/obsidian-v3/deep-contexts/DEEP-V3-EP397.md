...
beat: BEAT-V3-B54
concurrency: NONE
source_snapshot: router=CTX-V3-EP397; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT9-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-9B
- beat: BEAT-V3-B54
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT9-v0.1.md selector `EP397`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP396: End Turn=the unsynchronized seed node becomes the only stable bridge for staged recovery. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=determine why one node survived better. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: protagonist gives the worker operational authority to scale the method rather than taking over.
...
- projected world pressure: emergent non-core action materially shapes final survival.
...
- Source-owned institutional/world pressure: emergent non-core action materially shapes final survival. Relationship/institution interface: protagonist gives the worker operational authority to scale the method rather than taking over.
...
- source clue: final emergent-actor payoff.
...
- classification=PAYOFF. Source clue=final emergent-actor payoff. Outgoing selector=recovery still requires coordinated operations across lineages/locations. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: traces survival to the settlement worker's earlier decision to keep commissioning asynchronous until local checks completed—not foresight, just good local practice. Immediate Want: determine why one node survived better. Act guard: Descendant completion and return/payoff outrank novelty. No rerun/new ontology by default; EP406-410 add no major mystery and close through consequence/return.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: traces survival to the settlement worker's earlier decision to keep commissioning asynchronous until local checks completed—not foresight, just good local practice.
- exact Immediate Want: determine why one node survived better.
- exact End Turn: recovery still requires coordinated operations across lineages/locations.
...
## Forecast Outgoing
- projected End Turn: recovery still requires coordinated operations across lineages/locations.
...
1. Episode Card — exact EP397 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=seed node / operations; current world/material/location router, branch=H-B.
