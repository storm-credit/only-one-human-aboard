...
source_snapshot: router=CTX-V3-EP245; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT6-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-6B
- beat: BEAT-V3-B34
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT6-v0.1.md selector `EP245`
- branch: H-B
- concurrency: ACT6_LEDGER
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP244: End Turn=rolling outages become less predictable and emergency policy begins hardening. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=assess a strategic fabrication/power-support system officials want restored quickly. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: public/managerial patience with technical caution is thinning.
...
- zone: Old Works
- projected world pressure: emergency pressure reaches engineering signoff.
...
- Source-owned institutional/world pressure: emergency pressure reaches engineering signoff. Relationship/institution interface: public/managerial patience with technical caution is thinning.
...
- source clue: high-capacity path risk REINFORCE.
...
- classification=REINFORCE. Source clue=high-capacity path risk REINFORCE. Outgoing selector=a strategic facility suffers obstruction/sabotage during the delay. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: finds operation possible only within narrowing safety margin; requests further inspection. Immediate Want: assess a strategic fabrication/power-support system officials want restored quickly. Act guard: Resolve ACT6_LEDGER concurrency/resource/network state before execution; causality must remain distributed across people and institutions.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: finds operation possible only within narrowing safety margin; requests further inspection.
- exact Immediate Want: assess a strategic fabrication/power-support system officials want restored quickly.
- exact End Turn: a strategic facility suffers obstruction/sabotage during the delay.
...
## Forecast Outgoing
- projected End Turn: a strategic facility suffers obstruction/sabotage during the delay.
...
1. Episode Card — exact EP245 Blueprint selector; A-Plot/Want/End Turn authority.
