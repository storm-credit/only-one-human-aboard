...
source_snapshot: router=CTX-V3-EP236; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT6-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-6A
- beat: BEAT-V3-B32
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT6-v0.1.md selector `EP236`
- branch: H-B
- concurrency: ACT6_LEDGER
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP235: End Turn=security reports parts theft is real but not centrally organized. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.
...
- projected relationship line: pressure from officials/public for a simple enemy begins.
...
- projected world pressure: collapse remains multi-causal.
...
- Source-owned institutional/world pressure: collapse remains multi-causal. Relationship/institution interface: pressure from officials/public for a simple enemy begins.
...
- classification=NONE. Source clue=NONE. Outgoing selector=Transfer Belt congestion forces a dispatcher to improvise next week. No authorial ominous narration beyond Blueprint evidence.
...
## Forecast Outgoing
- projected End Turn: Transfer Belt congestion forces a dispatcher to improvise next week.
...
1. Episode Card — exact EP236 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=Civic Core / distributed investigation; current world/material/location router, branch=H-B.
