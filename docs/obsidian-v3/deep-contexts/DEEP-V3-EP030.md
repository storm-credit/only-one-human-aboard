...
beat: BEAT-V3-B05
concurrency: NONE
source_snapshot: router=CTX-V3-EP030; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT1-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-1C
- beat: BEAT-V3-B05
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT1-v0.1.md selector `EP030`
- branch: H-A
- concurrency: NONE
- Current-lived namespace remains H-A; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP029: End Turn=paperwork says the impossible layer should never have been installed there. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=decide whether the mismatch is counterfeit material, mislabeling or unsafe hidden repair. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.

## Character Context
- active_core_cap: max 3 salient characters including POV.
- projected_active_core: [주인공/TBD], Gideon
...
- projected relationship line: protagonist requests Gideon's independent review instead of protecting his own theory.
...
- zone: Old Works
- projected world pressure: safety review can shut down production access.
...
- Source-owned institutional/world pressure: safety review can shut down production access. Relationship/institution interface: protagonist requests Gideon's independent review instead of protecting his own theory.
...
- classification=REINFORCE. Source clue=D03 REINFORCE. Outgoing selector=Gideon takes the evidence away rather than agreeing immediately. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: wear pattern indicates the layer has been present longer than the recorded retrofit. Immediate Want: decide whether the mismatch is counterfeit material, mislabeling or unsafe hidden repair. Act guard: Ordinary-world first. Do not objectively confirm regression, branching, substrate, or HUMAN:1; ordinary failures remain genuinely possible.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: wear pattern indicates the layer has been present longer than the recorded retrofit.
- exact Immediate Want: decide whether the mismatch is counterfeit material, mislabeling or unsafe hidden repair.
- exact End Turn: Gideon takes the evidence away rather than agreeing immediately.
...
## Forecast Outgoing
- projected End Turn: Gideon takes the evidence away rather than agreeing immediately.
...
1. Episode Card — exact EP030 Blueprint selector; A-Plot/Want/End Turn authority.
