...
beat: BEAT-V3-B40
concurrency: NONE
source_snapshot: router=CTX-V3-EP295; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT7-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-7A
- beat: BEAT-V3-B40
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT7-v0.1.md selector `EP295`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP294: End Turn=Leila reports a continuity/identity case where `same person` assumptions are causing immediate harm. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.
...
- projected relationship line: current family/claimant tensions matter more than theory.
...
- zone: Med-University
- projected world pressure: counterpart/personhood problem becomes operational.
...
- Source-owned institutional/world pressure: counterpart/personhood problem becomes operational. Relationship/institution interface: current family/claimant tensions matter more than theory.
...
- source clue: D09 setup + D01/D04 social consequence.
...
- classification=SOURCE_DEFINED. Source clue=D09 setup + D01/D04 social consequence. Outgoing selector=protagonist recognizes the case resembles how he treated Arun. No authorial ominous narration beyond Blueprint evidence.
...
## Forecast Outgoing
- projected End Turn: protagonist recognizes the case resembles how he treated Arun.
...
1. Episode Card — exact EP295 Blueprint selector; A-Plot/Want/End Turn authority.
