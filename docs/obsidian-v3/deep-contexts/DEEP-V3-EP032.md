...
beat: BEAT-V3-B05
concurrency: NONE
source_snapshot: router=CTX-V3-EP032; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT1-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-1C
- beat: BEAT-V3-B05
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT1-v0.1.md selector `EP032`
- branch: H-A
- concurrency: NONE
- Current-lived namespace remains H-A; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP031: End Turn=one old identifier points to a retired access registry. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=map the retired identifier to a physical maintenance route. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: Sora/security compliance enters only to authorize restricted records, not join a mystery team.
...
- projected world pressure: access logging/privacy/safety boundaries.
...
- Source-owned institutional/world pressure: access logging/privacy/safety boundaries. Relationship/institution interface: Sora/security compliance enters only to authorize restricted records, not join a mystery team.
...
- source clue: D03 + future Uncountable Index very soft seed; no scale meaning.
...
- classification=SEED. Source clue=D03 + future Uncountable Index very soft seed; no scale meaning. Outgoing selector=route map and material location overlap imperfectly. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: identifier resolves to a decommissioned service classification but not a current route. Immediate Want: map the retired identifier to a physical maintenance route. Act guard: Ordinary-world first. Do not objectively confirm regression, branching, substrate, or HUMAN:1; ordinary failures remain genuinely possible.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: identifier resolves to a decommissioned service classification but not a current route.
- exact Immediate Want: map the retired identifier to a physical maintenance route.
- exact End Turn: route map and material location overlap imperfectly.
...
## Forecast Outgoing
- projected End Turn: route map and material location overlap imperfectly.
...
1. Episode Card — exact EP032 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=Old Works / local archive interface; current world/material/location router, branch=H-A.
