...
source_snapshot: router=CTX-V3-EP270; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT6-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-6C
- beat: BEAT-V3-B36
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT6-v0.1.md selector `EP270`
- branch: H-B
- concurrency: ACT6_LEDGER
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP269: End Turn=the cross-group route could be formalized if institutions/groups accept neutrality. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.
...
- projected relationship line: moves from defending his decision to accepting responsibility for its costs.
...
- projected world pressure: mystery inference from physical scarcity advances toward Act7.
...
- Source-owned institutional/world pressure: mystery inference from physical scarcity advances toward Act7. Relationship/institution interface: moves from defending his decision to accepting responsibility for its costs.
...
- source clue: hidden broader load REINFORCE.
...
- classification=REINFORCE. Source clue=hidden broader load REINFORCE. Outgoing selector=Mira/Juno/medical/security actors begin building a neutral corridor without him. No authorial ominous narration beyond Blueprint evidence.
...
## Forecast Outgoing
- projected End Turn: Mira/Juno/medical/security actors begin building a neutral corridor without him.
...
1. Episode Card — exact EP270 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=Old Works / recovery planning; current world/material/location router, branch=H-B.
