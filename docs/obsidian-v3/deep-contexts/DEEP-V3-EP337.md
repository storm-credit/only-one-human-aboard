...
beat: BEAT-V3-B46
concurrency: NONE
source_snapshot: router=CTX-V3-EP337; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT8-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-8A
- beat: BEAT-V3-B46
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT8-v0.1.md selector `EP337`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP336: End Turn=exact old count remains uncertain in damaged records, but clearly >1. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.
...
- projected relationship line: history includes designers/operators making imperfect triage choices, not one conspiracy.
...
- projected world pressure: `1` emerges over centuries.
...
- Source-owned institutional/world pressure: `1` emerges over centuries. Relationship/institution interface: history includes designers/operators making imperfect triage choices, not one conspiracy.
...
- source clue: D07 FINAL PAYOFF sequence.
...
- classification=PAYOFF. Source clue=D07 FINAL PAYOFF sequence. Outgoing selector=one major loss event intersects known Outer Ark physical history. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: identifies several real outer-ark loss eras, independent degradation and progressively stricter preservation priority as count fell. Immediate Want: reconstruct attrition chronology without inventing precise numbers from gaps. Act guard: HUMAN provenance is not personhood. HUMAN:1 must remain de-collectified and must not become a collectible-character family or sacred merchandise target.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: identifies several real outer-ark loss eras, independent degradation and progressively stricter preservation priority as count fell.
- exact Immediate Want: reconstruct attrition chronology without inventing precise numbers from gaps.
- exact End Turn: one major loss event intersects known Outer Ark physical history.
...
## Forecast Outgoing
- projected End Turn: one major loss event intersects known Outer Ark physical history.
...
1. Episode Card — exact EP337 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=departure/mission archive; current world/material/location router, branch=H-B.
