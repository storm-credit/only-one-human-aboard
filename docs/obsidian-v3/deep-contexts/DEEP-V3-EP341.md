...
beat: BEAT-V3-B46
concurrency: NONE
source_snapshot: router=CTX-V3-EP341; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT8-v0.1.md; mode=blueprint-compiled
...
---
# DEEP V3 EP341 — 모르는 사람을 기억할 수 없다
...
- subact: SA-V3-8A
- beat: BEAT-V3-B46
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT8-v0.1.md selector `EP341`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP340: End Turn=Ivo chooses how to interpret that absence himself. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=explain why lack of memory matters without mystifying HUMAN. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: current citizens' accumulated histories are not inferior to blank origin.
...
- projected world pressure: `no past` contrast established.
...
- Source-owned institutional/world pressure: `no past` contrast established. Relationship/institution interface: current citizens' accumulated histories are not inferior to blank origin.
...
- source clue: D06 emotional recontextualization.
...
- classification=SOURCE_DEFINED. Source clue=D06 emotional recontextualization. Outgoing selector=Ivo publicly retracts one speculative claim about the one. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: frames it narrowly: repeated-lineage memory residues concern lives that were lived; the protected continuity has not lived those histories. Immediate Want: explain why lack of memory matters without mystifying HUMAN. Act guard: HUMAN provenance is not personhood. HUMAN:1 must remain de-collectified and must not become a collectible-character family or sacred merchandise target.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: frames it narrowly: repeated-lineage memory residues concern lives that were lived; the protected continuity has not lived those histories.
- exact Immediate Want: explain why lack of memory matters without mystifying HUMAN.
- exact End Turn: Ivo publicly retracts one speculative claim about the one.
...
## Forecast Outgoing
- projected End Turn: Ivo publicly retracts one speculative claim about the one.
...
1. Episode Card — exact EP341 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=Midring / evidence aftermath; current world/material/location router, branch=H-B.
