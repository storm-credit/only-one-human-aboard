...
beat: BEAT-V3-B19
concurrency: NONE
source_snapshot: router=CTX-V3-EP135; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT3-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-3C
- beat: BEAT-V3-B19
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT3-v0.1.md selector `EP135`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP134: End Turn=protagonist realizes another claimant could become socially explosive if public. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=decide what to do with the evidence. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: trust with Sora/Leila becomes conditional collaboration.
...
- projected world pressure: institutions now possess a small anomaly file, not a secret truth department.
...
- Source-owned institutional/world pressure: institutions now possess a small anomaly file, not a secret truth department. Relationship/institution interface: trust with Sora/Leila becomes conditional collaboration.
...
- source clue: social consequences deferred.
...
- classification=SOURCE_DEFINED. Source clue=social consequences deferred. Outgoing selector=rumor nevertheless leaks through an ordinary channel. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: agrees to limited handling rather than public revelation because evidence proves inconsistency, not mechanism. Immediate Want: decide what to do with the evidence. Act guard: H-B is current-lived. H-A knowledge/state enters only through explicit memory/provenance; secondary characters retain independent causality.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: agrees to limited handling rather than public revelation because evidence proves inconsistency, not mechanism.
- exact Immediate Want: decide what to do with the evidence.
- exact End Turn: rumor nevertheless leaks through an ordinary channel.
...
## Forecast Outgoing
- projected End Turn: rumor nevertheless leaks through an ordinary channel.
...
1. Episode Card — exact EP135 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=Central/clinic/security interface; current world/material/location router, branch=H-B.
