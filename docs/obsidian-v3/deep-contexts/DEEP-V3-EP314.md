...
beat: BEAT-V3-B43
concurrency: NONE
source_snapshot: router=CTX-V3-EP314; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT7-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-7C
- beat: BEAT-V3-B43
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT7-v0.1.md selector `EP314`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP313: End Turn=load patterns imply different execution depths. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=explain why some indexed states consume dramatically different resources. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: protagonist explicitly rejects `그럼 전부 30만 명이 살아 있는 세계인가` because data do not support it.
...
- projected world pressure: astronomical breadth ≠ astronomical simultaneous conscious suffering.
...
- Source-owned institutional/world pressure: astronomical breadth ≠ astronomical simultaneous conscious suffering. Relationship/institution interface: protagonist explicitly rejects `그럼 전부 30만 명이 살아 있는 세계인가` because data do not support it.
...
- source clue: D08 key distinction REINFORCE.
...
- classification=REINFORCE. Source clue=D08 key distinction REINFORCE. Outgoing selector=Hana finds metadata associating deep states with social/continuity terms. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: infers tiers from usage behavior: many shallow/archival/predictive states, fewer deep interactive states, rare crisis-depth spikes. Immediate Want: explain why some indexed states consume dramatically different resources. Act guard: Action/evidence before ontology. Every explanatory beat must be earned by a concrete decision, cost, failed model, or operational consequence.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: infers tiers from usage behavior: many shallow/archival/predictive states, fewer deep interactive states, rare crisis-depth spikes.
- exact Immediate Want: explain why some indexed states consume dramatically different resources.
- exact End Turn: Hana finds metadata associating deep states with social/continuity terms.
...
## Forecast Outgoing
- projected End Turn: Hana finds metadata associating deep states with social/continuity terms.
...
1. Episode Card — exact EP314 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=technical analysis; current world/material/location router, branch=H-B.
