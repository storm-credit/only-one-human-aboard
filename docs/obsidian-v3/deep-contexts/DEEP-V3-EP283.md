...
beat: BEAT-V3-B39
concurrency: NONE
source_snapshot: router=CTX-V3-EP283; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT7-v0.1.md; mode=blueprint-compiled
...
---
# DEEP V3 EP283 — 고장 전으로 돌아갈 수 없는 것
...
- subact: SA-V3-7A
- beat: BEAT-V3-B39
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT7-v0.1.md selector `EP283`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP282: End Turn=Juno's network preserves a crisis practice nobody plans to undo. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=restore a damaged utility route to its pre-Act6 topology. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: Niko/Gideon observe his language/decision shift from restoration to adaptation.
...
- zone: Old Works
- projected world pressure: physical city itself moves forward.
...
- Source-owned institutional/world pressure: physical city itself moves forward. Relationship/institution interface: Niko/Gideon observe his language/decision shift from restoration to adaptation.
...
- source clue: protagonist arc embodied, no exposition.
...
- classification=SOURCE_DEFINED. Source clue=protagonist arc embodied, no exposition. Outgoing selector=an older inherited procedure proves unexpectedly relevant to the redesign. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: discovers new loads/settlements/social dependencies make exact restoration unsafe; designs a forward repair instead. Immediate Want: restore a damaged utility route to its pre-Act6 topology. Act guard: Action/evidence before ontology. Every explanatory beat must be earned by a concrete decision, cost, failed model, or operational consequence.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: discovers new loads/settlements/social dependencies make exact restoration unsafe; designs a forward repair instead.
- exact Immediate Want: restore a damaged utility route to its pre-Act6 topology.
- exact End Turn: an older inherited procedure proves unexpectedly relevant to the redesign.
...
## Forecast Outgoing
- projected End Turn: an older inherited procedure proves unexpectedly relevant to the redesign.
...
1. Episode Card — exact EP283 Blueprint selector; A-Plot/Want/End Turn authority.
