...
beat: BEAT-V3-B30
concurrency: NONE
source_snapshot: router=CTX-V3-EP220; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT5-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-5C
- beat: BEAT-V3-B30
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT5-v0.1.md selector `EP220`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP219: End Turn=deeper records confirm the count is current and actively maintained. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=establish whether `1` is historical artifact or live current state. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: Sora/Hana/protagonist agree only on narrow statement.
...
- projected world pressure: category is operationally real.
...
- Source-owned institutional/world pressure: category is operationally real. Relationship/institution interface: Sora/Hana/protagonist agree only on narrow statement.
...
- source clue: HUMAN:1 count — PARTIAL PAYOFF.
...
- classification=PAYOFF. Source clue=HUMAN:1 count — PARTIAL PAYOFF. Outgoing selector=question shifts from `is the 1 real?` to `what is HUMAN?` No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: independent records/maintenance signaling confirm it is a current count/state field. Immediate Want: establish whether `1` is historical artifact or live current state. Act guard: Keep Arun current-life separation explicit and hold HUMAN meaning behind the reveal fence; do not collapse identity into explanation.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: independent records/maintenance signaling confirm it is a current count/state field.
- exact Immediate Want: establish whether `1` is historical artifact or live current state.
- exact End Turn: question shifts from `is the 1 real?` to `what is HUMAN?`
...
## Forecast Outgoing
- projected End Turn: question shifts from `is the 1 real?` to `what is HUMAN?`
...
1. Episode Card — exact EP220 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=technical/archive verification; current world/material/location router, branch=H-B.
