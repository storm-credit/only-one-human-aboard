...
source_snapshot: router=CTX-V3-EP065; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT2-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-2B
- beat: BEAT-V3-B09
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT2-v0.1.md selector `EP065`
- branch: H-A
- concurrency: ACT2_LEDGER
- Current-lived namespace remains H-A; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP064: End Turn=public rumor turns `unauthorized bypass` into `terrorist attack` before facts are settled. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=keep technical team focused despite rumor and family concern. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.

## Character Context
- active_core_cap: max 3 salient characters including POV.
- projected_active_core: [주인공/TBD], Arun, family
...
- projected relationship line: family member asks whether he is staying because of old Arun guilt; he deflects.
...
- projected world pressure: media/social rumor affects behavior but not physical truth.
...
- Source-owned institutional/world pressure: media/social rumor affects behavior but not physical truth. Relationship/institution interface: family member asks whether he is staying because of old Arun guilt; he deflects.
...
- source clue: Arun emotional shadow REINFORCE.
...
- classification=REINFORCE. Source clue=Arun emotional shadow REINFORCE. Outgoing selector=Sora identifies the bypass motive as likely mundane productivity/workflow pressure. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: rejects a colleague's claim that every odd repair proves sabotage; updates family with only what he knows. Immediate Want: keep technical team focused despite rumor and family concern. Act guard: Disaster/concurrency first. Resolve ACT2_LEDGER geography/time before scene execution; do not explain the branch mechanism. EP094 ends H-A current-lived state.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: rejects a colleague's claim that every odd repair proves sabotage; updates family with only what he knows.
- exact Immediate Want: keep technical team focused despite rumor and family concern.
- exact End Turn: Sora identifies the bypass motive as likely mundane productivity/workflow pressure.
...
## Forecast Outgoing
- projected End Turn: Sora identifies the bypass motive as likely mundane productivity/workflow pressure.
...
1. Episode Card — exact EP065 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=L-A / short family contact; current world/material/location router, branch=H-A.
