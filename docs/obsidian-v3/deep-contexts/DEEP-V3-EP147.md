...
beat: BEAT-V3-B21
concurrency: NONE
source_snapshot: router=CTX-V3-EP147; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT4-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-4A
- beat: BEAT-V3-B21
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT4-v0.1.md selector `EP147`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP146: End Turn=another famous predictor announces a conflicting target. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: ordinary believer/fraud-victim lens
- OFF-POV / INFLUENCE_ONLY_UNLESS_BLUEPRINT_EXPLICIT. ordinary believer/fraud-victim lens owns the episode's lived decision line. Do not reroute success, discovery, or emotional resolution through the protagonist merely for centrality.

## Character Context
- active_core_cap: max 3 salient characters including POV.
- projected_active_core: ordinary believer/fraud-victim lens, family
...
- projected relationship line: family disagreement shows belief as social stress.
...
- zone: Midring
- projected world pressure: multiple claims cannot all be a single deterministic future.
...
- Source-owned institutional/world pressure: multiple claims cannot all be a single deterministic future. Relationship/institution interface: family disagreement shows belief as social stress.
...
- source clue: conflicting-foreknowledge social evidence.
...
- classification=SOURCE_DEFINED. Source clue=conflicting-foreknowledge social evidence. Outgoing selector=one claimant is exposed as buying leaked schedules. No authorial ominous narration beyond Blueprint evidence.
...
## Forecast Outgoing
- projected End Turn: one claimant is exposed as buying leaked schedules.
...
1. Episode Card — exact EP147 Blueprint selector; A-Plot/Want/End Turn authority.
2. Immediate Continuity — prior realized CONTINUITY-FROZEN + this forecast selector; never future guessed Actual.
3. POV/Relationship — POV=ordinary believer/fraud-victim lens; relationship line + current role/relationship graph, active core <=3.
