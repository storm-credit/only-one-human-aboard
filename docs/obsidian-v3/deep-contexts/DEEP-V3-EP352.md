...
beat: BEAT-V3-B48
concurrency: NONE
source_snapshot: router=CTX-V3-EP352; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT8-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-8B
- beat: BEAT-V3-B48
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT8-v0.1.md selector `EP352`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP351: End Turn=current law lacks a clean category for lineage-level consent. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.
...
- projected relationship line: Leila resists both technocratic and sentimental shortcuts.
...
- projected world pressure: rights require multiple scales.
...
- Source-owned institutional/world pressure: rights require multiple scales. Relationship/institution interface: Leila resists both technocratic and sentimental shortcuts.
...
- source clue: D09 institutional complexity.
...
- classification=SOURCE_DEFINED. Source clue=D09 institutional complexity. Outgoing selector=civic review proposes temporary trusteeship/representation mechanism. No authorial ominous narration beyond Blueprint evidence.
...
## Forecast Outgoing
- projected End Turn: civic review proposes temporary trusteeship/representation mechanism.
...
1. Episode Card — exact EP352 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=medical/rights review; current world/material/location router, branch=H-B.
