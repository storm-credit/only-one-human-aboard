...
source_snapshot: router=CTX-V3-EP044; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT2-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-2A
- beat: BEAT-V3-B07
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT2-v0.1.md selector `EP044`
- branch: H-A
- concurrency: ACT2_LEDGER
- Current-lived namespace remains H-A; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP043: End Turn=visible rupture is followed by a second alarm from an adjacent electrical path. | Continuity Output=T0 established.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=decide whether the rupture threatens surrounding structure. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: Niko wants to retrieve a trapped tool/worker marker; protagonist blocks him.
...
- zone: L-A
- projected world pressure: automated isolation begins closing service corridors.
...
- Source-owned institutional/world pressure: automated isolation begins closing service corridors. Relationship/institution interface: Niko wants to retrieve a trapped tool/worker marker; protagonist blocks him.
...
- source clue: D03 old repair-layer issue lightly echoes in exposed material.
...
- classification=SOURCE_DEFINED. Source clue=D03 old repair-layer issue lightly echoes in exposed material. Outgoing selector=first injured workers are reported beyond the closed corridor. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: identifies heat/coolant exposure beyond the visible break and refuses an immediate manual restart. Immediate Want: decide whether the rupture threatens surrounding structure. Act guard: Disaster/concurrency first. Resolve ACT2_LEDGER geography/time before scene execution; do not explain the branch mechanism. EP094 ends H-A current-lived state.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: identifies heat/coolant exposure beyond the visible break and refuses an immediate manual restart.
- exact Immediate Want: decide whether the rupture threatens surrounding structure.
- exact End Turn: first injured workers are reported beyond the closed corridor.
...
## Forecast Outgoing
- projected End Turn: first injured workers are reported beyond the closed corridor.
...
1. Episode Card — exact EP044 Blueprint selector; A-Plot/Want/End Turn authority.
