...
source_snapshot: router=CTX-V3-EP058; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT2-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-2A
- beat: BEAT-V3-B08
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT2-v0.1.md selector `EP058`
- branch: H-A
- concurrency: ACT2_LEDGER
- Current-lived namespace remains H-A; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP057: End Turn=Juno's venue is filling with stranded residents. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.
...
- projected_active_core: Mira, Juno
...
- projected relationship line: coordinates with Mira's network and stranded families; outsider/regular fairness tension begins.
...
- projected world pressure: informal mutual aid supplements institutions without replacing them.
...
- Source-owned institutional/world pressure: informal mutual aid supplements institutions without replacing them. Relationship/institution interface: coordinates with Mira's network and stranded families; outsider/regular fairness tension begins.
...
- classification=NONE. Source clue=NONE. Outgoing selector=rumor arrives that the accident may have been deliberate. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: turns normal business/community space into charging/info/waiting point, but refuses to claim official shelter authority. Immediate Want: keep the venue from becoming chaotic while power/transport are unstable. Act guard: Disaster/concurrency first. Resolve ACT2_LEDGER geography/time before scene execution; do not explain the branch mechanism. EP094 ends H-A current-lived state.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: turns normal business/community space into charging/info/waiting point, but refuses to claim official shelter authority.
- exact Immediate Want: keep the venue from becoming chaotic while power/transport are unstable.
- exact End Turn: rumor arrives that the accident may have been deliberate.
...
## Forecast Outgoing
- projected End Turn: rumor arrives that the accident may have been deliberate.
...
1. Episode Card — exact EP058 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=L-C Midring community venue; current world/material/location router, branch=H-A.
