...
beat: BEAT-V3-B17
concurrency: NONE
source_snapshot: router=CTX-V3-EP121; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT3-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-3B
- beat: BEAT-V3-B17
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT3-v0.1.md selector `EP121`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP120: End Turn=authorized detail points to a closed/ordinary location. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=test the claimant's one authorized detail without assuming truth. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: Sora is informed only if access/evidence requires it.
...
- projected world pressure: ordinary infrastructure can carry hidden-history evidence.
...
- Source-owned institutional/world pressure: ordinary infrastructure can carry hidden-history evidence. Relationship/institution interface: Sora is informed only if access/evidence requires it.
...
- source clue: independent case REINFORCE.
...
- classification=REINFORCE. Source clue=independent case REINFORCE. Outgoing selector=first check is ambiguous rather than miraculous. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: checks a physical feature/old service arrangement that should be impossible or absent under H-B records. Immediate Want: test the claimant's one authorized detail without assuming truth. Act guard: H-B is current-lived. H-A knowledge/state enters only through explicit memory/provenance; secondary characters retain independent causality.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: checks a physical feature/old service arrangement that should be impossible or absent under H-B records.
- exact Immediate Want: test the claimant's one authorized detail without assuming truth.
- exact End Turn: first check is ambiguous rather than miraculous.
...
## Forecast Outgoing
- projected End Turn: first check is ambiguous rather than miraculous.
...
1. Episode Card — exact EP121 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=ordinary service location; current world/material/location router, branch=H-B.
