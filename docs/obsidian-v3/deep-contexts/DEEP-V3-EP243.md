...
source_snapshot: router=CTX-V3-EP243; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT6-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-6A
- beat: BEAT-V3-B33
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT6-v0.1.md selector `EP243`
- branch: H-B
- concurrency: ACT6_LEDGER
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP242: End Turn=ordinary families begin self-organizing travel. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: ordinary parent/community lens
- OFF-POV / INFLUENCE_ONLY_UNLESS_BLUEPRINT_EXPLICIT. ordinary parent/community lens owns the episode's lived decision line. Do not reroute success, discovery, or emotional resolution through the protagonist merely for centrality.

## Character Context
- active_core_cap: max 3 salient characters including POV.
- projected_active_core: ordinary parent/community lens
...
- projected relationship line: a small trust relationship forms between households that normally would not meet.
...
- projected world pressure: scarcity changes daily life more than slogans do.
...
- Source-owned institutional/world pressure: scarcity changes daily life more than slogans do. Relationship/institution interface: a small trust relationship forms between households that normally would not meet.
...
- source clue: emergent chain social depth.
...
- classification=SOURCE_DEFINED. Source clue=emergent chain social depth. Outgoing selector=one practical workaround is copied by other blocks. No authorial ominous narration beyond Blueprint evidence.
...
## Forecast Outgoing
- projected End Turn: one practical workaround is copied by other blocks.
...
1. Episode Card — exact EP243 Blueprint selector; A-Plot/Want/End Turn authority.
2. Immediate Continuity — prior realized CONTINUITY-FROZEN + this forecast selector; never future guessed Actual.
3. POV/Relationship — POV=ordinary parent/community lens; relationship line + current role/relationship graph, active core <=3.
4. World/Zone/Material — Zone=Midring / school routes; current world/material/location router, branch=H-B.
