...
beat: BEAT-V3-B47
concurrency: NONE
source_snapshot: router=CTX-V3-EP345; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT8-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-8B
- beat: BEAT-V3-B47
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT8-v0.1.md selector `EP345`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP344: End Turn=branch-born child exposes source-ownership logic as incoherent. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: D3 rights-family adult B
- OFF-POV / INFLUENCE_ONLY_UNLESS_BLUEPRINT_EXPLICIT. D3 rights-family adult B owns the episode's lived decision line. Do not reroute success, discovery, or emotional resolution through the protagonist merely for centrality.

## Character Context
- active_core_cap: max 3 salient characters including POV.
- projected_active_core: D3 rights-family adult B, family
...
- projected relationship line: adults' rights arguments are also explicit and independent; child is not sole proof of personhood.
...
- projected world pressure: branch-born child = new person operational fact.
...
- Source-owned institutional/world pressure: branch-born child = new person operational fact. Relationship/institution interface: adults' rights arguments are also explicit and independent; child is not sole proof of personhood.
...
- classification=REINFORCE. Source clue=D09 REINFORCE. Outgoing selector=old doctrine treats lineage relation more like one continuity family than current citizens find acceptable. No authorial ominous narration beyond Blueprint evidence.
...
## Forecast Outgoing
- projected End Turn: old doctrine treats lineage relation more like one continuity family than current citizens find acceptable.
...
1. Episode Card — exact EP345 Blueprint selector; A-Plot/Want/End Turn authority.
2. Immediate Continuity — prior realized CONTINUITY-FROZEN + this forecast selector; never future guessed Actual.
3. POV/Relationship — POV=D3 rights-family adult B; relationship line + current role/relationship graph, active core <=3.
4. World/Zone/Material — Zone=family/current services; current world/material/location router, branch=H-B.
