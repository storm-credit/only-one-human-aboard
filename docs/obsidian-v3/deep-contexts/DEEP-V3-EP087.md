...
source_snapshot: router=CTX-V3-EP087; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT2-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-2C
- beat: BEAT-V3-B12
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT2-v0.1.md selector `EP087`
- branch: H-A
- concurrency: ACT2_LEDGER
- Current-lived namespace remains H-A; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP086: End Turn=protagonist later sees/hears part of this reaction. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.
...
- projected relationship line: Gideon/Niko know different amounts; no one delivers a therapy speech.
...
- projected world pressure: old accidents shaped professional culture and personal rules.
...
- Source-owned institutional/world pressure: old accidents shaped professional culture and personal rules. Relationship/institution interface: Gideon/Niko know different amounts; no one delivers a therapy speech.
...
- source clue: Arun device — major REINFORCE, still ordinary tragedy.
...
- classification=REINFORCE. Source clue=Arun device — major REINFORCE, still ordinary tragedy. Outgoing selector=new data suggest the present event's initiating cause can finally be closed. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: enough of Arun's old accident is revealed: young protagonist, cascade threat, Arun inside, sealed bulkhead, official death, lasting guilt. Immediate Want: keep functioning after the closure. Act guard: Disaster/concurrency first. Resolve ACT2_LEDGER geography/time before scene execution; do not explain the branch mechanism. EP094 ends H-A current-lived state.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: enough of Arun's old accident is revealed: young protagonist, cascade threat, Arun inside, sealed bulkhead, official death, lasting guilt.
- exact Immediate Want: keep functioning after the closure.
- exact End Turn: new data suggest the present event's initiating cause can finally be closed.
...
## Forecast Outgoing
- projected End Turn: new data suggest the present event's initiating cause can finally be closed.
...
1. Episode Card — exact EP087 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=responder rest/Old Works; current world/material/location router, branch=H-A.
