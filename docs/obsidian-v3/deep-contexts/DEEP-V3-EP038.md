...
beat: BEAT-V3-B06
concurrency: NONE
source_snapshot: router=CTX-V3-EP038; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT1-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-1C
- beat: BEAT-V3-B06
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT1-v0.1.md selector `EP038`
- branch: H-A
- concurrency: NONE
- Current-lived namespace remains H-A; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP037: End Turn=maintenance scheduler chooses which physical inspection moves first. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.
...
- projected relationship line: protagonist argues but accepts the final schedule after risk review.
...
- projected world pressure: ordinary institutional compromise can later matter without being sabotage.
...
- Source-owned institutional/world pressure: ordinary institutional compromise can later matter without being sabotage. Relationship/institution interface: protagonist argues but accepts the final schedule after risk review.
...
- source clue: Act2 schedule chain — PLANT.
...
- classification=PLANT. Source clue=Act2 schedule chain — PLANT. Outgoing selector=Transfer Belt announces route maintenance overlapping the new inspection window. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: scheduler shifts one low-priority segment, not the critical measurement, due labor/access collision. Decision is reasonable, not villainous negligence. Immediate Want: protect the higher-risk inspection slot. Act guard: Ordinary-world first. Do not objectively confirm regression, branching, substrate, or HUMAN:1; ordinary failures remain genuinely possible.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: scheduler shifts one low-priority segment, not the critical measurement, due labor/access collision. Decision is reasonable, not villainous negligence.
- exact Immediate Want: protect the higher-risk inspection slot.
- exact End Turn: Transfer Belt announces route maintenance overlapping the new inspection window.
...
## Forecast Outgoing
- projected End Turn: Transfer Belt announces route maintenance overlapping the new inspection window.
...
1. Episode Card — exact EP038 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=Old Works planning / field; current world/material/location router, branch=H-A.
