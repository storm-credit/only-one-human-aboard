...
beat: BEAT-V3-B47
concurrency: NONE
source_snapshot: router=CTX-V3-EP350; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT8-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-8B
- beat: BEAT-V3-B47
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT8-v0.1.md selector `EP350`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP349: End Turn=branch-born youth/child speaks or acts within family decision without becoming symbolic mascot. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: D3 rights-family branch-born youth/child lens
- OFF-POV / INFLUENCE_ONLY_UNLESS_BLUEPRINT_EXPLICIT. D3 rights-family branch-born youth/child lens owns the episode's lived decision line. Do not reroute success, discovery, or emotional resolution through the protagonist merely for centrality.

## Character Context
- active_core_cap: max 3 salient characters including POV.
- projected_active_core: D3 rights-family branch-born youth/child lens, family
...
- projected relationship line: family decision remains collective/contested.
...
- projected world pressure: lived history is felt at mundane scale.
...
- Source-owned institutional/world pressure: lived history is felt at mundane scale. Relationship/institution interface: family decision remains collective/contested.
...
- source clue: D09 emotional payoff, not sole legal basis.
...
- classification=PAYOFF. Source clue=D09 emotional payoff, not sole legal basis. Outgoing selector=formal review must choose immediate procedure. No authorial ominous narration beyond Blueprint evidence.
...
## Forecast Outgoing
- projected End Turn: formal review must choose immediate procedure.
...
1. Episode Card — exact EP350 Blueprint selector; A-Plot/Want/End Turn authority.
2. Immediate Continuity — prior realized CONTINUITY-FROZEN + this forecast selector; never future guessed Actual.
3. POV/Relationship — POV=D3 rights-family branch-born youth/child lens; relationship line + current role/relationship graph, active core <=3.
4. World/Zone/Material — Zone=ordinary family/home activity; current world/material/location router, branch=H-B.
