...
source_snapshot: router=CTX-V3-EP239; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT6-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-6A
- beat: BEAT-V3-B33
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT6-v0.1.md selector `EP239`
- branch: H-B
- concurrency: ACT6_LEDGER
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP238: End Turn=delayed residents/workers complain about allocation favoritism. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.
...
- projected relationship line: Mira↔Dispatcher respect begins without declaring heroism.
...
- zone: Transfer Belt
- projected world pressure: fairness and local optimization conflict.
...
- Source-owned institutional/world pressure: fairness and local optimization conflict. Relationship/institution interface: Mira↔Dispatcher respect begins without declaring heroism.
...
- source clue: emergent chain REINFORCE invisibly.
...
- classification=REINFORCE. Source clue=emergent chain REINFORCE invisibly. Outgoing selector=rerouted medical staff/supplies begin interacting with Juno's network. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: audit shows deviation saved a real crush/isolation risk but shifted cost elsewhere. Mira retains it temporarily with transparency/limits. Immediate Want: decide whether to cancel dispatcher's local deviation for network fairness. Act guard: Resolve ACT6_LEDGER concurrency/resource/network state before execution; causality must remain distributed across people and institutions.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: audit shows deviation saved a real crush/isolation risk but shifted cost elsewhere. Mira retains it temporarily with transparency/limits.
- exact Immediate Want: decide whether to cancel dispatcher's local deviation for network fairness.
- exact End Turn: rerouted medical staff/supplies begin interacting with Juno's network.
...
## Forecast Outgoing
- projected End Turn: rerouted medical staff/supplies begin interacting with Juno's network.
...
1. Episode Card — exact EP239 Blueprint selector; A-Plot/Want/End Turn authority.
