...
beat: BEAT-V3-B06
concurrency: NONE
source_snapshot: router=CTX-V3-EP041; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT1-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-1C
- beat: BEAT-V3-B06
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT1-v0.1.md selector `EP041`
- branch: H-A
- concurrency: NONE
- Current-lived namespace remains H-A; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP040: End Turn=one bulkhead behavior triggers a brief Arun association. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=finish drill follow-up without dwelling on Arun. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.

## Character Context
- active_core_cap: max 3 salient characters including POV.
- projected_active_core: [주인공/TBD], Arun, Gideon
...
- projected relationship line: Gideon notices discomfort but does not force confession; Niko only knows the broad accident history.
...
- projected world pressure: old accidents leave human habits.
...
- Source-owned institutional/world pressure: old accidents leave human habits. Relationship/institution interface: Gideon notices discomfort but does not force confession; Niko only knows the broad accident history.
...
- source clue: Arun autobiographical mismatch — extremely soft PLANT. NOT proof of cross-history memory.
...
- classification=PLANT. Source clue=Arun autobiographical mismatch — extremely soft PLANT. NOT proof of cross-history memory. Outgoing selector=cooling trend update shows the drift stopped for now. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: a mundane door-sequence resembles the old accident. He recalls one specific phrase/sequence from Arun that does not cleanly match an old accessible log, but attributes it to trauma/time. Immediate Want: finish drill follow-up without dwelling on Arun. Act guard: Ordinary-world first. Do not objectively confirm regression, branching, substrate, or HUMAN:1; ordinary failures remain genuinely possible.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: a mundane door-sequence resembles the old accident. He recalls one specific phrase/sequence from Arun that does not cleanly match an old accessible log, but attributes it to trauma/time.
- exact Immediate Want: finish drill follow-up without dwelling on Arun.
- exact End Turn: cooling trend update shows the drift stopped for now.
...
## Forecast Outgoing
- projected End Turn: cooling trend update shows the drift stopped for now.
...
1. Episode Card — exact EP041 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=Old Works / old bulkhead route; current world/material/location router, branch=H-A.
