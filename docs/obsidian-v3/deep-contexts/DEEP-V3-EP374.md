...
beat: BEAT-V3-B51
concurrency: NONE
source_snapshot: router=CTX-V3-EP374; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT9-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-9A
- beat: BEAT-V3-B51
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT9-v0.1.md selector `EP374`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP373: End Turn=persistent local continuity modes are requested for work that cannot tolerate long communication delay. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=identify which jobs truly require persistent local embodiment/continuity rather than remote avatars. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: others challenge his tendency to take risk personally.
...
- projected world pressure: embodiment is functional/voluntary.
...
- Source-owned institutional/world pressure: embodiment is functional/voluntary. Relationship/institution interface: others challenge his tendency to take risk personally.
...
- source clue: death-stakes setup.
...
- classification=SOURCE_DEFINED. Source clue=death-stakes setup. Outgoing selector=one technical team must choose persistent local mode for upcoming installation. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: separates remote inspection/robotics from tasks needing local autonomy under communication loss; protagonist volunteers only where his damage-analysis skill is relevant later, not because bodies prove personhood. Immediate Want: identify which jobs truly require persistent local embodiment/continuity rather than remote avatars. Act guard: Descendant completion and return/payoff outrank novelty. No rerun/new ontology by default; EP406-410 add no major mystery and close through consequence/return.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: separates remote inspection/robotics from tasks needing local autonomy under communication loss; protagonist volunteers only where his damage-analysis skill is relevant later, not because bodies prove personhood.
- exact Immediate Want: identify which jobs truly require persistent local embodiment/continuity rather than remote avatars.
- exact End Turn: one technical team must choose persistent local mode for upcoming installation.
...
## Forecast Outgoing
- projected End Turn: one technical team must choose persistent local mode for upcoming installation.
...
1. Episode Card — exact EP374 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=local deployment planning; current world/material/location router, branch=H-B.
