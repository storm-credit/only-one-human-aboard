...
beat: BEAT-V3-B18
concurrency: NONE
source_snapshot: router=CTX-V3-EP129; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT3-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-3C
- beat: BEAT-V3-B18
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT3-v0.1.md selector `EP129`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP128: End Turn=protagonist is left with evidence but no oracle. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=re-audit his own H-A memories using the same skeptical standard. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: decides not to use Mira as a memory-validation instrument.
...
- zone: home / Old Works
- projected world pressure: investigation turns inward without solipsism.
...
- Source-owned institutional/world pressure: investigation turns inward without solipsism. Relationship/institution interface: decides not to use Mira as a memory-validation instrument.
...
- source clue: Arun long-term setup REINFORCE.
...
- classification=REINFORCE. Source clue=Arun long-term setup REINFORCE. Outgoing selector=family/community life produces a small H-B fact he genuinely likes despite its difference. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: categorizes what is verified, contradicted, untestable, and emotionally distorted; Arun memory remains especially loaded. Immediate Want: re-audit his own H-A memories using the same skeptical standard. Act guard: H-B is current-lived. H-A knowledge/state enters only through explicit memory/provenance; secondary characters retain independent causality.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: categorizes what is verified, contradicted, untestable, and emotionally distorted; Arun memory remains especially loaded.
- exact Immediate Want: re-audit his own H-A memories using the same skeptical standard.
- exact End Turn: family/community life produces a small H-B fact he genuinely likes despite its difference.
...
## Forecast Outgoing
- projected End Turn: family/community life produces a small H-B fact he genuinely likes despite its difference.
...
1. Episode Card — exact EP129 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=home / Old Works; current world/material/location router, branch=H-B.
