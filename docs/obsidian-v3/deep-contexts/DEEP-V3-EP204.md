...
beat: BEAT-V3-B29
concurrency: NONE
source_snapshot: router=CTX-V3-EP204; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT5-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-5B
- beat: BEAT-V3-B29
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT5-v0.1.md selector `EP204`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP203: End Turn=meeting begins next episode. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=determine what Arun remembers without imposing H-A narrative. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: reunion is uncomfortable, not sentimental resurrection.
...
- projected world pressure: same people can have different relationship states.
...
- Source-owned institutional/world pressure: same people can have different relationship states. Relationship/institution interface: reunion is uncomfortable, not sentimental resurrection.
...
- source clue: Arun H-B contradiction TRIGGER.
...
- classification=SOURCE_DEFINED. Source clue=Arun H-B contradiction TRIGGER. Outgoing selector=Arun states a fact about the old incident that directly contradicts protagonist's guilt memory. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: current Arun recognizes protagonist from a different shared history; basic facts diverge. Immediate Want: determine what Arun remembers without imposing H-A narrative. Act guard: Keep Arun current-life separation explicit and hold HUMAN meaning behind the reveal fence; do not collapse identity into explanation.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: current Arun recognizes protagonist from a different shared history; basic facts diverge.
- exact Immediate Want: determine what Arun remembers without imposing H-A narrative.
- exact End Turn: Arun states a fact about the old incident that directly contradicts protagonist's guilt memory.
...
## Forecast Outgoing
- projected End Turn: Arun states a fact about the old incident that directly contradicts protagonist's guilt memory.
...
1. Episode Card — exact EP204 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=neutral current-H-B meeting place; current world/material/location router, branch=H-B.
