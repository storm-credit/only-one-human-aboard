...
source_snapshot: router=CTX-V3-EP277; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT6-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-6C
- beat: BEAT-V3-B38
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT6-v0.1.md selector `EP277`
- branch: H-B
- concurrency: ACT6_LEDGER
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP276: End Turn=city enters exhausted stabilization rather than victory. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.
...
- projected relationship line: encounters people who still blame him and people who credit him; neither settles moral truth.
...
- projected world pressure: H-B remains changed, no reset.
...
- Source-owned institutional/world pressure: H-B remains changed, no reset. Relationship/institution interface: encounters people who still blame him and people who credit him; neither settles moral truth.
...
- source clue: protagonist false belief `restore original` weakens further.
...
- classification=SOURCE_DEFINED. Source clue=protagonist false belief `restore original` weakens further. Outgoing selector=an old external-observation dataset is reexamined amid recovery work. No authorial ominous narration beyond Blueprint evidence.
...
## Forecast Outgoing
- projected End Turn: an old external-observation dataset is reexamined amid recovery work.
...
1. Episode Card — exact EP277 Blueprint selector; A-Plot/Want/End Turn authority.
