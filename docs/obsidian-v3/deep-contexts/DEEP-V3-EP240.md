...
source_snapshot: router=CTX-V3-EP240; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT6-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-6A
- beat: BEAT-V3-B33
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT6-v0.1.md selector `EP240`
- branch: H-B
- concurrency: ACT6_LEDGER
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP239: End Turn=rerouted medical staff/supplies begin interacting with Juno's network. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=inspect a small utility problem at a community facility. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.

## Character Context
- active_core_cap: max 3 salient characters including POV.
- projected_active_core: [주인공/TBD], Juno
...
- projected relationship line: Juno's network has new outside contacts protagonist did not create.
...
- zone: Midring
- projected world pressure: path dependence becomes social texture.
...
- Source-owned institutional/world pressure: path dependence becomes social texture. Relationship/institution interface: Juno's network has new outside contacts protagonist did not create.
...
- classification=NONE. Source clue=NONE. Outgoing selector=one new contact offers a medical transport coordination channel. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: sees people/resources from different routes now sharing space; solves only the utility issue, not the social tensions. Immediate Want: inspect a small utility problem at a community facility. Act guard: Resolve ACT6_LEDGER concurrency/resource/network state before execution; causality must remain distributed across people and institutions.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: sees people/resources from different routes now sharing space; solves only the utility issue, not the social tensions.
- exact Immediate Want: inspect a small utility problem at a community facility.
- exact End Turn: one new contact offers a medical transport coordination channel.
...
## Forecast Outgoing
- projected End Turn: one new contact offers a medical transport coordination channel.
...
1. Episode Card — exact EP240 Blueprint selector; A-Plot/Want/End Turn authority.
