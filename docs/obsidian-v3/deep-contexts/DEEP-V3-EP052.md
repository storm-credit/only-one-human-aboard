...
source_snapshot: router=CTX-V3-EP052; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT2-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-2A
- beat: BEAT-V3-B08
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT2-v0.1.md selector `EP052`
- branch: H-A
- concurrency: ACT2_LEDGER
- Current-lived namespace remains H-A; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP051: End Turn=Mira's network loses a planned alternative route. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.
...
- projected relationship line: contacts Juno/community only for local capacity facts, not favoritism.
...
- projected world pressure: ordinary allocation becomes emergency logistics.
...
- Source-owned institutional/world pressure: ordinary allocation becomes emergency logistics. Relationship/institution interface: contacts Juno/community only for local capacity facts, not favoritism.
...
- classification=NONE. Source clue=NONE. Outgoing selector=crowding at one junction exceeds model prediction. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: formal reroute overloads one corridor; she freezes nonessential freight and prioritizes medical/service flows. Immediate Want: keep passenger evacuation and freight flow separated after losing a feed. Act guard: Disaster/concurrency first. Resolve ACT2_LEDGER geography/time before scene execution; do not explain the branch mechanism. EP094 ends H-A current-lived state.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: formal reroute overloads one corridor; she freezes nonessential freight and prioritizes medical/service flows.
- exact Immediate Want: keep passenger evacuation and freight flow separated after losing a feed.
- exact End Turn: crowding at one junction exceeds model prediction.
...
## Forecast Outgoing
- projected End Turn: crowding at one junction exceeds model prediction.
...
1. Episode Card — exact EP052 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=L-B Transfer Belt control; current world/material/location router, branch=H-A.
