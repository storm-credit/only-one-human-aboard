...
beat: BEAT-V3-B19
concurrency: NONE
source_snapshot: router=CTX-V3-EP132; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT3-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-3C
- beat: BEAT-V3-B19
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT3-v0.1.md selector `EP132`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP131: End Turn=final independent record test is ready. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=compare H-A memory, H-B record and claimant-linked evidence without forcing one model. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: Sora accepts incompatibility as a fact while rejecting cosmological conclusions.
...
- projected world pressure: institutional evidence threshold crossed.
...
- Source-owned institutional/world pressure: institutional evidence threshold crossed. Relationship/institution interface: Sora accepts incompatibility as a fact while rejecting cosmological conclusions.
...
- source clue: multiple-history evidence TRIGGER.
...
- classification=SOURCE_DEFINED. Source clue=multiple-history evidence TRIGGER. Outgoing selector=one physical location can test the record directly. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: establishes all three cannot be the same timeline with simple personal-memory error. Immediate Want: compare H-A memory, H-B record and claimant-linked evidence without forcing one model. Act guard: H-B is current-lived. H-A knowledge/state enters only through explicit memory/provenance; secondary characters retain independent causality.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: establishes all three cannot be the same timeline with simple personal-memory error.
- exact Immediate Want: compare H-A memory, H-B record and claimant-linked evidence without forcing one model.
- exact End Turn: one physical location can test the record directly.
...
## Forecast Outgoing
- projected End Turn: one physical location can test the record directly.
...
1. Episode Card — exact EP132 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=archive/security/technical interface; current world/material/location router, branch=H-B.
