...
source_snapshot: router=CTX-V3-EP050; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT2-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-2A
- beat: BEAT-V3-B07
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT2-v0.1.md selector `EP050`
- branch: H-A
- concurrency: ACT2_LEDGER
- Current-lived namespace remains H-A; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP049: End Turn=electrical isolation knocks out a Transfer Belt feed before extraction is fully complete. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=prevent secondary structural/electrical damage from reaching the rescue route. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.

## Character Context
- active_core_cap: max 3 salient characters including POV.
- projected_active_core: [주인공/TBD], Selene
...
- projected relationship line: accepts Selene's order to leave one work area uninspected until hazard changes.
...
- zone: L-A
- projected world pressure: incident scales from industrial to urban infrastructure.
...
- Source-owned institutional/world pressure: incident scales from industrial to urban infrastructure. Relationship/institution interface: accepts Selene's order to leave one work area uninspected until hazard changes.
...
- source clue: local cause remains ordinary physical failure.
...
- classification=SOURCE_DEFINED. Source clue=local cause remains ordinary physical failure. Outgoing selector=Transfer Belt reports cascading route/power disruption. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: recognizes adjacent electrical path has been heat/coolant compromised; rescue completes narrowly, but the city impact is expanding. Immediate Want: prevent secondary structural/electrical damage from reaching the rescue route. Act guard: Disaster/concurrency first. Resolve ACT2_LEDGER geography/time before scene execution; do not explain the branch mechanism. EP094 ends H-A current-lived state.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: recognizes adjacent electrical path has been heat/coolant compromised; rescue completes narrowly, but the city impact is expanding.
- exact Immediate Want: prevent secondary structural/electrical damage from reaching the rescue route.
- exact End Turn: Transfer Belt reports cascading route/power disruption.
...
## Forecast Outgoing
- projected End Turn: Transfer Belt reports cascading route/power disruption.
...
1. Episode Card — exact EP050 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=L-A; current world/material/location router, branch=H-A.
