...
beat: BEAT-V3-B30
concurrency: NONE
source_snapshot: router=CTX-V3-EP218; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT5-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-5C
- beat: BEAT-V3-B30
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT5-v0.1.md selector `EP218`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP217: End Turn=one rumor targets a restricted facility, creating real security/resource consequences. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=keep investigation from becoming a hunt for a person. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: protagonist resists temptation to ask whether he is the category.
...
- projected world pressure: restricted-site protection/rumor management.
...
- Source-owned institutional/world pressure: restricted-site protection/rumor management. Relationship/institution interface: protagonist resists temptation to ask whether he is the category.
...
- source clue: HUMAN:1 count remains real, meaning open.
...
- classification=OPEN. Source clue=HUMAN:1 count remains real, meaning open. Outgoing selector=family/community rumor reaches protagonist's private life. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: helps Sora/Hana separate field verification from identity claims; physical route is too indirect to name endpoint. Immediate Want: keep investigation from becoming a hunt for a person. Act guard: Keep Arun current-life separation explicit and hold HUMAN meaning behind the reveal fence; do not collapse identity into explanation.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: helps Sora/Hana separate field verification from identity claims; physical route is too indirect to name endpoint.
- exact Immediate Want: keep investigation from becoming a hunt for a person.
- exact End Turn: family/community rumor reaches protagonist's private life.
...
## Forecast Outgoing
- projected End Turn: family/community rumor reaches protagonist's private life.
...
1. Episode Card — exact EP218 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=Central/Old Works interface; current world/material/location router, branch=H-B.
