...
beat: BEAT-V3-B42
concurrency: NONE
source_snapshot: router=CTX-V3-EP306; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT7-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-7B
- beat: BEAT-V3-B42
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT7-v0.1.md selector `EP306`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP305: End Turn=one older continuity record shows interrupted and uninterrupted cases are treated differently. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=see whether claimant can obtain current practical rights without pretending to be the deceased/other-history person. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: family conflict remains emotionally unresolved.
...
- zone: civic review
- projected world pressure: institutions can recognize new claims without declaring resurrection.
...
- Source-owned institutional/world pressure: institutions can recognize new claims without declaring resurrection. Relationship/institution interface: family conflict remains emotionally unresolved.
...
- classification=REINFORCE. Source clue=D09 REINFORCE. Outgoing selector=a second case lacks even the claimant's remembered continuity but shares lineage metadata. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: supports a limited solution based on present relationship/evidence/consent, not identity substitution. Immediate Want: see whether claimant can obtain current practical rights without pretending to be the deceased/other-history person. Act guard: Action/evidence before ontology. Every explanatory beat must be earned by a concrete decision, cost, failed model, or operational consequence.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: supports a limited solution based on present relationship/evidence/consent, not identity substitution.
- exact Immediate Want: see whether claimant can obtain current practical rights without pretending to be the deceased/other-history person.
- exact End Turn: a second case lacks even the claimant's remembered continuity but shares lineage metadata.
...
## Forecast Outgoing
- projected End Turn: a second case lacks even the claimant's remembered continuity but shares lineage metadata.
...
1. Episode Card — exact EP306 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=civic review; current world/material/location router, branch=H-B.
