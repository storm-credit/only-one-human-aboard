...
beat: BEAT-V3-B22
concurrency: NONE
source_snapshot: router=CTX-V3-EP151; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT4-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-4B
- beat: BEAT-V3-B22
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT4-v0.1.md selector `EP151`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP150: End Turn=security raises posture as the remembered/predicted window approaches. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=prepare structural/system safety without assuming exact remembered sequence. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: protagonist/Mira agree on precaution boundaries more cleanly than Act3.
...
- projected world pressure: preparation changes target environment before event.
...
- Source-owned institutional/world pressure: preparation changes target environment before event. Relationship/institution interface: protagonist/Mira agree on precaution boundaries more cleanly than Act3.
...
- source clue: future-memory intervention effect begins.
...
- classification=SOURCE_DEFINED. Source clue=future-memory intervention effect begins. Outgoing selector=one predicted detail occurs early and differently. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: checks barriers, pressure/power isolation and fallback routes. Immediate Want: prepare structural/system safety without assuming exact remembered sequence. Act guard: Prediction and social consequence before ontology. Evidence must change choices/relationships before any explanatory model hardens.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: checks barriers, pressure/power isolation and fallback routes.
- exact Immediate Want: prepare structural/system safety without assuming exact remembered sequence.
- exact End Turn: one predicted detail occurs early and differently.
...
## Forecast Outgoing
- projected End Turn: one predicted detail occurs early and differently.
...
1. Episode Card — exact EP151 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=Old Works/Transfer target family; current world/material/location router, branch=H-B.
