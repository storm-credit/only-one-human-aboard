...
beat: BEAT-V3-B31
concurrency: NONE
source_snapshot: router=CTX-V3-EP224; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT5-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-5C
- beat: BEAT-V3-B31
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT5-v0.1.md selector `EP224`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP223: End Turn=physical preservation chain access becomes the only route to meaning. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.
...
- projected_active_core: Hana, Sora
...
- projected relationship line: Hana↔Sora tension over timing and harm reaches a temporary compromise.
...
- projected world pressure: truth preservation vs public safety becomes institutional action.
...
- Source-owned institutional/world pressure: truth preservation vs public safety becomes institutional action. Relationship/institution interface: Hana↔Sora tension over timing and harm reaches a temporary compromise.
...
- source clue: HUMAN social AFTERSHOCK.
...
- classification=SOURCE_DEFINED. Source clue=HUMAN social AFTERSHOCK. Outgoing selector=release fails to stop speculation but makes false claims easier to challenge. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: prepares a narrow factual disclosure: field exists/current count=1/meaning unknown; withholds protected identity guesses. Immediate Want: decide what evidence can be released without turning uncertain classification into a witch hunt. Act guard: Keep Arun current-life separation explicit and hold HUMAN meaning behind the reveal fence; do not collapse identity into explanation.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: prepares a narrow factual disclosure: field exists/current count=1/meaning unknown; withholds protected identity guesses.
- exact Immediate Want: decide what evidence can be released without turning uncertain classification into a witch hunt.
- exact End Turn: release fails to stop speculation but makes false claims easier to challenge.
...
## Forecast Outgoing
- projected End Turn: release fails to stop speculation but makes false claims easier to challenge.
...
1. Episode Card — exact EP224 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=archive/civic review; current world/material/location router, branch=H-B.
