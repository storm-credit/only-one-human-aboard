...
beat: BEAT-V3-B53
concurrency: NONE
source_snapshot: router=CTX-V3-EP387; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT9-v0.1.md; mode=blueprint-compiled
...
---
# DEEP V3 EP387 — 연결을 끊으면 사는 것과 죽는 것
...
- subact: SA-V3-9B
- beat: BEAT-V3-B53
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT9-v0.1.md selector `EP387`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP386: End Turn=persistent local continuity teams risk being isolated if synchronized links fail. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=decide which couplings can be safely isolated without severing active persistent continuities/services. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: rights rules directly constrain engineering response.
...
- projected world pressure: ontology becomes survival mechanic.
...
- Source-owned institutional/world pressure: ontology becomes survival mechanic. Relationship/institution interface: rights rules directly constrain engineering response.
...
- source clue: D09/D10 payoff under crisis.
...
- classification=PAYOFF. Source clue=D09/D10 payoff under crisis. Outgoing selector=medical team has local embodied persons exposed to rising stress. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: maps local vs remote continuity modes; some remote avatars can simply drop, persistent nodes cannot be treated as disposable equipment. Immediate Want: decide which couplings can be safely isolated without severing active persistent continuities/services. Act guard: Descendant completion and return/payoff outrank novelty. No rerun/new ontology by default; EP406-410 add no major mystery and close through consequence/return.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: maps local vs remote continuity modes; some remote avatars can simply drop, persistent nodes cannot be treated as disposable equipment.
- exact Immediate Want: decide which couplings can be safely isolated without severing active persistent continuities/services.
- exact End Turn: medical team has local embodied persons exposed to rising stress.
...
## Forecast Outgoing
- projected End Turn: medical team has local embodied persons exposed to rising stress.
...
1. Episode Card — exact EP387 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=Ark/settlement link; current world/material/location router, branch=H-B.
