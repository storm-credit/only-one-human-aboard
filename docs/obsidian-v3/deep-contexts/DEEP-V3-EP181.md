...
- classification=PAYOFF. Source clue=Act4 major PAYOFF. Outgoing selector=a physical legacy site becomes the next question—something happened there that official H-B history says never happened. No authorial ominous narration beyond Blueprint evidence.
...
- exact End Turn: a physical legacy site becomes the next question—something happened there that official H-B history says never happened.
...
## Forecast Outgoing
- projected End Turn: a physical legacy site becomes the next question—something happened there that official H-B history says never happened.
