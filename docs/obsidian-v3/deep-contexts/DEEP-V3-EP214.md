...
beat: BEAT-V3-B30
concurrency: NONE
source_snapshot: router=CTX-V3-EP214; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT5-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-5C
- beat: BEAT-V3-B30
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT5-v0.1.md selector `EP214`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP213: End Turn=access to one deeper record is restricted by mission-era classification. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=test obvious meanings—population, crew, survivors, biological patients. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: protagonist experiences title-like `one` anxiety without assuming himself yet.
...
- projected world pressure: category systems can persist after meaning fades.
...
- Source-owned institutional/world pressure: category systems can persist after meaning fades. Relationship/institution interface: protagonist experiences title-like `one` anxiety without assuming himself yet.
...
- classification=REINFORCE. Source clue=HUMAN:1 REINFORCE. Outgoing selector=someone notes protagonist's unique H-A→H-B anomaly, feeding red herring. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: current 300k-scale citizen data makes those interpretations impossible; field is a special category. Immediate Want: test obvious meanings—population, crew, survivors, biological patients. Act guard: Keep Arun current-life separation explicit and hold HUMAN meaning behind the reveal fence; do not collapse identity into explanation.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: current 300k-scale citizen data makes those interpretations impossible; field is a special category.
- exact Immediate Want: test obvious meanings—population, crew, survivors, biological patients.
- exact End Turn: someone notes protagonist's unique H-A→H-B anomaly, feeding red herring.
...
## Forecast Outgoing
- projected End Turn: someone notes protagonist's unique H-A→H-B anomaly, feeding red herring.
...
1. Episode Card — exact EP214 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=archive / public statistics comparison; current world/material/location router, branch=H-B.
