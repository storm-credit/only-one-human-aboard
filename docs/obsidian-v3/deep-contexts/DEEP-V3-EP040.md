...
beat: BEAT-V3-B06
concurrency: NONE
source_snapshot: router=CTX-V3-EP040; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT1-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-1C
- beat: BEAT-V3-B06
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT1-v0.1.md selector `EP040`
- branch: H-A
- concurrency: NONE
- Current-lived namespace remains H-A; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP039: End Turn=fallback route is approved for the coming maintenance window. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=certify structural/access conditions for a routine evacuation drill. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.

## Character Context
- active_core_cap: max 3 salient characters including POV.
- projected_active_core: [주인공/TBD], caregiver, Caregiver
...
- projected relationship line: caregiver/parent role seeded; protagonist sees how civilians interpret technical instructions differently.
...
- projected world pressure: emergency literacy is ordinary civic life.
...
- Source-owned institutional/world pressure: emergency literacy is ordinary civic life. Relationship/institution interface: caregiver/parent role seeded; protagonist sees how civilians interpret technical instructions differently.
...
- source clue: Act2 evacuation/caregiver seed — PLANT.
...
- classification=PLANT+SEED. Source clue=Act2 evacuation/caregiver seed — PLANT. Outgoing selector=one bulkhead behavior triggers a brief Arun association. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: school/caregiver staff run a drill; protagonist checks doors/routes rather than leading children. Immediate Want: certify structural/access conditions for a routine evacuation drill. Act guard: Ordinary-world first. Do not objectively confirm regression, branching, substrate, or HUMAN:1; ordinary failures remain genuinely possible.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: school/caregiver staff run a drill; protagonist checks doors/routes rather than leading children.
- exact Immediate Want: certify structural/access conditions for a routine evacuation drill.
- exact End Turn: one bulkhead behavior triggers a brief Arun association.
...
## Forecast Outgoing
- projected End Turn: one bulkhead behavior triggers a brief Arun association.
...
1. Episode Card — exact EP040 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=Midring school/community boundary near Old Works-Transfer interface; current world/material/location router, branch=H-A.
