...
beat: BEAT-V3-B42
concurrency: NONE
source_snapshot: router=CTX-V3-EP305; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT7-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-7B
- beat: BEAT-V3-B42
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT7-v0.1.md selector `EP305`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP304: End Turn=current registry cannot resolve case through normal death/identity rules. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=understand whether technical identity linkage implies personal continuity. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: he maps lesson back to H-A Arun and his own C4 experience cautiously.
...
- projected world pressure: backup/reference vs continuity distinction becomes concrete.
...
- Source-owned institutional/world pressure: backup/reference vs continuity distinction becomes concrete. Relationship/institution interface: he maps lesson back to H-A Arun and his own C4 experience cautiously.
...
- source clue: D02 mechanism prep, D09 REINFORCE.
...
- classification=REINFORCE. Source clue=D02 mechanism prep, D09 REINFORCE. Outgoing selector=one older continuity record shows interrupted and uninterrupted cases are treated differently. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: learns systems can preserve/reference related state information without guaranteeing uninterrupted subjectivity. Immediate Want: understand whether technical identity linkage implies personal continuity. Act guard: Action/evidence before ontology. Every explanatory beat must be earned by a concrete decision, cost, failed model, or operational consequence.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: learns systems can preserve/reference related state information without guaranteeing uninterrupted subjectivity.
- exact Immediate Want: understand whether technical identity linkage implies personal continuity.
- exact End Turn: one older continuity record shows interrupted and uninterrupted cases are treated differently.
...
## Forecast Outgoing
- projected End Turn: one older continuity record shows interrupted and uninterrupted cases are treated differently.
...
1. Episode Card — exact EP305 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=registry/technical consultation; current world/material/location router, branch=H-B.
