...
beat: BEAT-V3-B31
concurrency: NONE
source_snapshot: router=CTX-V3-EP227; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT5-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-5C
- beat: BEAT-V3-B31
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT5-v0.1.md selector `EP227`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP226: End Turn=unusual resource margin concerns begin appearing elsewhere in the city. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=return to normal life after weeks of anomaly investigation. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.

## Character Context
- active_core_cap: max 3 salient characters including POV.
- projected_active_core: [주인공/TBD], Mira, Juno
...
- projected relationship line: Mira/Juno/family pull him back into H-B present obligations.
...
- projected world pressure: Act6 scarcity seeds move to foreground.
...
- Source-owned institutional/world pressure: Act6 scarcity seeds move to foreground. Relationship/institution interface: Mira/Juno/family pull him back into H-B present obligations.
...
- source clue: C3/resource-pressure seed for Act6.
...
- classification=SEED. Source clue=C3/resource-pressure seed for Act6. Outgoing selector=one small transit-routing decision is made by the already-seeded Dispatcher under increasing load. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: ordinary shortages/delays/political distrust are growing; people care about current services more than his ontology puzzle. Immediate Want: return to normal life after weeks of anomaly investigation. Act guard: Keep Arun current-life separation explicit and hold HUMAN meaning behind the reveal fence; do not collapse identity into explanation.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: ordinary shortages/delays/political distrust are growing; people care about current services more than his ontology puzzle.
- exact Immediate Want: return to normal life after weeks of anomaly investigation.
- exact End Turn: one small transit-routing decision is made by the already-seeded Dispatcher under increasing load.
...
## Forecast Outgoing
- projected End Turn: one small transit-routing decision is made by the already-seeded Dispatcher under increasing load.
...
1. Episode Card — exact EP227 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=Midring/Transfer; current world/material/location router, branch=H-B.
