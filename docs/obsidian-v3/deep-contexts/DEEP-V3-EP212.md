...
beat: BEAT-V3-B29
concurrency: NONE
source_snapshot: router=CTX-V3-EP212; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT5-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-5B
- beat: BEAT-V3-B29
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT5-v0.1.md selector `EP212`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP211: End Turn=Hana asks protagonist to examine a technical field attached to legacy preservation records. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=move from personal Arun case back to broader evidence. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: protagonist/Hana collaboration becomes bounded, each with separate expertise.
...
- projected world pressure: investigation shifts from individual identity to mission-era infrastructure/records.
...
- Source-owned institutional/world pressure: investigation shifts from individual identity to mission-era infrastructure/records. Relationship/institution interface: protagonist/Hana collaboration becomes bounded, each with separate expertise.
...
- source clue: HUMAN field pre-plant.
...
- classification=PLANT. Source clue=HUMAN field pre-plant. Outgoing selector=one repeated value reads `HUMAN: 1` without definition. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: links records from absent history to a preservation/mission data chain containing unfamiliar count/category fields. Immediate Want: move from personal Arun case back to broader evidence. Act guard: Keep Arun current-life separation explicit and hold HUMAN meaning behind the reveal fence; do not collapse identity into explanation.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: links records from absent history to a preservation/mission data chain containing unfamiliar count/category fields.
- exact Immediate Want: move from personal Arun case back to broader evidence.
- exact End Turn: one repeated value reads `HUMAN: 1` without definition.
...
## Forecast Outgoing
- projected End Turn: one repeated value reads `HUMAN: 1` without definition.
...
1. Episode Card — exact EP212 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=Central archive / technical interface; current world/material/location router, branch=H-B.
