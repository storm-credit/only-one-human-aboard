...
source_snapshot: router=CTX-V3-EP274; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT6-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-6C
- beat: BEAT-V3-B37
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT6-v0.1.md selector `EP274`
- branch: H-B
- concurrency: ACT6_LEDGER
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP273: End Turn=first major civilian/supply movement starts. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=keep one utility crossing stable during the corridor's first large movement. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: explicitly does not take leadership/credit.
...
- projected world pressure: protagonist supports but does not intermediate solution.
...
- Source-owned institutional/world pressure: protagonist supports but does not intermediate solution. Relationship/institution interface: explicitly does not take leadership/credit.
...
- source clue: emergent importance PAYOFF begins.
...
- classification=PAYOFF. Source clue=emergent importance PAYOFF begins. Outgoing selector=corridor prevents one confrontation and moves vulnerable people. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: contributes local structural safety only; learns the route/social agreement originated from decisions he barely noticed weeks ago. Immediate Want: keep one utility crossing stable during the corridor's first large movement. Act guard: Resolve ACT6_LEDGER concurrency/resource/network state before execution; causality must remain distributed across people and institutions.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: contributes local structural safety only; learns the route/social agreement originated from decisions he barely noticed weeks ago.
- exact Immediate Want: keep one utility crossing stable during the corridor's first large movement.
- exact End Turn: corridor prevents one confrontation and moves vulnerable people.
...
## Forecast Outgoing
- projected End Turn: corridor prevents one confrontation and moves vulnerable people.
...
1. Episode Card — exact EP274 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=Old Works / corridor edge; current world/material/location router, branch=H-B.
