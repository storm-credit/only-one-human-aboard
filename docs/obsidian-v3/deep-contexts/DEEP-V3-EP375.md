...
beat: BEAT-V3-B51
concurrency: NONE
source_snapshot: router=CTX-V3-EP375; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT9-v0.1.md; mode=blueprint-compiled
...
---
# DEEP V3 EP375 — 연결이 끊겨도 일해야 하는 사람
...
- subact: SA-V3-9A
- beat: BEAT-V3-B51
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT9-v0.1.md selector `EP375`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP374: End Turn=one technical team must choose persistent local mode for upcoming installation. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: technical deployment role 1
- OFF-POV / INFLUENCE_ONLY_UNLESS_BLUEPRINT_EXPLICIT. technical deployment role 1 owns the episode's lived decision line. Do not reroute success, discovery, or emotional resolution through the protagonist merely for centrality.

## Character Context
- active_core_cap: max 3 salient characters including POV.
- projected_active_core: technical deployment role 1, family
...
- projected relationship line: family/crew consent and safety procedure are explicit.
...
- projected world pressure: local death risk is real when continuity is physically anchored there.
...
- Source-owned institutional/world pressure: local death risk is real when continuity is physically anchored there. Relationship/institution interface: family/crew consent and safety procedure are explicit.
...
- source clue: Act9 survival stakes PLANT.
...
- classification=PLANT. Source clue=Act9 survival stakes PLANT. Outgoing selector=one quiescent-lineage representation question delays shared-resource approval. No authorial ominous narration beyond Blueprint evidence.
...
## Forecast Outgoing
- projected End Turn: one quiescent-lineage representation question delays shared-resource approval.
...
1. Episode Card — exact EP375 Blueprint selector; A-Plot/Want/End Turn authority.
2. Immediate Continuity — prior realized CONTINUITY-FROZEN + this forecast selector; never future guessed Actual.
3. POV/Relationship — POV=technical deployment role 1; relationship line + current role/relationship graph, active core <=3.
4. World/Zone/Material — Zone=destination-side infrastructure; current world/material/location router, branch=H-B.
