...
source_snapshot: router=CTX-V3-EP054; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT2-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-2A
- beat: BEAT-V3-B08
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT2-v0.1.md selector `EP054`
- branch: H-A
- concurrency: ACT2_LEDGER
- Current-lived namespace remains H-A; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP053: End Turn=reroute crowding creates a separate emergency protagonist cannot reach. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: Transit Dispatcher
- OFF-POV / INFLUENCE_ONLY_UNLESS_BLUEPRINT_EXPLICIT. Transit Dispatcher owns the episode's lived decision line. Do not reroute success, discovery, or emotional resolution through the protagonist merely for centrality.

## Character Context
- active_core_cap: max 3 salient characters including POV.
- projected_active_core: Mira, Transit Dispatcher
...
- projected relationship line: Mira initially questions the deviation, then keeps it because the local data are better.
...
- zone: L-B
- projected world pressure: minor worker competence changes immediate outcomes without becoming grand heroism.
...
- Source-owned institutional/world pressure: minor worker competence changes immediate outcomes without becoming grand heroism. Relationship/institution interface: Mira initially questions the deviation, then keeps it because the local data are better.
...
- classification=NONE. Source clue=NONE. Outgoing selector=reroute saves one crowd but leaves a school/community group with a shrinking exit window. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: uses observed crowd behavior and vehicle position to make a local nonstandard turnback/reroute. Immediate Want: stop one overloaded junction from trapping passengers when a second route closes. Act guard: Disaster/concurrency first. Resolve ACT2_LEDGER geography/time before scene execution; do not explain the branch mechanism. EP094 ends H-A current-lived state.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: uses observed crowd behavior and vehicle position to make a local nonstandard turnback/reroute.
- exact Immediate Want: stop one overloaded junction from trapping passengers when a second route closes.
- exact End Turn: reroute saves one crowd but leaves a school/community group with a shrinking exit window.
...
## Forecast Outgoing
- projected End Turn: reroute saves one crowd but leaves a school/community group with a shrinking exit window.
...
1. Episode Card — exact EP054 Blueprint selector; A-Plot/Want/End Turn authority.
2. Immediate Continuity — prior realized CONTINUITY-FROZEN + this forecast selector; never future guessed Actual.
3. POV/Relationship — POV=Transit Dispatcher; relationship line + current role/relationship graph, active core <=3.
4. World/Zone/Material — Zone=L-B; current world/material/location router, branch=H-A.
