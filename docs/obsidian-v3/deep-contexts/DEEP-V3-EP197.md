...
beat: BEAT-V3-B28
concurrency: NONE
source_snapshot: router=CTX-V3-EP197; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT5-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-5B
- beat: BEAT-V3-B28
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT5-v0.1.md selector `EP197`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP196: End Turn=one old incident reference contains the name `Arun Kalev` where protagonist expects a dead colleague. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.
...
- projected_active_core: 루카스, Arun, Sora
...
- projected relationship line: protagonist becomes less objective; Sora/Hana restrict interpretation.
...
- projected world pressure: personal stakes invade historical investigation.
...
- Source-owned institutional/world pressure: personal stakes invade historical investigation. Relationship/institution interface: protagonist becomes less objective; Sora/Hana restrict interpretation.
...
- source clue: Arun device TRIGGER toward H-B current person.
...
- classification=SOURCE_DEFINED. Source clue=Arun device TRIGGER toward H-B current person. Outgoing selector=H-B public records indicate Arun is not dead. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: identifiers/age/work history align too closely with his Arun to dismiss. Immediate Want: determine whether the Arun reference is another person. Act guard: Keep Arun current-life separation explicit and hold HUMAN meaning behind the reveal fence; do not collapse identity into explanation.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: identifiers/age/work history align too closely with his Arun to dismiss.
- exact Immediate Want: determine whether the Arun reference is another person.
- exact End Turn: H-B public records indicate Arun is not dead.
...
## Forecast Outgoing
- projected End Turn: H-B public records indicate Arun is not dead.
...
1. Episode Card — exact EP197 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=archive/registry interface; current world/material/location router, branch=H-B.
