...
beat: BEAT-V3-B31
concurrency: NONE
source_snapshot: router=CTX-V3-EP222; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT5-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-5C
- beat: BEAT-V3-B31
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT5-v0.1.md selector `EP222`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP221: End Turn=protagonist's own anomaly makes him a public/private suspect candidate despite no matching field evidence. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=privately test the chosen-one theory without believing it. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: he confronts the desire for a simple explanation centered on himself.
...
- zone: home / work
- projected world pressure: no hidden key appears.
...
- Source-owned institutional/world pressure: no hidden key appears. Relationship/institution interface: he confronts the desire for a simple explanation centered on himself.
...
- source clue: protagonist=HUMAN RH remains plausible socially, weakens evidentially.
...
- classification=SOURCE_DEFINED. Source clue=protagonist=HUMAN RH remains plausible socially, weakens evidentially. Outgoing selector=one archival route suggests old `HUMAN` values changed over voyage history, but data are incomplete. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: checks what his current medical/civic/technical records actually show; nothing grants special HUMAN/admin status. Immediate Want: privately test the chosen-one theory without believing it. Act guard: Keep Arun current-life separation explicit and hold HUMAN meaning behind the reveal fence; do not collapse identity into explanation.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: checks what his current medical/civic/technical records actually show; nothing grants special HUMAN/admin status.
- exact Immediate Want: privately test the chosen-one theory without believing it.
- exact End Turn: one archival route suggests old `HUMAN` values changed over voyage history, but data are incomplete.
...
## Forecast Outgoing
- projected End Turn: one archival route suggests old `HUMAN` values changed over voyage history, but data are incomplete.
...
1. Episode Card — exact EP222 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=home / work; current world/material/location router, branch=H-B.
