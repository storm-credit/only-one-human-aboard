...
beat: BEAT-V3-B54
concurrency: NONE
source_snapshot: router=CTX-V3-EP399; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT9-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-9B
- beat: BEAT-V3-B54
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT9-v0.1.md selector `EP399`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP398: End Turn=external disturbance begins easing/phase shifting, but one continuity group remains at risk. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=secure remaining persistent continuities before disturbance returns or thermal reserve collapses. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: no one component is sufficient alone.
...
- projected world pressure: institutional cooperation + individual choices form solution.
...
- Source-owned institutional/world pressure: institutional cooperation + individual choices form solution. Relationship/institution interface: no one component is sufficient alone.
...
- source clue: final crisis PAYOFF near completion.
...
- classification=PAYOFF. Source clue=final crisis PAYOFF near completion. Outgoing selector=operation succeeds enough for survival but not restoration of lost assets. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: integrates Niko/local worker method, Mira resource allocation, Selene access guarantee and medical constraints into one bounded repair/evacuation operation. Immediate Want: secure remaining persistent continuities before disturbance returns or thermal reserve collapses. Act guard: Descendant completion and return/payoff outrank novelty. No rerun/new ontology by default; EP406-410 add no major mystery and close through consequence/return.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: integrates Niko/local worker method, Mira resource allocation, Selene access guarantee and medical constraints into one bounded repair/evacuation operation.
- exact Immediate Want: secure remaining persistent continuities before disturbance returns or thermal reserve collapses.
- exact End Turn: operation succeeds enough for survival but not restoration of lost assets.
...
## Forecast Outgoing
- projected End Turn: operation succeeds enough for survival but not restoration of lost assets.
...
1. Episode Card — exact EP399 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=final unstable local segment; current world/material/location router, branch=H-B.
