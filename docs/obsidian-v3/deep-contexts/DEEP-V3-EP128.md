...
beat: BEAT-V3-B18
concurrency: NONE
source_snapshot: router=CTX-V3-EP128; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT3-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-3C
- beat: BEAT-V3-B18
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT3-v0.1.md selector `EP128`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP127: End Turn=claimant withdraws from further contact. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=ask one more question before claimant disappears from the case. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: Leila reinforces consent boundary without lecturing.
...
- projected world pressure: personhood ethics seeded through ordinary rights, long before D3 reveal.
...
- Source-owned institutional/world pressure: personhood ethics seeded through ordinary rights, long before D3 reveal. Relationship/institution interface: Leila reinforces consent boundary without lecturing.
...
- source clue: no new information.
...
- classification=SOURCE_DEFINED. Source clue=no new information. Outgoing selector=protagonist is left with evidence but no oracle. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: claimant refuses; protagonist must accept they are a person, not a mystery key. Immediate Want: ask one more question before claimant disappears from the case. Act guard: H-B is current-lived. H-A knowledge/state enters only through explicit memory/provenance; secondary characters retain independent causality.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: claimant refuses; protagonist must accept they are a person, not a mystery key.
- exact Immediate Want: ask one more question before claimant disappears from the case.
- exact End Turn: protagonist is left with evidence but no oracle.
...
## Forecast Outgoing
- projected End Turn: protagonist is left with evidence but no oracle.
...
1. Episode Card — exact EP128 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=clinic/public route; current world/material/location router, branch=H-B.
