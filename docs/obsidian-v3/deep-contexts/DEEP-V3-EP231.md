...
source_snapshot: router=CTX-V3-EP231; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT6-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-6A
- beat: BEAT-V3-B32
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT6-v0.1.md selector `EP231`
- branch: H-B
- concurrency: ACT6_LEDGER
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP230: End Turn=Transfer Belt begins formal curtailment. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.
...
- projected relationship line: public/internal anger attaches to Mira even though she did not create scarcity.
...
- zone: Transfer Belt
- projected world pressure: finite throughput becomes daily politics.
...
- Source-owned institutional/world pressure: finite throughput becomes daily politics. Relationship/institution interface: public/internal anger attaches to Mira even though she did not create scarcity.
...
- classification=NONE. Source clue=NONE. Outgoing selector=Midring community networks start bulk-buying/organizing around delays. No authorial ominous narration beyond Blueprint evidence.
...
## Forecast Outgoing
- projected End Turn: Midring community networks start bulk-buying/organizing around delays.
...
1. Episode Card — exact EP231 Blueprint selector; A-Plot/Want/End Turn authority.
