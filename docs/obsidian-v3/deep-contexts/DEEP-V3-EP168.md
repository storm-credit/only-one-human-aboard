...
beat: BEAT-V3-B24
concurrency: NONE
source_snapshot: router=CTX-V3-EP168; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT4-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-4C
- beat: BEAT-V3-B24
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT4-v0.1.md selector `EP168`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP167: End Turn=Sora learns Cassian once acted on a similar fragment years earlier. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.
...
- projected relationship line: Sora↔Leila/Hana future privacy tensions seeded.
...
- projected world pressure: institutions lack a clean anomaly category.
...
- Source-owned institutional/world pressure: institutions lack a clean anomaly category. Relationship/institution interface: Sora↔Leila/Hana future privacy tensions seeded.
...
- source clue: independent source pattern.
...
- classification=SOURCE_DEFINED. Source clue=independent source pattern. Outgoing selector=Ivo chooses to speak publicly despite advice. No authorial ominous narration beyond Blueprint evidence.
...
## Forecast Outgoing
- projected End Turn: Ivo chooses to speak publicly despite advice.
...
1. Episode Card — exact EP168 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=security/legal interface; current world/material/location router, branch=H-B.
