...
beat: BEAT-V3-B45
concurrency: NONE
source_snapshot: router=CTX-V3-EP329; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT8-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-8A
- beat: BEAT-V3-B45
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT8-v0.1.md selector `EP329`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP328: End Turn=Hana locates a damaged departure-era definition chain. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.
...
- projected relationship line: Hana insists historical label cannot define current rights.
...
- zone: archive
- projected world pressure: taxonomy drift across centuries.
...
- Source-owned institutional/world pressure: taxonomy drift across centuries. Relationship/institution interface: Hana insists historical label cannot define current rights.
...
- classification=REINFORCE. Source clue=D06 REINFORCE. Outgoing selector=definition points to biological preservation systems distinct from civic substrate. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: finds `Natural-Origin` / departure-continuity language contrasted with synthetic/civilization continuity categories; wording is technical/legacy, not moral ranking. Immediate Want: reconstruct the historical meaning of HUMAN from departure-era mission documents. Act guard: HUMAN provenance is not personhood. HUMAN:1 must remain de-collectified and must not become a collectible-character family or sacred merchandise target.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: finds `Natural-Origin` / departure-continuity language contrasted with synthetic/civilization continuity categories; wording is technical/legacy, not moral ranking.
- exact Immediate Want: reconstruct the historical meaning of HUMAN from departure-era mission documents.
- exact End Turn: definition points to biological preservation systems distinct from civic substrate.
...
## Forecast Outgoing
- projected End Turn: definition points to biological preservation systems distinct from civic substrate.
...
1. Episode Card — exact EP329 Blueprint selector; A-Plot/Want/End Turn authority.
