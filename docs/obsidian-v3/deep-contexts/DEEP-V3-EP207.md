...
beat: BEAT-V3-B29
concurrency: NONE
source_snapshot: router=CTX-V3-EP207; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT5-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-5B
- beat: BEAT-V3-B29
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT5-v0.1.md selector `EP207`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP206: End Turn=Arun decides to provide one current record because it matters to safety/history, not to comfort protagonist. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=compare H-A memory and H-B record without forcing one original. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: protagonist's role as sole guilty agent collapses.
...
- projected world pressure: moral identity is history-dependent.
...
- Source-owned institutional/world pressure: moral identity is history-dependent. Relationship/institution interface: protagonist's role as sole guilty agent collapses.
...
- source clue: Arun multi-lineage meaning REINFORCE.
...
- classification=REINFORCE. Source clue=Arun multi-lineage meaning REINFORCE. Outgoing selector=Sora finds a third fragment where the event did not occur in either remembered form. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: discovers current Arun may remember protagonist making a different consequential choice—or Arun making the decisive sacrifice himself. Immediate Want: compare H-A memory and H-B record without forcing one original. Act guard: Keep Arun current-life separation explicit and hold HUMAN meaning behind the reveal fence; do not collapse identity into explanation.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: discovers current Arun may remember protagonist making a different consequential choice—or Arun making the decisive sacrifice himself.
- exact Immediate Want: compare H-A memory and H-B record without forcing one original.
- exact End Turn: Sora finds a third fragment where the event did not occur in either remembered form.
...
## Forecast Outgoing
- projected End Turn: Sora finds a third fragment where the event did not occur in either remembered form.
...
1. Episode Card — exact EP207 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=technical/archive comparison; current world/material/location router, branch=H-B.
