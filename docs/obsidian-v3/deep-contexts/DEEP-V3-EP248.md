...
source_snapshot: router=CTX-V3-EP248; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT6-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-6B
- beat: BEAT-V3-B34
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT6-v0.1.md selector `EP248`
- branch: H-B
- concurrency: ACT6_LEDGER
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP247: End Turn=Sora investigates whether sabotage justified broader restrictions. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.
...
- projected_active_core: Selene, Sora, Juno
...
- projected relationship line: she must answer to Selene/Juno/affected people, not protagonist.
...
- projected world pressure: good procedure can cause bad outcomes under scarcity.
...
- Source-owned institutional/world pressure: good procedure can cause bad outcomes under scarcity. Relationship/institution interface: she must answer to Selene/Juno/affected people, not protagonist.
...
- source clue: moral-variation theme through current action.
...
- classification=SOURCE_DEFINED. Source clue=moral-variation theme through current action. Outgoing selector=Hana possesses records that could explain allocation decisions but inflame the public. No authorial ominous narration beyond Blueprint evidence.
...
## Forecast Outgoing
- projected End Turn: Hana possesses records that could explain allocation decisions but inflame the public.
...
1. Episode Card — exact EP248 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=security / Midring route; current world/material/location router, branch=H-B.
