...
source_snapshot: router=CTX-V3-EP092; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT2-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-2D
- beat: BEAT-V3-B13
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT2-v0.1.md selector `EP092`
- branch: H-A
- concurrency: ACT2_LEDGER
- Current-lived namespace remains H-A; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP091: End Turn=seemingly unrelated power/thermal service margin degrades again. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=leave the incident after one last abnormal reading check. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.

## Character Context
- active_core_cap: max 3 salient characters including POV.
- projected_active_core: [주인공/TBD], Gideon, Niko
...
- projected relationship line: he tells Niko/Gideon to go off shift rather than keeping everyone with him.
...
- projected world pressure: recovery systems start behaving inconsistently; citizens receive ordinary service explanations.
...
- Source-owned institutional/world pressure: recovery systems start behaving inconsistently; citizens receive ordinary service explanations. Relationship/institution interface: he tells Niko/Gideon to go off shift rather than keeping everyone with him.
...
- source clue: hidden C3 outer-capacity event — AUTHOR-ONLY TRIGGER. Reader sees symptoms only.
- local knowledge fence: protagonist cannot infer substrate/Outer Ark cause.
...
- classification=SOURCE_DEFINED. Source clue=hidden C3 outer-capacity event — AUTHOR-ONLY TRIGGER. Reader sees symptoms only. Outgoing selector=one maintenance/access identifier resolves incorrectly for a moment, then corrects. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: experiences scattered secondary service instability that does not fit the now-understood local accident. From his perspective it could be wider ship power/thermal trouble. Immediate Want: leave the incident after one last abnormal reading check. Act guard: Disaster/concurrency first. Resolve ACT2_LEDGER geography/time before scene execution; do not explain the branch mechanism. EP094 ends H-A current-lived state.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: experiences scattered secondary service instability that does not fit the now-understood local accident. From his perspective it could be wider ship power/thermal trouble.
- exact Immediate Want: leave the incident after one last abnormal reading check.
- exact End Turn: one maintenance/access identifier resolves incorrectly for a moment, then corrects.
...
## Forecast Outgoing
- projected End Turn: one maintenance/access identifier resolves incorrectly for a moment, then corrects.
...
1. Episode Card — exact EP092 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=recovery route / Old Works; current world/material/location router, branch=H-A.
