...
source_snapshot: router=CTX-V3-EP076; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT2-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-2C
- beat: BEAT-V3-B11
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT2-v0.1.md selector `EP076`
- branch: H-A
- concurrency: ACT2_LEDGER
- Current-lived namespace remains H-A; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP075: End Turn=limited reopening is scheduled under conditions. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=define physical conditions for limited reopening. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: Niko wants direct verification of excluded route; protagonist refuses.
...
- projected world pressure: technical recommendation enters multi-agency decision.
...
- Source-owned institutional/world pressure: technical recommendation enters multi-agency decision. Relationship/institution interface: Niko wants direct verification of excluded route; protagonist refuses.
...
- source clue: old interface remains risk.
...
- classification=SOURCE_DEFINED. Source clue=old interface remains risk. Outgoing selector=a separate rescue need arises behind the restricted area. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: sets load, route and pressure constraints; explicitly excludes one legacy shortcut. Immediate Want: define physical conditions for limited reopening. Act guard: Disaster/concurrency first. Resolve ACT2_LEDGER geography/time before scene execution; do not explain the branch mechanism. EP094 ends H-A current-lived state.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: sets load, route and pressure constraints; explicitly excludes one legacy shortcut.
- exact Immediate Want: define physical conditions for limited reopening.
- exact End Turn: a separate rescue need arises behind the restricted area.
...
## Forecast Outgoing
- projected End Turn: a separate rescue need arises behind the restricted area.
...
1. Episode Card — exact EP076 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=L-A/L-B boundary; current world/material/location router, branch=H-A.
