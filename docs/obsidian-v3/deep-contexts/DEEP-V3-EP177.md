...
beat: BEAT-V3-B25
concurrency: NONE
source_snapshot: router=CTX-V3-EP177; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT4-v0.1.md; mode=blueprint-compiled
...
---
# DEEP V3 EP177 — 둘 다 거짓말하지 않을 수 있다
...
- subact: SA-V3-4C
- beat: BEAT-V3-B25
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT4-v0.1.md selector `EP177`
- branch: H-B
- concurrency: NONE
...
- projected relationship line: Mira challenges whether theory changes how he treats current people.
...
- projected world pressure: theory remains private/limited.
...
- Source-owned institutional/world pressure: theory remains private/limited. Relationship/institution interface: Mira challenges whether theory changes how he treats current people.
...
- source clue: few-alternate-world red herring rises naturally.
...
- classification=SOURCE_DEFINED. Source clue=few-alternate-world red herring rises naturally. Outgoing selector=institutions must decide how to handle future claims after Act4 attack. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: considers multiple histories/versions as provisional model; refuses to call them parallel universes as fact. Immediate Want: formulate a theory that does not require picking one liar. Act guard: Prediction and social consequence before ontology. Evidence must change choices/relationships before any explanatory model hardens.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: considers multiple histories/versions as provisional model; refuses to call them parallel universes as fact.
- exact Immediate Want: formulate a theory that does not require picking one liar.
- exact End Turn: institutions must decide how to handle future claims after Act4 attack.
...
## Forecast Outgoing
- projected End Turn: institutions must decide how to handle future claims after Act4 attack.
