...
beat: BEAT-V3-B41
concurrency: NONE
source_snapshot: router=CTX-V3-EP302; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT7-v0.1.md; mode=blueprint-compiled
...
---
# DEEP V3 EP302 — 서로 다른 삶을 같은 이름으로 부를 때
...
- subact: SA-V3-7B
- beat: BEAT-V3-B41
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT7-v0.1.md selector `EP302`
- branch: H-B
- concurrency: NONE
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP301: End Turn=their evidence points to an identity/continuity registry collision. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=understand why systems sometimes group related identities while current law treats current persons separately. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: Leila/Sora resist treating the grouping as proof of sameness.
...
- projected world pressure: lineage terminology becomes technically unavoidable but still undefined in scale.
...
- Source-owned institutional/world pressure: lineage terminology becomes technically unavoidable but still undefined in scale. Relationship/institution interface: Leila/Sora resist treating the grouping as proof of sameness.
...
- classification=REINFORCE. Source clue=D08/D09 REINFORCE. Outgoing selector=Sora identifies multiple distinct life/status records under one lineage family. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: sees legacy identity-lineage references that are not ordinary aliases or backups. Immediate Want: understand why systems sometimes group related identities while current law treats current persons separately. Act guard: Action/evidence before ontology. Every explanatory beat must be earned by a concrete decision, cost, failed model, or operational consequence.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: sees legacy identity-lineage references that are not ordinary aliases or backups.
- exact Immediate Want: understand why systems sometimes group related identities while current law treats current persons separately.
- exact End Turn: Sora identifies multiple distinct life/status records under one lineage family.
...
## Forecast Outgoing
- projected End Turn: Sora identifies multiple distinct life/status records under one lineage family.
...
1. Episode Card — exact EP302 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=registry/medical interface; current world/material/location router, branch=H-B.
