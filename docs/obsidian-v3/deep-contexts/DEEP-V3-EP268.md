...
source_snapshot: router=CTX-V3-EP268; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT6-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-6C
- beat: BEAT-V3-B36
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT6-v0.1.md selector `EP268`
- branch: H-B
- concurrency: ACT6_LEDGER
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP267: End Turn=one control point faces armed/semi-armed confrontation. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=prevent a violent group from forcing the disabled coupling back online. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: Selene handles people; protagonist handles irreversible hardware state.
...
- projected world pressure: concentrated infrastructure confrontation, not generalized war.
...
- Source-owned institutional/world pressure: concentrated infrastructure confrontation, not generalized war. Relationship/institution interface: Selene handles people; protagonist handles irreversible hardware state.
...
- source clue: technical choice AFTERSHOCK.
...
- classification=SOURCE_DEFINED. Source clue=technical choice AFTERSHOCK. Outgoing selector=short-term network becomes even more dependent on improvised routes. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: physically removes/isolates a critical component or access dependency so restart cannot occur through a simple seizure. Immediate Want: prevent a violent group from forcing the disabled coupling back online. Act guard: Resolve ACT6_LEDGER concurrency/resource/network state before execution; causality must remain distributed across people and institutions.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: physically removes/isolates a critical component or access dependency so restart cannot occur through a simple seizure.
- exact Immediate Want: prevent a violent group from forcing the disabled coupling back online.
- exact End Turn: short-term network becomes even more dependent on improvised routes.
...
## Forecast Outgoing
- projected End Turn: short-term network becomes even more dependent on improvised routes.
...
1. Episode Card — exact EP268 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=strategic technical point; current world/material/location router, branch=H-B.
