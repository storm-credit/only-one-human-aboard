...
beat: BEAT-V3-B05
concurrency: NONE
source_snapshot: router=CTX-V3-EP033; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT1-v0.1.md; mode=blueprint-compiled
...
- subact: SA-V3-1C
- beat: BEAT-V3-B05
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT1-v0.1.md selector `EP033`
- branch: H-A
- concurrency: NONE
- Current-lived namespace remains H-A; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP032: End Turn=route map and material location overlap imperfectly. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.

## Protagonist Context
- POV: [주인공/TBD]
- POV_OWNER. Immediate Want=inspect only the physically relevant section. Decision surface is bounded by A-Plot and authority in World/Relationship; competence creates options, not universal command.
...
- projected relationship line: accepts Sora's restriction instead of treating security as obstruction.
...
- projected world pressure: most legacy space is ordinary infrastructure history.
...
- Source-owned institutional/world pressure: most legacy space is ordinary infrastructure history. Relationship/institution interface: accepts Sora's restriction instead of treating security as obstruction.
...
- source clue: D03 REINFORCE; avoids secret-dungeon trope.
...
- classification=REINFORCE. Source clue=D03 REINFORCE; avoids secret-dungeon trope. Outgoing selector=transit maintenance outside the case forces supplies to reroute. No authorial ominous narration beyond Blueprint evidence.
- ordinary-cause guard: mundane incidents remain allowed to be mundane; not every repeat, object, route, failure, or record gap becomes a clue.

## Genre Engine
- Execution engine: finds a mundane reason much of the area is closed—obsolete pressure/fire isolation—plus one repair seam whose chronology still does not fit. Immediate Want: inspect only the physically relevant section. Act guard: Ordinary-world first. Do not objectively confirm regression, branching, substrate, or HUMAN:1; ordinary failures remain genuinely possible.
- causal diversity guard: rotate practical, social, institutional, survival, mystery, relationship, and cost/reward engines as Blueprint assigns; no protagonist causal monopoly.

## Execution Constraints
- exact Blueprint A-Plot: finds a mundane reason much of the area is closed—obsolete pressure/fire isolation—plus one repair seam whose chronology still does not fit.
- exact Immediate Want: inspect only the physically relevant section.
- exact End Turn: transit maintenance outside the case forces supplies to reroute.
...
## Forecast Outgoing
- projected End Turn: transit maintenance outside the case forces supplies to reroute.
...
1. Episode Card — exact EP033 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=restricted Old Works access; current world/material/location router, branch=H-A.
