...
source_snapshot: router=CTX-V3-EP263; blueprint=docs/prewriting-v3/EPISODE-BLUEPRINT-ACT6-v0.1.md; mode=blueprint-compiled
...
---
# DEEP V3 EP263 — 강제로 움직이게 할 수 있는가
...
- subact: SA-V3-6C
- beat: BEAT-V3-B36
- blueprint: docs/prewriting-v3/EPISODE-BLUEPRINT-ACT6-v0.1.md selector `EP263`
- branch: H-B
- concurrency: ACT6_LEDGER
- Current-lived namespace remains H-B; cross-branch inheritance stays blocked unless explicitly sourced.

## Projected Incoming
FORECAST from EP262: End Turn=civic pressure asks for a binary recommendation. | Continuity Output=No explicit Continuity Output.. This is not realized Actual; replace with JIT CONTINUITY-FROZEN before drafting.
...
- projected relationship line: hardliners call her weak; civil networks call her authoritarian.
...
- projected world pressure: emergency power cannot produce technical safety.
...
- Source-owned institutional/world pressure: emergency power cannot produce technical safety. Relationship/institution interface: hardliners call her weak; civil networks call her authoritarian.
...
- classification=NONE. Source clue=NONE. Outgoing selector=Juno's network considers blocking freight to force medical allocation change. No authorial ominous narration beyond Blueprint evidence.
...
## Forecast Outgoing
- projected End Turn: Juno's network considers blocking freight to force medical allocation change.
...
1. Episode Card — exact EP263 Blueprint selector; A-Plot/Want/End Turn authority.
...
4. World/Zone/Material — Zone=Civic Core / infrastructure perimeter; current world/material/location router, branch=H-B.
