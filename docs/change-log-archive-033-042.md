# Design Change Log Archive — CHG-033~042

Archived: 2026-08-18

This archive preserves the active change history immediately before final Package H/I, P1 closure and Canon Freeze v2.
...
- Status at that checkpoint: `STRUCTURAL GRAPH PASS / FULL DATASET PENDING`
...
- Status at checkpoint: `STRUCTURAL BASE PASS / CROSS-PACKAGE DEPENDENCIES OPEN`
...
- New:
  ...
  - `Sub-Act candidate ≠ episode exposure` made a hard rule.
  - full Reveal/PR-H1/Arrival/Insertion/POV/Shadow-Canon regression added.
  - exact locked full-series POV totals reproduced.
...
- Blocking P0: 0
- Status: `PACKAGE G NARRATIVE ENGINEERING DESIGN PASS / 230/230 REGISTRY`.
